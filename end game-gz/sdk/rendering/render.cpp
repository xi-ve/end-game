...
bool sdk::render::c_render::IsRenderClassInitialized()
{
	return this->bIsInitialized;
}

bool sdk::render::c_render::InitializeRenderClass(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext, float DefaultFontSize, char* DefaultFont, UINT DefaultFontFlags)
{
...
void sdk::render::c_render::RenderText(int x, int y, DWORD color, char* szText, ...)
{
...
void sdk::render::c_render::_RenderText(int x, int y, DWORD color, float Size, UINT Flags, char* szText, ...)
{
	if (this->bIsInitialized == false)
		return;
...
void sdk::render::c_render::FillARGB(int x, int y, int w, int h, DWORD color/*ARGB*/)
{
	int a = (color >> 24) & 0xff;
	int r = (color >> 16) & 0xff;
	int g = (color >> 8) & 0xff;
...
void sdk::render::c_render::DrawLine(int x, int y, int x1, int y1, DWORD color/*ARGB*/)
{
	int a = (color >> 24) & 0xff;
	int r = (color >> 16) & 0xff;
	int g = (color >> 8) & 0xff;
...
void sdk::render::c_render::DrawCircle(int x, int y, int radius, DWORD color/*ARGB*/)
{
	int a = (color >> 24) & 0xff;
	int r = (color >> 16) & 0xff;
	int g = (color >> 8) & 0xff;
...
void sdk::render::c_render::DrawBorder(int x, int y, int w, int h, int px, DWORD BorderColor)
{
...
void sdk::render::c_render::DrawBox(int x, int y, int w, int h, DWORD BoxColor, DWORD BorderColor)
{
...
void sdk::render::c_render::DrawRadar(int x, int y, int size)
{
...
void sdk::render::c_render::DrawRectInternal(int x0, int y0, int x1, int y1, int r, int g, int b, int a)
{
	if (this->bIsInitialized == false)
		return;
...
void sdk::render::c_render::DrawLineInternal(int x0, int y0, int x1, int y1, int r, int g, int b, int a)
{
	if (this->bIsInitialized == false)
		return;
...
void sdk::render::c_render::DrawCircleInternal(int x0, int y0, int radius, int r, int g, int b, int a)
{
	if (this->bIsInitialized == false)
		return;
...
sdk::render::c_render* sdk::render::render;