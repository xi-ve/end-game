...
uint64_t core::offsets::hk::packet_outbound = 0x140E19790;
//tostring
uint64_t core::offsets::hk::lua_to_string = 0x141E78150;
//48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 20 48 8B 39 48 8B F2 
uint64_t core::offsets::hk::lua_do_buffer = 0x14162A770;
//48 89 4C 24 ? 57 48 83 EC 30 48 C7 44 24 ? ? ? ? ? 48 89 5C 24 ? 48 89 74 24 ? 8B F2 48 8B D9 48 8D 05 ? ? ? ? 48 89 01 48 8D B9 ? ? ? ? 48 8B 07 
uint64_t core::offsets::hk::proxy_deadbody = 0x140818D10;//0x1407F77C0;//ref v7 = sub_xxxx(0x4A0...  /1160
//89 54 24 10 55 56 57 41 54 41 55 41 56 41 57 48 83 EC 40 48 C7 44 24 ? ? ? ? ? 
uint64_t core::offsets::hk::proxy_delete = 0x1408025F0;
//48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 20 8B F2 41 0F B6 F8 
uint64_t core::offsets::hk::is_key_pressed = 0x1419AB490;
//40 53 48 83 EC 20 48 8B D9 33 D2 48 83 C1 40 
uint64_t core::offsets::hk::reset_input_class = 0x1419AB520;
//40 53 48 83 EC 20 48 8B C2 48 8B D9 48 85 D2 75 06 
uint64_t core::offsets::hk::focus_validator = 0x14197F100;
//44 89 4C 24 ? 44 89 44 24 ? 89 54 24 10 48 89 4C 24 ? 55 
uint64_t core::offsets::hk::add_damage = 0x140B5FB70;


//C6 83 ? ? ? ? ? 48 85 FF 
uint64_t core::offsets::patch::walk_to_pos = 0x1407242B0;
//48 8B CB 40 84 F6 0F 84 ? ? ? ? 48 8D 54 24 ? 
uint64_t core::offsets::patch::walk_mouse = 0x1407243A1 + 0x18;
//48 8B C4 48 89 48 08 55 48 8D 68 A1 48 81 EC ? ? ? ? 48 C7 45 ? ? ? ? ? 48 89 58 10 48 89 70 18 48 89 78 20 0F 29 70 E8 
uint64_t core::offsets::patch::window_focus_validity = 0x1402F6250;
//48 8D 0D ? ? ? ? E8 ? ? ? ? 84 C0 75 13 45 33 C0 48 8B CF 41 8D 50 28 
uint64_t core::offsets::patch::window_base = 0x143E41960;


//48 8B 35 ? ? ? ? 48 85 F6 0F 84 ? ? ? ? 48 8B 76 18
uint64_t core::offsets::cl::client_base = 0x143DF4B80;
//0F 29 05 ? ? ? ? 0F 10 4C 24 ? 0F 29 0D ? ? ? ? 0F 10 44 24 ? 0F 29 05 ? ? ? ? 0F 10 4C 24 ? 0F 29 0D ? ? ? ? 0F 28 05 ? ? ? ?
uint64_t core::offsets::cl::camera_matrice = 0x144F8C5E0;
//48 8B 05 ? ? ? ? 4C 8B 00 48 8B 48 08 49 2B C8 48 C1 F9 04 48 3B CA 76 40 
uint64_t core::offsets::cl::ascii_table = 0x143DF4C48;
//81 0D ? ? ? ? ? ? ? ? 48 8B 05 ? ? ? ? C6 05 ? ? ? ? ? 
uint64_t core::offsets::cl::loot_base = 0x143E4AFB0;
//F2 0F 10 35 ? ? ? ? F2 0F 11 74 24 ? 44 8B 3D ? ? ? ? 
uint64_t core::offsets::cl::cursor_world = 0x143E4A1E8;
//48 8D 0D ? ? ? ? C7 80 ? ? ? ? ? ? ? ? E8 ? ? ? ? 
uint64_t core::offsets::cl::dialog_base = 0x143E4F230;
//48 8B 05 ? ? ? ? 48 8B 90 ? ? ? ? 48 8B 4A 48 
uint64_t core::offsets::cl::ui_manager = 0x143DFD028;
//ch_updatingSkinningTextureBatchSize second off_14xxxxx counting upwards
uint64_t core::offsets::cl::symvar_base = 0x143CB9748;


//48 8B C4 56 57 41 56 48 81 EC ? ? ? ? 48 C7 80 ? ? ? ? ? ? ? ? 48 89 58 10 48 89 68 18 0F 29 70 D8 
uint64_t core::offsets::fn::cast_ray = 0x14175E870;
...
uint64_t core::offsets::fn::start_npc_dialog = 0x1403667B0;
//E8 ? ? ? ? E9 ? ? ? ? 41 8B 86 ? ? ? ? C1 E8 08 A8 01 49 8B CE 
uint64_t core::offsets::fn::start_npc_interaction = 0x1408607C0;
//getGradeType
uint64_t core::offsets::fn::loot_get_rarity = 0x140C24090;
//ItemEnchantStaticStatusWrapper getName
uint64_t core::offsets::fn::loot_get_name = 0x140C23E90;
//looting_getItem
uint64_t core::offsets::fn::loot_get_base = 0x140AC85C0;
//looting_slotClick
uint64_t core::offsets::fn::loot_click_slot = 0x140AC8A80;
//looting_getItemCount
uint64_t core::offsets::fn::loot_item_count = 0x140AC8700;
//40 53 48 83 EC 30 48 C7 44 24 ? ? ? ? ? 0F B6 DA 0F B6 D1 
uint64_t core::offsets::fn::inv_get_item = 0x140AC5890;
//40 53 48 83 EC 50 48 C7 44 24 ? ? ? ? ? 48 8B D9 48 8D 51 20 33 C0 66 3B 02 73 0C 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 8D 90 ? ? ? ? 
uint64_t core::offsets::fn::buff_get_name = 0x140AC5890;
//40 57 48 83 EC 50 48 C7 44 24 ? ? ? ? ? 48 89 5C 24 ? 48 89 74 24 ? 48 8B D9 C7 44 24 ? ? ? ? ? 65 48 8B 04 25 ? ? ? ? B9 ? ? ? ? 48 8B 10 8B 04 11 39 05 ? ? ? ? 0F 8F ? ? ? ? 
uint64_t core::offsets::fn::dialog_gettext = 0x14068A660;
//4C 8B 41 70 48 B8 ? ? ? ? ? ? ? ? 48 8B 49 78 4C 63 CA 49 2B C8 48 F7 E9 48 C1 FA 05 
uint64_t core::offsets::fn::dialog_getbutton = 0x14068AFE0;
//E8 ? ? ? ? 83 F8 FF 0F 84 ? ? ? ? 4C 89 B4 24 ? ? ? ? 
uint64_t core::offsets::fn::canjump = 0x14168EAE0;
//48 83 EC 68 48 C7 44 24 ? ? ? ? ? 8B C1 
uint64_t core::offsets::fn::delete_item = 0x143E4A1A0;
//80 F9 20 0F 83 ? ? ? ? 48 83 EC 58 
uint64_t core::offsets::fn::uneq_item = 0x140AC82E0;

//FromClient_SelfPlayerExpChanged
uint64_t core::offsets::actor::actor_self = 0x143E4A1A0;
//48 8B 35 ? ? ? ? 45 33 FF 48 85 F6 
uint64_t core::offsets::actor::interaction_current = 0x143E4F260;
//48 8D 15 ? ? ? ? 48 8D 4D EF E8 ? ? ? ? 90 4C 8B 75 F7  
uint64_t core::offsets::actor::actor_list_base = 0x143E49CF0;//-40 to list
uint64_t core::offsets::actor::actor_list_start = 0x143E49D30;//470 delta to local
...
uint64_t core::offsets::actor::actor_inv_base = 0x1F38;
...
uint64_t core::offsets::actor::actor_cursor_3d_x = 0x5D80;
...
uint64_t core::offsets::actor::actor_inv_max_weight = 0x10D0;
uint64_t core::offsets::actor::actor_guild_name = 0x1330;
uint64_t core::offsets::actor::actor_inv_gear_weight = 0x2180;
