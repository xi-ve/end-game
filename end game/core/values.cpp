...
uint64_t core::offsets::hk::packet_outbound = 0x140DE6560;
//tostring
uint64_t core::offsets::hk::lua_to_string = 0x141E180A0;
//48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 20 48 8B 39 48 8B F2 
uint64_t core::offsets::hk::lua_do_buffer = 0x1415CB890;
...
uint64_t core::offsets::hk::reset_input_class = 0x14194B520;
//40 53 48 83 EC 20 48 8B C2 48 8B D9 48 85 D2 75 06 
uint64_t core::offsets::hk::focus_validator = 0x014191F6D0;
//44 89 4C 24 ? 44 89 44 24 ? 89 54 24 10 48 89 4C 24 ? 55 
uint64_t core::offsets::hk::add_damage = 0x140B31BE0;


//C6 83 ? ? ? ? ? 48 85 FF 
uint64_t core::offsets::patch::walk_to_pos = 0x14070DE70;
//48 8B CB 40 84 F6 0F 84 ? ? ? ? 48 8D 54 24 ? 
uint64_t core::offsets::patch::walk_mouse = 0x14070DF61 + 0x18;
...
uint64_t core::offsets::cl::client_base = 0x143D60320;
//0F 29 05 ? ? ? ? 0F 10 4C 24 ? 0F 29 0D ? ? ? ? 0F 10 44 24 ? 0F 29 05 ? ? ? ? 0F 10 4C 24 ? 0F 29 0D ? ? ? ? 0F 28 05 ? ? ? ?
uint64_t core::offsets::cl::camera_matrice = 0x144BE8390;
//48 8B 05 ? ? ? ? 4C 8B 00 48 8B 48 08 49 2B C8 48 C1 F9 04 48 3B CA 76 40 
uint64_t core::offsets::cl::ascii_table = 0x143D603D8;
//81 0D ? ? ? ? ? ? ? ? 48 8B 05 ? ? ? ? C6 05 ? ? ? ? ? 
uint64_t core::offsets::cl::loot_base = 0x143DB60E0;
//F2 0F 10 35 ? ? ? ? F2 0F 11 74 24 ? 44 8B 3D ? ? ? ? 
uint64_t core::offsets::cl::cursor_world = 0x143DB5318;
//48 8D 0D ? ? ? ? C7 80 ? ? ? ? ? ? ? ? E8 ? ? ? ? 
uint64_t core::offsets::cl::dialog_base = 0x143DBA360;
//
uint64_t core::offsets::cl::ui_manager = 0x143D687D8;


//48 8B C4 56 57 41 56 48 81 EC ? ? ? ? 48 C7 80 ? ? ? ? ? ? ? ? 48 89 58 10 48 89 68 18 0F 29 70 D8 
uint64_t core::offsets::fn::cast_ray = 0x1416FF140;
...
uint64_t core::offsets::fn::start_npc_dialog = 0x14035C3D0;
//48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 30 48 8B F9 FF 15 ? ? ? ? 
uint64_t core::offsets::fn::start_npc_interaction = 0x14083EB90;
//getGradeType
uint64_t core::offsets::fn::loot_get_rarity = 0x140BF4FA0;
//40 53 48 83 EC 50 48 C7 44 24 ? ? ? ? ? 48 8D 91 ? ? ? ? 83 3A 00 75 0D 48 8D 05 ? ? ? ? 48 83 C4 50 5B C3 48 8D 59 68 48 C7 43 ? ? ? ? ? 
uint64_t core::offsets::fn::loot_get_name = 0x140BF4DA0;
//looting_getItem
uint64_t core::offsets::fn::loot_get_base = 0x140A9C070;
//looting_slotClick
uint64_t core::offsets::fn::loot_click_slot = 0x140A9C530;
//looting_getItemCount
uint64_t core::offsets::fn::loot_item_count = 0x140A9C1B0;
//40 53 48 83 EC 30 48 C7 44 24 ? ? ? ? ? 0F B6 DA 0F B6 D1 
uint64_t core::offsets::fn::inv_get_item = 0x140A99400;
//40 53 48 83 EC 50 48 C7 44 24 ? ? ? ? ? 48 8B D9 48 8D 51 20 33 C0 66 3B 02 73 0C 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 8D 90 ? ? ? ? 
uint64_t core::offsets::fn::buff_get_name = 0x1403073D0;
//40 57 48 83 EC 50 48 C7 44 24 ? ? ? ? ? 48 89 5C 24 ? 48 89 74 24 ? 48 8B D9 C7 44 24 ? ? ? ? ? 65 48 8B 04 25 ? ? ? ? B9 ? ? ? ? 48 8B 10 8B 04 11 39 05 ? ? ? ? 0F 8F ? ? ? ? 
uint64_t core::offsets::fn::dialog_gettext = 0x1406794F0;
//4C 8B 41 70 48 B8 ? ? ? ? ? ? ? ? 48 8B 49 78 4C 63 CA 49 2B C8 48 F7 E9 48 C1 FA 05 
uint64_t core::offsets::fn::dialog_getbutton = 0x140679E70;
//E8 ? ? ? ? 83 F8 FF 0F 84 ? ? ? ? 4C 89 B4 24 ? ? ? ? 
uint64_t core::offsets::fn::canjump = 0x14162F650;

//FromClient_SelfPlayerExpChanged
uint64_t core::offsets::actor::actor_self = 0x143DB52D0;
//48 8B 35 ? ? ? ? 45 33 FF 48 85 F6 
uint64_t core::offsets::actor::interaction_current = 0x143DBA390;
//48 8D 15 ? ? ? ? 48 8D 4D EF E8 ? ? ? ? 90 4C 8B 75 F7  
uint64_t core::offsets::actor::actor_list_base = 0x143DB4E20;//-40 to list
uint64_t core::offsets::actor::actor_list_start = 0x143DB4E60;//470 delta to local
...
uint64_t core::offsets::actor::actor_inv_base = 0x1F08;
...
uint64_t core::offsets::actor::actor_cursor_3d_x = 0x5D38;
...
uint64_t core::offsets::actor::actor_inv_gear_weight = 0x2138;
