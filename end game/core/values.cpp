...
uint64_t core::offsets::hk::packet_outbound = 0x140DE4110;
//tostring
uint64_t core::offsets::hk::lua_to_string = 0x141E14770;
//48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC 20 48 8B 39 48 8B F2 
uint64_t core::offsets::hk::lua_do_buffer = 0x1415C8140;
...
uint64_t core::offsets::hk::proxy_deadbody = 0x1407F7E10;//ref v7 = sub_xxxx(0x488...  /1160
...
uint64_t core::offsets::hk::is_key_pressed = 0x141947B60;
//40 53 48 83 EC 20 48 8B D9 33 D2 48 83 C1 40 
uint64_t core::offsets::hk::reset_input_class = 0x141947BF0;
//40 53 48 83 EC 20 48 8B C2 48 8B D9 48 85 D2 75 06 
uint64_t core::offsets::hk::focus_validator = 0x14191BDA0;
//44 89 4C 24 ? 44 89 44 24 ? 89 54 24 10 48 89 4C 24 ? 55 
uint64_t core::offsets::hk::add_damage = 0x140B2F350;


//C6 83 ? ? ? ? ? 48 85 FF 
uint64_t core::offsets::patch::walk_to_pos = 0x14070E300;
//48 8B CB 40 84 F6 0F 84 ? ? ? ? 48 8D 54 24 ? 
uint64_t core::offsets::patch::walk_mouse = 0x14070E3F1 + 0x18;
//48 8B C4 48 89 48 08 55 48 8D 68 A1 48 81 EC ? ? ? ? 48 C7 45 ? ? ? ? ? 48 89 58 10 48 89 70 18 48 89 78 20 0F 29 70 E8 
uint64_t core::offsets::patch::window_focus_validity = 0x1402EB4C0;
...
uint64_t core::offsets::cl::client_base = 0x143D5AF20;
//0F 29 05 ? ? ? ? 0F 10 4C 24 ? 0F 29 0D ? ? ? ? 0F 10 44 24 ? 0F 29 05 ? ? ? ? 0F 10 4C 24 ? 0F 29 0D ? ? ? ? 0F 28 05 ? ? ? ?
uint64_t core::offsets::cl::camera_matrice = 0x144BE1360;
//48 8B 05 ? ? ? ? 4C 8B 00 48 8B 48 08 49 2B C8 48 C1 F9 04 48 3B CA 76 40 
uint64_t core::offsets::cl::ascii_table = 0x143D5AFD8;
...
uint64_t core::offsets::fn::cast_ray = 0x1416FB810;
...
uint64_t core::offsets::fn::start_npc_dialog = 0x14035C2E0;
//48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC 30 48 8B F9 FF 15 ? ? ? ? 
uint64_t core::offsets::fn::start_npc_interaction = 0x14083EE40;
//getGradeType
uint64_t core::offsets::fn::loot_get_rarity = 0x140BF2980;
//40 53 48 83 EC 50 48 C7 44 24 ? ? ? ? ? 48 8D 91 ? ? ? ? 83 3A 00 75 0D 48 8D 05 ? ? ? ? 48 83 C4 50 5B C3 48 8D 59 68 48 C7 43 ? ? ? ? ? 
uint64_t core::offsets::fn::loot_get_name = 0x140BF2780;
//looting_getItem
uint64_t core::offsets::fn::loot_get_base = 0x140A99C50;
//looting_slotClick
uint64_t core::offsets::fn::loot_click_slot = 0x140A9A110;
//looting_getItemCount
uint64_t core::offsets::fn::loot_item_count = 0x140A99D90;
...
uint64_t core::offsets::actor::interaction_current = 0x143DB4F90;
//48 8D 15 ? ? ? ? 48 8D 4D EF E8 ? ? ? ? 90 4C 8B 75 F7  
uint64_t core::offsets::actor::actor_list_base = 0x143DAFA20;//-40 to list
uint64_t core::offsets::actor::actor_list_start = 0x143DAFA60;//470 delta to local
...
uint64_t core::offsets::actor::actor_cursor_3d_x = 0x5D28;
