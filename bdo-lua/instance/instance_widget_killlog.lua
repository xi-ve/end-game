...
function dataStruct:set(attackerName, attackeeName, attackerClassType, attackeeClassType, attackerKey, attackeeKey)
  ...
  if attackerClassType == __eClassType_ReservedBlackSpirit or attackerClassType == __eClassType_Count then
...
function logStruct:addLog(data)
  local stringHead = ""
  if data.attackerName == data.attackeeName and data.attackerClassType == __eClassType_ReservedBlackSpirit then
...
function FromClient_killLog_BattleRoyaleKillLog(attackerName, attackeeName, attackerClassType, attackeeClassType, attackerKey, attackeeKey)
  ...
  if attackerName == myName and __eClassType_ReservedBlackSpirit ~= attackerClassType and __eClassType_Count ~= attackerClassType then
    local msg = {}
