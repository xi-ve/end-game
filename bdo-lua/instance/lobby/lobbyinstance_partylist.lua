...
function FGlobal_PartyList_ShowToggle()
  ...
  partyList.control._txtMessage:SetTextMode(__eTextMode_AutoWrap)
...
function partyList:RegisterEvent()
  ...
  self.control._list2PartyList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PartyListControlCreate")
  self.control._list2PartyList:createChildContent(__ePAUIList2ElementManagerType_List)
