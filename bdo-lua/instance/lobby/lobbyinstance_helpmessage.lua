...
local _staticDescBG = UI.getChildControl(LobbyInstance_HelpMessage, "Static_DescBG")
local _staticTextDesc = UI.getChildControl(LobbyInstance_HelpMessage, "StaticText_Desc")
...
function HelpMessageQuestion_On()
  if getMousePosX() <= getScreenSizeX() / 2 and getMousePosY() <= getScreenSizeY() / 2 then
    LobbyInstance_HelpMessage:SetPosX(getMousePosX() + 15)
    LobbyInstance_HelpMessage:SetPosY(getMousePosY() + 15)
  elseif getMousePosX() > getScreenSizeX() / 2 and getMousePosY() <= getScreenSizeY() / 2 then
    LobbyInstance_HelpMessage:SetPosX(getMousePosX() - 200)
    LobbyInstance_HelpMessage:SetPosY(getMousePosY() + 15)
  elseif getMousePosX() <= getScreenSizeX() / 2 and getMousePosY() > getScreenSizeY() / 2 then
    LobbyInstance_HelpMessage:SetPosX(getMousePosX() + 15)
    LobbyInstance_HelpMessage:SetPosY(getMousePosY() - 90)
  else
    LobbyInstance_HelpMessage:SetPosX(getMousePosX() - 200)
    LobbyInstance_HelpMessage:SetPosY(getMousePosY() - 90)
  end
  LobbyInstance_HelpMessage:SetShow(true)
end
