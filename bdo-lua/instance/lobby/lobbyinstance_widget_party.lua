...
function partyWidget:updatePartyList()
  ...
  if true == LobbyInstance_Widget_Party:GetShow() then
    ...
    self._partyMemberCount = partyMemberCount
  elseif false == LobbyInstance_Widget_Party:GetShow() and 1 < partyMemberCount then
...
function partyWidget:setScreenSize()
  ...
  local initPosX = 10
  local initPosY = LobbyInstance_Widget_Rating:GetSizeY()
  local result = getScreenSizeY() - self._ui._static_PartyMember_Template:GetSizeY() * self._config._maxPartyMemberCount
  if result <= LobbyInstance_Widget_Rating:GetSizeY() + Instance_Chat:GetSizeY() then
    initPosX = LobbyInstance_Widget_Rating:GetSizeX() + 10
    initPosY = 0
  end
