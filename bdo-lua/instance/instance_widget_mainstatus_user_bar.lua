...
local classIconUV = {
  [__eClassType_Warrior] = float4(137, 176, 175, 214),
  [__eClassType_ElfRanger] = float4(176, 176, 214, 214),
  [__eClassType_Sorcerer] = float4(215, 176, 253, 214),
  [__eClassType_Giant] = float4(254, 176, 292, 214),
  [__eClassType_Tamer] = float4(293, 176, 331, 214),
  [__eClassType_BladeMaster] = float4(332, 176, 370, 214),
  [__eClassType_Valkyrie] = float4(371, 176, 409, 214),
  [__eClassType_BladeMasterWoman] = float4(410, 176, 448, 214),
  [__eClassType_WizardMan] = float4(137, 215, 175, 253),
  [__eClassType_WizardWoman] = float4(176, 215, 214, 253),
  [__eClassType_Kunoichi] = float4(215, 215, 253, 253),
  [__eClassType_NinjaMan] = float4(254, 215, 292, 253),
  [__eClassType_DarkElf] = float4(293, 215, 331, 253),
  [__eClassType_Combattant] = float4(332, 215, 370, 253),
  [__eClassType_Mystic] = float4(371, 215, 409, 253),
  [__eClassType_Lhan] = float4(410, 215, 448, 253),
  [__eClassType_RangerMan] = float4(137, 254, 175, 292)
}
...
function PaGlobalFunc_UserBar_CharacterInfoWindowUpdate()
  ...
  local isFP_Character = __eClassType_Warrior == playerWrapper:getClassType() or __eClassType_Giant == playerWrapper:getClassType() or __eClassType_BladeMaster == playerWrapper:getClassType() or __eClassType_BladeMasterWoman == playerWrapper:getClassType() or __eClassType_Kunoichi == playerWrapper:getClassType() or __eClassType_Combattant == playerWrapper:getClassType() or __eClassType_Lhan == playerWrapper:getClassType()
