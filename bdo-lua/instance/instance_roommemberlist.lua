...
function roomMemberList:registEventHandler()
  self._ui.list_roomMember:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_roomMemberList_CreateControl")
  self._ui.list_roomMember:createChildContent(__ePAUIList2ElementManagerType_List)
