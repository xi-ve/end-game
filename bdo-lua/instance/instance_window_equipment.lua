...
local toolTip_Templete = UI.getChildControl(Instance_Window_Equipment, "StaticText_Notice_1")
...
function Equipment_NilSlot_MouseOn(slotNo, isOn)
  ...
  if true == isOn then
    ...
    toolTip_BlankSlot:SetPosY(getMousePosY() - Instance_Window_Equipment:GetPosY() - 50)
