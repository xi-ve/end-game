...
function RadarMap_Init()
  Panel_RadarRealLine.panel = Panel_SA_Widget_Minimap
  ...
  for index = 0, loopCount do
    Panel_RadarRealLine.mapImage[index] = UI.createControl(__ePAUIControl_Static, radar_Background, "Static_minimap_Image_" .. index)
  ...
  for index = 0, loopCount do
    Panel_RadarRealLine.desertMapImage[index] = UI.createControl(__ePAUIControl_Static, radar_Background, "Static_minimap_ImageDesert_" .. index)
  ...
  Panel_SA_Widget_Minimap:RemoveControl(radarMap.controls.mapLine_next)
  Panel_SA_Widget_Minimap:RemoveControl(radarMap.controls.mapLine_current)
end
local function updatePanel()
  if getEnableSimpleUI() then
    ...
    local IsMouseOver = radarPosX < mousePosX and mousePosX < radarPosX + Panel_SA_Widget_Minimap:GetSizeX() and radarPosY < mousePosY and mousePosY < radarPosY + Panel_SA_Widget_Minimap:GetSizeY()
