...
Panel_SA_Widget_Minimap:setGlassBackground(true)
Panel_SA_Widget_Minimap:RegisterShowEventFunc(true, "RadarShowAni()")
Panel_SA_Widget_Minimap:RegisterShowEventFunc(false, "RadarHideAni()")
local PaGlobal_SA_Widget_Rader = {_isGameStart = false}
local radarType = {
  radarType_none = 0,
  radarType_hide = 1,
...
local template = {
  ...
  [radarType.radarType_hide] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_hide"),
  [radarType.radarType_allymonster] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_horse"),
  [radarType.radarType_normalMonster] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_monsterGeneral_normal"),
  [radarType.radarType_namedMonster] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_monsterNamed_normal"),
  [radarType.radarType_bossMonster] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_monsterBoss_normal"),
  [radarType.radarType_normalMonsterQuestTarget] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_monsterGeneral_quest"),
  [radarType.radarType_namedMonsterQuestTarget] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_monsterNamed_quest"),
  [radarType.radarType_bossMonsterQuestTarget] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_monsterBoss_quest"),
  [radarType.radarType_lordManager] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_lordManager"),
  [radarType.radarType_skillTrainner] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_skillTrainner"),
  [radarType.radarType_tradeMerchantNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_trader"),
  [radarType.radarType_nodeManager] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_nodeManager"),
  [radarType.radarType_normalNpc] = nil,
  [radarType.radarType_warehouseNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_warehouse"),
  [radarType.radarType_potionNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_potion"),
  [radarType.radarType_weaponNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_storeArmor"),
  [radarType.radarType_horseNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_horse"),
  [radarType.radarType_workerNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_worker"),
  [radarType.radarType_jewelNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_jewel"),
  [radarType.radarType_furnitureNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_furniture"),
  [radarType.radarType_collectNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_collect"),
  [radarType.radarType_shipNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_ship"),
  [radarType.radarType_alchemyNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_alchemy"),
  [radarType.radarType_fishNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_fish"),
  [radarType.radarType_guild] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_guild"),
  [radarType.radarType_guildShop] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_guildShop"),
  [radarType.radarType_itemTrader] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_itemTrader"),
  [radarType.radarType_TerritorySupply] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_territorySupply"),
  [radarType.radarType_TerritoryTrade] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_territoryTrade"),
  [radarType.radarType_Cook] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_cook"),
  [radarType.radarType_Wharf] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_wharf"),
  [radarType.radarType_itemRepairer] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_repairer"),
  [radarType.radarType_shopMerchantNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_shop"),
  [radarType.radarType_ImportantNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_important"),
  [radarType.radarType_QuestAcceptable] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_quest_accept"),
  [radarType.radarType_QuestProgress] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_quest_doing"),
  [radarType.radarType_QuestComplete] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_quest_clear"),
  [radarType.radarType_unknownNpc] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_npc_unknown"),
  [radarType.radarType_partyMember] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_partyMember"),
  [radarType.radarType_guildMember] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_guildMember"),
  [radarType.radarType_normalPlayer] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_player"),
  [radarType.radarType_isHorse] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_horse"),
  [radarType.radarType_isDonkey] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_donkey"),
  [radarType.radarType_isShip] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_ship"),
  [radarType.radarType_isCarriage] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_carriage"),
  [radarType.radarType_isCamel] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_camel"),
  [radarType.radarType_isElephant] = nil,
  [radarType.radarType_isBabyElePhant] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_babyElephant"),
  [radarType.radarType_installation] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_tent"),
  [radarType.radarType_kingGuildTent] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_tent"),
  [radarType.radarType_lordGuildTent] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_tent"),
  [radarType.radarType_villageGuildTent] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_tent"),
  [radarType.radarType_selfDeadBody] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_deadbody"),
  [radarType.radarType_advancedBase] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_Outpost"),
  [radarType.radarType_Raft] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_Raft"),
  [radarType.radarType_Boat] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_Boat"),
  [radarType.radarType_FishingBoat] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_FishingBoat"),
  [radarType.radarType_PersonalTradeShip] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_PersonalTradeShip"),
  [radarType.radarType_GalleyShip] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_GalleyShip"),
  [radarType.radarType_PersonalBattleShip] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_PersonalBattleShip"),
  [radarType.radarType_huntingMonster] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_monsterHunting_normal"),
  [radarType.radarType_huntingMonsterQuestTarget] = UI.getChildControl(Panel_SA_Widget_Minimap, "icon_monsterHunting_quest")
}
local typeDepth = {
...
local miniMapBG = UI.getChildControl(Panel_SA_Widget_Minimap, "Static_Minimap")
local radar_regionName = UI.getChildControl(miniMapBG, "StaticText_RegionCondition")
local rader_ramainTimer = UI.getChildControl(miniMapBG, "StaticText_RemainTimer")
rader_ramainTimer:SetShow(false)
rader_ramainTimer:SetText(PAGetStringParam2(Defines.StringSheet_GAME, "LUA_BATTLEROYAL_RESULT_TIME", "minute", tostring(0), "second", tostring(0)))
local radar_regionNodeName = UI.getChildControl(Panel_SA_Widget_Minimap, "StaticText_RegionNodeName")
local radar_regionWarName = UI.getChildControl(Panel_SA_Widget_Minimap, "StaticText_RegionWarName")
local radar_DangerIcon = UI.getChildControl(Panel_SA_Widget_Minimap, "Static_DangerArea")
local redar_DangerAletText = UI.getChildControl(Panel_SA_Widget_Minimap, "StaticText_MonsterAlert")
local radar_DangetAlertBg = UI.getChildControl(Panel_SA_Widget_Minimap, "Static_Alert")
local radar_WarAlert = UI.getChildControl(Panel_SA_Widget_Minimap, "StaticText_WarAlert")
local radar_GuildTeamBattleAlert = UI.getChildControl(Panel_SA_Widget_Minimap, "StaticText_GuildTeamBattleAlert")
local radar_ChangeBtn = UI.getChildControl(Panel_SA_Widget_Minimap, "Button_Swap")
local radar_SequenceAni = UI.getChildControl(Panel_SA_Widget_Minimap, "Static_SequenceAni")
...
UI.getChildControl(Panel_SA_Widget_Minimap, "StaticText_RegionName"):SetShow(false)
UI.getChildControl(Panel_SA_Widget_Minimap, "regionType"):SetShow(false)
...
local function radarAlert_Resize()
  if redar_DangerAletText:GetSizeY() < redar_DangerAletText:GetTextSizeY() then
    redar_DangerAletText:SetSize(Panel_SA_Widget_Minimap:GetSizeX() - 60, redar_DangerAletText:GetSizeY() + 20)
  else
    redar_DangerAletText:SetSize(Panel_SA_Widget_Minimap:GetSizeX() - 60, redar_DangerAletText:GetSizeY())
  end
  if radar_WarAlert:GetSizeY() < radar_WarAlert:GetTextSizeY() then
    radar_WarAlert:SetSize(Panel_SA_Widget_Minimap:GetSizeX() - 60, radar_WarAlert:GetSizeY() + 20)
  else
    radar_WarAlert:SetSize(Panel_SA_Widget_Minimap:GetSizeX() - 60, radar_WarAlert:GetSizeY())
  end
  if radar_GuildTeamBattleAlert:GetSizeY() < radar_GuildTeamBattleAlert:GetTextSizeY() then
    radar_GuildTeamBattleAlert:SetSize(Panel_SA_Widget_Minimap:GetSizeX() - 60, radar_GuildTeamBattleAlert:GetSizeY() + 20)
  else
    radar_GuildTeamBattleAlert:SetSize(Panel_SA_Widget_Minimap:GetSizeX() - 60, radar_GuildTeamBattleAlert:GetSizeY())
  end
...
local terrainNotice = UI.getChildControl(Panel_SA_Widget_Minimap, "Static_Notice")
local terrainNoticeStyle = UI.getChildControl(Panel_SA_Widget_Minimap, "StaticText_Notice")
local terrainNoticeText = UI.createControl(UCT_STATICTEXT, terrainNotice, "terrainNoticeText")
local textInfo = ""
Panel_SA_Widget_Minimap:SetChildIndex(terrainNotice, 9999)
...
local function controlAlignForNomal()
  radarMap.scaleRateWidth = Panel_SA_Widget_Minimap:GetSizeX() * Panel_ReciprocalOrigSizeX
  radarMap.scaleRateHeight = Panel_SA_Widget_Minimap:GetSizeY() * Panel_ReciprocalOrigSizeY
...
local function controlAlignForRemaster()
  if false == Panel_SA_Widget_Minimap:GetShow() then
    return
  end
  radarMap.scaleRateWidth = Panel_SA_Widget_Minimap:GetSizeX() * Panel_ReciprocalOrigSizeX
  radarMap.scaleRateHeight = Panel_SA_Widget_Minimap:GetSizeY() * Panel_ReciprocalOrigSizeY
...
function FromClient_MapSizeScale()
  local origEndX = Panel_SA_Widget_Minimap:GetPosX() + Panel_SA_Widget_Minimap:GetSizeX()
  local mousePosX = getMousePosX()
  local mousePosY = getMousePosY()
  if MAX_WIDTH >= origEndX - mousePosX and origEndX - mousePosX >= Panel_OrigSizeX then
    Panel_SA_Widget_Minimap:SetPosX(mousePosX)
    Panel_SA_Widget_Minimap:SetSize(origEndX - mousePosX, Panel_SA_Widget_Minimap:GetSizeY())
    radarMap.controls.radar_Background:SetPosX(0)
    radarMap.controls.radar_Background:SetSize(origEndX - mousePosX, Panel_SA_Widget_Minimap:GetSizeY())
  end
  if MAX_HEIGHT >= mousePosY - Panel_SA_Widget_Minimap:GetPosY() and mousePosY - Panel_SA_Widget_Minimap:GetPosY() >= Panel_OrigSizeY then
    Panel_SA_Widget_Minimap:SetSize(Panel_SA_Widget_Minimap:GetSizeX(), mousePosY - Panel_SA_Widget_Minimap:GetPosY())
    radarMap.controls.radar_Background:SetSize(Panel_SA_Widget_Minimap:GetSizeX(), mousePosY - Panel_SA_Widget_Minimap:GetPosY())
  end
  local SPI = radarMap.controls.icon_SelfPlayer
  local halfSelfSizeX = SPI:GetSizeX() / 2
  local halfSelfSizeY = SPI:GetSizeY() / 2
  local halfSizeX = Panel_SA_Widget_Minimap:GetSizeX() / 2
  local halfSizeY = Panel_SA_Widget_Minimap:GetSizeY() / 2
...
function RadarMap_Background_MouseRUp()
  ...
  local mousePosX = getMousePosX()
  local mousePosY = getMousePosY()
  local posX = mousePosX - Panel_SA_Widget_Minimap:GetPosX()
  local posZ = mousePosY - Panel_SA_Widget_Minimap:GetPosY() - Panel_SA_Widget_Minimap:GetSizeY()
  ...
  if ToClient_IsShowNaviGuideGroup(0) then
    ...
    radar_MiniMapScl:AddEffect("fUI_Button_Hide", false, posX, posZ)
    local posX = mousePosX - Panel_SA_Widget_Minimap:GetPosX()
    local posY = mousePosY - Panel_SA_Widget_Minimap:GetPosY()
...
local function controlInit()
  ...
  updateWorldMapDistance(scaleMinValue + scaleSlideValue * 100)
  radarAlert_Resize()
  Panel_SA_Widget_Minimap:ChangeSpecialTextureInfoName("Renewal/Function/Console_Minimap_Mask.dds")
  Panel_SA_Widget_Minimap:setMaskingChild(true)
end
...
function RadarShowAni()
  Panel_SA_Widget_Minimap:ResetVertexAni()
  local aniInfo1 = Panel_SA_Widget_Minimap:addMoveAnimation(0, 0.3, CppEnums.PAUI_ANIM_ADVANCE_TYPE.PAUI_ANIM_ADVANCE_SIN_HALF_PI)
  aniInfo1:SetStartPosition(getScreenSizeX(), Panel_SA_Widget_Minimap:GetPosY())
  aniInfo1:SetEndPosition(getScreenSizeX() - Panel_SA_Widget_Minimap:GetSizeX() - Panel_SA_Widget_Minimap:GetSpanSize().x, Panel_SA_Widget_Minimap:GetPosY())
  aniInfo1.IsChangeChild = true
end
function RadarHideAni()
  Panel_SA_Widget_Minimap:ResetVertexAni()
  local aniInfo1 = Panel_SA_Widget_Minimap:addMoveAnimation(0, 0.3, CppEnums.PAUI_ANIM_ADVANCE_TYPE.PAUI_ANIM_ADVANCE_COS_HALF_PI)
  aniInfo1:SetStartPosition(Panel_SA_Widget_Minimap:GetPosX(), Panel_SA_Widget_Minimap:GetPosY())
  aniInfo1:SetEndPosition(Panel_SA_Widget_Minimap:GetPosX() + 600, Panel_SA_Widget_Minimap:GetPosY())
  aniInfo1.IsChangeChild = true
end
function SortRadar_IconIndex()
  local mapButton = radarMap.controls
  Panel_SA_Widget_Minimap:SetChildIndex(radar_SizeSlider, 9999)
  Panel_SA_Widget_Minimap:SetChildIndex(radar_AlphaScrl, 9999)
  Panel_SA_Widget_Minimap:SetChildIndex(mapButton.radar_Reset, 9999)
  Panel_SA_Widget_Minimap:SetChildIndex(radar_MiniMapScl, 9999)
end
function radarMap:getIdleIcon()
  ...
  if 0 < iconPool:length() then
    ...
    local make_Icon = UI.createControl(__ePAUIControl_Static, Panel_SA_Widget_Minimap, "Static_Icon_" .. self.iconCreateCount)
    return make_Icon
  end
end
...
function radarMap:getIdleQuest()
  ...
  if 0 < questPool:length() then
    ...
    local iconQuestArea = UI.createControl(__ePAUIControl_Static, Panel_SA_Widget_Minimap, "Static_QuestArea_" .. self.questCreateCount)
    local iconQuestArrow = UI.createControl(__ePAUIControl_Static, Panel_SA_Widget_Minimap, "Static_QuestArrow_" .. self.questCreateCount)
...
local function RadarMap_UpdateSelfPlayerPerFrame()
  ...
  if false == radarMap.isRotateMode then
    ...
    Panel_SA_Widget_Minimap:SetRotate(-getCameraRotation() + PI)
  end
...
local function RadarMap_UpdateQuestAreaPositionPerFrame()
  ...
  local sizeX = Panel_SA_Widget_Minimap:GetSizeX()
  local sizeY = Panel_SA_Widget_Minimap:GetSizeY()
  ...
  local radarPosX = Panel_SA_Widget_Minimap:GetPosX()
  local radarPosY = Panel_SA_Widget_Minimap:GetPosY()
  local selfPlayerControlPos = radarMap.pcPosBaseControl
...
function Panel_Radar_ShowToggle()
  local isShow = Panel_SA_Widget_Minimap:IsShow()
  if isShow then
...
function PaGlobal_Minimap_Open()
  Panel_SA_Widget_Minimap:RegisterUpdateFunc("RadarMap_UpdatePerFrame")
  Panel_SA_Widget_Minimap:SetShow(true)
  radarMap.controls.icon_SelfPlayer:SetShow(true)
  RadarBackground_Show()
end
function PaGlobal_Minimap_Close()
  Panel_SA_Widget_Minimap:ClearUpdateLuaFunc()
  Panel_SA_Widget_Minimap:SetShow(false)
...
local function partyMemberArrowIcon(index, isShow)
  if nil == iconPartyMemberArrow[index] then
    ...
    iconPartyMemberArrow[index] = UI.createControl(__ePAUIControl_Static, Panel_SA_Widget_Minimap, "Static_PartyMemberArrow_" .. index)
    ...
    Panel_SA_Widget_Minimap:SetChildIndex(iconPartyMemberArrow[index], 9999)
...
local function partyMemberIconPerFrame()
  local partyMemberCount = PaGlobalFunc_SA_Widget_Party_PartyMemberCount()
  for i = 0, 4 do
  ...
  elseif partyMemberCount <= 0 or false == PaGlobalFunc_SA_Widget_Party_GetShow() then
    return
  end
...
function RadarMap_UpdatePerFrame(deltaTime)
  ...
  PaGlobal_SA_Widget_Rader_UpdateRemainTimer(deltaTime)
end
...
function RadarMap_SimpleUIUpdatePerFrame(deltaTime)
  ...
  local IsMouseOver = mousePosX > Panel_SA_Widget_Minimap:GetPosX() - 20 and mousePosX < Panel_SA_Widget_Minimap:GetPosX() + Panel_SA_Widget_Minimap:GetSizeX() + 20 and mousePosY > Panel_SA_Widget_Minimap:GetPosY() - 20 and mousePosY < Panel_SA_Widget_Minimap:GetPosY() + Panel_SA_Widget_Minimap:GetSizeY() + 20
...
function RadarMap_InitPanel()
  ...
  ToClient_setRadorUIPanel(Panel_SA_Widget_Minimap)
  ...
  if 0 < remainTime then
    PaGlobal_SA_Widget_Rader._isGameStart = true
    rader_ramainTimer:SetShow(true)
  end
  PaGlobal_Minimap_Close()
end
checkLoad()
controlInit()
RadarMap_InitPanel()
registerEvent("EventActorDelete", "RadarMap_DestoryOtherActor")
Panel_SA_Widget_Minimap:addInputEvent("Mouse_On", "Radar_ChangeTexture_On()")
Panel_SA_Widget_Minimap:addInputEvent("Mouse_Out", "Radar_ChangeTexture_Off()")
Panel_SA_Widget_Minimap:addInputEvent("Mouse_LUp", "ResetPos_WidgetButton()")
...
function CalcPositionUseToTextUI(targetUIposX, targetUIposY, textUI)
  if Panel_SA_Widget_Minimap:GetSizeX() < targetUIposX + textUI:GetTextSizeX() then
    textUI:SetPosX(Panel_SA_Widget_Minimap:GetSizeX() - textUI:GetTextSizeX())
  else
    textUI:SetPosX(targetUIposX)
  end
  if Panel_SA_Widget_Minimap:GetPosY() > targetUIposY - textUI:GetTextSizeY() then
    textUI:SetPosY(Panel_SA_Widget_Minimap:GetPosY())
  else
...
function RadarResizeByReset(resetRadarScale)
  if false == resetRadarScale then
    local RadarCurrentSizeX = Panel_SA_Widget_Minimap:GetSizeX()
    local RadarCurrentSizeY = Panel_SA_Widget_Minimap:GetSizeY()
    Panel_SA_Widget_Minimap:SetSize(RadarCurrentSizeX, RadarCurrentSizeY)
  else
    Panel_SA_Widget_Minimap:SetSize(Panel_OrigSizeX, Panel_OrigSizeY)
  end
  radarMap.controls.radar_Background:SetPosX(0)
  radarMap.controls.radar_Background:SetSize(Panel_OrigSizeX, Panel_OrigSizeY)
  Panel_SA_Widget_Minimap:ComputePos()
  local SPI = radarMap.controls.icon_SelfPlayer
  local halfSelfSizeX = SPI:GetSizeX() / 2
  local halfSelfSizeY = SPI:GetSizeY() / 2
  local halfSizeX = Panel_SA_Widget_Minimap:GetSizeX() / 2
...
function Radar_luaLoadComplete()
  ...
  if false == ToClient_getGameUIManagerWrapper():getLuaCacheDataListBool(__eRadarSwap) then
    if 0 <= ToClient_GetUiInfo(CppEnums.PAGameUIType.PAGameUIPanel_RadarMap, 0, CppEnums.PanelSaveType.PanelSaveType_IsShow) then
      Panel_SA_Widget_Minimap:SetShow(ToClient_GetUiInfo(CppEnums.PAGameUIType.PAGameUIPanel_RadarMap, 0, CppEnums.PanelSaveType.PanelSaveType_IsShow))
    else
      Panel_SA_Widget_Minimap:SetShow(true, false)
    end
  end
  battleRoyale._ui.mapLine_current:SetShow(false)
...
function FromClient_WatchTimer_BattleRoyaleStateChanged(state)
  if __eBattleRoyaleState_Wait == state then
    rader_ramainTimer:SetShow(false)
  elseif __eBattleRoyaleState_StartSequence == state then
    local secondTime = 10
    Proc_ShowMessage_Ack(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_SHADOWARENA_START_MESSAGE_1", "second", secondTime))
  elseif __eBattleRoyaleState_Playing == state then
    Proc_ShowMessage_Ack(PAGetString(Defines.StringSheet_GAME, "LUA_SHADOWARENA_START_MESSAGE_2"))
    PaGlobal_SA_Widget_Rader_SetGameStart()
    rader_ramainTimer:SetShow(true)
  end
end
local _brStartTime = 0
local _timer = 1
local _lastUpdateTime = 0
function PaGlobal_SA_Widget_Rader_UpdateRemainTimer(delta)
  if false == PaGlobal_SA_Widget_Rader._isGameStart then
    return
  end
  _timer = _timer + delta
  if _timer < _lastUpdateTime + 1 then
    return
  end
  if 0 == _brStartTime then
    local brStartTime = ToClient_BattleRoyaleStartTime()
    if nil == brStartTime then
      rader_ramainTimer:SetShow(false)
      return
    end
    _brStartTime = Int64toInt32(brStartTime)
  end
  _lastUpdateTime = math.floor(_timer)
  local brStartTime = _brStartTime
  ...
  rader_ramainTimer:SetText(PAGetStringParam2(Defines.StringSheet_GAME, "LUA_BATTLEROYAL_RESULT_TIME", "minute", clockMinutesText, "second", clockSecondsText))
end
function PaGlobal_SA_Widget_Rader_SetGameStart()
  PaGlobal_SA_Widget_Rader._isGameStart = true
end
