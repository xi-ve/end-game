...
function InitPinInRadar()
  ...
  for i = 0, _listPingMax do
    _listPing[i] = UI.createControl(__ePAUIControl_Static, Instance_Radar, "Ping_Effect" .. tostring(i))
    CopyBaseProperty(Ping_Effect, _listPing[i])
  end
  for i = 0, _listGuildMax do
    _listGuild[i] = UI.createControl(__ePAUIControl_Static, Instance_Radar, "Radar_Guild_" .. tostring(i))
    CopyBaseProperty(Pin_Guild, _listGuild[i])
  end
  for i = 0, _listPartyMax do
    _listParty[i] = UI.createControl(__ePAUIControl_Static, Instance_Radar, "Radar_Party_" .. tostring(i))
    CopyBaseProperty(Pin_Party, _listParty[i])
  end
  for i = 0, _listGuideMax do
    _listGuide[i] = UI.createControl(__ePAUIControl_Static, Instance_Radar, "Radar_Guide_" .. tostring(i))
