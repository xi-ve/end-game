Instance_Scroll:SetShow(false, false)
UIScrollButton = {
  static_upAni = UI.getChildControl(Instance_Scroll, "Static_Up_Ani"),
  button_up = UI.getChildControl(Instance_Scroll, "Button_Up"),
  static_downAni = UI.getChildControl(Instance_Scroll, "Static_Down_Ani"),
  button_down = UI.getChildControl(Instance_Scroll, "Button_Down"),
  currentPanel = nil
}
local staticUpAni = {}
local buttonUp = {}
...
function UIScrollButton.CreateScrollButton(parentPanel)
  ...
  if nil == staticUpAni[panelName] then
    staticUpAni[panelName] = UI.createControl(__ePAUIControl_Static, parentPanel, "Static_Up_Ani_" .. panelName)
  ...
  if nil == buttonUp[panelName] then
    buttonUp[panelName] = UI.createControl(__ePAUIControl_Button, parentPanel, "Button_Up_" .. panelName)
  ...
  if nil == staticDownAni[panelName] then
    staticDownAni[panelName] = UI.createControl(__ePAUIControl_Static, parentPanel, "Static_Down_Ani_" .. panelName)
  ...
  if nil == buttonDown[panelName] then
    buttonDown[panelName] = UI.createControl(__ePAUIControl_Button, parentPanel, "Button_Down_" .. panelName)
...
function UIScrollButton.ScrollMoveEvent(parentPanel, moveDirection)
  if false == _ContentsGroup_RenewUI_Skill then
    ...
    elseif Instance_Window_Skill == parentPanel then
