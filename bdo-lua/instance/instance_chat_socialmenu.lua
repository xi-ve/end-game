...
Instance_Chat_SocialMenu:setGlassBackground(true)
Instance_Chat_SocialMenu:SetDragEnable(true)
Instance_Chat_SocialMenu:SetDragAll(true)
Instance_Chat_SocialMenu:SetPosX(getScreenSizeX() / 2 + Instance_Chat_SocialMenu:GetSizeX() / 2)
Instance_Chat_SocialMenu:SetPosY(getScreenSizeY() / 2 - Instance_Chat_SocialMenu:GetSizeY() / 2)
local btn_winClose = UI.getChildControl(Instance_Chat_SocialMenu, "Button_WinClose")
local mainBg = UI.getChildControl(Instance_Chat_SocialMenu, "Static_MainBg")
local socialIconSlotBG = UI.getChildControl(Instance_Chat_SocialMenu, "Static_C_IconBG")
local socialIconSlot = UI.getChildControl(Instance_Chat_SocialMenu, "Static_C_SocialIcon")
local selectedSlotBG = UI.getChildControl(Instance_Chat_SocialMenu, "Static_C_IconSelect")
local frameSocialAction = UI.getChildControl(Instance_Chat_SocialMenu, "Frame_SocialAction")
...
function SocialAction_Icon_Initialize()
  ...
  for index = 0, socialIconCount do
    ...
    _socialIconSlotBG[index] = createControl(__ePAUIControl_Static, socialActioncontent, "Static_SocialIconSlotBG_" .. index)
    _socialIconSlot[index] = createControl(__ePAUIControl_Static, socialActioncontent, "Static_SocialIconSlot_" .. index)
  ...
  _selectedSlotBG = createControl(__ePAUIControl_Static, socialActioncontent, "Static_SelectedSlot")
...
local SocialAction = {
  _name = UI.getChildControl(Instance_Chat_SocialMenu, "StaticText_SocialName"),
  _conditionText = UI.getChildControl(Instance_Chat_SocialMenu, "StaticText_ConditionMessage"),
  _icon = UI.getChildControl(Instance_Chat_SocialMenu, "Static_SelectedIcon"),
  _command = UI.getChildControl(Instance_Chat_SocialMenu, "Edit_Command"),
  _keyword_1 = UI.getChildControl(Instance_Chat_SocialMenu, "Edit_Keyword_1"),
  _keyword_2 = UI.getChildControl(Instance_Chat_SocialMenu, "Edit_Keyword_2"),
  _keyword_3 = UI.getChildControl(Instance_Chat_SocialMenu, "Edit_Keyword_3"),
  _desc = UI.getChildControl(Instance_Chat_SocialMenu, "StaticText_Desc"),
  _btnApply = UI.getChildControl(Instance_Chat_SocialMenu, "Button_Apply"),
  _btnReset = UI.getChildControl(Instance_Chat_SocialMenu, "Button_Reset"),
  _btnCancel = UI.getChildControl(Instance_Chat_SocialMenu, "Button_Cancel"),
  _descBG = UI.getChildControl(Instance_Chat_SocialMenu, "Static_DescBG"),
  _keyTitle = UI.getChildControl(Instance_Chat_SocialMenu, "StaticText_Key_Title")
}
Instance_Chat_SocialMenu:SetChildIndex(SocialAction._icon, 9999)
SocialAction._conditionText:SetTextMode(__eTextMode_AutoWrap)
...
local Control_Location_Save = {
  _panelSizeX = Instance_Chat_SocialMenu:GetSizeX(),
  _panelSizeY = Instance_Chat_SocialMenu:GetSizeY(),
...
function SocialAction:Description_Setting(index)
  ...
  if "" == sASS:getConditionMessage() then
    ...
    Instance_Chat_SocialMenu:SetSize(cls._panelSizeX, cls._panelSizeY)
    ...
    Instance_Chat_SocialMenu:SetSize(cls._panelSizeX, cls._panelSizeY + isConditionGap)
...
function FGlobal_SocialAction_ShowToggle()
  ...
  elseif Instance_Chatting_Macro:IsShow() then
    ...
    Instance_Chat_SocialMenu:SetShow(true)
    return true
  else
