...
local normalTooltip = {
  mainPanel = Instance_Tooltip_Item,
  itemName = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_Name"),
  itemIcon = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_Icon"),
  enchantLevel = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_Enchant_value"),
  itemType = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_Type"),
  dying = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Dying"),
  isEnchantable = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_isEnchantable"),
  isSealed = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_isSealed"),
  bindType = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_BindType"),
  balksExtraction = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_Balks"),
  cronsExtraction = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_Cron"),
  useDyeColorTitle = UI.getChildControl(Instance_Tooltip_Item, "StaticText_DyeColorInfo"),
  useDyeColorIcon_Part = {
    [0] = UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part1"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part2"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part3"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part4"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part5"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part6"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part7"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part8"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part9"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part10"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part11"),
    UI.getChildControl(Instance_Tooltip_Item, "Static_DyeColorIcon_Part12")
  },
  useLimit_category = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_category"),
  useLimit_panel = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_panel"),
  useLimit_level = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_level"),
  useLimit_level_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_level_value"),
  useLimit_extendedslot = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_extendedslot"),
  useLimit_extendedslot_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_extendedslot_value"),
  useLimit_class = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_class"),
  useLimit_class_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_class_value"),
  useLimit_Exp = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_Exp"),
  useLimit_Exp_gage = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_Exp_gage"),
  useLimit_Exp_gage_value = UI.getChildControl(Instance_Tooltip_Item, "Progress_UseLimit_Exp_gage_value"),
  useLimit_Exp_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_Exp_value"),
  useLimit_endurance = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_endurance"),
  useLimit_endurance_gage = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_endurance_gage"),
  useLimit_endurance_gage_value = UI.getChildControl(Instance_Tooltip_Item, "Progress_UseLimit_endurance_gage_value"),
  useLimit_dynamic_endurance_gage_value = UI.getChildControl(Instance_Tooltip_Item, "Progress2_MaxEndurance"),
  useLimit_endurance_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_endurance_value"),
  remainTime = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_remainTime"),
  remainTime_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_remainTime_value"),
  expireIcon_white = UI.getChildControl(Instance_Tooltip_Item, "Static_Expire_Icon1"),
  expireIcon_red = UI.getChildControl(Instance_Tooltip_Item, "Static_Expire_Icon2"),
  expireIcon_end = UI.getChildControl(Instance_Tooltip_Item, "Static_Expire_Icon3"),
  defaultEffect_category = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_category"),
  defaultEffect_panel = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_panel"),
  attack = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_attack"),
  attack_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_attack_value"),
  attack_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_attackDiff_value"),
  isMeleeAttack = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_attack_isMeleeAttack"),
  isRangeAttack = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_attack_isRangeAttack"),
  isMagicAttack = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_attack_isMagicAttack"),
  defense = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_defense"),
  defense_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_defense_value"),
  defense_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_defenseDiff_value"),
  weight = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_weight"),
  weight_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_weight_value"),
  weight_diffValue = UI.getChildControl(Instance_Tooltip_Item, "StaticText_DefaultEffect_weightDiff_value"),
  _hit = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_hit"),
  _hit_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_hit_value"),
  _hit_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_hitDiff_value"),
  _dv = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_dv"),
  _dv_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_dv_value"),
  _dv_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_dvDiff_value"),
  _pv = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_pv"),
  _pv_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_pv_value"),
  _pv_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_pvDiff_value"),
  _txt_MaxEnchanter = UI.getChildControl(Instance_Tooltip_Item, "StaticText_MaxEnchantCharName"),
  soketOption_panel = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_SoketOption_panel"),
  soketSlot = {},
  soketName = {},
  soketEffect = {},
  itemProducedPlace = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_ProducedPlace"),
  itemDescription = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_Description"),
  itemPrice_panel = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_ItemPrice_panel"),
  itemPrice_transportBuy = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_ItemPrice_transportBuy"),
  itemPrice_transportBuy_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_ItemPrice_transportBuy_value"),
  itemPrice_storeSell = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_ItemPrice_storeSell"),
  itemPrice_storeSell_value = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_ItemPrice_storeSell_value"),
  grapeSize = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_UseLimit_endurance_value"):GetSizeX(),
  panelSize = Instance_Tooltip_Item:GetSizeY(),
  socketSize = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_SoketOption_panel"):GetSizeY(),
  deltaTime = 0,
  att_Value = 0,
  def_Value = 0,
  wei_Value = 0,
  tradeInfo_Panel = UI.getChildControl(Instance_Tooltip_Item, "Static_TradeInfoPanel"),
  tradeInfo_Title = UI.getChildControl(Instance_Tooltip_Item, "StaticText_TradePriceTitle"),
  tradeInfo_Value = UI.getChildControl(Instance_Tooltip_Item, "StaticText_TradePriceValue"),
  equipSlotName = UI.getChildControl(Instance_Tooltip_Item, "StaticText_EquipTypeName"),
  productNotify = UI.getChildControl(Instance_Tooltip_Item, "Static_ProductNotify"),
  itemLockNotify = UI.getChildControl(Instance_Tooltip_Item, "Static_ItemLockNotify"),
  personalTrade = UI.getChildControl(Instance_Tooltip_Item, "StaticText_IsPersnalTrade"),
  itemLock = UI.getChildControl(Instance_Tooltip_Item, "StaticText_IsItemLock"),
  exchangeTitle = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_ExchangeTitle"),
  exchangeDesc = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_ExchangeDescription"),
  recoveryDesc = UI.getChildControl(Instance_Tooltip_Item, "StaticText_ItemRecoveryDesc"),
  bagSize = UI.getChildControl(Instance_Tooltip_Item, "StaticText_BagSize"),
  equipmentInBag = UI.getChildControl(Instance_Tooltip_Item, "StaticText_EquipmentInBag"),
  cronStoneEnchant = UI.getChildControl(Instance_Tooltip_Item, "StaticText_CronEnchant"),
  cronStoneGrade = UI.getChildControl(Instance_Tooltip_Item, "StaticText_CronGrade"),
  cronStoneProgressBg = UI.getChildControl(Instance_Tooltip_Item, "Static_CronStoneStackBg"),
  cronStoneProgress = UI.getChildControl(Instance_Tooltip_Item, "Progress2_StackCount"),
  cronStoneGradeValue = {
    [0] = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Grade1"),
    [1] = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Grade2"),
    [2] = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Grade3"),
    [3] = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Grade4")
  },
  cronStoneCountValue = {
    [0] = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Count1"),
    [1] = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Count2"),
    [2] = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Count3"),
    [3] = UI.getChildControl(Instance_Tooltip_Item, "StaticText_Count4")
  },
  cronStoneValue = UI.getChildControl(Instance_Tooltip_Item, "StaticText_CronStackDesc"),
  enchantDifficulty = UI.getChildControl(Instance_Tooltip_Item, "StaticText_EnchantDifficulty"),
  soulCollector = UI.getChildControl(Instance_Tooltip_Item, "StaticText_SoulCollector")
}
local equippedTooltip = {
  equippedTag = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_nowEquiped_tag"),
  mainPanel = Instance_Tooltip_Item_equipped,
  itemName = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_Name"),
  itemIcon = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_Icon"),
  enchantLevel = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_Enchant_value"),
  itemType = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_Type"),
  dying = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Dying"),
  isEnchantable = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_isEnchantable"),
  isSealed = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_isSealed"),
  bindType = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_BindType"),
  balksExtraction = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_Balks"),
  cronsExtraction = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_Cron"),
  useDyeColorTitle = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_DyeColorInfo"),
  useDyeColorIcon_Part = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part1"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part2"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part3"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part4"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part5"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part6"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part7"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part8"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part9"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part10"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part11"),
    UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_DyeColorIcon_Part12")
  },
  useLimit_category = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_category"),
  useLimit_panel = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_panel"),
  useLimit_level = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_level"),
  useLimit_level_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_level_value"),
  useLimit_extendedslot = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_extendedslot"),
  useLimit_extendedslot_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_extendedslot_value"),
  useLimit_class = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_class"),
  useLimit_class_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_class_value"),
  useLimit_Exp = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_Exp"),
  useLimit_Exp_gage = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_Exp_gage"),
  useLimit_Exp_gage_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Progress_UseLimit_Exp_gage_value"),
  useLimit_Exp_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_Exp_value"),
  useLimit_endurance = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_endurance"),
  useLimit_endurance_gage = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_endurance_gage"),
  useLimit_endurance_gage_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Progress_UseLimit_endurance_gage_value"),
  useLimit_dynamic_endurance_gage_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Progress2_MaxEndurance"),
  useLimit_endurance_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_endurance_value"),
  remainTime = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_remainTime"),
  remainTime_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_remainTime_value"),
  expireIcon_white = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_Expire_Icon1"),
  expireIcon_red = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_Expire_Icon2"),
  expireIcon_end = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_Expire_Icon3"),
  defaultEffect_category = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_category"),
  defaultEffect_panel = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_panel"),
  attack = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_attack"),
  attack_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_attack_value"),
  attack_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_attackDiff_value"),
  isMeleeAttack = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_attack_isMeleeAttack"),
  isRangeAttack = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_attack_isRangeAttack"),
  isMagicAttack = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_attack_isMagicAttack"),
  defense = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_defense"),
  defense_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_defense_value"),
  defense_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_defenseDiff_value"),
  weight = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_weight"),
  weight_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_weight_value"),
  weight_diffValue = UI.getChildControl(Instance_Tooltip_Item, "StaticText_DefaultEffect_weightDiff_value"),
  _hit = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_hit"),
  _hit_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_hit_value"),
  _hit_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_hitDiff_value"),
  _dv = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_dv"),
  _dv_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_dv_value"),
  _dv_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_dvDiff_value"),
  _pv = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_pv"),
  _pv_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_DefaultEffect_pv_value"),
  _pv_diffValue = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_DefaultEffect_pvDiff_value"),
  _txt_MaxEnchanter = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_MaxEnchantCharName"),
  soketOption_panel = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_SoketOption_panel"),
  soketSlot = {},
  soketName = {},
  soketEffect = {},
  itemProducedPlace = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_ProducedPlace"),
  itemDescription = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_Description"),
  itemPrice_panel = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_ItemPrice_panel"),
  itemPrice_transportBuy = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_ItemPrice_transportBuy"),
  itemPrice_transportBuy_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_ItemPrice_transportBuy_value"),
  itemPrice_storeSell = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_ItemPrice_storeSell"),
  itemPrice_storeSell_value = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_ItemPrice_storeSell_value"),
  arrow = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_Arrow"),
  arrow_L = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_Arrow_L"),
  grapeSize = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_UseLimit_endurance_value"):GetSizeX(),
  panelSize = Instance_Tooltip_Item:GetSizeY(),
  socketSize = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_SoketOption_panel"):GetSizeY(),
  deltaTime = 0,
  att_Value = 0,
  def_Value = 0,
  wei_Value = 0,
  tradeInfo_Panel = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_TradeInfoPanel"),
  tradeInfo_Title = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_TradePriceTitle"),
  tradeInfo_Value = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_TradePriceValue"),
  equipSlotName = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_EquipTypeName"),
  productNotify = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_ProductNotify"),
  itemLockNotify = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_ItemLockNotify"),
  personalTrade = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_IsPersnalTrade"),
  itemLock = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_IsItemLock"),
  exchangeTitle = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_ExchangeTitle"),
  exchangeDesc = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_ExchangeDescription"),
  recoveryDesc = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_ItemRecoveryDesc"),
  cronStoneEnchant = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_CronEnchant"),
  cronStoneGrade = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_CronGrade"),
  cronStoneProgressBg = UI.getChildControl(Instance_Tooltip_Item_equipped, "Static_CronStoneStackBg"),
  cronStoneProgress = UI.getChildControl(Instance_Tooltip_Item_equipped, "Progress2_StackCount"),
  cronStoneGradeValue = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Grade1"),
    [1] = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Grade2"),
    [2] = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Grade3"),
    [3] = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Grade4")
  },
  cronStoneCountValue = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Count1"),
    [1] = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Count2"),
    [2] = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Count3"),
    [3] = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_Count4")
  },
  cronStoneValue = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_CronStackDesc"),
  enchantDifficulty = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_EnchantDifficulty"),
  soulCollector = UI.getChildControl(Instance_Tooltip_Item_equipped, "StaticText_SoulCollector")
}
local chattingLinkedItemTooltip = {
  mainPanel = Instance_Tooltip_Item_chattingLinkedItem,
  itemName = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_Name"),
  itemIcon = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_Icon"),
  closeBtn = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Button_Win_Close"),
  enchantLevel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_Enchant_value"),
  itemType = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_Type"),
  dying = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Dying"),
  isEnchantable = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_isEnchantable"),
  isSealed = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_isSealed"),
  bindType = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_BindType"),
  balksExtraction = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_Balks"),
  cronsExtraction = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_Cron"),
  useDyeColorTitle = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_DyeColorInfo"),
  useDyeColorIcon_Part = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part1"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part2"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part3"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part4"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part5"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part6"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part7"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part8"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part9"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part10"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part11"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_DyeColorIcon_Part12")
  },
  useLimit_category = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_category"),
  useLimit_panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_panel"),
  useLimit_level = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_level"),
  useLimit_level_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_level_value"),
  useLimit_extendedslot = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_extendedslot"),
  useLimit_extendedslot_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_extendedslot_value"),
  useLimit_class = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_class"),
  useLimit_class_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_class_value"),
  useLimit_Exp = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_Exp"),
  useLimit_Exp_gage = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_Exp_gage"),
  useLimit_Exp_gage_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Progress_UseLimit_Exp_gage_value"),
  useLimit_Exp_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_Exp_value"),
  useLimit_endurance = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_endurance"),
  useLimit_endurance_gage = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_endurance_gage"),
  useLimit_endurance_gage_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Progress_UseLimit_endurance_gage_value"),
  useLimit_dynamic_endurance_gage_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Progress2_MaxEndurance"),
  useLimit_endurance_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_endurance_value"),
  remainTime = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_remainTime"),
  remainTime_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_remainTime_value"),
  expireIcon_white = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_Expire_Icon1"),
  expireIcon_red = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_Expire_Icon2"),
  expireIcon_end = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_Expire_Icon3"),
  defaultEffect_category = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_category"),
  defaultEffect_panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_panel"),
  attack = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_attack"),
  attack_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_attack_value"),
  attack_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_attackDiff_value"),
  isMeleeAttack = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_attack_isMeleeAttack"),
  isRangeAttack = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_attack_isRangeAttack"),
  isMagicAttack = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_attack_isMagicAttack"),
  defense = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_defense"),
  defense_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_defense_value"),
  defense_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_defenseDiff_value"),
  weight = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_weight"),
  weight_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_weight_value"),
  weight_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_DefaultEffect_weightDiff_value"),
  _hit = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_hit"),
  _hit_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_hit_value"),
  _hit_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_hitDiff_value"),
  _dv = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_dv"),
  _dv_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_dv_value"),
  _dv_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_dvDiff_value"),
  _pv = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_pv"),
  _pv_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_pv_value"),
  _pv_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_DefaultEffect_pvDiff_value"),
  _txt_MaxEnchanter = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_MaxEnchantCharName"),
  soketOption_panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_SoketOption_panel"),
  soketSlot = {},
  soketName = {},
  soketEffect = {},
  itemProducedPlace = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_ProducedPlace"),
  itemDescription = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_Description"),
  itemPrice_panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_ItemPrice_panel"),
  itemPrice_transportBuy = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_ItemPrice_transportBuy"),
  itemPrice_transportBuy_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_ItemPrice_transportBuy_value"),
  itemPrice_storeSell = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_ItemPrice_storeSell"),
  itemPrice_storeSell_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_ItemPrice_storeSell_value"),
  grapeSize = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_UseLimit_endurance_value"):GetSizeX(),
  panelSize = Instance_Tooltip_Item_chattingLinkedItem:GetSizeY(),
  socketSize = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_SoketOption_panel"):GetSizeY(),
  deltaTime = 0,
  att_Value = 0,
  def_Value = 0,
  wei_Value = 0,
  tradeInfo_Panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_TradeInfoPanel"),
  tradeInfo_Title = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_TradePriceTitle"),
  tradeInfo_Value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_TradePriceValue"),
  equipSlotName = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_EquipTypeName"),
  productNotify = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_ProductNotify"),
  itemLockNotify = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_ItemLockNotify"),
  personalTrade = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_IsPersnalTrade"),
  itemLock = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_IsItemLock"),
  exchangeTitle = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_ExchangeTitle"),
  exchangeDesc = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_ExchangeDescription"),
  recoveryDesc = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_ItemRecoveryDesc"),
  cronStoneEnchant = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_CronEnchant"),
  cronStoneGrade = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_CronGrade"),
  cronStoneProgressBg = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Static_CronStoneStackBg"),
  cronStoneProgress = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Progress2_StackCount"),
  cronStoneGradeValue = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Grade1"),
    [1] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Grade2"),
    [2] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Grade3"),
    [3] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Grade4")
  },
  cronStoneCountValue = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Count1"),
    [1] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Count2"),
    [2] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Count3"),
    [3] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_Count4")
  },
  cronStoneValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_CronStackDesc"),
  enchantDifficulty = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_EnchantDifficulty"),
  soulCollector = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "StaticText_SoulCollector")
}
local chattingLinkedItemClickTooltip = {
  mainPanel = Instance_Tooltip_Item_chattingLinkedItemClick,
  itemName = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_Name"),
  itemIcon = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_Icon"),
  closeBtn = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Button_Win_Close"),
  enchantLevel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_Enchant_value"),
  itemType = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_Type"),
  dying = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Dying"),
  isEnchantable = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_isEnchantable"),
  isSealed = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_isSealed"),
  bindType = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_BindType"),
  balksExtraction = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_Balks"),
  cronsExtraction = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_Cron"),
  useDyeColorTitle = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_DyeColorInfo"),
  useDyeColorIcon_Part = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part1"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part2"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part3"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part4"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part5"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part6"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part7"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part8"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part9"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part10"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part11"),
    UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_DyeColorIcon_Part12")
  },
  useLimit_category = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_category"),
  useLimit_panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_panel"),
  useLimit_level = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_level"),
  useLimit_level_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_level_value"),
  useLimit_extendedslot = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_extendedslot"),
  useLimit_extendedslot_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_extendedslot_value"),
  useLimit_class = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_class"),
  useLimit_class_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_class_value"),
  useLimit_Exp = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_Exp"),
  useLimit_Exp_gage = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_Exp_gage"),
  useLimit_Exp_gage_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Progress_UseLimit_Exp_gage_value"),
  useLimit_Exp_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_Exp_value"),
  useLimit_endurance = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_endurance"),
  useLimit_endurance_gage = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_endurance_gage"),
  useLimit_endurance_gage_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Progress_UseLimit_endurance_gage_value"),
  useLimit_dynamic_endurance_gage_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Progress2_MaxEndurance"),
  useLimit_endurance_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_endurance_value"),
  remainTime = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_remainTime"),
  remainTime_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_remainTime_value"),
  expireIcon_white = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_Expire_Icon1"),
  expireIcon_red = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_Expire_Icon2"),
  expireIcon_end = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_Expire_Icon3"),
  defaultEffect_category = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_category"),
  defaultEffect_panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_panel"),
  attack = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_attack"),
  attack_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_attack_value"),
  attack_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_attackDiff_value"),
  isMeleeAttack = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_attack_isMeleeAttack"),
  isRangeAttack = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_attack_isRangeAttack"),
  isMagicAttack = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_attack_isMagicAttack"),
  defense = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_defense"),
  defense_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_defense_value"),
  defense_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_defenseDiff_value"),
  weight = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_weight"),
  weight_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_weight_value"),
  weight_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_DefaultEffect_weightDiff_value"),
  _hit = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_hit"),
  _hit_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_hit_value"),
  _hit_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_hitDiff_value"),
  _dv = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_dv"),
  _dv_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_dv_value"),
  _dv_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_dvDiff_value"),
  _pv = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_pv"),
  _pv_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_pv_value"),
  _pv_diffValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_DefaultEffect_pvDiff_value"),
  _txt_MaxEnchanter = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_MaxEnchantCharName"),
  soketOption_panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_SoketOption_panel"),
  soketSlot = {},
  soketName = {},
  soketEffect = {},
  itemProducedPlace = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_ProducedPlace"),
  itemDescription = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_Description"),
  itemPrice_panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_ItemPrice_panel"),
  itemPrice_transportBuy = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_ItemPrice_transportBuy"),
  itemPrice_transportBuy_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_ItemPrice_transportBuy_value"),
  itemPrice_storeSell = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_ItemPrice_storeSell"),
  itemPrice_storeSell_value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_ItemPrice_storeSell_value"),
  grapeSize = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_UseLimit_endurance_value"):GetSizeX(),
  panelSize = Instance_Tooltip_Item_chattingLinkedItemClick:GetSizeY(),
  socketSize = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_SoketOption_panel"):GetSizeY(),
  deltaTime = 0,
  att_Value = 0,
  def_Value = 0,
  wei_Value = 0,
  tradeInfo_Panel = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_TradeInfoPanel"),
  tradeInfo_Title = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_TradePriceTitle"),
  tradeInfo_Value = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_TradePriceValue"),
  equipSlotName = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_EquipTypeName"),
  productNotify = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_ProductNotify"),
  itemLockNotify = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_ItemLockNotify"),
  personalTrade = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_IsPersnalTrade"),
  itemLock = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_IsItemLock"),
  exchangeTitle = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_ExchangeTitle"),
  exchangeDesc = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_ExchangeDescription"),
  recoveryDesc = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_ItemRecoveryDesc"),
  cronStoneEnchant = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_CronEnchant"),
  cronStoneGrade = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_CronGrade"),
  cronStoneProgressBg = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Static_CronStoneStackBg"),
  cronStoneProgress = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Progress2_StackCount"),
  cronStoneGradeValue = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Grade1"),
    [1] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Grade2"),
    [2] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Grade3"),
    [3] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Grade4")
  },
  cronStoneCountValue = {
    [0] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Count1"),
    [1] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Count2"),
    [2] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Count3"),
    [3] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_Count4")
  },
  cronStoneValue = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_CronStackDesc"),
  enchantDifficulty = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_EnchantDifficulty"),
  soulCollector = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "StaticText_SoulCollector")
}
...
function Panel_Tooltip_Item_Initialize()
  Instance_Tooltip_Item:SetShow(false, false)
  Instance_Tooltip_Item:setMaskingChild(true)
  Instance_Tooltip_Item:SetIgnore(true)
  Instance_Tooltip_Item:SetIgnoreChild(true)
  Instance_Tooltip_Item:setGlassBackground(true)
  Instance_Tooltip_Item_equipped:SetShow(false, false)
  Instance_Tooltip_Item_equipped:setMaskingChild(true)
  Instance_Tooltip_Item_equipped:SetIgnore(true)
  Instance_Tooltip_Item_equipped:SetIgnoreChild(true)
  Instance_Tooltip_Item_equipped:setGlassBackground(true)
  Instance_Tooltip_Item_chattingLinkedItem:SetShow(false, false)
  Instance_Tooltip_Item_chattingLinkedItem:setMaskingChild(true)
  Instance_Tooltip_Item_chattingLinkedItem:SetIgnore(true)
  Instance_Tooltip_Item_chattingLinkedItem:SetIgnoreChild(true)
  Instance_Tooltip_Item_chattingLinkedItem:setGlassBackground(true)
  ...
  for idx = 1, 6 do
    normalTooltip.soketSlot[idx] = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_SoketOption_soketSlot" .. idx)
    normalTooltip.soketName[idx] = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_SoketOption_soketName" .. idx)
    normalTooltip.soketEffect[idx] = UI.getChildControl(Instance_Tooltip_Item, "Tooltip_Item_SoketOption_soketEffect" .. idx)
    equippedTooltip.soketSlot[idx] = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_SoketOption_soketSlot" .. idx)
    equippedTooltip.soketName[idx] = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_SoketOption_soketName" .. idx)
    equippedTooltip.soketEffect[idx] = UI.getChildControl(Instance_Tooltip_Item_equipped, "Tooltip_Item_SoketOption_soketEffect" .. idx)
    chattingLinkedItemTooltip.soketSlot[idx] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_SoketOption_soketSlot" .. idx)
    chattingLinkedItemTooltip.soketName[idx] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_SoketOption_soketName" .. idx)
    chattingLinkedItemTooltip.soketEffect[idx] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItem, "Tooltip_Item_SoketOption_soketEffect" .. idx)
    chattingLinkedItemClickTooltip.soketSlot[idx] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_SoketOption_soketSlot" .. idx)
    chattingLinkedItemClickTooltip.soketName[idx] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_SoketOption_soketName" .. idx)
    chattingLinkedItemClickTooltip.soketEffect[idx] = UI.getChildControl(Instance_Tooltip_Item_chattingLinkedItemClick, "Tooltip_Item_SoketOption_soketEffect" .. idx)
  end
    ...
    if servantItem or isServantEquipOn then
      ...
      if nil ~= temporaryWrapper then
        ...
        if nil ~= campingWrapper then
          ...
          local servantKindSub = campingWrapper:getServantKindSub()
          if itemWrapper:getStaticStatus():get():isServantTypeUsable(servantKind, servantKindSub) then
...
function Panel_Tooltip_Item_Show_GeneralStatic(slotNo, slotType, isOn, index, posX, posY)
  ...
  local slot = Panel_Tooltip_Item_DataObject.slotData[slotType][slotNo]
  local itemSSW
  if "QuestReward_Base" == slotType or "QuestReward_Select" == slotType or "Dialog_QuestReward_Base" == slotType or "Dialog_QuestReward_Select" == slotType or "ItemSlot" == slotType or "betterItemList" == slotType or "tierReward" == slotType then
...
function Panel_Tooltip_Item_chattingLinkedItem_Set_Position(positionData, isClicked)
  local target
  if isClicked then
    target = Instance_Tooltip_Item_chattingLinkedItemClick
    linkItemTooltipParent = positionData
  else
    target = Instance_Tooltip_Item_chattingLinkedItem
  end
  ...
  target:SetPosX(posX)
  target:SetPosY(yTmp)
  if Instance_Tooltip_Item_chattingLinkedItemClick:GetShow() and target ~= Instance_Tooltip_Item_chattingLinkedItemClick then
    if positionData == linkItemTooltipParent then
      if isLeft then
        target:SetPosX(posX - Instance_Tooltip_Item_chattingLinkedItemClick:GetSizeX())
      else
        target:SetPosX(posX + Instance_Tooltip_Item_chattingLinkedItemClick:GetSizeX())
      end
    else
...
function Panel_Tooltip_Item_Set_Position_UISubApp(positionData, parent, inven)
  local itemShow = Instance_Tooltip_Item:GetShow()
  local equipItemShow = Instance_Tooltip_Item_equipped:GetShow()
  if not itemShow and not equipItemShow then
    return
  end
  local screenSizeX = getScreenSizeX()
  local screenSizeY = getScreenSizeY()
  local itemPosX = Instance_Tooltip_Item:GetSizeX()
  local itemPosY = Instance_Tooltip_Item:GetSizeY()
  local itemEquipPosX = Instance_Tooltip_Item_equipped:GetSizeX()
  local itemEquipPosY = Instance_Tooltip_Item_equipped:GetSizeY()
  ...
  if Instance_Tooltip_Item:GetShow() then
    tooltipSize.width = Instance_Tooltip_Item:GetSizeX()
    tooltipSize.height = Instance_Tooltip_Item:GetSizeY()
    sumSize.width = sumSize.width + tooltipSize.width
    sumSize.height = math.max(sumSize.height, tooltipSize.height)
  end
  if Instance_Tooltip_Item_equipped:GetShow() then
    tooltipEquipped.width = Instance_Tooltip_Item_equipped:GetSizeX()
    tooltipEquipped.height = Instance_Tooltip_Item_equipped:GetSizeY()
  ...
  if Instance_Tooltip_Item:GetShow() then
    ...
    Instance_Tooltip_Item:SetPosX(posX)
    Instance_Tooltip_Item:SetPosY(yTmp)
  end
  if Instance_Tooltip_Item_equipped:GetShow() then
    if isLeft then
    ...
    Instance_Tooltip_Item_equipped:SetPosX(posX)
    Instance_Tooltip_Item_equipped:SetPosY(yTmp)
  end
  if equippedTooltip.mainPanel:GetShow() and normalTooltip.mainPanel:GetShow() then
    local arrow = equippedTooltip.arrow
    if Instance_Tooltip_Item:GetPosX() < Instance_Tooltip_Item_equipped:GetPosX() then
...
function Panel_Tooltip_Item_hideTooltip()
  ...
  if Instance_Tooltip_Item:IsShow() then
    Instance_Tooltip_Item:SetShow(false, false)
    Instance_Tooltip_Item:CloseUISubApp()
    Panel_Tooltip_Item_DataObject.currentSlotNo = -1
  end
  if Instance_Tooltip_Item_equipped:IsShow() then
    Instance_Tooltip_Item_equipped:SetShow(false, false)
    Instance_Tooltip_Item_equipped:CloseUISubApp()
    Panel_Tooltip_Item_DataObject.currentSlotNo = -1
  end
  if Instance_Tooltip_Item_chattingLinkedItem:IsShow() then
    Instance_Tooltip_Item_chattingLinkedItem:SetShow(false, false)
    Panel_Tooltip_Item_DataObject.currentSlotNo = -1
  end
end
...
function Panel_Tooltip_Item_chattingLinkedItemClick_hideTooltip()
  if Instance_Tooltip_Item_chattingLinkedItemClick:IsShow() then
    linkItemTooltipParent = nil
    Instance_Tooltip_Item_chattingLinkedItemClick:SetShow(false, false)
  end
end
...
function Panel_Tooltip_Item_ShowInfo(target, inputValue, isSSW, isItemWrapper, chattingLinkedItem, index, isNextEnchantInfo, invenSlotNo, itemNamingStr)
  ...
  if (equippedTooltip ~= target or true ~= isNextEnchantInfo) and equippedTooltip == target then
  ...
  if true == Panel_Tooltip_Item_DataObject.inventory and true == isItemLock and not Instance_Tooltip_Item_equipped:GetShow() then
    local itemSSW = itemWrapper:getStaticStatus()
  ...
  for jewelIdx = 0, 5 do
    if jewelIdx < socketMaxCount - 1 then
      ...
      if target.mainPanel ~= Instance_Tooltip_Item_equipped and nil ~= Panel_Tooltip_Item_DataObject.itemMarket then
        itemEnchantSSW = nil
      end
...
- ]] .. itemSSW:getEnchantDescription()
  ...
  if isTradeItem then
    ...
    if s64_sellPrice > _const.s64_0 and 0 == enchantLevel then
      ...
      target.itemPrice_storeSell_value:SetText(PAGetString(Defines.StringSheet_GAME, priceString) .. " " .. tostring(makeDotMoney(s64_sellPrice)))
      target.itemPrice_storeSell_value:SetFontColor(4292726146)
    else
      target.itemPrice_storeSell_value:SetText(PAGetString(Defines.StringSheet_GAME, "PANEL_TOOLTIP_NOT_SELLING_ITEM"))
      target.itemPrice_storeSell_value:SetFontColor(4290733156)
  ...
  if target.mainPanel == Instance_Tooltip_Item_equipped then
  end
