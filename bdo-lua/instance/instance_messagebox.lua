...
Instance_MessageBox:RegisterShowEventFunc(true, "MessageBox_ShowAni()")
Instance_MessageBox:RegisterShowEventFunc(false, "MessageBox_HideAni()")
Instance_MessageBox:SetShow(false, false)
Instance_MessageBox:setMaskingChild(true)
Instance_MessageBox:setGlassBackground(true)
local UI_PP = CppEnums.PAUIMB_PRIORITY
local UI_color = Defines.Color
local UI_PSFT = CppEnums.PAUI_SHOW_FADE_TYPE
local UI_ANI_ADV = CppEnums.PAUI_ANIM_ADVANCE_TYPE
local textTitle = UI.getChildControl(Instance_MessageBox, "Static_Text_Title")
local textBG = UI.getChildControl(Instance_MessageBox, "Static_Text")
local textContent = UI.getChildControl(Instance_MessageBox, "StaticText_Content")
local buttonYes = UI.getChildControl(Instance_MessageBox, "Button_Yes")
local buttonApply = UI.getChildControl(Instance_MessageBox, "Button_Apply")
local buttonNo = UI.getChildControl(Instance_MessageBox, "Button_No")
local buttonIgnore = UI.getChildControl(Instance_MessageBox, "Button_Ignore")
local buttonCancel = UI.getChildControl(Instance_MessageBox, "Button_Cancel")
local buttonClose = UI.getChildControl(Instance_MessageBox, "Button_Close")
local refuseInvite = UI.getChildControl(Instance_MessageBox, "CheckButton_RefuseGo")
local blockBG = UI.getChildControl(Instance_MessageBox, "Static_BlockBG")
local static_Beginner_BG = UI.getChildControl(Instance_MessageBox, "Static_Beginner_BG")
local static_BeginnerTitleBG = UI.getChildControl(Instance_MessageBox, "Static_BeginnerTitleBG")
local staticText_BeginnerTxt1 = UI.getChildControl(Instance_MessageBox, "StaticText_BeginnerTxt1")
local staticText_BeginnerTxt2 = UI.getChildControl(Instance_MessageBox, "StaticText_BeginnerTxt2")
...
local function messageBox_Resize(refuseType)
  ...
  Instance_MessageBox:SetSize(Instance_MessageBox:GetSizeX(), textBG:GetSizeY() + 97)
end
function setCurrentMessageData(currentData, position, refuseType)
  if currentData ~= nil then
    ...
    Instance_MessageBox:SetShow(true, false)
    Instance_MessageBox:SetScaleChild(1, 1)
    ...
    if 1 == buttonShowCount then
      buttonYes:SetPosX(Instance_MessageBox:GetSizeX() / 2 - buttonYes:GetSizeX() / 2)
      buttonApply:SetPosX(Instance_MessageBox:GetSizeX() / 2 - buttonApply:GetSizeX() / 2)
      buttonNo:SetPosX(Instance_MessageBox:GetSizeX() / 2 - buttonNo:GetSizeX() / 2)
      buttonIgnore:SetPosX(Instance_MessageBox:GetSizeX() / 2 - buttonIgnore:GetSizeX() / 2)
      buttonCancel:SetPosX(Instance_MessageBox:GetSizeX() / 2 - buttonCancel:GetSizeX() / 2)
    elseif 2 == buttonShowCount then
      buttonYes:SetPosX(Instance_MessageBox:GetSizeX() / 2 - (buttonYes:GetSizeX() / 2 + 5))
      buttonNo:SetPosX(Instance_MessageBox:GetSizeX() / 2 + (buttonNo:GetSizeX() / 2 + 5))
      buttonApply:SetPosX(Instance_MessageBox:GetSizeX() / 2 - (buttonApply:GetSizeX() / 2 + 5))
      buttonIgnore:SetPosX(Instance_MessageBox:GetSizeX() / 2 + (buttonIgnore:GetSizeX() / 2 + 5))
      buttonCancel:SetPosX(Instance_MessageBox:GetSizeX() / 2 + (buttonCancel:GetSizeX() / 2 + 5))
...
function MessageBox.showMessageBox(MessageData, position, isGameExit, keyUse, refuseType)
  ...
  if true == isGameExit and ToClient_GetUserPlayMinute() < 1440 then
    Instance_MessageBox:SetSize(441, 317)
  ...
  refuseInvite:SetPosX(Instance_MessageBox:GetSizeX() / 2 - (refuseInvite:GetSizeX() + refuseInvite:GetTextSizeX() / 2))
  blockBG:SetSize(getScreenSizeX() + 500, getScreenSizeY() + 500)
  blockBG:ComputePos()
  messageBoxComputePos()
end
function MessageBox:isShow()
  if Instance_MessageBox:GetShow() and nil == MessageData.enablePriority then
    return true
  end
  return false
end
...
function messageBoxComputePos()
  blockBG:SetSize(getScreenSizeX() + 500, getScreenSizeY() + 500)
  Instance_MessageBox:ComputePos()
  ...
  elseif 2 == globalButtonShowCount then
    buttonYes:SetPosX(Instance_MessageBox:GetSizeX() / 2 - (buttonYes:GetSizeX() + 1))
    buttonNo:SetPosX(Instance_MessageBox:GetSizeX() / 2 + 1)
    buttonApply:SetPosX(Instance_MessageBox:GetSizeX() / 2 - (buttonApply:GetSizeX() + 1))
    buttonIgnore:SetPosX(Instance_MessageBox:GetSizeX() / 2 + 1)
    buttonCancel:SetPosX(Instance_MessageBox:GetSizeX() / 2 + 1)
...
function MessageBox.isPopUp()
  return Instance_MessageBox:IsShow()
end
...
function MessageBox_ShowAni()
  local aniInfo8 = Instance_MessageBox:addColorAnimation(0, 0.15, UI_ANI_ADV.PAUI_ANIM_ADVANCE_COS_HALF_PI)
  ...
  local aniInfo1 = Instance_MessageBox:addScaleAnimation(0, 0.08, UI_ANI_ADV.PAUI_ANIM_ADVANCE_COS_HALF_PI)
  aniInfo1:SetStartScale(0.1)
  aniInfo1:SetEndScale(1.1)
  aniInfo1.AxisX = Instance_MessageBox:GetSizeX() / 2
  aniInfo1.AxisY = Instance_MessageBox:GetSizeY() / 2
  aniInfo1.ScaleType = 2
  aniInfo1.IsChangeChild = true
  local aniInfo2 = Instance_MessageBox:addScaleAnimation(0.08, 0.14, UI_ANI_ADV.PAUI_ANIM_ADVANCE_COS_HALF_PI)
  aniInfo2:SetStartScale(1.1)
  aniInfo2:SetEndScale(1)
  aniInfo2.AxisX = Instance_MessageBox:GetSizeX() / 2
  aniInfo2.AxisY = Instance_MessageBox:GetSizeY() / 2
...
Instance_MessageBox:RegisterUpdateFunc("messageBox_UpdatePerFrame")
