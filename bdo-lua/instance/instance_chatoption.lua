...
Instance_ChatOption:SetShow(false)
Instance_ChatOption:SetIgnore(true)
Instance_ChatOption:ActiveMouseEventEffect(true)
Instance_ChatOption:setGlassBackground(true)
Instance_ChatOption:RegisterShowEventFunc(true, "ChatOption_ShowAni()")
Instance_ChatOption:RegisterShowEventFunc(false, "ChatOption_HideAni()")
Instance_ChatOption:RegisterUpdateFunc("RegisterUpdate_ChatOption")
...
local roleplayTypeOpen = isGameTypeEnglish() or isGameServiceTypeDev()
...
local _ChatOption_Title = UI.getChildControl(Instance_ChatOption, "StaticText_ChatOptionTitle")
local _msgFilter_BG = UI.getChildControl(Instance_ChatOption, "Static_FilterBG")
local msgFilter_Chkbox = UI.getChildControl(Instance_ChatOption, "Template_CheckButton_Filter")
local selectColor_btn = UI.getChildControl(Instance_ChatOption, "Template_Radiobutton_SelectColor")
local onlySystemSelectColor = UI.getChildControl(Instance_ChatOption, "Template_Radiobutton_SystemSelectColor")
local _alpha_0 = UI.getChildControl(Instance_ChatOption, "StaticText_PanelTransparency_0")
local _alpha_50 = UI.getChildControl(Instance_ChatOption, "StaticText_PanelTransparency_50")
local _alpha_100 = UI.getChildControl(Instance_ChatOption, "StaticText_PanelTransparency_100")
local _alphaSlider_Control = UI.getChildControl(Instance_ChatOption, "Slider_PanelTransparencyControl")
local _alphaSlider_ControlBTN = UI.getChildControl(_alphaSlider_Control, "Slider_PanelTransparency_Button")
local _button_Confirm = UI.getChildControl(Instance_ChatOption, "Button_Confirm")
local _button_Cancle = UI.getChildControl(Instance_ChatOption, "Button_Cancle")
local _button_Close = UI.getChildControl(Instance_ChatOption, "Button_WinClose")
local _button_blockList = UI.getChildControl(Instance_ChatOption, "Button_BlockList")
local _button_resetColor = UI.getChildControl(Instance_ChatOption, "Button_ResetColor")
local fontSizeTitleBg = UI.getChildControl(Instance_ChatOption, "Static_FontSizeTitleBg")
local fontSizeBG = UI.getChildControl(Instance_ChatOption, "Static_FontSizeBG")
local rdo_FontSizeSmall = UI.getChildControl(Instance_ChatOption, "RadioButton_FontSizeSmall")
local rdo_FontSizeSmall2 = UI.getChildControl(Instance_ChatOption, "RadioButton_FontSizeSmall2")
local rdo_FontSizeNormal = UI.getChildControl(Instance_ChatOption, "RadioButton_FontSizeNormal")
local rdo_FontSizeNormal2 = UI.getChildControl(Instance_ChatOption, "RadioButton_FontSizeNormal2")
local rdo_FontSizeBig = UI.getChildControl(Instance_ChatOption, "RadioButton_FontSizeBig")
local stringHeadTitleBg = UI.getChildControl(Instance_ChatOption, "Static_StringHeadTitleBg")
local stringHeadBg = UI.getChildControl(Instance_ChatOption, "Static_StringHeadBG")
...
local panelSizeY = Instance_ChatOption:GetSizeY()
local buttonSizeY = _button_Confirm:GetPosY()
local _buttonQuestion = UI.getChildControl(Instance_ChatOption, "Button_Question")
...
local _check_Division = UI.getChildControl(Instance_ChatOption, "Checkbox_DivisionOption")
...
local _checkButton_ChatTime = UI.getChildControl(Instance_ChatOption, "CheckButton_ChatTime")
...
local ChattingAnimationTitleBg = UI.getChildControl(Instance_ChatOption, "Static_AnimationTitleBg")
local ChattingAnimationOptionBg = UI.getChildControl(Instance_ChatOption, "Static_AnimationOptionBg")
...
local ApplyHarfBuzzTitleBg = UI.getChildControl(Instance_ChatOption, "Static_TurkeyOnlyTitleBg")
local ApplyHarfBuzzOptionBg = UI.getChildControl(Instance_ChatOption, "Static_TurkeyOnlyOptionBg")
...
function ChattingOption_Initialize(panelIdex, _transparency, isCombinedMainPanel)
  ...
  Instance_ChatOption:RemoveControl(onlySystemSelectColor)
  local index = 0
  ...
  Instance_ChatOption:SetSize(Instance_ChatOption:GetSizeX(), panelSizeY + (optionLineCount - 5) * lineGapY)
...
function HandleClicked_ChattingOption_SetFilter(panelIdex)
  ...
  Instance_ChatOption:SetShow(false, false)
  Instance_ChatOption:SetIgnore(true)
  ChattingColor_Hide()
end
...
function ApplyHarfBuzzOption_Initialize()
  ...
  if true == isShow then
    local offsetY = 70
    Instance_ChatOption:SetSize(Instance_ChatOption:GetSizeX(), Instance_ChatOption:GetSizeY() + offsetY)
...
function ChattingOption_Open(penelIdex, drawPanelIndex, isCombinedMainPanel)
  if false == Instance_ChatOption:GetShow() then
    Instance_ChatOption:SetShow(true, true)
    Instance_ChatOption:SetSpanSize(0, 0)
    Instance_ChatOption:SetIgnore(false)
  end
...
function ChatOption_ShowAni()
  UIAni.fadeInSCR_Left(Instance_ChatOption)
end
...
function ChatOption_HideAni()
  Instance_ChatOption:SetShowWithFade(UI_PSFT.PAUI_ANI_TYPE_FADE_OUT)
  local mailHideAni = Instance_ChatOption:addColorAnimation(0, 0.22, UI_ANI_ADV.PAUI_ANIM_ADVANCE_SIN_HALF_PI)
...
local BlockList = {
  _uiBlockList = UI.getChildControl(Instance_ChatOption, "Listbox_Block"),
  _uiBackGround = UI.getChildControl(Instance_ChatOption, "Static_OfferWindow"),
  _uiBlackListTItle = UI.getChildControl(Instance_ChatOption, "StaticText_ChatOptionOfferTitle"),
  _uiClose = UI.getChildControl(Instance_ChatOption, "Block_Close"),
  _uiDelete = UI.getChildControl(Instance_ChatOption, "Button_Delete"),
  _uiAllDelete = UI.getChildControl(Instance_ChatOption, "Button_AllDelete"),
  _uiScroll = nil,
