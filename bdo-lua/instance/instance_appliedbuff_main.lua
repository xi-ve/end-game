...
function PaGlobalAppliedBuffList:initialize()
  ...
  for index = 1, self._maxBuffCount do
    local buffIcon = UI.createControl(__ePAUIControl_StaticText, Instance_AppliedBuffList, "AppliedBuff_" .. index)
    ...
    local deBuffIcon = UI.createControl(__ePAUIControl_StaticText, Instance_AppliedBuffList, "AppliedDeBuff_" .. index)
