PaGlobal_Skill = {
  slotConfig = {
    ...
    template = {
      effect = UI.getChildControl(Instance_Window_Skill, "Static_Icon_Skill_Effect"),
      iconFG = UI.getChildControl(Instance_Window_Skill, "Static_Icon_FG"),
      iconFGDisabled = UI.getChildControl(Instance_Window_Skill, "Static_Icon_FG_DISABLE"),
      iconFG_Passive = UI.getChildControl(Instance_Window_Skill, "Static_Icon_BG"),
      iconMinus = UI.getChildControl(Instance_Window_Skill, "Static_Icon_Skill_EffectMinus"),
      learnButton = UI.getChildControl(Instance_Window_Skill, "Button_Skill_Point"),
      mouseOverButton = UI.getChildControl(Instance_Window_Skill, "Button_Skill_OverMouse"),
      testimonial = UI.getChildControl(Instance_Window_Skill, "Static_Skill_Effect"),
      lockIcon = UI.getChildControl(Instance_Window_Skill, "Static_SkillLockIcon")
    }
  },
  config = {
    slotStartX = 6,
  ...
  radioButtons = {
    [0] = UI.getChildControl(Instance_Window_Skill, "RadioButton_Tab_Combat"),
    UI.getChildControl(Instance_Window_Skill, "RadioButton_Tab_Product")
  },
  staticRemainPoint = UI.getChildControl(Instance_Window_Skill, "Static_Text_RemainSkillPoint"),
  buttonClose = UI.getChildControl(Instance_Window_Skill, "Button_Close"),
  _buttonQuestion = UI.getChildControl(Instance_Window_Skill, "Button_Question"),
  staticSkillLevel = UI.getChildControl(Instance_Window_Skill, "Static_Text_Skill_Level"),
  textSkillPoint = UI.getChildControl(Instance_Window_Skill, "Static_Text_SkillPoint"),
  progressSkillExp = UI.getChildControl(Instance_Window_Skill, "Progress2_SkillExpGage"),
  frames = {
    [0] = UI.getChildControl(Instance_Window_Skill, "Frame_Combat"),
    UI.getChildControl(Instance_Window_Skill, "Frame_Awaken")
  },
  template_guideLine = {
    h = {
      [3] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_LT"),
      [4] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_CT"),
      [5] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_RT"),
      [6] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_LM"),
      [7] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_CM"),
      [8] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_RM"),
      [9] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_LB"),
      [10] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_CB"),
      [11] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_RB"),
      [12] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_HORI"),
      [13] = UI.getChildControl(Instance_Window_Skill, "Static_TypeH_VERTI")
    },
    v = {
      [3] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_LT"),
      [4] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_CT"),
      [5] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_RT"),
      [6] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_LM"),
      [7] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_CM"),
      [8] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_RM"),
      [9] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_LB"),
      [10] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_CB"),
      [11] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_RB"),
      [12] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_HORI"),
      [13] = UI.getChildControl(Instance_Window_Skill, "Static_TypeV_VERTI")
    },
    l = {
      [3] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_LT"),
      [4] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_CT"),
      [5] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_RT"),
      [6] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_LM"),
      [7] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_CM"),
      [8] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_RM"),
      [9] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_LB"),
      [10] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_CB"),
      [11] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_RB"),
      [12] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_HORI"),
      [13] = UI.getChildControl(Instance_Window_Skill, "Static_TypeL_VERTI")
    },
    s = {
      [3] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_LT"),
      [4] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_CT"),
      [5] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_RT"),
      [6] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_LM"),
      [7] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_CM"),
      [8] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_RM"),
      [9] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_LB"),
      [10] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_CB"),
      [11] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_RB"),
      [12] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_HORI"),
      [13] = UI.getChildControl(Instance_Window_Skill, "Static_TypeS_VERTI")
    }
  },
  awakenDesc = UI.getChildControl(Instance_Window_Skill, "StaticText_AwakenWeaponDesc"),
  _btn_MovieToolTipBG = UI.getChildControl(Instance_Window_Skill, "Static_MovieBG"),
  _btn_MovieToolTipDesc = UI.getChildControl(Instance_Window_Skill, "StaticText_MovieToolTip"),
  _btn_MovieToolTip = UI.getChildControl(Instance_Window_Skill, "Button_MovieTooltip"),
  _btn_MovieToolTip2 = UI.getChildControl(Instance_Window_Skill, "Button_MovieTooltip_SpacialCombo"),
  _btn_BlackSpiritLock = UI.getChildControl(Instance_Window_Skill, "Button_BlackSpiritLock"),
  ...
  slotTypeCache = 0,
  tooltipcacheCount = 0,
  skillLevelBg = UI.getChildControl(Instance_Window_Skill, "Static_SkillLevel"),
  _txt_MentalTip = UI.getChildControl(Instance_Window_Skill, "StaticText_Mental_Tip"),
  _txt_ResourceSaveDesc = UI.getChildControl(Instance_Window_Skill, "StaticText_ResourceSaveDesc"),
  _btn_ResetAllSkill = UI.getChildControl(Instance_Window_Skill, "Button_ResetAllSkill"),
  _btn_CommandLock = UI.getChildControl(Instance_Window_Skill, "Button_SkillCommandLock"),
  _btn_Enable_CoolTime_Change = UI.getChildControl(Instance_Window_Skill, "Button_Enable_CoolTime_Change"),
  _bottomBG = UI.getChildControl(Instance_Window_Skill, "Static_BottomBox"),
  ...
  _stc_mouseL = UI.getChildControl(Instance_Window_Skill, "StaticText_MouseL_Icon"),
  _stc_mouseR = UI.getChildControl(Instance_Window_Skill, "StaticText_MouseR_Icon")
}
...
function PaGlobal_Skill:initialize()
  if _ContentsGroup_skillOldandNew then
    self._static_CombiSkill_BG = UI.getChildControl(Instance_Window_Skill, "Static_SlotBG")
    self._combinationSkillTitle = UI.getChildControl(Instance_Window_Skill, "StaticText_SlotTitle")
  ...
  Instance_Window_Skill:setMaskingChild(true)
  Instance_Window_Skill:ActiveMouseEventEffect(true)
  Instance_Window_Skill:setGlassBackground(true)
  ...
  if _ContentsGroup_skillOldandNew == false then
    ...
    Instance_Window_Skill:SetSize(Instance_Window_Skill:GetSizeX(), 580 + self._txt_MentalTip:GetTextSizeY() + 10)
  else
...
function PaGlobal_Skill:initControl()
  ...
  local _frame_Combat = UI.getChildControl(Instance_Window_Skill, "Frame_Combat")
  ...
  local _btn_NewSkill = UI.getChildControl(Instance_Window_Skill, "Button_NewSkill")
...
function PaGlobal_Skill:OnOffCombinationTab()
  ...
  local skillCombinationBg = UI.getChildControl(Instance_Window_Skill, "Static_SlotBG")
  ...
  Instance_Window_Skill:ComputePos()
  ...
  self._btn_BlackSpiritLock:SetShow(false)
...
function PaGlobal_Skill:initSkillLearnableSlot()
  self.staticBottomBox = UI.getChildControl(Instance_Window_Skill, "Static_BottomBox")
