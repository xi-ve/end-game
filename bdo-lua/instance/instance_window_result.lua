...
function result:init()
  ...
  ui.itemName:SetTextMode(__eTextMode_AutoWrap)
  ui.stc_emptyDesc:SetTextMode(__eTextMode_AutoWrap)
  ui.addRewardDesc:SetTextMode(__eTextMode_AutoWrap)
  ui.rewardItemName:SetTextMode(__eTextMode_AutoWrap)
...
function result:updateMyData()
  ...
  if __eClassType_ReservedBlackSpirit == myClassType then
    self._ui.myClass:SetText("")
    self._ui.myClassIcon:SetShow(false)
  else
