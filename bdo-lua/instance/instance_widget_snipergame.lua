PaGlobal_SniperGame = {
  _ui = {
    ...
    _fade = UI.getChildControl(Panel_SniperGame, "Static_Fade"),
    _fadeCircle = nil
  },
  _breathXOffset = 4,
...
function PaGlobal_SniperGame:Open()
  _PA_LOG("\234\185\128\236\176\189\236\151\133", "\235\147\164\236\150\180\236\152\168\235\139\164.")
...
function PaGlobal_SniperGame:StartSearchMode(withAnimation)
  ...
  Panel_SniperGame:SetShow(true)
  _PA_LOG("\234\185\128\236\176\189\236\151\133", "\236\138\164\237\131\128\237\138\184 \236\132\156\236\185\152 \235\170\168\235\147\156")
end
...
function PaGlobal_SniperGame:animateLensEffect(deltaTime)
  ...
  if 1 < _lensDistortionPower then
