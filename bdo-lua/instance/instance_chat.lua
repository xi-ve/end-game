...
function ChatUIPoolManager:createPool(poolIndex, poolStylePanel, poolParentPanel)
  ...
  function ChatUIPool:initialize(stylePanel, parentControl, poolIndex)
    ...
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_ChattingIcon, __ePAUIControl_StaticText, "Static_ChatIcon", self._maxcount_ChattingIcon)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_ChattingSender, __ePAUIControl_StaticText, "StaticText_ChatSender", self._maxcount_ChattingSender)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_ChattingContents, __ePAUIControl_StaticText, "StaticText_ChatContent", self._maxcount_ChattingContents)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_ChattingLinkedItem, __ePAUIControl_StaticText, "StaticText_ChatLinkedItem", self._maxcount_ChattingLinkedItem)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_ChattingLinkedGuild, __ePAUIControl_StaticText, "StaticText_ChatLinkedGuild", self._maxcount_ChattingLinkedGuild)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_ChattingGuildMark, __ePAUIControl_Static, "Static_GuildMark", self._maxcount_ChattingGuildMark)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_ChattingLinkedWebSite, __ePAUIControl_StaticText, "StaticText_ChatLinkedWebSite", self._maxcount_ChattingLinkedWebSite)
    ...
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_Emoticon, __ePAUIControl_Static, "Static_Emoticon", self._maxcount_Emoticon)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_ChatEmoticon, __ePAUIControl_Static, "Static_ChatEmoticon", self._maxcount_Emoticon)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_At, __ePAUIControl_StaticText, "Static_At", self._maxcount_At)
    ChatUIPool:prepareControl(stylePanel, parentControl, self._list_EmoticonAni, __ePAUIControl_Static, "Static_ChatEmoticon_SequenceAni", self._maxcount_EmoticonAni)
