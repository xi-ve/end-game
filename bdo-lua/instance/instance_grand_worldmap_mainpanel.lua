...
local function MakeModeButton()
  local radioControl = __ePAUIControl_RadioButton
...
local function MakeModeChekcState()
  worldMapCheckState[eCheckState.eCheck_Quest] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_Quest")
  worldMapCheckState[eCheckState.eCheck_Knowledge] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_Knowledge")
  worldMapCheckState[eCheckState.eCheck_FishnChip] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_Fishnchip")
  worldMapCheckState[eCheckState.eCheck_Node] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_Node")
  worldMapCheckState[eCheckState.eCheck_Trade] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_Trade")
  worldMapCheckState[eCheckState.eCheck_Way] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_WayGuide")
  worldMapCheckState[eCheckState.eCheck_Postions] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_Positions")
  worldMapCheckState[eCheckState.eCheck_Wagon] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_Carriage")
  worldMapCheckState[eCheckState.eCheck_Monster] = UI.createControl(__ePAUIControl_CheckButton, Instance_WorldMap_Main, "CheckButton_Monster")
