...
function FromClient_CancelByAttacked()
  ...
  elseif true == _ContentsGroup_InstanceLocalWar then
    if nil ~= PaGlobal_LocalWarInfo_All_New_Close then
      PaGlobal_LocalWarInfo_All_New_Close()
    end
  elseif true == _ContentsGroup_NewUI_LocalWar_All then
    if PaGlobal_LocalWarInfo_All_GetShow() then
  ...
  if true == _ContentsGroup_NewUI_QuestOption_All then
    if true == Panel_Window_Quest_Option_All:GetShow() then
      PaGlobal_Quest_Option_All_Close()
    end
  elseif Panel_Window_Quest_New_Option:GetShow() then
