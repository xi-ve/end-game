...
function radarMap:getIdleIcon()
  ...
  if 0 < iconPool:length() then
    ...
    local make_Icon = UI.createControl(__ePAUIControl_Static, Instance_Radar, "Static_Icon_" .. self.iconCreateCount)
    return make_Icon
  end
end
...
function radarMap:getIdleQuest()
  ...
  if 0 < questPool:length() then
    ...
    local iconQuestArea = UI.createControl(__ePAUIControl_Static, Instance_Radar, "Static_QuestArea_" .. self.questCreateCount)
    local iconQuestArrow = UI.createControl(__ePAUIControl_Static, Instance_Radar, "Static_QuestArrow_" .. self.questCreateCount)
...
local function partyMemberArrowIcon(index, isShow)
  if nil == iconPartyMemberArrow[index] then
    ...
    iconPartyMemberArrow[index] = UI.createControl(__ePAUIControl_Static, Instance_Radar, "Static_PartyMemberArrow_" .. index)
