Instance_Equipment_SetEffectTooltip:SetShow(false, false)
Instance_Equipment_SetEffectTooltip:ActiveMouseEventEffect(true)
Instance_Equipment_SetEffectTooltip:setMaskingChild(true)
Instance_Equipment_SetEffectTooltip:setGlassBackground(true)
Instance_Equipment_SetEffectTooltip:RegisterShowEventFunc(true, "EquipmentEffectTooltip_ShowAni()")
Instance_Equipment_SetEffectTooltip:RegisterShowEventFunc(false, "EquipmentEffectTooltip_HideAni()")
PaGlobal_EquipmentTooltip = {
  _ui = {
    _Title = UI.getChildControl(Instance_Equipment_SetEffectTooltip, "StaticText_Title"),
    _NoEffect = UI.getChildControl(Instance_Equipment_SetEffectTooltip, "StaticText_NoEffect"),
    _BaseGroupTitle = UI.getChildControl(Instance_Equipment_SetEffectTooltip, "StaticText_EffectGroupTitle"),
    _BasePartTitle = UI.getChildControl(Instance_Equipment_SetEffectTooltip, "StaticText_EffectPartTitle"),
    _BaseSetDesc = UI.getChildControl(Instance_Equipment_SetEffectTooltip, "StaticText_EffectDesc"),
    _Desc = UI.getChildControl(Instance_Equipment_SetEffectTooltip, "StaticText_Desc"),
    _GroupTitle = {},
    _PartTitle = {},
    _PartDesc = {},
  ...
  _isDetail = false,
  _panel = Instance_Equipment_SetEffectTooltip,
  _info = {}
}
function EquipmentEffectTooltip_ShowAni()
end
function EquipmentEffectTooltip_HideAni()
end
