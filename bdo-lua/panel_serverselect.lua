...
function channelSelectInfo_Init()
  ...
  self._channelSelectDesc:SetTextMode(__eTextMode_AutoWrap)
...
function SpeedChannelInfo_Init()
  ...
  self._speedDesc:SetTextMode(__eTextMode_AutoWrap)
...
function PKChannelInfo_Init()
  ...
  self._pkDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  if value.isOpen then
    ...
    if value.imageCount > 0 then
      ...
      for index = 1, value.imageCount do
        local targetControl = UI.createControl(__ePAUIControl_Static, Panel_ServerSelect, "Static_ServerSelectBg_" .. imageIndex)
...
function StartUp_Panel_SelectServer()
  ...
  for idx = 0, _worldServerCount - 1 do
    ...
    local worldCtrl = {}
    local tempBtn = UI.createControl(__ePAUIControl_Button, FRAME_SERVERLIST:GetFrameContent(), "WorldButton_" .. tostring(idx))
    ...
    local tempName = UI.createControl(__ePAUIControl_StaticText, tempBtn, "WorldName_" .. tostring(idx))
    ...
    tempName:SetPosX(20)
    tempName:SetPosY(14)
    local tempPrimiumIcon = UI.createControl(__ePAUIControl_Static, tempBtn, "WorldPrimiumIcon_" .. tostring(idx))
    CopyBaseProperty(WORLD_PRIMIUMSERVER_ICON, tempPrimiumIcon)
    tempPrimiumIcon:SetPosX(20)
    local tempEvent = UI.createControl(__ePAUIControl_StaticText, tempBtn, "WorldEventName_" .. tostring(idx))
    ...
    local tempCount = UI.createControl(__ePAUIControl_StaticText, tempBtn, "WorldCount_" .. tostring(idx))
    ...
    local tempStatus = UI.createControl(__ePAUIControl_StaticText, tempBtn, "WorldStatus_" .. tostring(idx))
    ...
    local tempUnableCreate = UI.createControl(__ePAUIControl_Static, tempBtn, "WorldUnableCreate_" .. tostring(idx))
...
function Panel_SelectServer_ReCreateChannelCtrl(worldIndex)
  ...
  for idx = 0, _worldServerCtrls[worldIndex]._channelCount - 1 do
    ...
    local tempBG = UI.createControl(__ePAUIControl_Static, FRAME_SERVERLIST:GetFrameContent(), "ChannelBG_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    CopyBaseProperty(CHANNEL_BG_STATIC, tempBG)
    tempBG:SetShow(false)
    tempBG:ActiveMouseEventEffect(true)
    tempBG:SetIgnore(false)
    local tempCheckMainServer = UI.createControl(__ePAUIControl_RadioButton, tempBG, "ChannelRadioBtn_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    ...
    local tempCheckMainServerSQ = UI.createControl(__ePAUIControl_Static, tempBG, "ChannelSequense_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    ...
    local tempName = UI.createControl(__ePAUIControl_StaticText, tempBG, "ChannelName_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    CopyBaseProperty(CHANNEL_NAME_TEXT, tempName)
    tempName:SetShow(true)
    tempName:ActiveMouseEventEffect(true)
    local tempWar = UI.createControl(__ePAUIControl_Static, tempBG, "ChannelWar_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    CopyBaseProperty(channel_WarIcon, tempWar)
    tempWar:SetShow(false)
    tempWar:ActiveMouseEventEffect(true)
    local tempPremium = UI.createControl(__ePAUIControl_Static, tempBG, "ChannelPremium_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    CopyBaseProperty(channel_Premium, tempPremium)
    tempPremium:SetShow(false)
    tempPremium:ActiveMouseEventEffect(true)
    local tempPvPIcon = UI.createControl(__ePAUIControl_Static, tempBG, "ChannelPvP_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    ...
    local tempMainIcon = UI.createControl(__ePAUIControl_Static, tempBG, "ChannelMainIcon_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    ...
    local tempStatus = UI.createControl(__ePAUIControl_StaticText, tempBG, "ChannelStatus_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    ...
    local tempUnableCreate = UI.createControl(__ePAUIControl_Static, tempBG, "ChannelCreateStatus_" .. tostring(idx))
    ...
    local tempBtn = UI.createControl(__ePAUIControl_Button, tempBG, "ChannelButton_" .. tostring(worldIndex) .. "_" .. tostring(idx))
    ...
    local tempChgChannel = UI.createControl(__ePAUIControl_MultiLineText, tempBG, "ChannelChangeText_" .. tostring(worldIndex) .. "_" .. tostring(idx))
