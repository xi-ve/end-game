...
function Global_ItemComparer(ii, jj, getFunction, inventoryType, isSimpleInventory)
  local self = inven
  local invenItemII
  ...
  if not emptyII then
    if true == isSimpleInventory then
      itemStaticWrapperII = getItemEnchantStaticStatus(invenItemII:getItemEnchantKey())
      itemKeyII = invenItemII:getItemEnchantKey():getItemKey()
    else
  ...
  if not emptyJJ then
    if true == isSimpleInventory then
      itemStaticWrapperJJ = getItemEnchantStaticStatus(invenItemJJ:getItemEnchantKey())
      itemKeyJJ = invenItemJJ:getItemEnchantKey():getItemKey()
    else
