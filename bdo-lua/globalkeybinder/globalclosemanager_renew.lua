...
function registerClosePanelList()
  ...
  registerCloseLuaEvent(Panel_Window_CampWarehouse_All, closeTypeBitSet.default, "PanelCloseFunc_CampWarehouse_Close()")
  ...
  registerCloseLuaEvent(Panel_Change_Nickname_All, closeTypeBitSet.default, "HandleEventPadPress_ChangeNickNameAll_Close()")
...
function PanelCloseFunc_MovieTheater320()
  ...
  if value_Panel_MovieTheater_320_IsCheckedShow == true then
    ...
    if 3 <= isComboMovieClosedCount then
...
function PanelCloseFunc_CampWarehouse_Close()
  PaGlobalFunc_CampWarehouse_All_Close()
