...
function loginNickname:init()
  ...
  loginNickname.desc1:SetTextMode(__eTextMode_AutoWrap)
  loginNickname.desc2:SetTextMode(__eTextMode_AutoWrap)
  loginNickname.desc1:SetText(PAGetString(Defines.StringSheet_RESOURCE, "PANEL_NICKNAME_NOTIFY_1"))
  loginNickname.desc2:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_CHANGENAME_CONSOLE_TEXTBIND"))
  loginNickname.desc3:SetShow(false)
...
function loginNickname:setAlign()
  loginNickname.desc3:SetPosY(loginNickname.desc2:GetPosY() + loginNickname.desc2:GetTextSizeY())
  local gapSize = loginNickname.desc2:GetPosY() + loginNickname.desc2:GetTextSizeY() - loginNickname.stc_descGroup:GetSizeY()
