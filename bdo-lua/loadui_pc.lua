...
function preLoadGameUI_PC()
  ...
  basicLoadUI("UI_Data/Window/Arsha/NewUI/Panel_Widget_Arsha_Replay_All.XML", "Panel_Arsha_Replay_All", UIGroup.PAGameUIGroup_Widget)
  ...
  if false == _ContentsGroup_UISkillGroupTreeLayOut then
    ...
    loadUI("UI_Data/Window/Skill/Panel_Skill_Play_SelectType_All.xml", "Panel_Window_SkillGroup_SelectType", UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({
      RenderMode.eRenderMode_Default,
      RenderMode.eRenderMode_SkillWindow,
      RenderMode.eRenderMode_Dialog
    }))
  ...
  if _ContentsGroup_ExitConfirmHashashin then
    loadUI("UI_Data/Window/GameExit/Panel_Window_ExitConfirm_Hashashin.xml", "Panel_ExitConfirm", UIGroup.PAGameUIGroup_GameMenu, SETRENDERMODE_BITSET_ALLRENDER())
  else
  ...
  if true == _ContentsGroup_SeasonContents then
    basicLoadUI("UI_Data/Window/Season/Panel_Window_BlackspiritPass.XML", "Panel_Window_BlackspiritPass", UIGroup.PAGameUIGroup_Windows)
    basicLoadUI("UI_Data/Window/Season/Panel_Tooltip_BlackspiritPass.XML", "Panel_Window_BlackspiritPassTooltip", UIGroup.PAGameUIGroup_SimpleTooltip)
  end
  ...
  basicLoadUI("UI_Data/Widget/ThornCastle/Panel_Widget_ThornCastle_Nak_Sub_Boss.XML", "Panel_Widget_ThornCastle_Nak_Sub_Boss", UIGroup.PAGameUIGroup_Widget)
  basicLoadUI("UI_Data/Widget/ThornCastle/Panel_Widget_ThornCastle_Nak_Sub_Enemy.XML", "Panel_Widget_ThornCastle_Nak_Sub_Enemy", UIGroup.PAGameUIGroup_Widget)
  basicLoadUI("UI_Data/Widget/ThornCastle/Panel_Widget_ThornCastle_Nak_Sub_Friendly.XML", "Panel_Widget_ThornCastle_Nak_Sub_Friendly", UIGroup.PAGameUIGroup_Widget)
  basicLoadUI("UI_Data/Widget/ThornCastle/Panel_Widget_ThornCastle_Nak_Point.XML", "Panel_Widget_ThornCastle_Nak_Point", UIGroup.PAGameUIGroup_Widget)
  ...
  basicLoadUI("UI_Data/Widget/ThornCastle/Panel_Widget_ThornCastle_DeadMessage.XML", "Panel_Widget_ThornCastle_DeadMessage", UIGroup.PAGameUIGroup_BattleAlert)
  ...
  basicLoadUI("UI_Data/Widget/ThornCastle/Panel_Widget_ThornCastle_Enter.XML", "Panel_Widget_ThornCastle_Enter", UIGroup.PAGameUIGroup_Widget)
