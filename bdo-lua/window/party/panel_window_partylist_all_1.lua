...
function PaGlobal_PartyList_All:registEventHandler()
  ...
  if false == self._isPadSnap then
    ...
    if true == self._isConsole then
      ...
      Panel_PartyList_All:registerPadEvent(__eConsoleUIPadEvent_Up_X, "PaGlobalFunc_PartyRecruite_All_Open()")
    end
  ...
  registerEvent("ResponseParty_changeLeader", "PaGlobalFunc_PartyList_All_Update")
