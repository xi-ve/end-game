...
function Panel_Window_FindParty_info:childControl()
  ...
  self._ui.list2_PartyList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_FindParty_List")
  self._ui.list2_PartyList:createChildContent(__ePAUIList2ElementManagerType_List)
end
...
function PaGlobalFunc_FindParty_List(list_content, key)
  ...
  staticText_AdDesc:SetTextMode(__eTextMode_AutoWrap)
