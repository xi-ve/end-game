...
function partyInven:Init()
  if false == _ContentsGroup_NewUI_PartyWidget_All then
    btnPartyInven = UI.getChildControl(Panel_Widget_Party, "Button_PartyInven")
  end
  for listIdx = 0, self.slotCount - 1 do
    local slot = {}
    slot.empty = UI.createControl(__ePAUIControl_Static, Panel_Window_PartyInventory, "PartyInventory_Slot_Base_" .. listIdx)
