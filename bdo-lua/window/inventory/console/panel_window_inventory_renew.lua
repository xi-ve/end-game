...
function InventoryInfo:close()
  ...
  if Defines.UIMode.eUIMode_Default == GetUIMode() and _ContentsGroup_RenewUI_Quest and false == ToClient_IsInstanceFieldPlayerbyContentsType(__eInstanceContentsType_SavageDefence) then
    if true == _ContentsGroup_NewUI_Quest_All then
      if true == PaGlobalFunc_Quest_All_GetShow() then
