local _panel = Panel_Window_RewardList
local REWARD_STATE = {
  ENABLE = 1,
  RECIEVED = 2,
  DISABLE = 3,
...
function battleRoyaleRewardList:init()
  _panel:ComputePos()
  self._ui.txt_MainDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.btn_ReceiveMoney:addInputEvent("Mouse_LUp", "PaGlobal_RewardList_Receive(" .. __eInstanceContentsType_BattleRoyale .. ", " .. __eTItemMoneyKey .. ")")
...
function battleRoyaleRewardList:update()
  local moneyRewardInfoIndex = self:getRewardInfoIndex(__eInstanceContentsType_BattleRoyale, __eTItemMoneyKey)
  local moneyCount = 0
  if 0 <= moneyRewardInfoIndex then
...
function battleRoyaleRewardList:registEventHandler()
  ...
  self._ui.list_Reward:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_RewardList_CreateListContent")
  self._ui.list_Reward:createChildContent(__ePAUIList2ElementManagerType_List)
...
function battleRoyaleRewardList:receiveMoney()
  ...
  local rewardInfoIndex = self:getRewardInfoIndex(__eInstanceContentsType_BattleRoyale, __eTItemMoneyKey)
...
function battleRoyaleRewardList:createListContent(content, index)
  ...
  txt_RankTitle:SetTextMode(__eTextMode_AutoWrap)
  txt_RankDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  if 0 <= basicRewardInfoIndex then
  ...
  if 0 <= boostRewardInfoIndex then
