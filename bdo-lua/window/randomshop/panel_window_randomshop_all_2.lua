...
function HandleEventOn_RandomShop_All_SetPayment()
  ...
  if true == invenCheck then
    PaGlobal_RandowShop_All._ui.radio_inven:SetCheck(false)
    PaGlobal_RandowShop_All._ui.radio_warehouse:SetCheck(true)
  else
    PaGlobal_RandowShop_All._ui.radio_inven:SetCheck(true)
    PaGlobal_RandowShop_All._ui.radio_warehouse:SetCheck(false)
  end
end
...
function PaGlobalFunc_RandomShop_All_BuyItem()
  ...
  if true == invenCheck then
    ...
    if getSelfPlayer():get():getInventory():getMoney_s64() < PaGlobal_RandowShop_All._randomShopItemPrice then
    ...
    if wareHouseMoney < PaGlobal_RandowShop_All._randomShopItemPrice then
