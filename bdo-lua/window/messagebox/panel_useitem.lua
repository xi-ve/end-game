...
function Panel_UseItem_Initialize()
  ...
  for idx = 1, maxPopupSlotCount do
    popupItem.slotInfoBG[idx] = UI.createControl(__ePAUIControl_Static, Panel_UseItem, "Static_EmptyItemSlotBG_" .. idx)
    ...
    popupItem.slotInfoForBuffBG[idx] = UI.createControl(__ePAUIControl_Static, Panel_UseItem, "Static_EmptyBuffSlotBG_" .. idx)
    CopyBaseProperty(_copyItemSlot, popupItem.slotInfoForBuffBG[idx])
    popupItem.slotInfoForBuff[idx] = UI.createControl(__ePAUIControl_Static, Panel_UseItem, "Static_EmptyBuffSlot_" .. idx)
...
function Click_Panel_UserItem_Yes()
  ...
  if true == _ContentsGroup_NewUI_Inventory_All then
    PaGlobalFunc_Inventory_All_UseItemTargetSelf(popupItem.selectWhereType, popupItem.selectSlotNo, popupItem.selectEquipNo)
  else
