...
improvement.descBg:SetTextMode(__eTextMode_AutoWrap)
...
function Panel_Improvement_Show()
  ...
  if true == _ContentsGroup_NewUI_Inventory_All then
    PaGlobalFunc_Inventory_All_SetInventoryDragNoUse(Panel_Improvement)
  else
...
function DoImprove()
  ...
  if self._doImprove then
    ...
    self._chk_Skip:SetIgnore(false)
    return
  end
  local improveInfo = getImproveInformation()
...
function PaGlobal_Improvement_IsImprovementing()
  return improvement._doImprove
end
