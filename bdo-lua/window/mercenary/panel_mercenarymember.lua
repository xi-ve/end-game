...
function mercenaryList:Initialize()
  ...
  self._ui._list2_Member:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui._list2_Member:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_MercenaryMember_UpdateList")
