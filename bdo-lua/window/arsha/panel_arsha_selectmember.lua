...
function Panel_Arsha_SelectMember:Initialize()
  ...
  ui._list_entryMembers:registEvent(__ePAUIList2EventType_LuaChangeContent, "CreateListContent_Arsha_AttendMember")
  ui._list_entryMembers:createChildContent(__ePAUIList2ElementManagerType_List)
