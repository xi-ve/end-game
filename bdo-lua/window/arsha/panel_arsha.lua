...
function ArshaPvP_init()
  ...
  self.list2_ArshaTeamA:registEvent(__ePAUIList2EventType_LuaChangeContent, "ArshaPvP_TeamA_Update")
  self.list2_ArshaTeamA:createChildContent(__ePAUIList2ElementManagerType_List)
  self.list2_ArshaTeamB:changeAnimationSpeed(10)
  self.list2_ArshaTeamB:registEvent(__ePAUIList2EventType_LuaChangeContent, "ArshaPvP_TeamB_Update")
  self.list2_ArshaTeamB:createChildContent(__ePAUIList2ElementManagerType_List)
  self.list2_ArshaWait:changeAnimationSpeed(10)
  self.list2_ArshaWait:registEvent(__ePAUIList2EventType_LuaChangeContent, "ArshaPvP_Wait_Update")
  self.list2_ArshaWait:createChildContent(__ePAUIList2ElementManagerType_List)
  self.list2_ArshaObserver:changeAnimationSpeed(10)
  self.list2_ArshaObserver:registEvent(__ePAUIList2EventType_LuaChangeContent, "ArshaPvP_Observer_Update")
  self.list2_ArshaObserver:createChildContent(__ePAUIList2ElementManagerType_List)
