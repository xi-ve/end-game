...
local _remainTimeTitle = UI.getChildControl(Panel_Worldmap_TentInfo, "StaticText_T_RemainTime")
...
local function initTentInfo()
  ...
  for index = 0, maxCount - 1 do
    local dataGroup = {}
    dataGroup._iconSlot = UI.createControl(__ePAUIControl_Static, Panel_Worldmap_TentInfo, "Static_C_IconSlot_" .. index)
    CopyBaseProperty(template._iconSlot, dataGroup._iconSlot)
    dataGroup._iconSlot:SetPosY(template._iconSlot:GetPosY() + pushYValue)
    dataGroup._icon = UI.createControl(__ePAUIControl_Static, Panel_Worldmap_TentInfo, "Static_C_Icon_" .. index)
    CopyBaseProperty(template._icon, dataGroup._icon)
    dataGroup._icon:SetPosY(template._icon:GetPosY() + pushYValue)
    dataGroup._itemName = UI.createControl(__ePAUIControl_StaticText, Panel_Worldmap_TentInfo, "StaticText_C_ItemName_" .. index)
    CopyBaseProperty(template._itemName, dataGroup._itemName)
    dataGroup._itemName:SetPosY(template._itemName:GetPosY() + pushYValue)
    dataGroup._gageBg = UI.createControl(__ePAUIControl_Static, Panel_Worldmap_TentInfo, "Static_C_GaugeBG_" .. index)
    CopyBaseProperty(template._gageBg, dataGroup._gageBg)
    dataGroup._gageBg:SetPosY(template._gageBg:GetPosY() + pushYValue)
    dataGroup._progress = UI.createControl(__ePAUIControl_Progress2, Panel_Worldmap_TentInfo, "Progress2_C_Gauge_" .. index)
    CopyBaseProperty(template._progress, dataGroup._progress)
    dataGroup._progress:SetPosY(template._progress:GetPosY() + pushYValue)
    dataGroup._percent = UI.createControl(__ePAUIControl_StaticText, Panel_Worldmap_TentInfo, "StaticText_C_Percent_" .. index)
    CopyBaseProperty(template._percent, dataGroup._percent)
    dataGroup._percent:SetPosY(template._percent:GetPosY() + pushYValue)
    dataGroup._iconPruning = UI.createControl(__ePAUIControl_Static, Panel_Worldmap_TentInfo, "StaticText_C_IconPruning_" .. index)
    ...
    dataGroup._iconInsectDamege = UI.createControl(__ePAUIControl_Static, Panel_Worldmap_TentInfo, "StaticText_C_IconInsectDamege_" .. index)
...
function FromClient_TentTooltipShow(tentIcon, householdDataWithInstallationWrapper)
  ...
  _remainTimeTitle:SetSize(_remainTime:GetPosX(), _remainTimeTitle:GetSizeY())
  _remainTimeTitle:SetTextMode(__eTextMode_AutoWrap)
  _remainTimeTitle:SetText(_remainTimeTitle:GetText())
