...
function occupyGuildSection:SetInfo(territoryInfo, territoryKeyRaw)
  ...
  if Panel_Worldmap_Territory:GetSizeX() < self.guildOwner:GetPosX() + self.guildOwner:GetTextSizeX() then
    ...
    self.guildOwner:SetSpanSize(self.guildOwner:GetSpanSize().x, self.guildName:GetSpanSize().y + self.guildName:GetTextSizeY() + 5)
    self.occupyDate:SetSpanSize(self.occupyDate:GetSpanSize().x, self.guildOwner:GetSpanSize().y + self.guildOwner:GetTextSizeY() + 5)
    self.occupyEffect:SetSpanSize(self.occupyEffect:GetSpanSize().x, self.occupyDate:GetSpanSize().y + self.occupyDate:GetTextSizeY() + 3)
  end
  ...
  if true == _ContentsGroup_MajorSiege_AddMaxHp then
    ...
    local lineSizeY = self.occupyEffect:GetTextSizeY()
    if siegeWrapper:doOccupantExist() then
      self.line_2:SetSpanSize(0, 378 + lineSizeY)
    end
  else
    self.occupyEffect:SetShow(false)
  end
...
function occupyBenefit:SetInfo(territoryKeyRaw)
  ...
  local lineSizeY = 0
  if true == _ContentsGroup_MajorSiege_AddMaxHp then
    lineSizeY = occupyGuildSection.occupyEffect:GetTextSizeY()
  end
  local siegeWrapper = ToClient_GetSiegeWrapper(territoryKeyRaw)
  if nil ~= siegeWrapper and siegeWrapper:doOccupantExist() then
    ...
    self.sectionBG:SetSpanSize(20, 390 + lineSizeY)
    self.sectionTitle:SetSpanSize(20, 400 + lineSizeY)
    self.sectionDesc:SetSpanSize(30, 430 + lineSizeY)
  else
    self.sectionBG:SetSize(self.sectionBG:GetSizeX(), self.sectionDesc:GetTextSizeY() + 50)
...
function commonInfoSection:SetInfo(territoryInfo, territoryKeyRaw)
  ...
  if nil ~= siegeWrapper and siegeWrapper:doOccupantExist() then
    ...
    self.sectionBG:SetSpanSize(0, 390 + occupyBenefitSizeY + lineSizeY)
    self.playerInfoTitle:SetSpanSize(20, 400 + occupyBenefitSizeY + lineSizeY)
    self.playerPopular:SetSpanSize(30, 430 + occupyBenefitSizeY + lineSizeY)
    self.warInfoTitle:SetSpanSize(20, 470 + occupyBenefitSizeY + lineSizeY)
    self.warInfo:SetSpanSize(30, 500 + occupyBenefitSizeY + lineSizeY)
  else
