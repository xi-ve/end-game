...
local nodeStableInfo = {
  ...
  _Info_InsideBg = UI.getChildControl(Panel_NodeStableInfo, "Static_InsideBG"),
...
function nodeStableInfo:update()
  ...
  self._Info_InsideBg:SetSize(self._Info_InsideBg:GetSizeX(), 344)
  ...
  if servantInfo:getVehicleType() == CppEnums.VehicleType.Type_Donkey and 0 == self._learnSkillCount then
    self._SkillTitle:SetShow(false)
    self._SkillCountValue:SetShow(false)
    self._SkillBG:SetShow(false)
    Panel_NodeStableInfo:SetSize(Panel_NodeStableInfo:GetSizeX(), 355)
    self._Info_InsideBg:SetSize(self._Info_InsideBg:GetSizeX(), 235)
  end
  for index = 0, #ServantInfoTitle do
    ServantInfoTitle[index]:SetTextMode(__eTextMode_LimitText)
