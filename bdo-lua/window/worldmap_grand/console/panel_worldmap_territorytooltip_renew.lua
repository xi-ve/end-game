...
function TerritoryTooltipInfo:update_OccupiersInfoGroup(territoryInfo, territoryKeyRaw)
  ...
  if true == _ContentsGroup_MajorSiege_AddMaxHp then
    ...
    self._ui.stc_guildOccupationEffect:SetText(PAGetStringParam2(Defines.StringSheet_GAME, "LUA_WORLDMAP_TERRITORYTOOLTIP_SIEGEHP", "value1", hpStack, "value2", hpValue))
  else
