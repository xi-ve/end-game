  ...
  for territory_idx = 0, territoryCount - 1 do
    ...
    if toInt64(0, 5) ~= territoryKey then
      ...
      if nil ~= territoryKey then
        ...
        territoryDATA.Name = UI.createControl(__ePAUIControl_StaticText, statusTemplate, "StaticText_Territory_Name_" .. territory_idx)
        ...
        territoryDATA.FindCount = UI.createControl(__ePAUIControl_StaticText, statusTemplate, "StaticText_Territory_FindCount_" .. territory_idx)
        CopyBaseProperty(self._ui.txt_findCount, territoryDATA.FindCount)
        territoryDATA.FindCount:SetShow(true)
        territoryDATA.DestroyCount = UI.createControl(__ePAUIControl_StaticText, statusTemplate, "StaticText_Territory_DestroyCount_" .. territory_idx)
        CopyBaseProperty(self._ui.txt_destroyCount, territoryDATA.DestroyCount)
        territoryDATA.DestroyCount:SetShow(true)
        territoryDATA.AllCount = UI.createControl(__ePAUIControl_StaticText, statusTemplate, "StaticText_Territory_AllCount_" .. territory_idx)
