...
function SubWork_List:_updateSlot(isRefresh)
  ...
  for idx = 1, self._rowMax do
    ...
    if nil == _data[_idx] then
      ...
      if 0 < _onGoingCount and (self._selected_Index == _idx or self._over_Index == _idx) then
...
local function Worker_SortByRegionInfo()
  ...
  local territory = {}
  if 0 < buildingTerritoryKey and buildingTerritoryKey <= 300 then
    territory[0] = true
    territory[1] = false
    territory[2] = false
    territory[3] = false
  elseif 301 <= buildingTerritoryKey and buildingTerritoryKey <= 600 then
    territory[0] = false
    territory[1] = true
    territory[2] = false
    territory[3] = false
  elseif 601 <= buildingTerritoryKey and buildingTerritoryKey <= 1000 then
    territory[0] = false
    territory[1] = false
    territory[2] = true
    territory[3] = false
