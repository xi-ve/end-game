...
ItemMarket_FavoriteItem._emptyItem:SetTextMode(__eTextMode_AutoWrap)
ItemMarket_FavoriteItem._notifyText:SetTextMode(__eTextMode_AutoWrap)
...
function ItemMarket_registEventHandler()
  local self = ItemMarket_FavoriteItem
  self.list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "FavoriteItem_ListControlCreate")
