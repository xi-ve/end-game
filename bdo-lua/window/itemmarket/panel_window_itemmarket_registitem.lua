...
function FGlobal_ItemMarketRegistItemFromInventory(s64_count, slotNo, inventoryType, waypointKey)
  ...
  if 1 == itemSS:getItemType() and 15 < enchantLevel then
    self.itemName:SetText(HighEnchantLevel_ReplaceString(enchantLevel) .. " " .. itemSS:getName())
  elseif 0 < enchantLevel and CppEnums.ItemClassifyType.eItemClassify_Accessory == itemSS:getItemClassify() and false == itemSS:isSpecialEnchantItem() then
