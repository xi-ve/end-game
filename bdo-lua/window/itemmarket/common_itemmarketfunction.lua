...
function FromClient_notifyItemMarketMessage(msgType, strParam1, param1, param2, param3, param4)
  ...
  elseif 1 == msgType then
    ...
    elseif 0 < enchantLevel and enchantLevel < 16 and 4 ~= issw:getItemClassify() then
      if true == isCash then
        strParam1 = itemName
      else
        strParam1 = "+" .. enchantLevel .. " " .. itemName
  ...
  elseif 11 == msgType then
    ...
    local itemNameStr = PaGlobalFunc_MarketPlace_setNameAndEnchantLevel(enchantLevel, itemType, itemName, itemClassify, issw:isSpecialEnchantItem())
