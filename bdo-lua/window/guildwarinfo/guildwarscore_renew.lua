...
function PAGlobal_GuildWarScore:init()
  ...
  local function createWarfareInfo(pIndex)
    ...
    rtGuildWarfareInfo._txtCharName = UI.createControl(__ePAUIControl_StaticText, Panel_Window_GuildWarScore, "StaticText_CharacterName" .. pIndex)
    rtGuildWarfareInfo._txtBuilding = UI.createControl(__ePAUIControl_StaticText, Panel_Window_GuildWarScore, "StaticText_V_Destroyed" .. pIndex)
    rtGuildWarfareInfo._txtKill = UI.createControl(__ePAUIControl_StaticText, Panel_Window_GuildWarScore, "StaticText_V_Kill" .. pIndex)
    rtGuildWarfareInfo._txtDead = UI.createControl(__ePAUIControl_StaticText, Panel_Window_GuildWarScore, "StaticText_V_Dead" .. pIndex)
    rtGuildWarfareInfo._txtVehicle = UI.createControl(__ePAUIControl_StaticText, Panel_Window_GuildWarScore, "StaticText_V_StableDead" .. pIndex)
