...
function GuildWarInfo:initialize()
  ...
  self._ui.list2_offenceGuilds:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_GuildWarInfo_ListCreateControl")
  self._ui.list2_offenceGuilds:createChildContent(__ePAUIList2ElementManagerType_List)
