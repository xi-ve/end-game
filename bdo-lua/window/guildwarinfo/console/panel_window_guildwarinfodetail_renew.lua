...
function GuildWarInfoDetail:initialize()
  ...
  self._ui.list2_members:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_GuildWarInfoDetail_ListCreateControl")
  self._ui.list2_members:createChildContent(__ePAUIList2ElementManagerType_List)
end
