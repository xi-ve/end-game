...
function PAGlobal_GuildWarInfo:InitDefenceGuild()
  ...
  for tIndex = 0, 4 do
    self._defenceGuildInfo.title[tIndex]:SetTextMode(__eTextMode_LimitText)
...
function PAGlobal_GuildWarInfo:InitOffenceGuild()
  ...
  for index = 0, 1 do
    ...
    for tIndex = 0, 4 do
      self._offenceGuildInfo_2[index].title[tIndex]:SetTextMode(__eTextMode_LimitText)
  ...
  ui_main.rightGuild_Bg_list:registEvent(__ePAUIList2EventType_LuaChangeContent, "FGlobal_GuildWarInfo_ListUpdate")
  ui_main.rightGuild_Bg_list:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PAGlobal_GuildWarInfo:UpdateGuildScoreMain(siegeWrapper, guildCount)
  ...
  for index = 0, guildCount - 1 do
    ...
    if 5 <= rightGuildCount and false == isDefenceGuild then
