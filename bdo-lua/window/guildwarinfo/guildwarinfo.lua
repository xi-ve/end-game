...
warInfo_Content.setFreeDesc:SetTextMode(__eTextMode_AutoWrap)
...
function FromClient_WarInfoContent_Set(territoryKey)
  ...
  if battleGuildCount[territoryKey] <= 0 then
    if true == controlReGenerate then
      local index = 0
      local contentBg = UI.createControl(__ePAUIControl_Static, self.frame_content, "Static_WarInfoContent_" .. index)
      ...
      local setFree = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_setFree_" .. index)
      ...
      local setFreeDesc = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_setFreeDesc_" .. index)
  ...
  elseif 1 == battleGuildCount[territoryKey] then
    ...
    if true == controlReGenerate then
      ...
      warInfoContent[territoryKey][index].setFreeDesc:SetShow(true)
      index = 1
      local contentBg1 = UI.createControl(__ePAUIControl_Static, self.frame_content, "Static_WarInfoContent_" .. index)
      ...
      warInfoContent[territoryKey][index].contentBg:SetShow(true)
      local occupyGuildBg = UI.createControl(__ePAUIControl_Static, self.frame_content, "Static_WarInfoContentBg_" .. index)
      ...
      local guildMarkBg = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_GuildMarkBg_" .. index)
      ...
      local guildMark = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_GuildMark_" .. index)
      ...
      local guildName = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].occupyGuildBg, "StaticText_GuildName_" .. index)
      ...
      local lordCrownIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "StaticText_LordIcon")
      ...
      local guildMaster = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].occupyGuildBg, "StaticText_GuildMaster_" .. index)
      ...
      local guildWarIconBg = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_GuildWarIconBg_" .. index)
      ...
      local destroySiegeCountIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_DestroySiegeCountIcon_" .. index)
      ...
      local destroySiegeCountValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].occupyGuildBg, "StaticText_DestroySiegeCountValue_" .. index)
      ...
      local killCountIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_KillCountIcon_" .. index)
      ...
      local killCountValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].occupyGuildBg, "StaticText_KillCountValue_" .. index)
      ...
      local deathCountIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_DeathCountIcon_" .. index)
      ...
      local deathCountValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].occupyGuildBg, "StaticText_DeathCountValue_" .. index)
      ...
      local cannonCountIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_CannonCountIcon_" .. index)
      ...
      local cannonCountValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].occupyGuildBg, "StaticText_CannonCountValue_" .. index)
      ...
      local moraleIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_MoraleIcon_" .. index)
      ...
      local moraleProgressBg = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].occupyGuildBg, "Static_MoraleProgressBg_" .. index)
      ...
      local moraleProgress = UI.createControl(__ePAUIControl_Progress2, warInfoContent[territoryKey][index].occupyGuildBg, "Progress2_MoraleProgress_" .. index)
      ...
      local btn_CurrentInfo = UI.createControl(__ePAUIControl_Button, warInfoContent[territoryKey][index].occupyGuildBg, "Button_CurrentInfo_" .. index)
      ...
      local btn_Cheer = UI.createControl(__ePAUIControl_Button, warInfoContent[territoryKey][index].occupyGuildBg, "Button_Cheer_" .. index)
      ...
      local cheerPoint = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].occupyGuildBg, "StaticText_CheerPoint_" .. index)
  ...
  elseif 1 < battleGuildCount[territoryKey] then
    ...
    if true == controlReGenerate then
      ...
      for index = startIndex, lastIndex - 1 do
        ...
        local guildMarkBg = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_GuildMarkBg_" .. index)
        CopyBaseProperty(self.guildMarkBg, guildMarkBg)
        warInfoContent[territoryKey][index].guildMarkBg = guildMarkBg
        warInfoContent[territoryKey][index].guildMarkBg:SetShow(true)
        local guildMark = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_GuildMark_" .. index)
        CopyBaseProperty(self.guildMark, guildMark)
        warInfoContent[territoryKey][index].guildMark = guildMark
        warInfoContent[territoryKey][index].guildMark:SetShow(true)
        local guildName = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_GuildName_" .. index)
        CopyBaseProperty(self.guildName, guildName)
        warInfoContent[territoryKey][index].guildName = guildName
        warInfoContent[territoryKey][index].guildName:SetShow(true)
        local lordCrownIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "StaticText_LordIcon")
        CopyBaseProperty(self.lordCrownIcon, lordCrownIcon)
        warInfoContent[territoryKey][index].lordCrownIcon = lordCrownIcon
        warInfoContent[territoryKey][index].lordCrownIcon:SetShow(false)
        local guildMaster = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_GuildMaster_" .. index)
        CopyBaseProperty(self.guildMaster, guildMaster)
        warInfoContent[territoryKey][index].guildMaster = guildMaster
        warInfoContent[territoryKey][index].guildMaster:SetShow(true)
        local guildWarIconBg = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_GuildWarIconBg_" .. index)
        CopyBaseProperty(self.guildWarIconBg, guildWarIconBg)
        warInfoContent[territoryKey][index].guildWarIconBg = guildWarIconBg
        warInfoContent[territoryKey][index].guildWarIconBg:SetShow(true)
        local siegeEnduranceIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_SiegeEnduranceIcon_" .. index)
        ...
        local siegeEnduranceValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_SiegeEnduranceValue_" .. index)
        ...
        local destroySiegeCountIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_DestroySiegeCountIcon_" .. index)
        CopyBaseProperty(self.destroySiegeCountIcon, destroySiegeCountIcon)
        warInfoContent[territoryKey][index].destroySiegeCountIcon = destroySiegeCountIcon
        warInfoContent[territoryKey][index].destroySiegeCountIcon:SetShow(true)
        local destroySiegeCountValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_DestroySiegeCountValue_" .. index)
        CopyBaseProperty(self.destroySiegeCountValue, destroySiegeCountValue)
        warInfoContent[territoryKey][index].destroySiegeCountValue = destroySiegeCountValue
        warInfoContent[territoryKey][index].destroySiegeCountValue:SetShow(true)
        local killCountIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_KillCountIcon_" .. index)
        CopyBaseProperty(self.killCountIcon, killCountIcon)
        warInfoContent[territoryKey][index].killCountIcon = killCountIcon
        warInfoContent[territoryKey][index].killCountIcon:SetShow(true)
        local killCountValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_KillCountValue_" .. index)
        CopyBaseProperty(self.killCountValue, killCountValue)
        warInfoContent[territoryKey][index].killCountValue = killCountValue
        warInfoContent[territoryKey][index].killCountValue:SetShow(true)
        local deathCountIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_DeathCountIcon_" .. index)
        CopyBaseProperty(self.deathCountIcon, deathCountIcon)
        warInfoContent[territoryKey][index].deathCountIcon = deathCountIcon
        warInfoContent[territoryKey][index].deathCountIcon:SetShow(true)
        local deathCountValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_DeathCountValue_" .. index)
        CopyBaseProperty(self.deathCountValue, deathCountValue)
        warInfoContent[territoryKey][index].deathCountValue = deathCountValue
        warInfoContent[territoryKey][index].deathCountValue:SetShow(true)
        local cannonCountIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_CannonCountIcon_" .. index)
        CopyBaseProperty(self.cannonCountIcon, cannonCountIcon)
        warInfoContent[territoryKey][index].cannonCountIcon = cannonCountIcon
        warInfoContent[territoryKey][index].cannonCountIcon:SetShow(true)
        local cannonCountValue = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_CannonCountValue_" .. index)
        CopyBaseProperty(self.cannonCountValue, cannonCountValue)
        warInfoContent[territoryKey][index].cannonCountValue = cannonCountValue
        warInfoContent[territoryKey][index].cannonCountValue:SetShow(true)
        local moraleIcon = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_MoraleIcon_" .. index)
        CopyBaseProperty(self.moraleIcon, moraleIcon)
        warInfoContent[territoryKey][index].moraleIcon = moraleIcon
        warInfoContent[territoryKey][index].moraleIcon:SetShow(false)
        local moraleProgressBg = UI.createControl(__ePAUIControl_Static, warInfoContent[territoryKey][index].contentBg, "Static_MoraleProgressBg_" .. index)
        CopyBaseProperty(self.moraleProgressBg, moraleProgressBg)
        warInfoContent[territoryKey][index].moraleProgressBg = moraleProgressBg
        warInfoContent[territoryKey][index].moraleProgressBg:SetShow(false)
        local moraleProgress = UI.createControl(__ePAUIControl_Progress2, warInfoContent[territoryKey][index].contentBg, "Progress2_MoraleProgress_" .. index)
        CopyBaseProperty(self.moraleProgress, moraleProgress)
        warInfoContent[territoryKey][index].moraleProgress = moraleProgress
        warInfoContent[territoryKey][index].moraleProgress:SetShow(false)
        warInfoContent[territoryKey][index].moraleProgress:SetAniSpeed(0)
        warInfoContent[territoryKey][index].moraleProgress:SetProgressRate(0)
        local btn_CurrentInfo = UI.createControl(__ePAUIControl_Button, warInfoContent[territoryKey][index].contentBg, "Button_CurrentInfo_" .. index)
        CopyBaseProperty(self.btn_CurrentInfo, btn_CurrentInfo)
        warInfoContent[territoryKey][index].btn_CurrentInfo = btn_CurrentInfo
        warInfoContent[territoryKey][index].btn_CurrentInfo:SetShow(true)
        if isSiegeChannel then
        ...
        local btn_Cheer = UI.createControl(__ePAUIControl_Button, warInfoContent[territoryKey][index].contentBg, "Button_Cheer_" .. index)
        CopyBaseProperty(self.btn_Cheer, btn_Cheer)
        warInfoContent[territoryKey][index].btn_Cheer = btn_Cheer
        warInfoContent[territoryKey][index].btn_Cheer:SetShow(false)
        local cheerPoint = UI.createControl(__ePAUIControl_StaticText, warInfoContent[territoryKey][index].contentBg, "StaticText_CheerPoint_" .. index)
        CopyBaseProperty(self.cheerPoint, cheerPoint)
        warInfoContent[territoryKey][index].cheerPoint = cheerPoint
        warInfoContent[territoryKey][index].cheerPoint:SetShow(false)
        warInfoContent[territoryKey][index].cheerPoint:SetPosX(warInfoContent[territoryKey][index].moraleIcon:GetPosX() + warInfoContent[territoryKey][index].moraleIcon:GetSizeX() + 5)
...
function Panel_GuildWarInfo_Icon_ToolTip_Show(territoryKey, index, iconType)
  ...
  warInfo_Content._tooltip:SetTextMode(__eTextMode_None)
    ...
    if nil ~= siegeGuildInfo then
      ...
      if true == siegeGuildInfo._isCheerUp then
        ...
        if nil ~= guildName and nil ~= userName then
          ...
          local txtLog = UI.createControl(__ePAUIControl_StaticText, log_Content.frame_content, "GuildWar_Log_" .. logIndex)
          CopyBaseProperty(warInfo_Log.textLog, txtLog)
          log_Content.textLog[logIndex] = txtLog
          log_Content.textLog[logIndex]:SetShow(true)
          local isGuildMasterBg = UI.createControl(__ePAUIControl_Static, log_Content.frame_content, "GuildWar_LogBg_" .. logIndex)
      ...
      elseif true == siegeGuildInfo._isKill then
        ...
        if nil ~= _guildname and nil ~= _username then
          ...
          CopyBaseProperty(warInfo_Log.isGuildMasterBg, isGuildMasterBg)
          log_Content.isGuildMasterBg[logIndex] = isGuildMasterBg
          log_Content.textLog[logIndex]:SetTextMode(__eTextMode_AutoWrap)
          log_Content.textLog[logIndex]:SetText(msg)
...
function GuildWarInfo_UpdatePerFrame(deltaTime)
  ...
  if 30 < guildWarInfoUpdateTimer then
    ToClient_RequestSiegeScore()
