function PaGlobal_GuildWarInfoSmall:initialize()
  ...
  PaGlobal_GuildWarInfoSmall._ui._list_attackGuild:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_GuildWarInfoSmall_updateListContent")
  PaGlobal_GuildWarInfoSmall._ui._list_attackGuild:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PaGlobal_GuildWarInfoSmall:update(territoryKey)
  ...
  if true == PaGlobal_GuildWarInfoSmall._isSeigeBeing then
    ...
    PaGlobal_GuildWarInfoSmall._ui._stc_nowarTitle:SetTextMode(__eTextMode_AutoWrap)
    PaGlobal_GuildWarInfoSmall._ui._stc_nowarResult:SetTextMode(__eTextMode_AutoWrap)
    if true == siegeWrapper:doOccupantExist() then
...
function PaGlobal_GuildWarInfoSmall:updateGuildWarMain(siegeWrapper, guildCount)
  ...
  if 1 <= addAttackGuildCount and addAttackGuildCount < 5 then
  ...
  elseif 5 <= addAttackGuildCount then
