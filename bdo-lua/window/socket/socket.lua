...
PaGlobal_Util_RegistHelpTooltipEvent(_buttonQuestion, "\"Socket\"")
...
local function Socket_Pop_Confirm()
  ...
  Socket_PopJewelFromSocket(socket._indexSocket, CppEnums.ItemWhereType.eCount, __eTInventorySlotNoUndefined)
end
...
function Socket_OnScreenEvent()
  ...
  if true == _ContentsGroup_NewUI_Inventory_All then
    Panel_Window_Socket:SetPosY(Panel_Window_Inventory_All:GetPosY())
  else
