...
local PetList = {
  ...
  BTN_GroupSeal4 = UI.getChildControl(Panel_Window_PetListNew, "Button_AllSeal_Group4"),
  BTN_GroupSeal5 = UI.getChildControl(Panel_Window_PetListNew, "Button_AllSeal_Group5"),
...
PetList.BTN_GroupSeal4:addInputEvent("Mouse_On", "PetListNew_SimpleTooltip( true, 6 )")
PetList.BTN_GroupSeal4:addInputEvent("Mouse_Out", "PetListNew_SimpleTooltip( false )")
PetList.BTN_GroupSeal5:addInputEvent("Mouse_On", "PetListNew_SimpleTooltip( true, 7 )")
PetList.BTN_GroupSeal5:addInputEvent("Mouse_Out", "PetListNew_SimpleTooltip( false )")
...
function PetList:Initialize()
  ...
  PetList.BTN_GroupSeal4:SetTextSpan(btnAllSealTextPosX, 5)
  PetList.BTN_GroupSeal5:SetTextSpan(btnAllSealTextPosX, 5)
...
function PetListNew_SimpleTooltip(isShow, tipType)
  ...
  elseif 6 == tipType then
    name = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_WINDOW_PETLISTNEW_ALLSEAL")
    desc = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PETLIST_ALLSEAL_GROUP_SEAL4", "count", maxUnsealCount) .. [[


]] .. PAGetString(Defines.StringSheet_GAME, "LUA_SHORTBUTTON_HOWTOUSE_TOOLTIP_DESC")
    control = PetList.BTN_GroupSeal4
  elseif 7 == tipType then
    name = PAGetString(Defines.StringSheet_RESOURCE, "PANEL_WINDOW_PETLISTNEW_ALLSEAL")
    desc = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PETLIST_ALLSEAL_GROUP_SEAL5", "count", maxUnsealCount) .. [[


]] .. PAGetString(Defines.StringSheet_GAME, "LUA_SHORTBUTTON_HOWTOUSE_TOOLTIP_DESC")
    control = PetList.BTN_GroupSeal5
  end
...
function PetListNew_IgnoreAllSealButton(isShow)
  ...
  self.BTN_GroupSeal4:SetIgnore(isShow)
  self.BTN_GroupSeal4:SetMonoTone(isShow)
  self.BTN_GroupSeal5:SetIgnore(isShow)
  self.BTN_GroupSeal5:SetMonoTone(isShow)
...
function PetListControlCreate(control, key)
  ...
  local groupIndexBtn4 = UI.getChildControl(control, "Template_Button_GroupIndex4")
  local groupIndexBtn5 = UI.getChildControl(control, "Template_Button_GroupIndex5")
  ...
  groupIndexBtn4:SetShow(isShow)
  groupIndexBtn5:SetShow(isShow)
  ...
  if isUnsealPet(key) then
    for index = 0, unsealPetCount - 1 do
      ...
      if nil ~= pcPetData and key == pcPetData:getPcPetNo() then
        ...
        groupIndexBtn4:SetShow(false)
        groupIndexBtn5:SetShow(false)
    ...
    for index = 0, sealPetCount - 1 do
      ...
      if nil ~= pcPetData and key == pcPetData._petNo then
        ...
        groupIndexBtn4:SetShow(true)
        groupIndexBtn5:SetShow(true)
        ...
        groupIndexBtn4:addInputEvent("Mouse_LUp", "petListNew_AllSealCheck(" .. Int64toInt32(petNo_s64) .. ", 4 )")
        groupIndexBtn5:addInputEvent("Mouse_LUp", "petListNew_AllSealCheck(" .. Int64toInt32(petNo_s64) .. ", 5 )")
        ...
        groupIndexBtn4:SetCheck(PetList:IsCheckGroupBtnByPetNo(petNo_s64, 4))
        groupIndexBtn5:SetCheck(PetList:IsCheckGroupBtnByPetNo(petNo_s64, 5))
        ...
        groupIndexBtn4:addInputEvent("Mouse_On", "PetListNew_SimpleTooltipBTN(true, " .. index .. ", " .. 10 .. ")")
        groupIndexBtn4:addInputEvent("Mouse_Out", "PetListNew_SimpleTooltipBTN(false)")
        groupIndexBtn5:addInputEvent("Mouse_On", "PetListNew_SimpleTooltipBTN(true, " .. index .. ", " .. 11 .. ")")
        groupIndexBtn5:addInputEvent("Mouse_Out", "PetListNew_SimpleTooltipBTN(false)")
  ...
  property:SetTextMode(__eTextMode_LimitText)
...
function PetListNew_SimpleTooltipBTN(isShow, index, tipType)
  ...
  elseif 10 == tipType then
    ...
    desc = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PETLIST_TOOLTIP_BTN_GROUP4_DESC", "count", maxUnsealCount)
  ...
  elseif 11 == tipType then
    ...
    desc = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_PETLIST_TOOLTIP_BTN_GROUP5_DESC", "count", maxUnsealCount)
...
function PetList:initializeFilterUi()
  ...
  PetList.BTN_GroupSeal4:SetPosY(PetList.BTN_GroupSeal4:GetPosY() + addPosY)
  PetList.BTN_GroupSeal5:SetPosY(PetList.BTN_GroupSeal5:GetPosY() + addPosY)
...
function PetList:registEventHandler()
  ...
  self.BTN_GroupSeal4:addInputEvent("Mouse_LUp", "FGlobal_HandleClicked_petControl_AllSeal(4)")
  self.BTN_GroupSeal5:addInputEvent("Mouse_LUp", "FGlobal_HandleClicked_petControl_AllSeal(5)")
  ...
  self.BTN_GroupSeal4:setButtonShortcuts("PANEL_SIMPLESHORTCUT_PET_GROUP4")
  self.BTN_GroupSeal5:setButtonShortcuts("PANEL_SIMPLESHORTCUT_PET_GROUP5")
