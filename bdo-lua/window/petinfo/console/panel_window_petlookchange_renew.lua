...
function PetLookChange:init()
  ...
  self._ui.stc_KeyGuide = UI.getChildControl(_panel, "Static_Bottom")
  local txt_Key_Y = UI.getChildControl(self._ui.stc_KeyGuide, "StaticText_ButtonY")
  local txt_Key_B = UI.getChildControl(self._ui.stc_KeyGuide, "StaticText_ButtonB")
  local keyGuide = {txt_Key_Y, txt_Key_B}
  PaGlobalFunc_ConsoleKeyGuide_SetAlign(keyGuide, self._ui.stc_KeyGuide, CONSOLEKEYGUID_ALIGN_TYPE.eALIGN_TYPE_RIGHT)
  self._ui._list2Pet:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_PetLookList_ListControlCreate")
  self._ui._list2Pet:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui.txt_alert:SetTextMode(__eTextMode_AutoWrap)
