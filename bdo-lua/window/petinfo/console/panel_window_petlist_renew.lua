...
function petList:initControl()
  ...
  petListUI._static_CommandAll = UI.getChildControl(petListUI._static_BottomBG, "StaticText_CommandAll_ConsoleUI")
  ...
  petListUI._static_CommandAll:SetText("          " .. petListUI._static_CommandAll:GetText())
  self._keyGuideAlign = {
    petListUI._static_CommandAll,
    petListUI._staticText_FeedAll,
    petListUI._staticText_CheckInAll,
    petListUI._static_Confirm,
    petListUI._static_Exit
  }
  PaGlobalFunc_ConsoleKeyGuide_SetAlign(self._keyGuideAlign, petListUI._static_BottomBG, CONSOLEKEYGUID_ALIGN_TYPE.eALIGN_TYPE_AUTO_WRAP_LEFT)
  petListUI._static_SkillEffectDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  Panel_Window_PetList_Renew:registerPadEvent(__eConsoleUIPadEvent_LTPress_A, "FGlobal_PetList_CommandAll()")
end
...
function petList:selectCommand()
  ...
  FGlobal_PetCommand_Init(self.selectPetIndex, false)
end
...
function petListCreate(control, key)
  ...
  _staticText_PetSkill:SetTextMode(__eTextMode_LimitText)
  ...
  _staticText_PetLevName:SetTextMode(__eTextMode_LimitText)
  ...
  if true == isUnseal then
    ...
    self.petCommandCondition[tostring(key)][PaGlobal_petCommandType._lootingType] = petLootingType
    ...
    if CppEnums.PetLootingType.Celerity == petLootingType then
      x1, y1, x2, y2 = setTextureUV_Func(_button_Speed, 1, 59, 29, 87)
    elseif CppEnums.PetLootingType.Precision == petLootingType then
...
function FGlobal_PetList_CommandAll()
  petList:commandAll()
end
function petList:commandAll()
  _AudioPostEvent_SystemUiForXBOX(1, 40)
  local unsealPetCount = ToClient_getPetUnsealedList()
  ...
  petList:tmporaryClose()
  FGlobal_PetCommand_Init(0, true)
end
...
function petList:registEventHandler()
  ...
  registerEvent("FromClient_UpdateControlIconInfo", "FromClient_PetCommandStateInit")
  self._ui._list2_PetList:registEvent(__ePAUIList2EventType_LuaChangeContent, "petListCreate")
  self._ui._list2_PetList:createChildContent(__ePAUIList2ElementManagerType_List)
end
function FGlobal_PetListNew_NoPet()
end
function FromClient_PetCommandStateInit(petNo64, followAndWait, isFind, isGetItem)
  local self = petList
  self.petCommandCondition[tostring(petNo64)] = {}
  self.petCommandCondition[tostring(petNo64)] = {
    [PaGlobal_petCommandType._follow] = followAndWait,
    [PaGlobal_petCommandType._getItem] = isGetItem,
    [PaGlobal_petCommandType._lootingType] = CppEnums.PetLootingType.Normal,
    [PaGlobal_petCommandType._find] = isFind
  }
end
