...
function PetMarketRegist:Init()
  for index = 0, self._maxSlotCount - 1 do
    local temp = {}
    local actionSlotBg = UI.createControl(__ePAUIControl_Static, Panel_Window_PetMarketRegist, "Static_ActionSlotBg_" .. index)
    ...
    temp.actionSlot = UI.createControl(__ePAUIControl_Static, actionSlotBg, "Static_ActionSlot_" .. index)
    CopyBaseProperty(self.actionSlot, temp.actionSlot)
    local skillSlotBg = UI.createControl(__ePAUIControl_Static, Panel_Window_PetMarketRegist, "Static_SkillSlotBg_" .. index)
    ...
    temp.skillSlot = UI.createControl(__ePAUIControl_Static, skillSlotBg, "Static_SkillSlot_" .. index)
