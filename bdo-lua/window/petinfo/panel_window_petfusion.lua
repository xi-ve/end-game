...
function PetFusion:createControl()
  ...
  self._ui._staticText_SelectDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  for ii = 0, self._config._subPetMaxTableCount - 1 do
    local bg = UI.createControl(__ePAUIControl_Static, self._ui._static_fusionBg, "Static_PetIconBg_" .. ii)
  ...
  self._ui._static_FusionDesc:SetTextMode(__eTextMode_AutoWrap)
...
function PetFusion:initEvent()
  ...
  self._ui._list2_Skill:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_PetFusion_CreateSkillList")
  self._ui._list2_Skill:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui._list2_Look:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_PetFusion_CreateLookList")
