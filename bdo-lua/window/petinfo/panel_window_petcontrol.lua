...
function PetControl:Init()
  for index = 0, maxPetControlCount - 1 do
    local temp = {}
    local _petInfo = UI.createControl(__ePAUIControl_Button, Panel_Window_PetControl, "Button_PetInfo_" .. index)
    ...
    local _follow = UI.createControl(__ePAUIControl_RadioButton, Panel_Window_PetControl, "Button_Follow_" .. index)
    ...
    local _wait = UI.createControl(__ePAUIControl_RadioButton, Panel_Window_PetControl, "Button_Wait_" .. index)
    ...
    temp._wait = _wait
    local _find = UI.createControl(__ePAUIControl_CheckButton, Panel_Window_PetControl, "Button_Find_" .. index)
    ...
    temp._find = _find
    local _getItem = UI.createControl(__ePAUIControl_CheckButton, Panel_Window_PetControl, "Button_GetItem_" .. index)
    ...
    local _getPlay = UI.createControl(__ePAUIControl_CheckButton, Panel_Window_PetControl, "Button_Play_" .. index)
    ...
    local _seal = UI.createControl(__ePAUIControl_CheckButton, Panel_Window_PetControl, "Button_Seal_" .. index)
    ...
    temp._seal = _seal
    local _redDotIcon = UI.createControl(__ePAUIControl_Static, Panel_Window_PetControl, "Static_RedDotIcon_" .. index)
    CopyBaseProperty(self.Dot_RedIcon, _redDotIcon)
    temp._redDotIcon = _redDotIcon
    local _greenDotIcon = UI.createControl(__ePAUIControl_Static, Panel_Window_PetControl, "Static_GreenDotIcon_" .. index)
    CopyBaseProperty(self.Dot_GreenIcon, _greenDotIcon)
    temp._greenDotIcon = _greenDotIcon
    local _yellowDotIcon = UI.createControl(__ePAUIControl_Static, Panel_Window_PetControl, "Static_YellowDotIcon_" .. index)
    CopyBaseProperty(self.Dot_YellowIcon, _yellowDotIcon)
    temp._yellowDotIcon = _yellowDotIcon
    local _purpleDotIcon = UI.createControl(__ePAUIControl_Static, Panel_Window_PetControl, "Static_PurpleDotIcon_" .. index)
    CopyBaseProperty(self.Dot_PurpleIcon, _purpleDotIcon)
    temp._purpleDotIcon = _purpleDotIcon
    local _grayDotIcon1 = UI.createControl(__ePAUIControl_Static, Panel_Window_PetControl, "Static_GrayDotIcon1_" .. index)
    CopyBaseProperty(self.Dot_GrayIcon1, _grayDotIcon1)
    temp._grayDotIcon1 = _grayDotIcon1
    local _grayDotIcon2 = UI.createControl(__ePAUIControl_Static, Panel_Window_PetControl, "Static_GrayDotIcon2_" .. index)
    CopyBaseProperty(self.Dot_GrayIcon2, _grayDotIcon2)
    temp._grayDotIcon2 = _grayDotIcon2
    local _iconPet = UI.createControl(__ePAUIControl_Button, Panel_Window_PetControl, "Button_IconPet_" .. index)
    ...
    local _iconPetBg = UI.createControl(__ePAUIControl_Static, Panel_Window_PetControl, "Static_IconPetBG_" .. index)
    CopyBaseProperty(self.Stc_IconPetBg, _iconPetBg)
    temp._iconPetBg = _iconPetBg
    local _hungryBg = UI.createControl(__ePAUIControl_Static, Panel_Window_PetControl, "Static_HungryBG_" .. index)
    CopyBaseProperty(self.Stc_HungryBG, _hungryBg)
    temp._hungryBg = _hungryBg
    local _progress = UI.createControl(__ePAUIControl_Progress2, Panel_Window_PetControl, "Progress2_Hungry_" .. index)
...
function FGlobal_PetControl_RestoreUI()
  ...
  local isUnSealPetIndex = (Panel_Window_PetControl:GetShow() or Panel_Window_PetIcon:GetShow()) and unsealedCount - 1
end
