...
function FriendMessangerManager:createMessanger(messangerId, userName, isOnline)
  ...
  function messanger:prepareControl(messangerId, userName, isOnline)
    self._uiClose = messanger:createControl(__ePAUIControl_Button, Panel_Friend_Messanger, self._mainPanel, "Button_Close", 0)
    self._uiClose:addInputEvent("Mouse_LUp", "FriendMessanger_Close(" .. messangerId .. ")")
    self._uiFrame = messanger:createControl(__ePAUIControl_Frame, Panel_Friend_Messanger, self._mainPanel, "Frame_1", 0)
    ...
    self._uiEnter = messanger:createControl(__ePAUIControl_Button, Panel_Friend_Messanger, self._mainPanel, "Button_Enter", 0)
    self._uiEnter:addInputEvent("Mouse_LUp", "friend_sendMessage(" .. messangerId .. ")")
    self._uiEditInputChat = messanger:createControl(__ePAUIControl_Edit, Panel_Friend_Messanger, self._mainPanel, "Edit_InputChat", 0)
    ...
    self._uiStaticTitle = messanger:createControl(__ePAUIControl_StaticText, Panel_Friend_Messanger, self._mainPanel, "StaticText_TitleName", 0)
    self._uiStaticTitle:SetText(userName)
    self._uiStaticTitleImg = messanger:createControl(__ePAUIControl_Static, Panel_Friend_Messanger, self._mainPanel, "Static_TitleImage", 0)
    self._uiSizeControl = messanger:createControl(__ePAUIControl_Button, Panel_Friend_Messanger, self._mainPanel, "Button_SizeControl", 0)
    ...
    self._uiCall = messanger:createControl(__ePAUIControl_Button, Panel_Friend_Messanger, self._mainPanel, "Button_Call", 0)
    self._uiSlider = UI.createControl(__ePAUIControl_Slider, self._mainPanel, "Slider_Alpha")
  ...
  function messanger:createMessageUI(isMe)
    ...
    self._uiStaticBg[self._messageCount] = UI.createControl(__ePAUIControl_Static, self._uiFrameContent, "Static_BG_" .. self._messageCount)
    self._uiStaticText[self._messageCount] = UI.createControl(__ePAUIControl_StaticText, self._uiFrameContent, "Static_Text_" .. self._messageCount)
...
function FriendList:initialize()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"PanelFriends\"")
...
function PopupGroupMenu:initialize()
  self._uiBackGround = UI.createControl(__ePAUIControl_Static, Panel_FriendList, "FriendPopupGroupMenu")
  CopyBaseProperty(stylePopupBackGround, self._uiBackGround)
  self._uiRenameGroup = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupRenameGroup")
  CopyBaseProperty(styleMenuButton, self._uiRenameGroup)
  self._uiAddGroup = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupAddGroup")
...
function PopupFriendMenu:initialize()
  self._uiBackGround = UI.createControl(__ePAUIControl_Static, Panel_FriendList, "FriendPopupFriendMenu")
  self._uiPartyInvite = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupPartyInvite")
  CopyBaseProperty(styleMenuButton, self._uiPartyInvite)
  self._uiMessanger = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupWhisper")
  CopyBaseProperty(styleMenuButton, self._uiMessanger)
  self._uiMoveGroup = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupMoveGroup")
  CopyBaseProperty(styleMenuButton, self._uiMoveGroup)
  self._uiDelete = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupDeleteFriend")
  CopyBaseProperty(styleMenuButton, self._uiDelete)
  self._uiXboxProfile = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupXboxProfile")
  CopyBaseProperty(styleMenuButton, self._uiXboxProfile)
  self._uiRecallFriend = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupXboxRecallFriend")
...
function PopupPartyFriendMenu:initialize()
  self._uiBackGround = UI.createControl(__ePAUIControl_Static, Panel_FriendList, "FriendPopupPartyFriendMenu")
  self._uiAddFriend = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupRequestAddFriend")
  self._uiDeletePartyFriend = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupRequestDeletePartyFriend")
...
function PopupGroupList:initialize()
  self._uiBackGround = UI.createControl(__ePAUIControl_Static, Panel_FriendList, "FriendPopupGroupList")
  for groupIndex = 0, self._maxGroupCount - 1 do
    self._uiMoveGroups[groupIndex] = UI.createControl(__ePAUIControl_Button, self._uiBackGround, "FriendPopupMoveGroups_" .. groupIndex)
