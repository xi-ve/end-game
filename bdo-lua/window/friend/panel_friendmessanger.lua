...
function PaGlobal_FriendMessanger:CreateMessanger(messangerId, userName, isOnline)
  ...
  function messanger:PrepareControl(messangerId, userName, isOnline)
    self._ui._btnClose = messanger:CreateControl(__ePAUIControl_Button, Panel_Friend_Messanger, self._ui._mainPanel, "Button_Close", 0)
    self._ui._frame = messanger:CreateControl(__ePAUIControl_Frame, Panel_Friend_Messanger, self._ui._mainPanel, "Frame_1", 0)
    self._ui._enterBtn = messanger:CreateControl(__ePAUIControl_Button, Panel_Friend_Messanger, self._ui._mainPanel, "Button_Enter", 0)
    self._ui._staticTitle = messanger:CreateControl(__ePAUIControl_StaticText, Panel_Friend_Messanger, self._ui._mainPanel, "StaticText_TitleName", 0)
    self._ui._staticTitleImg = messanger:CreateControl(__ePAUIControl_Static, Panel_Friend_Messanger, self._ui._mainPanel, "Static_TitleImage", 0)
    self._ui._sizeControl = messanger:CreateControl(__ePAUIControl_Button, Panel_Friend_Messanger, self._ui._mainPanel, "Button_SizeControl", 0)
    self._ui._editInputChat = messanger:CreateControl(__ePAUIControl_Edit, Panel_Friend_Messanger, self._ui._mainPanel, "Edit_InputChat", 0)
    ...
    self._ui._slider = UI.createControl(__ePAUIControl_Slider, self._ui._mainPanel, "Slider_Alpha")
  ...
  function messanger:CreateMessageUI(isMe)
    ...
    self._ui._staticBg[self._messageCount] = UI.createControl(__ePAUIControl_Static, self._ui._frameContent, "Static_BG_" .. self._messageCount)
    self._ui._staticText[self._messageCount] = UI.createControl(__ePAUIControl_StaticText, self._ui._frameContent, "Static_Text_" .. self._messageCount)
