...
function PaGlobal_FriendList:Initialize()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._ui._btnQuestion, "\"PanelFriends\"")
...
function PopupGroupMenu:Initialize()
  ...
  self._ui._backGround = UI.createControl(__ePAUIControl_Static, Panel_FriendList, "FriendPopupGroupMenu")
  self._ui._renameGroup = UI.createControl(__ePAUIControl_Button, self._ui._backGround, "FriendPopupRenameGroup")
  self._ui._addGroup = UI.createControl(__ePAUIControl_Button, self._ui._backGround, "FriendPopupAddGroup")
...
function PopupFriendMenu:Initialize()
  self._ui._backGround = UI.createControl(__ePAUIControl_Static, Panel_FriendList, "FriendPopupFriendMenu")
  self._ui._partyInvite = UI.createControl(__ePAUIControl_Button, self._ui._backGround, "FriendPopupPartyInvite")
  self._ui._messanger = UI.createControl(__ePAUIControl_Button, self._ui._backGround, "FriendPopupWhisper")
  self._ui._moveGroup = UI.createControl(__ePAUIControl_Button, self._ui._backGround, "FriendPopupMoveGroup")
  self._ui._delete = UI.createControl(__ePAUIControl_Button, self._ui._backGround, "FriendPopupDeleteFriend")
...
function PopupGroupList:Initialize()
  self._ui._backGround = UI.createControl(__ePAUIControl_Static, Panel_FriendList, "FriendPopupGroupList")
  for groupIndex = 0, PaGlobal_FriendList._groupData._maxCount - 1 do
    self._ui._moveGroups[groupIndex] = UI.createControl(__ePAUIControl_Button, self._ui._backGround, "FriendPopupMoveGroups_" .. groupIndex)
