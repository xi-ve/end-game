...
function FromClient_DailyChallenge_Update()
  ...
  if _ContentsGroup_NewUI_DailyStamp_All then
    ...
    if false == _ContentsGroup_RenewUI and nil ~= PaGlobalFunc_IsDailyChallengeShow and false == PaGlobalFunc_IsDailyChallengeShow() then
      return
    end
  end
  if true == _ContentsGroup_RenewUI and false == PaGlobalFunc_DailyStamp_IsDailyChallengeShow() then
    return
  end
  dailyChallenge:open()
end
