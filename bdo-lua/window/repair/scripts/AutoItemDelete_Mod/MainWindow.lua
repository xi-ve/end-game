...
function MainWindow.DrawMainWindow()
  ...
  ImGui.SameLine()
  _, AutoItemDelete.CurrentProfile.CleanupTimeInterval = ImGui.InputInt("Cleanup Inteval##CleanupInterval_IntInput", AutoItemDelete.CurrentProfile.CleanupTimeInterval, 1000, 60000)
