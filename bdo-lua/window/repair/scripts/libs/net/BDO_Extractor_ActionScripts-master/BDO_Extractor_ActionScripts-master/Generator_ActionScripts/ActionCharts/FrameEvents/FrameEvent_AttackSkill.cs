...
{
    public class FrameEvent_AttackSkill : FrameEvent_Attack
    {
        public byte[] m_Data0 { get; set; }
        public byte m_Unk0 { get; set; }

        public FrameEvent_AttackSkill(BinaryReader br, eActionChart_FrameEvent frameEventType) : base(br, frameEventType)
        {
