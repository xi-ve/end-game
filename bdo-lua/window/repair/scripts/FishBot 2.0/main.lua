...
Infinity.Scripting.CurrentScript:RegisterCallback("Infinity.OnAutoLoginAutoLoad", function()
    FishBot.OnAutoLoginAutoLoad()
  end)

Infinity.Scripting.CurrentScript:RegisterGlobalHook("Inventory_AddItem", FishBot.OnInventoryAddItem)
Infinity.Scripting.CurrentScript:RegisterCallback("Infinity.OnPacketReceive", FishBot.OnPacketReceive)