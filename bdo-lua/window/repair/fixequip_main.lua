...
function PaGlobal_FixEquip:initialize()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._uiButtonQuestion, "\"PanelFixEquip\"")
...
function PaGlobal_FixEquip:fixEquip_FixHelp()
  self._uiFixHelp:SetTextMode(__eTextMode_AutoWrap)
  ...
  if self._slotMainTbl.empty then
    if index == 0 then
      if isMouseOn == true then
        ...
        self._slot_1_Notice:SetTextMode(__eTextMode_AutoWrap)
  ...
  if self._slotSubTbl.empty then
    if index == 1 then
      if isMouseOn == true then
        ...
        self._slot_0_Notice:SetTextMode(__eTextMode_AutoWrap)
