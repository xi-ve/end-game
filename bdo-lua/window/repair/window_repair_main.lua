...
function PaGlobal_Repair:initialize()
  ...
  if false == _ContentsGroup_NewUI_BlackSmith_All then
    ...
    self._uiFixEquipItemButton:addInputEvent("Mouse_LUp", "PaGlobal_Endurance_Recovery_All_Open()")
  end
  ...
  self._uiRepairStableEquippedItemButton:SetTextMode(__eTextMode_LimitText)
  self._uiRepairWharfEquippedItemButton:SetTextMode(__eTextMode_LimitText)
  self._uiRepairElephantButton:SetTextMode(__eTextMode_LimitText)
  self._uiRepairAllEquippedItemButton:SetTextMode(__eTextMode_LimitText)
  self._uiRepairAllInvenItemButton:SetTextMode(__eTextMode_LimitText)
  self._uiFixEquipItemButton:SetTextMode(__eTextMode_LimitText)
...
function PaGlobal_Repair:repair_OpenPanel(isShow, eType)
  if true == isShow then
    self._eRepairType = eType
    if _ContentsGroup_NewUI_Camp_All then
      PaGlobalFunc_Camp_All_SetIsCamping(self._eType._camp == self._eRepairType)
      self._isCamping = PaGlobalFunc_Camp_All_GetIsCamping()
    else
      PaGlobal_Camp:setIsCamping(self._eType._camp == self._eRepairType)
  ...
  if not _ContentsGroup_RenewUI then
    if true == _ContentsGroup_NewUI_Equipment_All then
      Panel_Window_Equipment_All:SetShow(isShow, true)
    else
  ...
  local equipPanelShow = false
  if true == _ContentsGroup_NewUI_Equipment_All then
    equipPanelShow = Panel_Window_Equipment_All:IsShow()
  else
    equipPanelShow = Panel_Equipment:IsShow()
  end
  if false == equipPanelShow then
