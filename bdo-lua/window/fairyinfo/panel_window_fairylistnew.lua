  ...
  if isUnsealPet(key) then
    for index = 0, unsealPetCount - 1 do
      ...
      if nil ~= pcPetData and key == pcPetData:getPcPetNo() then
        ...
        name:SetTextMode(__eTextMode_None)
...
function FairyListNew:RegistEvent()
  self._list2_FairyListNew:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_FairyListNew_Update")
  self._list2_FairyListNew:createChildContent(__ePAUIList2ElementManagerType_List)
