...
function fairySkill:initControl()
  ...
  self._ui._list2_SkillList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_fairySkill_ListCreate")
...
function fairySkill:listCreate(control, key)
  ...
  UI.setLimitTextAndAddTooltip(_staticText_SkillDesc1, skillTypeSSW:getName(), skillTypeSSW:getDescription())
