...
function PaGlobal_HouseInstallation:initialize()
  ...
  local function do_MakeSlot()
    for slot_Idx = 0, self._maxSlotCount - 1 do
      ...
      local created_normalSlot = UI.createControl(__ePAUIControl_Static, self._ui._itemListBg, "Panel_House_Installation_normalSlot_" .. slot_Idx)
      ...
      local created_cashSlot = UI.createControl(__ePAUIControl_Static, self._ui._itemListBg, "Panel_House_Installation_cashSlot_" .. slot_Idx)
      ...
      local created_InstalledMark = UI.createControl(__ePAUIControl_StaticText, self._ui._itemListBg, "Panel_House_Installation_InstalledMark_" .. slot_Idx)
