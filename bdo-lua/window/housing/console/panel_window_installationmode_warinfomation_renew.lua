...
function WarInfomation:init()
  ...
  for index = 0, innerObjectCount - 1 do
    ...
    temp[index]._name = UI.createControl(__ePAUIControl_StaticText, statusTemplate, "StaticText_Installation_Name_" .. index)
    CopyBaseProperty(self._ui.txt_installationName, temp[index]._name)
    temp[index]._name:SetShow(true)
    temp[index]._count = UI.createControl(__ePAUIControl_StaticText, statusTemplate, "StaticText_Installation_NowCount_" .. index)
    CopyBaseProperty(self._ui.txt_installedCount, temp[index]._count)
    temp[index]._count:SetShow(true)
    temp[index]._size = UI.createControl(__ePAUIControl_StaticText, statusTemplate, "StaticText_Installation_Required" .. index)
    CopyBaseProperty(self._ui.txt_requireCount, temp[index]._size)
    temp[index]._size:SetShow(true)
    temp[index]._maxCount = UI.createControl(__ePAUIControl_StaticText, statusTemplate, "StaticText_Installation_LimitCount" .. index)
