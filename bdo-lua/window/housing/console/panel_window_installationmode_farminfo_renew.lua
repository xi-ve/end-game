...
function Panel_Window_InstallationMode_Farm_info:childControl()
  ...
  self._ui.staticText_WaterwayDec:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.staticText_ScarecrowDec:SetTextMode(__eTextMode_AutoWrap)
...
function Panel_Window_InstallationMode_Farm_info:createGuideAndSetData()
  ...
  for index = 0, self._config.guidTitleCount - 1 do
    ...
    self._plantTitle[index]:SetTextMode(__eTextMode_AutoWrap)
    self._animalTitle[index]:SetAutoResize(true)
    self._animalTitle[index]:SetTextMode(__eTextMode_AutoWrap)
    ...
    for index2 = 0, self._config.guideCount[index] - 1 do
      ...
      self._plantSubTitle[calculateIndex + index2]:SetTextMode(__eTextMode_AutoWrap)
      self._animalSubTitle[calculateIndex + index2]:SetAutoResize(true)
      self._animalSubTitle[calculateIndex + index2]:SetTextMode(__eTextMode_AutoWrap)
      ...
      self._plantDesc[calculateIndex + index2]:SetTextMode(__eTextMode_AutoWrap)
      self._animalDesc[calculateIndex + index2]:SetAutoResize(true)
      self._animalDesc[calculateIndex + index2]:SetTextMode(__eTextMode_AutoWrap)
