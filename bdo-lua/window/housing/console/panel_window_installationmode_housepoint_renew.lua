...
function Panel_Window_InstallationMode_HousePoint_info:setPoints()
  self._ui.staticText_HousingPoints:SetText(toClient_GetVisitingTotalInteriorPoint())
  self._ui.staticText_BasePoints:SetText(toClient_GetVisitingBaseInteriorPoint())
  self._ui.staticText_SetPoints:SetText(toClient_GetVisitingSetOptionInteriorPoint())
  self._ui.staticText_AddPoints:SetText(toClient_GetVisitingBonusInteriorPoint())
end
