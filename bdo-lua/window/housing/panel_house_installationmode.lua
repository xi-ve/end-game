...
function HouseInstallation:Initialize()
  ...
  local function do_MakeSlot()
    for slot_Idx = 0, self.maxSlotCount - 1 do
      ...
      local created_normalSlot = UI.createControl(__ePAUIControl_Static, self.bg_List, "Panel_House_Installation_normalSlot_" .. slot_Idx)
      ...
      local created_cashSlot = UI.createControl(__ePAUIControl_Static, self.bg_List, "Panel_House_Installation_cashSlot_" .. slot_Idx)
      ...
      local created_InstalledMark = UI.createControl(__ePAUIControl_StaticText, self.bg_List, "Panel_House_Installation_InstalledMark_" .. slot_Idx)
