...
function Window_GameExitInfo:SetCharacterSlot(charInfo, charSlot)
  ...
  charSlot._staticText_Name:SetTextMode(__eTextMode_Limit_AutoWrap)
  charSlot._staticText_Name:SetText(charInfo._name)
  charSlot._staticText_Location:SetTextMode(__eTextMode_Limit_AutoWrap)
  ...
  if true == isCaptureExist then
    ...
    if false == _ContentsGroup_isUsedNewCharacterInfo then
      if charInfo._classType == __eClassType_Warrior then
        ...
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_ElfRanger then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_00.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 157, 1, 312, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_Sorcerer then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_00.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 313, 1, 468, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_Giant then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_00.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 1, 202, 156, 402)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_Tamer then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_00.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 157, 202, 312, 402)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_BladeMaster then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_00.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 313, 202, 468, 402)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_Valkyrie then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_01.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 1, 1, 156, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_BladeMasterWoman then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_01.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 157, 1, 312, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_WizardMan then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_01.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 313, 1, 468, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_WizardWoman then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_01.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 1, 202, 156, 402)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_Kunoichi then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_01.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 157, 202, 312, 402)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_NinjaMan then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_01.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 313, 202, 468, 402)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_DarkElf then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_02.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 1, 1, 156, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_Combattant then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_02.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 157, 1, 312, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_Mystic then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_02.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 313, 1, 468, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_Lhan then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_03.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 1, 1, 156, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
      elseif charInfo._classType == __eClassType_RangerMan then
        charSlot._static_Picture:ChangeTextureInfoName("New_UI_Common_forLua/Window/GameExit/GameExit_CharSlot_03.dds")
        local x1, y1, x2, y2 = setTextureUV_Func(charSlot._static_Picture, 1, 1, 156, 201)
        charSlot._static_Picture:getBaseTexture():setUV(x1, y1, x2, y2)
        charSlot._static_Picture:setRenderTexture(charSlot._static_Picture:getBaseTexture())
...
function PaGlobalFunc_GameExit_ButtonClick_Exit(exitType)
  ...
  if false == _ContentsGroup_NewUI_MessageBox_All then
    ...
    local exitFunction = ""
    if 0 == exitType then
      titleText = PAGetString(Defines.StringSheet_GAME, "GAME_EXIT_MESSAGEBOX_TITLE")
      messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEEXIT_DISCONNECT")
      exitFunction = PaGlobalFunc_GameExit_ExitButton
    elseif 1 == exitType then
      titleText = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEEXITCONFIRM_TITLE")
      messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "PANEL_GAMEEXIT_TRAY_ASK2")
      exitFunction = PaGlobalFunc_GameExit_TrayButton
    elseif 2 == exitType then
      titleText = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEEXIT_CHARACTERSELECT_NAME_TEXT")
      messageBoxMemo = PAGetString(Defines.StringSheet_GAME, "LUA_GAMEEXIT_BACK_TO_CHARACTERSELECT_Q")
      exitFunction = PaGlobalFunc_GameExit_CharacterSelectButton
    end
    if exitType <= 2 then
      local messageBoxData = {
        title = titleText,
        content = messageBoxMemo,
        functionYes = exitFunction,
...
function PaGlobalFunc_GameExit_ExitButton()
  _AudioPostEvent_SystemUiForXBOX(50, 1)
  PaGlobalFunc_GameExit_ExitHandler(0)
end
function PaGlobalFunc_GameExit_TrayButton()
  _AudioPostEvent_SystemUiForXBOX(50, 1)
end
function PaGlobalFunc_GameExit_CharacterSelectButton()
...
function Window_GameExitInfo:InitControl()
  ...
  body._button_GameExit:SetTextMode(__eTextMode_AutoWrap)
  body._button_ServerChange:SetTextMode(__eTextMode_AutoWrap)
  body._button_SelectCharacter:SetTextMode(__eTextMode_AutoWrap)
  body._button_CharacterMove:SetTextMode(__eTextMode_AutoWrap)
  body._button_ChangeAccount:SetTextMode(__eTextMode_AutoWrap)
  ...
  bottom._staticText_QuestListTemplate:SetTextMode(__eTextMode_LimitText)
  ...
  bottom._staticText_JournalListTemplate:SetTextMode(__eTextMode_LimitText)
  bottom._staticText_JournalListTemplate:SetShow(false)
  for index = 0, self._config._maxJournalList - 1 do
    local control = UI.createControl(__ePAUIControl_StaticText, self._ui._static_Bottom, "staticText_Journal_" .. index)
  ...
  for index = 0, self._config._maxQuestList - 1 do
    local control = UI.createControl(__ePAUIControl_StaticText, self._ui._static_Bottom, "staticText_Quest_" .. index)
  ...
  for index = 0, self._config._maxCharacterSlot - 1 do
    ...
    uiTable._radioButton_CharBg = UI.createControl(__ePAUIControl_RadioButton, self._ui._static_MainBg, "radioButton_CharBg_" .. index)
    CopyBaseProperty(baseCharUI._radioButton_CharBg, uiTable._radioButton_CharBg)
    uiTable._static_Picture = UI.createControl(__ePAUIControl_Static, uiTable._radioButton_CharBg, "static_Picture_" .. index)
    CopyBaseProperty(baseCharUI._static_Picture, uiTable._static_Picture)
    uiTable._staticText_Level = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_CharBg, "staticText_Level_" .. index)
    CopyBaseProperty(baseCharUI._staticText_Level, uiTable._staticText_Level)
    uiTable._staticText_Name = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_CharBg, "staticText_Name_" .. index)
    CopyBaseProperty(baseCharUI._staticText_Name, uiTable._staticText_Name)
    uiTable._staticText_Location = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_CharBg, "staticText_Location_" .. index)
    CopyBaseProperty(baseCharUI._staticText_Location, uiTable._staticText_Location)
    uiTable._staticText_EnchantFailCount = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_CharBg, "staticText_EnchantFailCount_" .. index)
    CopyBaseProperty(baseCharUI._staticText_EnchantFailCount, uiTable._staticText_EnchantFailCount)
    uiTable._staticText_Energy = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_CharBg, "staticText_Energy_" .. index)
    CopyBaseProperty(baseCharUI._staticText_Energy, uiTable._staticText_Energy)
    uiTable._button_ChangePicture = UI.createControl(__ePAUIControl_Button, uiTable._radioButton_CharBg, "button_ChangePicture_" .. index)
    CopyBaseProperty(baseCharUI._button_ChangePicture, uiTable._button_ChangePicture)
    uiTable._staticText_Condtion = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_CharBg, "staticText_Condtion_" .. index)
    CopyBaseProperty(baseCharUI._staticText_Condtion, uiTable._staticText_Condtion)
    uiTable._staticText_RemindTime = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_CharBg, "staticText_RemindTime_" .. index)
