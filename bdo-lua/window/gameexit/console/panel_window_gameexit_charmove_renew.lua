...
function Window_GameExit_CharMoveInfo:InitControl()
  ...
  bottom._staticText_Desc:SetTextMode(__eTextMode_AutoWrap)
  ...
  for index = 0, self._config._maxCharacterSlot - 1 do
    ...
    uiTable._radioButton_Slot = UI.createControl(__ePAUIControl_RadioButton, self._ui._static_Bottom, "radioButton_Slot_" .. index)
    CopyBaseProperty(baseSlot._radioButton_Slot, uiTable._radioButton_Slot)
    uiTable._static_Picture = UI.createControl(__ePAUIControl_Static, uiTable._radioButton_Slot, "static_Picture_" .. index)
    CopyBaseProperty(baseSlot._static_Picture, uiTable._static_Picture)
    uiTable._staticText_Level = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_Slot, "staticText_Level_" .. index)
    CopyBaseProperty(baseSlot._staticText_Level, uiTable._staticText_Level)
    uiTable._staticText_Name = UI.createControl(__ePAUIControl_StaticText, uiTable._radioButton_Slot, "staticText_Name_" .. index)
