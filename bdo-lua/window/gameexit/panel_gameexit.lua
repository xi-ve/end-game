...
_exitConfirm_TrayString:SetTextMode(__eTextMode_AutoWrap)
...
local _exitConfirm_Chk_Tray_2 = UI.createControl(__ePAUIControl_CheckButton, Panel_ExitConfirm, "CheckButton_Tray_2")
...
function Panel_GameExit_Initialize()
  ...
  for idx = 0, totalCharacterCount - 1 do
    ...
    local charChange = UI.createControl(__ePAUIControl_Button, charSlot, "Button_CharChange_" .. idx)
    ...
    local charSelected = UI.createControl(__ePAUIControl_Static, _charSlotBG, "Statc_CharSelected_" .. idx)
    ...
    for journal_Idx = 0, journal_Count - 1 do
      ...
      if nil ~= journalWrapper then
        ...
        if 0 == journal_Idx then
          journalContents:SetTextMode(__eTextMode_LimitText)
