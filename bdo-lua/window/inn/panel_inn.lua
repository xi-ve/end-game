...
_noticeText:SetTextMode(__eTextMode_AutoWrap)
...
function Inn.createInnSlot(index)
  local innslot = {}
  innslot._staticBack = UI.createControl(__ePAUIControl_Static, Panel_Inn, "Style_BG" .. index)
  innslot._name = UI.createControl(__ePAUIControl_StaticText, innslot._staticBack, "StaticText_Name" .. index)
  innslot._buttonRent = UI.createControl(__ePAUIControl_Button, innslot._staticBack, "Button_Rent" .. index)
  innslot._time = UI.createControl(__ePAUIControl_StaticText, innslot._staticBack, "StaticText_Time" .. index)
  innslot._price = UI.createControl(__ePAUIControl_StaticText, innslot._staticBack, "StaticText_Price" .. index)
  innslot._rentable = UI.createControl(__ePAUIControl_StaticText, innslot._staticBack, "StaticText_Rentable" .. index)
  innslot._image = UI.createControl(__ePAUIControl_Static, innslot._staticBack, "Static_Image" .. index)
  innslot._area = UI.createControl(__ePAUIControl_StaticText, innslot._staticBack, "StaticText_Area" .. index)
  innslot._basicService = UI.createControl(__ePAUIControl_StaticText, innslot._staticBack, "StaticText_BasicService" .. index)
  innslot._specialService = UI.createControl(__ePAUIControl_StaticText, innslot._staticBack, "StaticText_SpecialService" .. index)
  ...
  function innslot:SetData(innData, myInnCharacterKey)
    ...
    innslot._name:SetTextMode(__eTextMode_AutoWrap)
