...
function expeditionRewardItemInfo:createControl()
  ...
  for ii = 0, self._config._rewardItemMaxCount - 1 do
    ...
    slot.background = UI.createControl(__ePAUIControl_Static, itemBG, "RewardItemBG_" .. ii)
    ...
    slot.select = UI.createControl(__ePAUIControl_Static, slot.background, "SelectItemBG_" .. ii)
