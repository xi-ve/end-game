...
function expeditionUnitSelectInfo:registEventHandler()
  ...
  self._ui._list2_myUnitList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_ExpeditionUnitSelectInfo_CreateControlList2")
  self._ui._list2_myUnitList:createChildContent(__ePAUIList2ElementManagerType_List)
end
...
function PaGlobalFunc_ExpeditionUnitSelectInfo_CreateControlList2(content, key)
  ...
  recoveryBtn:SetTextMode(__eTextMode_AutoWrap)
  recoveryBtn:SetText(recoveryBtn:GetText())
  promoteBtn:SetTextMode(__eTextMode_AutoWrap)
  promoteBtn:SetText(promoteBtn:GetText())
  button_select:SetTextMode(__eTextMode_AutoWrap)
  button_select:SetText(button_select:GetText())
  button_sell:SetTextMode(__eTextMode_AutoWrap)
