...
function PaGlobal_Window_Politics:initialize()
  ...
  self._ui.list2_visibleCandidateList:registEvent(__ePAUIList2EventType_LuaChangeContent, "FGlobal_Window_Politics_CandidateListControlCreate")
  self._ui.list2_visibleCandidateList:createChildContent(__ePAUIList2ElementManagerType_List)
...
function FGlobal_Window_Politics_CandidateListControlCreate(control, key)
  ...
  txt_introduce:SetTextMode(__eTextMode_Limit_AutoWrap)
