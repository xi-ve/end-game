...
needJournalText:SetTextMode(__eTextMode_AutoWrap)
...
function JournalInfo_Init()
  for index = 0, _journalInfoMaxCount - 1 do
    uiText[index] = UI.createControl(__ePAUIControl_StaticText, Panel_JournalInfo, "StaticText_journalInfoList_" .. index)
