...
function PaGlobal_TradeEventNotice_Renewal:InitializeUI()
  ...
  self._ui._staticTextTradeEventDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui._staticTextSupplyItemName:SetTextMode(__eTextMode_Limit_AutoWrap)
...
function PaGlobal_TradeEventNotice_Renewal:InitializeCreateUI()
  ...
  for terrIndex = 0, self._territoryCount - 1 do
    ...
    self._ui._staticSupplyBGList[terrIndex] = UI.createControl(__ePAUIControl_Static, self._ui._staticTradeEventDown, "Static_TerritorySupplyTownBG_" .. terrIndex)
    self._ui._btnSupplyNaviList[terrIndex] = UI.createControl(__ePAUIControl_Button, self._ui._staticSupplyBGList[terrIndex], "Button_TerritorySupplyNavi_" .. terrIndex)
    self._ui._staticTextSupplyTownList[terrIndex] = UI.createControl(__ePAUIControl_StaticText, self._ui._staticSupplyBGList[terrIndex], "StaticText_TerritorySupplyTown_" .. terrIndex)
    ...
    for itemIndex = 0, self._maxItemCount - 1 do
      self._ui._staticSupplyItemBGList[terrIndex][itemIndex] = UI.createControl(__ePAUIControl_Static, self._ui._staticSupplyBGList[terrIndex], "Static_TerritorySupplyItemBG_" .. terrIndex .. "_" .. itemIndex)
      self._ui._staticTextSupplyItemNameList[terrIndex][itemIndex] = UI.createControl(__ePAUIControl_StaticText, self._ui._staticSupplyBGList[terrIndex], "Static_TerritorySupplyItemName_" .. terrIndex .. "_" .. itemIndex)
      local itemSlot = UI.createControl(__ePAUIControl_Static, self._ui._staticSupplyItemBGList[terrIndex][itemIndex], "Static_TerritorySupplyItem_" .. terrIndex .. "_" .. itemIndex)
