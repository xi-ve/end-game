...
function TradeMarketGoods:registEvent()
  self._ui.list_GoodsList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_TradeMarketGoods_CreateList")
  self._ui.list_GoodsList:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  registerEvent("EventNpcTradeShopGraphRefresh", "PaGlobal_TradeMarketGoods_Update")
...
function TradeMarketGoods:update()
  ...
  if nil ~= servantInfo and 0 < vehicleSellCount then
...
function PaGlobal_TradeMarketGoods_CreateList(content, key)
  ...
  txt_OriginValue:SetTextMode(__eTextMode_LimitText)
