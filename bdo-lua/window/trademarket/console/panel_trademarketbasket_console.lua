...
function TradeMarketBasket:registEvent()
  self._ui.list_BasketList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_TradeMarketBasket_CreateList")
  self._ui.list_BasketList:createChildContent(__ePAUIList2ElementManagerType_List)
