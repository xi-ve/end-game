...
function global_sellItemFromPlayer()
  ...
  local vhicleSellCount = npcShop_getVehicleSellCount()
  local isValidDistance = getDistanceFromVehicle()
  if true == ToClient_IsContentsGroupOpen("576") and true == _isShip then
  ...
  for count = 1, commerceIndex - 1 do
    ...
    if true == tradeItemInfoList._isMyInventory then
      ...
      if false == ToClient_IsContentsGroupOpen("576") then
...
function fillSellTradeItemInfo(count, indexNum, itemValueType, tradeItemWrapper, characterStaticStatus, selfPlayerPosition, inventoryType)
  ...
  if isFishSupplyMerchant and 300000 < leftPeriod then
    leftPeriod = 1000000
  end
  ...
  if 100 < desertBuffPercent and fromToDistanceNavi >= desertBuffDistance then
...
function tradeSellMarket:setBuyItemDataInfo(index, itemName, leftCount, price, possibleCount)
  ...
  tradeSellMarket.itemName[index]:SetTextMode(__eTextMode_LimitText)
  local characterStaticStatusWrapper = npcShop_getCurrentCharacterKeyForTrade()
  local characterStaticStatus = characterStaticStatusWrapper:get()
...
function getItemList(index)
  local tempListBody = UI.createControl(__ePAUIControl_Static, Panel_Trade_Market_Sell_ItemList, "Static_SellMiniPanel_" .. index)
  ...
  local tempListBodyGame = UI.createControl(__ePAUIControl_Static, tempListBody, "Static_TradeGameMiniPanel_" .. index)
  ...
  local tempItemSlotBG = UI.createControl(__ePAUIControl_Static, tempListBody, "Static_Slot_" .. index)
  ...
  local tempRemainCount = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_remainCount_" .. index)
  CopyBaseProperty(_RemainCount, tempRemainCount)
  tradeSellMarket.remainCount[index] = tempRemainCount
  local tempNpcRemainCount = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_npcRemainCount_" .. index)
  CopyBaseProperty(_NpcRemainCount, tempNpcRemainCount)
  tradeSellMarket.npcRemainCount[index] = tempNpcRemainCount
  local tempItemName = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_itemName_" .. index)
  CopyBaseProperty(_ItemName, tempItemName)
  tempItemName:SetAutoResize(true)
  tempItemName:SetTextMode(__eTextMode_AutoWrap)
  tradeSellMarket.itemName[index] = tempItemName
  local tempSellPrice = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_sellPrice_" .. index)
  CopyBaseProperty(_SellPrice, tempSellPrice)
  tradeSellMarket.sellPrice[index] = tempSellPrice
  local tempQuotation = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_QuotationRate_" .. index)
  ...
  local tempExpiration = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_Expiration_" .. index)
  ...
  local tempTradePrice = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_TradePrice_" .. index)
  ...
  local tempDistanceBouns = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_Distance_" .. index)
  ...
  local tempDistanceBonusValue = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_DistanceValue_" .. index)
  ...
  local tempDistanceNoBonus = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_DistanceNoBonus_" .. index)
  ...
  local tempAddCart = UI.createControl(__ePAUIControl_Button, tempListBody, "Button_AddCart_" .. index)
  ...
  local tempProfitStatic = UI.createControl(__ePAUIControl_StaticText, tempListBody, "Static_Profit_" .. index)
  ...
  local tempProfitGold = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_ProfitGold_" .. index)
  CopyBaseProperty(_profitGold, tempProfitGold)
  tradeSellMarket.profitGold[index] = tempProfitGold
  local tempNoLinked = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_NoLinked_" .. index)
  ...
  local tempDesertBuff = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_DesertBuff_" .. index)
  ...
  local tempLifePowerBuffIcon = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_LifePowerBuffIcon_" .. index)
  ...
  local tempLifePowerBuffValue = UI.createControl(__ePAUIControl_StaticText, tempListBody, "StaticText_LifePowerBuffValue_" .. index)
...
function TradeMarket_CheckNodeLink_SellSome()
  ...
  elseif false == ToClient_IsContentsGroupOpen("576") then
