function PaGlobal_LobbyUserSetting:initialize()
  ...
  PaGlobal_LobbyUserSetting._ui.txt_offsetDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  PaGlobal_LobbyUserSetting._ui.txt_HDRSliderDesc:SetTextMode(__eTextMode_AutoWrap)
  PaGlobal_LobbyUserSetting._ui.txt_HDRSliderDesc:SetText(PaGlobal_LobbyUserSetting._ui.txt_HDRSliderDesc:GetText())
  PaGlobal_LobbyUserSetting._ui.txt_setLater:SetTextMode(__eTextMode_AutoWrap)
