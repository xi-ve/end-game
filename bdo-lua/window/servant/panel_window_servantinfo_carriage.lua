...
function carriageInfo:init()
  ...
  for idx = 0, 3 do
    local temp = {}
    temp._carriageHorseBg = UI.createControl(__ePAUIControl_Static, Panel_CarriageInfo, "Static_CarriageHorseBg_" .. idx)
    ...
    temp._carriageHorseSlot = UI.createControl(__ePAUIControl_Static, Panel_CarriageInfo, "Static_CarriageHorseSlot_" .. idx)
    ...
    temp._carriageHorse_Name = UI.createControl(__ePAUIControl_StaticText, Panel_CarriageInfo, "StaticText_CarriageHorse_Name_" .. idx)
    ...
    temp._btn_Skill = UI.createControl(__ePAUIControl_Button, Panel_CarriageInfo, "Button_CarriageHorse_Skill_" .. idx)
    ...
    temp._horse_Level = UI.createControl(__ePAUIControl_StaticText, Panel_CarriageInfo, "StaticText_Horse_Level_" .. idx)
    CopyBaseProperty(self._horse_Level, temp._horse_Level)
    temp._horse_Level:SetPosY(self._horse_Level:GetPosY() + self._gapY * idx)
    temp._EXP_CountData = UI.createControl(__ePAUIControl_StaticText, Panel_CarriageInfo, "Horse_EXP_CountData_" .. idx)
    ...
    temp._EXP_Bg = UI.createControl(__ePAUIControl_Static, Panel_CarriageInfo, "Horse_EXP_Bg_" .. idx)
    CopyBaseProperty(self._EXP_Bg, temp._EXP_Bg)
    temp._EXP_Bg:SetPosY(self._EXP_Bg:GetPosY() + self._gapY * idx)
    temp._EXP_GaugeBar = UI.createControl(__ePAUIControl_Static, Panel_CarriageInfo, "Horse_EXP_GaugeBar_" .. idx)
    ...
    temp._tier = UI.createControl(__ePAUIControl_StaticText, Panel_CarriageInfo, "Static_HorseTier_" .. idx)
  ...
  for idx = 0, 3 do
    local tempSkill = {}
    tempSkill._skillBg = UI.createControl(__ePAUIControl_Static, Panel_LinkedHorse_Skill, "Static_SkillBg_" .. idx)
    CopyBaseProperty(self._skillBg, tempSkill._skillBg)
    tempSkill._skillBg:SetPosY(self._skillBg:GetPosY() + self._gapY * idx + 25)
    tempSkill._skillIcon = UI.createControl(__ePAUIControl_Static, tempSkill._skillBg, "Static_SkillIcon_" .. idx)
    ...
    tempSkill._skillCondition = UI.createControl(__ePAUIControl_StaticText, tempSkill._skillBg, "Static_SkillCondition_" .. idx)
    ...
    tempSkill._skillName = UI.createControl(__ePAUIControl_StaticText, tempSkill._skillBg, "Static_SkillName_" .. idx)
    ...
    tempSkill._skillPercent = UI.createControl(__ePAUIControl_StaticText, tempSkill._skillBg, "Static_SkillPercent_" .. idx)
    ...
    tempSkill._skillGaugeBg = UI.createControl(__ePAUIControl_Static, tempSkill._skillBg, "Static_SkillGaugeBg_" .. idx)
    ...
    tempSkill._skillGauge = UI.createControl(__ePAUIControl_Progress2, tempSkill._skillBg, "Static_SkillGauge_" .. idx)
