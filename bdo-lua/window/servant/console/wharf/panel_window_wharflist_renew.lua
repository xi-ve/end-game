...
function Panel_Window_WharfList_info:childControl()
  ...
  self._ui.staticText_WharfRegist:SetTextMode(__eTextMode_AutoWrap)
...
function Panel_Window_WharfList_info:createSlot()
  for index = 0, self._config.maxSlotCount - 1 do
    ...
    slot.radioButton = UI.createControl(__ePAUIControl_RadioButton, self._ui.static_Wharf_List, "radioButton_Slot_" .. index)
