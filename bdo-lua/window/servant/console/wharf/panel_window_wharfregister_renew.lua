...
function Panel_Window_WharfRegister_info:childControl()
  ...
  self._ui.edit_Desc = UI.getChildControl(Panel_Window_WharfRegister, "StaticText_Edit_Desc")
  local defaultDecs = PAGetStringParam2(Defines.StringSheet_GAME, "LUA_STABLEINFO_EDITBOX_INFO_PARAM", "min", tostring(getGameServiceTypeNameMinLength()), "max", tostring(getGameServiceTypeServantNameLength()))
  self._ui.edit_Desc:SetText(defaultDecs)
