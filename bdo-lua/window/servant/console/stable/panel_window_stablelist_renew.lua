...
function Panel_Window_StableList_info:childControl()
  ...
  self._ui.staticText_Region:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.staticText_Unseal_NoUnseal:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.staticText_HorseRegist_Icon:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.staticText_WildRegist_Icon:SetTextMode(__eTextMode_AutoWrap)
...
function Panel_Window_StableList_info:createSlot()
  for index = 0, self._config.maxSlotCount - 1 do
    ...
    function slot:setServant(index)
      ...
      self.staticText_Name:SetTextMode(__eTextMode_Limit_AutoWrap)
      self.staticText_Name:SetText(servantInfo:getName())
      self.staticText_Location:SetShow(true)
      self.staticText_Location:SetTextMode(__eTextMode_Limit_AutoWrap)
    ...
    slot.radioButton = UI.createControl(__ePAUIControl_RadioButton, self._ui.static_Horse_List, "radioButton_Slot_" .. index)
    CopyBaseProperty(self._ui.radioButton_Slot, slot.radioButton)
    slot.static_Image = UI.createControl(__ePAUIControl_Static, slot.radioButton, "Static_Image_Template_" .. index)
    CopyBaseProperty(self._ui.static_Image_Template, slot.static_Image)
    slot.static_SexIcon = UI.createControl(__ePAUIControl_Static, slot.radioButton, "Static_SexIcon_Template_" .. index)
    CopyBaseProperty(self._ui.static_SexIcon_Template, slot.static_SexIcon)
    slot.staticText_Tier = UI.createControl(__ePAUIControl_StaticText, slot.radioButton, "StaticText_Tier_Template_" .. index)
    CopyBaseProperty(self._ui.staticText_Tier_Template, slot.staticText_Tier)
    slot.staticText_Name = UI.createControl(__ePAUIControl_StaticText, slot.radioButton, "StaticText_Name_Template_" .. index)
    CopyBaseProperty(self._ui.staticText_Name_Template, slot.staticText_Name)
    slot.staticText_Location = UI.createControl(__ePAUIControl_StaticText, slot.radioButton, "StaticText_Location_Template_" .. index)
    CopyBaseProperty(self._ui.staticText_Location_Template, slot.staticText_Location)
    slot.staticText_State = UI.createControl(__ePAUIControl_StaticText, slot.radioButton, "StaticText_State_Template_" .. index)
    CopyBaseProperty(self._ui.staticText_State_Template, slot.staticText_State)
    slot.staticText_SwiftIcon = UI.createControl(__ePAUIControl_Static, slot.radioButton, "Static_SwiftIcon_Template_" .. index)
    CopyBaseProperty(self._ui.static_SwiftIcon_Template, slot.staticText_SwiftIcon)
    slot.static_StateBg = UI.createControl(__ePAUIControl_Static, slot.radioButton, "Static_StateBg_" .. index)
    CopyBaseProperty(self._ui.static_StateBg, slot.static_StateBg)
    slot.static_StateIcon = UI.createControl(__ePAUIControl_Static, slot.radioButton, "Static_StateIcon_" .. index)
...
function Panel_Window_StableList_info:setUnsealButton()
  ...
  if nil ~= servantInfo then
    ...
    self._ui.staticText_Unseal_Name:SetTextMode(__eTextMode_Limit_AutoWrap)
...
function PaGlobalFunc_StableList_ScrollEvent(isUpScroll)
  ...
  if (_ContentsGroup_UsePadSnapping or ToClient_IsDevelopment()) and 0 ~= self._value.startButtonIndex then
...
function FromClient_StableList_ServantClearDeadCount(servantNo, isOceanShip)
