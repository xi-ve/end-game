...
function Panel_Window_StableInfo_info:childControl()
  ...
  self._ui.staticText_HP = UI.getChildControl(self._ui.static_InfoBg, "StaticText_HP")
...
function Panel_Window_StableInfo_info:setContent(unsealType)
  ...
  if true == isCarriage then
    ...
    self._ui.staticText_HP:SetText(PAGetString(Defines.StringSheet_RESOURCE, "SERVANT_INFO_TEXT_HP"))
