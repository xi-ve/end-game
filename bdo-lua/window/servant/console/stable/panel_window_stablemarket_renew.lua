...
function Panel_Window_StableMarket_info:resize()
  ...
  local basePosY = (screenSizeY - dialogSizeY) * 0.5 - Panel_Window_StableMarket:GetSizeY() * 0.5
  Panel_Window_StableMarket:SetSpanSize(Panel_Window_StableMarket:GetSpanSize().x, basePosY)
  Panel_Window_StableMarket:ComputePos()
end
function Panel_Window_StableMarket_info:childControl()
  ...
  self._ui.list2_1_Skill:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_StableMarket_SkillEventControlCreate")
