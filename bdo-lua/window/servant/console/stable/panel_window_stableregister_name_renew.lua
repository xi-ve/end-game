...
function Panel_Window_StableRegister_Name_info:childControl()
  ...
  self._ui.staticText_RegisterDesc:SetTextMode(__eTextMode_AutoWrap)
...
function Panel_Window_StableRegister_Name_info:setContent()
  local defaultDesc = PAGetStringParam2(Defines.StringSheet_GAME, "LUA_STABLE_REGISTNAME_DESC_PARAM", "min", tostring(getGameServiceTypeNameMinLength()), "max", tostring(getGameServiceTypeServantNameLength()))
  self._ui.staticText_RegisterDesc:SetText(defaultDesc)
  self:setEditName()
end
