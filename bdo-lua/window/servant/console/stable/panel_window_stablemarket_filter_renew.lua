...
function Panel_Window_StableMarket_Filter_info:childControl()
  ...
  self._ui.list2_1_SelectFilter:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_StableMarket_Filter_Create")
  self._ui.list2_1_SelectFilter:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui.static_Bottombg = UI.getChildControl(Panel_Window_StableMarket_Filter, "Static_BottomBg")
  self._ui.staticText_keyguide_Y = UI.getChildControl(self._ui.static_Bottombg, "StaticText_Confirm_ConsoleUI")
  self._ui.staticText_keyguide_A = UI.getChildControl(self._ui.static_Bottombg, "StaticText_Select_ConsoleUI")
