...
function Panel_Window_StableMating_info:resize()
  ...
  local dialogSizeY = Panel_Window_StableFunction:GetSizeY()
  local basePosY = (screenSizeY - dialogSizeY) * 0.5 - Panel_Window_StableMating:GetSizeY() * 0.5
  Panel_Window_StableMating:SetSpanSize(Panel_Window_StableMating:GetSpanSize().x, basePosY)
  Panel_Window_StableMating:ComputePos()
end
function Panel_Window_StableMating_info:childControl()
  ...
  self._ui.list2_1_Skill:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_StableMating_SkillEventControlCreate")
  self._ui.list2_1_Skill:createChildContent(__ePAUIList2ElementManagerType_List)
end
  ...
  if self._enum.eMYLIST == PaGlobalFunc_StableMating_GetCurrentTab() then
    ...
    if nil ~= servantInfo then
      if CppEnums.ServantStateType.Type_RegisterMating == servantInfo:getStateType() then
        ...
        if CppEnums.ServantStateType.Type_Mating == servantInfo:getStateType() and servantInfo:isMatingComplete() then
