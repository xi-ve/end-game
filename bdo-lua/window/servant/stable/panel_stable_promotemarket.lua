...
function Slot:init(index, control)
  ...
  cancelRentButton:SetTextMode(__eTextMode_AutoWrap)
  buyRentButton:SetTextMode(__eTextMode_AutoWrap)
  buyReturnButton:SetTextMode(__eTextMode_AutoWrap)
  receiveRentButton:SetTextMode(__eTextMode_AutoWrap)
  receiveReturnButton:SetTextMode(__eTextMode_AutoWrap)
  forceReturnButton:SetTextMode(__eTextMode_AutoWrap)
  ...
  for i = 1, #self._ui.skillTable do
    ...
    if showSkillFlag then
      ...
      if skill then
        ...
        icon:SetShow(true)
        text:SetTextMode(__eTextMode_AutoWrap)
...
function Slot:changeSkillPage(info, pageOffset)
  ...
  if 0 < nextPage and nextPage <= maxPage then
