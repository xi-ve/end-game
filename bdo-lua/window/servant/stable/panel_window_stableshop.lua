...
function stableShop:createSlot()
  for ii = 0, self.config.slotCount - 1 do
    ...
    slot.button = UI.createControl(__ePAUIControl_Button, Panel_Window_StableShop, "ServantShop_Slot_Button_" .. ii)
    ...
    slot.invenCount = UI.createControl(__ePAUIControl_StaticText, slot.button, "ServantShop_Slot_InventoryCount_" .. ii)
    CopyBaseProperty(self.baseInventoryCount, slot.invenCount)
    slot.remainCount = UI.createControl(__ePAUIControl_StaticText, slot.button, "ServantShop_Slot_RemainCount_" .. ii)
    CopyBaseProperty(self.baseRemainCount, slot.remainCount)
    slot.price = UI.createControl(__ePAUIControl_StaticText, slot.button, "ServantShop_Slot_Price_" .. ii)
    ...
    slot.effect = UI.createControl(__ePAUIControl_Static, slot.button, "ServantShop_Slot_Effect_" .. ii)
