...
UiSave.txt_Desc:SetTextMode(__eTextMode_AutoWrap)
...
UiSet.txt_UIHelp:SetTextMode(__eTextMode_AutoWrap)
...
if true == _ContentsGroup_SimpleUI then
  UiSet.txt_UIHelp:SetSpanSize(5, 300)
  ...
  UiSet.btn_remsaterUI:SetSpanSize(40, 195)
  UiSet.btn_FieldView:SetSpanSize(40, 220)
  UiSet.btn_QuickSlotMagnetic:SetSpanSize(40, 245)
  UiSet.chk_GridView:SetSpanSize(40, 270)
  UiSet.txt_UISize:SetSpanSize(0, 130)
  UiSet.txt_UI_LOW:SetSpanSize(40, 155)
  UiSet.txt_UI_HIGH:SetSpanSize(40, 155)
  UiSet.slider_UI_Scale:SetSpanSize(0, 180)
else
...
function UiSet_Initialize()
  ...
  for idx = 1, UiSet.panelCount do
    if nil ~= panelControl[idx].control then
      ...
      if true == panelControl[idx].showFixed then
...
function UiSet_update(isRemasterSwap)
  ...
  for idx = 1, UiSet.panelCount do
    ...
    if nil ~= slot and nil ~= slot.control then
      ...
      slot.close:SetShow(false == panelControl[idx].showFixed)
      slot.close:SetPosX(slot.control:GetSizeX() - slot.close:GetSizeX() - 3)
      slot.close:SetPosY(3)
...
UiSet.btn_UIFreeSet1:addInputEvent("Mouse_On", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.preset1 .. ", true)")
UiSet.btn_UIFreeSet2:addInputEvent("Mouse_On", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.preset2 .. ", true)")
UiSet.btn_UIFreeSet3:addInputEvent("Mouse_On", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.preset3 .. ", true)")
UiSet.btn_DefaultSet1:addInputEvent("Mouse_On", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.battleMode .. ", true)")
UiSet.btn_DefaultSet2:addInputEvent("Mouse_On", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.adventureMode .. ", true)")
UiSet.btn_UIFreeSet1:addInputEvent("Mouse_Out", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.preset1 .. ", false)")
UiSet.btn_UIFreeSet2:addInputEvent("Mouse_Out", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.preset2 .. ", false)")
UiSet.btn_UIFreeSet3:addInputEvent("Mouse_Out", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.preset3 .. ", false)")
UiSet.btn_DefaultSet1:addInputEvent("Mouse_Out", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.battleMode .. ", false)")
UiSet.btn_DefaultSet2:addInputEvent("Mouse_Out", "PaGlobal_UiSetting_ButtonTooltip(" .. eBtnType.adventureMode .. ", false)")
...
function PaGlobal_UiSetting_ButtonTooltip(_eBtnType, isShow)
  ...
  if eBtnType.preset1 == _eBtnType then
    control = UiSet.btn_UIFreeSet1
  ...
  elseif eBtnType.preset2 == _eBtnType then
    control = UiSet.btn_UIFreeSet2
  ...
  elseif eBtnType.preset3 == _eBtnType then
    control = UiSet.btn_UIFreeSet3
  ...
  elseif eBtnType.battleMode == _eBtnType then
    control = UiSet.btn_DefaultSet1
  ...
  elseif eBtnType.adventureMode == _eBtnType then
    control = UiSet.btn_DefaultSet2
    name = PAGetString(Defines.StringSheet_GAME, "LUA_UISETTING_BTNTOOLTIP_ADVENTURE_TITLE")
    desc = PAGetString(Defines.StringSheet_GAME, "LUA_UISETTING_BTNTOOLTIP_ADVENTURE_DESC")
  end
  TooltipSimple_Show(control, name, desc)
end
function FromClient_UiSetting_Initialize()
  UiSet.btn_UIFreeSet1:setButtonShortcutsWithEvent("applyPresetInfo( " .. 0 .. ")", "PANEL_SAVEFREESET_FREESET1")
  UiSet.btn_UIFreeSet2:setButtonShortcutsWithEvent("applyPresetInfo( " .. 1 .. ")", "PANEL_SAVEFREESET_FREESET2")
  UiSet.btn_UIFreeSet3:setButtonShortcutsWithEvent("applyPresetInfo( " .. 2 .. ")", "PANEL_SAVEFREESET_FREESET3")
end
...
registerEvent("FromClient_luaLoadComplete", "FromClient_UiSetting_Initialize")
