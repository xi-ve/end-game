...
runLua("UI_Data/Script/Window/UI_Setting/Panel_UI_Setting_1.lua")
runLua("UI_Data/Script/Window/UI_Setting/Panel_UI_Setting_2.lua")
registerEvent("FromClient_luaLoadComplete", "FromClient_UISettingInit")
function FromClient_UISettingInit()
  PaGlobal_UISetting:initialize()
end
