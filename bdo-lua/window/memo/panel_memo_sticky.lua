...
function PaGlobal_Memo:createStickyMemo(stickyMemoId, content)
  ...
  function stickyMemo:prepareControl(stickyMemoId)
    self._uiEditTitleImg = stickyMemo:createControl(__ePAUIControl_Static, Panel_Memo_Sticky, self._mainPanel, "Static_TitleImage", 0)
    self._uiClose = stickyMemo:createControl(__ePAUIControl_Button, Panel_Memo_Sticky, self._mainPanel, "Button_Close", 0)
    ...
    self._uiSizeControl = stickyMemo:createControl(__ePAUIControl_Button, Panel_Memo_Sticky, self._mainPanel, "Button_SizeControl", 0)
    ...
    self._uiframe = stickyMemo:createControl(__ePAUIControl_Frame, Panel_Memo_Sticky, self._mainPanel, "Frame_Sticky", 0)
    ...
    self._uiMultiLineText = UI.createControl(__ePAUIControl_MultiLineEdit, self._uiframeContent, "MultilineEdit_Content" .. 0)
    ...
    self._uiSave = stickyMemo:createControl(__ePAUIControl_Button, Panel_Memo_Sticky, self._mainPanel, "Button_SaveMemo", 0)
    self._uiSave:addInputEvent("Mouse_LUp", "PaGlobal_Memo:Save(" .. PaGlobal_Memo._SaveMode_.ALL .. "," .. stickyMemoId .. ")")
    self._uiAddMemo = stickyMemo:createControl(__ePAUIControl_Button, Panel_Memo_Sticky, self._mainPanel, "Button_AddMemo", 0)
    ...
    self._uiCheckbuttonPopup = stickyMemo:createControl(__ePAUIControl_CheckButton, Panel_Memo_Sticky, self._mainPanel, "CheckButton_PopUp", 0)
    ...
    self._uiButtonColorChange = stickyMemo:createControl(__ePAUIControl_Button, Panel_Memo_Sticky, self._mainPanel, "Button_ColorChange", 0)
    ...
    self._colorChange._uiframe = stickyMemo:createControl(__ePAUIControl_Frame, Panel_Memo_Sticky, self._mainPanel, "Frame_Sticky_ColorChange", 0)
    ...
    for color = 0, 5 do
      ...
      self._colorChange._uiButton[color] = UI.createControl(__ePAUIControl_Button, self._colorChange._uiframeContent, "Button_Color_" .. color)
