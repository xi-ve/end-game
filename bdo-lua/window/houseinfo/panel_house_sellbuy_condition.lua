...
function default_Control:Init()
  ...
  self._Cost_Need = UI.createControl(__ePAUIControl_StaticText, self._Cost_BG, "Cost_Need")
  self._Cost_Need_Value = UI.createControl(__ePAUIControl_StaticText, self._Cost_BG, "Cost_Need_Value")
  self._Cost_Have = UI.createControl(__ePAUIControl_StaticText, self._Cost_BG, "Cost_Have")
  self._Cost_Have_Value = UI.createControl(__ePAUIControl_StaticText, self._Cost_BG, "Cost_Have_Value")
  ...
  for idx = 0, param_Scroll._listMax - 1 do
    self._List_Value[idx] = UI.createControl(__ePAUIControl_Button, self._List_BG, "List_Value_" .. idx)
    ...
    self._List_Button[idx] = UI.createControl(__ePAUIControl_Button, self._List_BG, "List_Button_" .. idx)
    ...
    self._List_Button[idx]:SetTextMode(__eTextMode_LimitText)
  end
...
function default_Control:UpdateList()
  ...
  for idx = 0, lastIndex do
    ...
    default_Control._List_Value[idx]:SetTextMode(__eTextMode_LimitText)
