  ...
  for index = 0, rowCount - 1 do
    for cIndex = 0, 3 do
      ...
      if realIndex < self._maxItemCount then
        control._tradeItemSlotBg[realIndex] = UI.createControl(__ePAUIControl_Static, control._itemListBg, "TradeItemBg_" .. realIndex)
        ...
        control._tradeItemSlot[realIndex] = UI.createControl(__ePAUIControl_Static, control._tradeItemSlotBg[realIndex], "TradeItemSlot_" .. realIndex)
...
function WorkerTrade_SetAsset(assetType, increaseCount)
  ...
  local amuletCount = tradeGroupWrapper:getTradeGroupAmulet()
  if 0 == assetType then
    if 0 < carriageCount and increaseCount < 0 then
...
function WorkerTradeCaravan_SetItem(index, value)
  ...
  if not isSameItem and 0 < value then
...
function workerTradeCaravan:registerEvent()
  ...
  control._list2TradeWorker:registEvent(__ePAUIList2EventType_LuaChangeContent, "TradeWorkerListControlCreate")
  control._list2TradeWorker:createChildContent(__ePAUIList2ElementManagerType_List)
  control._routerNode._btnArrivalNode:addInputEvent("Mouse_LUp", "WorkerTradeCaravan_ShowArrivalNodeList()")
  control._list2ArrivalNode:registEvent(__ePAUIList2EventType_LuaChangeContent, "ArrivalNodeListControlCreate")
  control._list2ArrivalNode:createChildContent(__ePAUIList2ElementManagerType_List)
  for index = 1, 5 do
    control._routerNode._btnRouterNode[index]:addInputEvent("Mouse_LUp", "WorkerTradeCaravan_RouteNodeSet(" .. index .. ")")
  end
  control._list2RouteNode:registEvent(__ePAUIList2EventType_LuaChangeContent, "RouteNodeListControlCreate")
  control._list2RouteNode:createChildContent(__ePAUIList2ElementManagerType_List)
  control._itemSet._btnClose:addInputEvent("Mouse_LUp", "WorkerTradeCaravan_ItemListClose()")
  control._list2TradeItem:registEvent(__ePAUIList2EventType_LuaChangeContent, "TradeItemListControlCreate")
  control._list2TradeItem:createChildContent(__ePAUIList2ElementManagerType_List)
