...
function FishEncyclopedia:createSlot(index)
  local FishInfo = {}
  FishInfo._staticFishBack = UI.createControl(__ePAUIControl_Static, Panel_FishEncyclopedia, "Static_FishBG_" .. index)
  CopyBaseProperty(_staticFishBack, FishInfo._staticFishBack)
  FishInfo._textFishName = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_FishName_" .. index)
  CopyBaseProperty(_textFishName, FishInfo._textFishName)
  FishInfo._textFishName:SetPosX(18)
  FishInfo._textFishName:SetPosY(11)
  FishInfo._textFishRarity = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_Rarity_" .. index)
  ...
  FishInfo._staticFishImage = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_FishImage_" .. index)
  ...
  FishInfo._staticFishRating[0] = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_FishRating1_" .. index)
  ...
  FishInfo._staticFishRating[1] = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_FishRating2_" .. index)
  ...
  FishInfo._staticFishRating[2] = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_FishRating3_" .. index)
  ...
  FishInfo._staticFishRating[3] = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_FishRating4_" .. index)
  ...
  FishInfo._staticFishRating[4] = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_FishRating5_" .. index)
  ...
  FishInfo._staticTopLine = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_TopLine_" .. index)
  ...
  FishInfo._staticDescBack = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_ExplanationBG_" .. index)
  ...
  FishInfo._textDesc = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_FishExplanation_" .. index)
  ...
  FishInfo._textDesc:SetTextMode(__eTextMode_Limit_AutoWrap)
  FishInfo._textDesc:SetAutoResize(true)
  FishInfo._textDesc:SetLineCount(3)
  FishInfo._staticBottomLine = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_BottomLine_" .. index)
  ...
  FishInfo._staticInforBack = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_InfoBG_" .. index)
  ...
  FishInfo._textFishArea = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_FishArea_" .. index)
  CopyBaseProperty(_textFishArea, FishInfo._textFishArea)
  FishInfo._textFishArea:SetPosX(20)
  FishInfo._textFishArea:SetPosY(182)
  FishInfo._buttonFishPosition = UI.createControl(__ePAUIControl_Button, FishInfo._staticFishBack, "Button_FishLocation_" .. index)
  ...
  FishInfo._textFishPosition = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_FishPosition_" .. index)
  ...
  FishInfo._textFishCount = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_FishCount_" .. index)
  ...
  FishInfo._textFishCountNum = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_FishCountNumber_" .. index)
  ...
  FishInfo._textFishSize = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_FishMaxSize_" .. index)
  CopyBaseProperty(_textFishSize, FishInfo._textFishSize)
  FishInfo._textFishSize:SetPosX(20)
  FishInfo._textFishSize:SetPosY(222)
  FishInfo._textFishSizeNum = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_FishMaxSizeNumber_" .. index)
  ...
  FishInfo._textSizeRankTitle = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticFishBack, "StaticText_textSizeRankTitle_" .. index)
  ...
  FishInfo._staticSizeRankLine = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_staticSizeRankLine_" .. index)
  ...
  FishInfo._staticSizeRankBG = UI.createControl(__ePAUIControl_Static, FishInfo._staticFishBack, "Static_staticSizeRankBG_" .. index)
  ...
  FishInfo._textSizeNoAcquire = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticSizeRankBG, "StaticText_SizeNoAcquire_" .. index)
  ...
  FishInfo._textSizeRankLoading = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticSizeRankBG, "StaticText_SizeRankLoading_" .. index)
  ...
  for rankIdx = 0, 9 do
    ...
    FishInfo.rankList[rankIdx]._textSizeRanker = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticSizeRankBG, "StaticText_SizeRanker_" .. index .. "_" .. rankIdx)
    ...
    FishInfo.rankList[rankIdx]._textSizeRankerName = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticSizeRankBG, "StaticText_SizeRankerName_" .. index .. "_" .. rankIdx)
    ...
    FishInfo.rankList[rankIdx]._textSizeRankerSize = UI.createControl(__ePAUIControl_StaticText, FishInfo._staticSizeRankBG, "StaticText_SizeRankerSize_" .. index .. "_" .. rankIdx)
...
function FishEncyclopedia:createRadioButton(index, paramIndex, strLabel)
  local radioButton = UI.createControl(__ePAUIControl_RadioButton, Panel_FishEncyclopedia, "RadioButton_FishType_" .. index)
