...
function PaGlobal_MonsterRanking:MonsterRanking_Initialize()
  self._ui._btn_Close = UI.getChildControl(PaGlobal_MonsterRanking._ui._titleBg, "Button_Win_Close")
  local rankListBG = UI.getChildControl(Panel_Window_MonsterRanking, "Static_RankListTitleBG")
  self._ui._nameTitle = UI.getChildControl(rankListBG, "StaticText_NameTitle")
...
function PaGlobal_MonsterRanking:registEventHandler()
  self._ui._titleList2:registEvent(__ePAUIList2EventType_LuaChangeContent, "MonsterRanking_Title_ListControlCreate")
  self._ui._titleList2:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui._list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "MonsterRanking_Rank_ListControlCreate")
