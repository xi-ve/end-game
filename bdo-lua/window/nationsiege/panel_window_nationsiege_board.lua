...
function FromClient_NationSiegeBoard_BossHpChanged()
  ...
  if nil ~= mainBoss_Calpheon then
    ...
    nationCalpheon[ENUM_CLASS.GENERAL].txt_Name:SetTextMode(__eTextMode_Limit_AutoWrap)
  ...
  if nil ~= mainBoss_Valencia then
    ...
    nationValencia[ENUM_CLASS.GENERAL].txt_Name:SetTextMode(__eTextMode_Limit_AutoWrap)
  ...
  for index = 0, ToClient_getNationSiegeSubBossCount() - 1 do
    ...
    if nil ~= subBoss_Calpheon then
      ...
      nationCalpheon[currentClassIndex].txt_Name:SetTextMode(__eTextMode_Limit_AutoWrap)
    ...
    if nil ~= subBoss_Valencia then
      ...
      nationValencia[currentClassIndex].txt_Name:SetTextMode(__eTextMode_Limit_AutoWrap)
