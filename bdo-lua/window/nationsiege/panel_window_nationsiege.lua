...
function Panel_Window_NationSiege:Init_LeftNationGuild()
  self._ui._calPheonGuild_List:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_NationSiege_LeftListUpdate")
  self._ui._calPheonGuild_List:createChildContent(__ePAUIList2ElementManagerType_List)
...
function Panel_Window_NationSiege:Init_RightNationGuild()
  self._ui._valenciaGuild_List:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_NationSiege_RightListUpdate")
  self._ui._valenciaGuild_List:createChildContent(__ePAUIList2ElementManagerType_List)
