...
static_FilePath:SetTextMode(__eTextMode_LimitText)
...
local function MakeFileItem(name)
  local fileItem = {}
  fileItem._item = UI.createControl(__ePAUIControl_Static, _currentFrame.content, name)
  CopyBaseProperty(temp_ItemBase, fileItem._item)
  fileItem._icon = UI.createControl(__ePAUIControl_Static, fileItem._item, name .. "_icon")
  CopyBaseProperty(temp_IconBase, fileItem._icon)
  fileItem._text = UI.createControl(__ePAUIControl_StaticText, fileItem._item, name .. "_text")
  ...
  fileItem._text:SetTextMode(__eTextMode_LimitText)
  return fileItem
end
function refreshFileList()
  ...
  if 0 <= selectType then
    for index = 0, count - 1 do
      ...
      item._text:SetTextMode(__eTextMode_LimitText)
