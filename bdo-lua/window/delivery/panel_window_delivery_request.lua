...
function deliveryRequest:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"DeliveryRequest\"")
...
function deliveryRequest:init()
  ...
  for ii = 0, self.config.slotCount - 1 do
    self.slotbgs[ii] = UI.createControl(__ePAUIControl_Static, Panel_Window_Delivery_Request, "StaticSlotBG_" .. ii)
...
function DeliveryRequestWindow_Open()
  ...
  deliveryRequest.deliveryHelpDesc:SetTextMode(__eTextMode_AutoWrap)
