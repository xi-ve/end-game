...
function PanelDelivery:init()
  ...
  self._ui.txt_PricePenalty:SetTextMode(__eTextMode_AutoWrap)
...
function PanelDelivery:registEvent()
  ...
  self._ui.list_Delivery:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_PanelDelivery_ControlCreate")
