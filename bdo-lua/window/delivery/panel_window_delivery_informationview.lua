...
function deliveryInformationView:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"DeliveryInformation\"")
end
function deliveryInformationView:init()
  ...
  self.list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "DeliveryView_ListControlCreate")
