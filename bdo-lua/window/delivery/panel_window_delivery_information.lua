...
function deliveryInformation:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self.buttonQuestion, "\"DeliveryInformation\"")
...
function deliveryInformation:init()
  ...
  self.list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "Delivery_ListControlCreate")
