function PaGlobal_InformationView:initialize()
  ...
  PaGlobal_InformationView._slotMaxSize = ToClient_GetNewDeliveryItemMaxCount()
  ...
  PaGlobal_InformationView._ui.list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "DeliveryView_ListControlCreate_New")
  PaGlobal_InformationView._ui.list2:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PaGlobal_InformationView:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(PaGlobal_InformationView._ui._buttonQuestion, "\"DeliveryInformation\"")
end
...
function DeliveryView_ListControlCreate_New(content, key)
  ...
  remainTime:SetShow(true)
  remainTime:SetTextMode(__eTextMode_LimitText)
  if 0 ~= leftTime then
  ...
  elseif 5 == delivererIndex then
    remainTime:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_DELIVERYNEW_FIVENUMBER_CARRIAGE"))
  else
