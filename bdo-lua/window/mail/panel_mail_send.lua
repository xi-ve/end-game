...
local editContentWebcontrol = UI.createControl(__ePAUIControl_WebControl, Panel_Mail_Send, "Mail_TextArea")
...
function mailSend:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"PanelMailSend\"")
end
