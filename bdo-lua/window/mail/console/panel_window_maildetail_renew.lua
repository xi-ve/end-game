...
function mailDetail:init()
  ...
  self._ui._sender:SetTextMode(__eTextMode_LimitText)
  self._ui._title = UI.getChildControl(self._ui.stc_centerBG, "StaticText_Title")
  self._ui._title:SetTextMode(__eTextMode_LimitText)
  ...
  self._ui.txt_itemCount:SetTextMode(__eTextMode_LimitText)
...
function Mail_Detail_Open(mailNo)
  ...
  self._ui._contents:SetTextMode(__eTextMode_AutoWrap)
