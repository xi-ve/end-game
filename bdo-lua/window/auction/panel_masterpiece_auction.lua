...
function PaGlobal_MasterpieceAuction:initialize()
  ...
  slot2:createChild()
  self._ui._list2_RightContent:registEvent(__ePAUIList2EventType_LuaChangeContent, "MasterpieceAution_RightContent_ListControlCreate")
  self._ui._list2_RightContent:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui._editPriceInput:SetNumberMode(true)
  self._ui._but_Question:SetShow(false)
  self._ui._staticTextDescBG:SetTextMode(__eTextMode_AutoWrap)
...
function MasterpieceAution_LeftContent_ListControlCreate(content, key)
  ...
  radioBtn:SetTextMode(__eTextMode_AutoWrap)
...
function MasterpieceAution_RightContent_ListControlCreate(content, key)
  ...
  for i = index * self._list2LineCount, index * self._list2LineCount + self._list2LineCount - 1 do
    ...
    if isBiddable or false == isEnd then
      ...
      bidItemName:SetTextMode(__eTextMode_LimitText)
...
function PaGlobal_MasterpieceAuction:registerEvent()
  ...
  self._ui._list2_LeftContent:registEvent(__ePAUIList2EventType_LuaChangeContent, "MasterpieceAution_LeftContent_ListControlCreate")
  self._ui._list2_LeftContent:createChildContent(__ePAUIList2ElementManagerType_List)
