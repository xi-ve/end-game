...
function PaGlobal_GuildHouse_Auction_Bid_All:controlAll_Init()
  ...
  self._ui.txt_bidText = UI.getChildControl(self._ui.stc_bidBg, "Static_Text_Title")
...
function PaGlobal_GuildHouse_Auction_Bid_All:SetUiSetting()
  ...
  if false == PaGlobal_GuildHouse_Auction_Bid_All._isConsole then
    ...
    self._ui.stc_bidBg:SetSize(self._ui.stc_bidBg:GetSizeX(), Panel_GuildHouse_Auction_Bid_All:GetSizeY() - self._ui.stc_bidBg:GetSpanSize().y)
    self._ui.txt_bidText:SetTextHorizonCenter()
  else
