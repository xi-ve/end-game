...
txtExplain:SetTextMode(__eTextMode_AutoWrap)
...
function TerritoryAuth_CreateSlot()
  for i = 0, maxCount - 1 do
    ...
    slot:createChild()
    slots[i] = slot
    local tempItemSlotBG = UI.createControl(__ePAUIControl_Static, slot.icon, "Static_Slot_" .. i)
...
PaGlobal_Util_RegistHelpTooltipEvent(_buttonQuestion, "\"TerritoryAuth\"")
