...
function FromClient_GuildHouse_Auction_Detail_All_ReSizePanel()
  ...
  if true == PaGlobal_GuildHouse_Auction_Detail_All._isConsole then
    ...
    PaGlobalFunc_ConsoleKeyGuide_SetAlign(tempBtnGroup, PaGlobal_GuildHouse_Auction_Detail_All._ui_console.stc_bottom, CONSOLEKEYGUID_ALIGN_TYPE.eALIGN_TYPE_RIGHTAUTOWRAP)
  end
end
