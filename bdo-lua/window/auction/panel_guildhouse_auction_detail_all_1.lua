function PaGlobal_GuildHouse_Auction_Detail_All:initialize()
  ...
  PaGlobal_GuildHouse_Auction_Detail_All._isConsole = _ContentsGroup_UsePadSnapping
...
function PaGlobal_GuildHouse_Auction_Detail_All:controlAll_Init()
  ...
  PaGlobal_GuildHouse_Auction_Detail_All._sizeY.DESC_BG = PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_descBg:GetSizeY()
end
...
function PaGlobal_GuildHouse_Auction_Detail_All:SetUiSetting()
  ...
  if false == PaGlobal_GuildHouse_Auction_Detail_All._isConsole then
    ...
    PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_subFrameBg:SetSize(PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_subFrameBg:GetSizeX(), Panel_GuildHouse_Auction_Detail_All:GetSizeY() - PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_subFrameBg:GetSpanSize().y)
  else
  ...
  PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_descBg:SetSize(PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_descBg:GetSizeX(), PaGlobal_GuildHouse_Auction_Detail_All._sizeY.DESC_BG)
...
function PaGlobal_GuildHouse_Auction_Detail_All:setNoticeDesc()
  ...
  PaGlobal_GuildHouse_Auction_Detail_All._ui.stc_desc:SetTextMode(__eTextMode_AutoWrap)
