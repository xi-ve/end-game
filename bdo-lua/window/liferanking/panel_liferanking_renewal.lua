...
function PaGlobal_LifeRanking:Initialize()
  ...
  for index = 0, self._createTabCount - 1 do
    if FGlobal_LifeRanking_CheckEnAble(index) then
      ...
      self._ui._tabMyTitle[index]:SetTextMode(__eTextMode_LimitText)
...
function LifeRanking_registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(PaGlobal_LifeRanking._ui._btnHelp, "\"LifeRanking\"")
...
PaGlobal_LifeRanking._ui._tooltip._desc:SetTextMode(__eTextMode_AutoWrap)
