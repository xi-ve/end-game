...
function AlchemyFigureHead:PanelResize_ByFontSize()
  ...
  AlchemyFigureHead.control.guideString:SetTextMode(__eTextMode_AutoWrap)
  ...
  AlchemyFigureHead.control.desc:SetTextMode(__eTextMode_AutoWrap)
...
function FGlobal_AlchemyFigureHead_Open()
  ...
  if true == _ContentsGroup_NewUI_Inventory_All then
    PaGlobalFunc_Inventory_All_SetInventoryDragNoUse(Panel_AlchemyFigureHead)
  else
