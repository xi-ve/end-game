...
function PaGlobal_WorldDropItem:Init()
  ...
  self._ui._selectedRegionName:SetTextMode(__eTextMode_LimitText)
  ...
  control._list2Region:registEvent(__ePAUIList2EventType_LuaChangeContent, "DropItemRegion_ControlCreate")
  control._list2Region:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  for index = 0, self._maxSlot - 1 do
    control._slotBg[0][index] = UI.createControl(__ePAUIControl_Static, control._itemGroupUi[0], "DropItem_WeaponSlotBg_" .. index)
    ...
    control._slotBg[1][index] = UI.createControl(__ePAUIControl_Static, control._itemGroupUi[1], "DropItem_ArmorSlotBg_" .. index)
    ...
    control._slotBg[2][index] = UI.createControl(__ePAUIControl_Static, control._itemGroupUi[2], "DropItem_AccessorySlotBg_" .. index)
    ...
    control._slotBg[3][index] = UI.createControl(__ePAUIControl_Static, control._itemGroupUi[3], "DropItem_EtcSlotBg_" .. index)
...
function PaGlobal_WorldDropItem:SetDropItem(regionKey)
  ...
  control._scroll:SetShow(330 < contentSize)
