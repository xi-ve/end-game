...
function AccountLinking:open()
  ...
  elseif PaGlobalFunc_Window_CharacterInfo_GetShow() then
  ...
  if false == ToClient_isPS4() then
    ...
    id = ToClient_getPS4AccountLinkingId()
  end
...
function Input_AccountLinking_Unlink()
  ...
  if false == ToClient_isPS4() then
    ...
    ToClient_requestPS4AccountLinking(id, pw, false)
  end
end
function Input_AccountLinking_Link()
  ...
  if false == ToClient_isPS4() then
    ...
    ToClient_requestPS4AccountLinking(id, pw, true)
  end
end
