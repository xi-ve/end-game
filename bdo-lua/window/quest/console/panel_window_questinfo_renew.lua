...
function Window_QuestInfo:SetQuestData(uiQuestInfo)
  ...
  if uiQuestInfo:isSpecialType() then
    return
  end
  if uiQuestInfo:isSeasonPassType() then
    return
  end
  local questInfo = {
...
function Window_QuestInfo:InitInputEvent()
  ...
  self._ui._list2_Quest:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_Quest_List2EventControlCreate")
  self._ui._list2_Quest:createChildContent(__ePAUIList2ElementManagerType_Tree)
  ...
  Panel_Window_QuestInfo:ComputePos()
end
function PaGlobalFunc_Quest_List2EventControlCreate(list_content, key)
  ...
  questUI._staticText_QuestName:SetTextMode(__eTextMode_LimitText)
  ...
  questUI._button_QuestBg:addInputEvent("Mouse_On", "PaGlobalFunc_Quest_Detail_Close()")
  questUI._button_QuestBg:registerPadEvent(__eConsoleUIPadEvent_DpadLeft, "")
  ...
  if true == questInfo._isGroup then
    ...
    questUI._button_QuestBg:addInputEvent("Mouse_LUp", "PaGlobalFunc_Quest_FindWay(" .. id .. ",false)")
    questUI._button_QuestBg:registerPadEvent(__eConsoleUIPadEvent_DpadLeft, "PaGlobal_Quest_MoveSnapToDetail()")
...
function PaGlobalFunc_Quest_SelectQuest(index)
  ...
  for index = 0, demandCount - 1 do
    ...
    if nil == conditionUI then
      conditionUI = UI.createControl(__ePAUIControl_StaticText, self._ui._frameContent_1_Content, "staticText_questCondition_" .. index)
      CopyBaseProperty(self._ui._questDetail._staticText_ConditionTemplate, conditionUI)
    end
    conditionUI:SetTextMode(__eTextMode_AutoWrap)
...
function Window_QuestInfo:SetReward(groupID, questID)
  ...
  for baseIndex = 0, self._config._baseRewardMax - 1 do
    if baseIndex <= baseRewardCount - 1 then
      ...
      self._ui._baseRewardControl[baseIndex]:SetIgnore(false)
    else
      self._ui._baseRewardControl[baseIndex]:SetIgnore(true)
    end
  end
  for selectIndex = 0, self._config._selectRewardMax - 1 do
    if selectIndex <= selectRewardCount - 1 then
      ...
      self._ui._selectRewardControl[selectIndex]:SetIgnore(false)
    else
      self._ui._selectRewardControl[selectIndex]:SetIgnore(true)
    end
  end
end
function Window_QuestInfo:SetRewardIcon(slot, reward, index, rewardStr)
  ...
  elseif __eRewardItem == rewardType then
    ...
    if "base" == rewardStr then
      slot.icon:addInputEvent("Mouse_On", "PaGlobalFunc_QuestInfo_FloatingToolTip(" .. reward:getItemEnchantKey() .. ", " .. index .. ", \"" .. rewardStr .. "\")")
...
function PaGlobalFunc_QuestInfo_FloatingToolTip(rewardKey, slotIdx, rewardType)
  if nil == rewardKey then
    return
  end
  ...
  if "base" == rewardType then
    slot = Window_QuestInfo._ui._baseRewardControl[slotIdx]
  elseif "select" == rewardType then
    slot = Window_QuestInfo._ui._selectRewardControl[slotIdx]
  end
  local tooltipPosY = Panel_Widget_FloatingTooltip_Renew:GetPosY()
  Panel_Widget_FloatingTooltip_Renew:ComputePos()
  Panel_Widget_FloatingTooltip_Renew:SetPosY(slot:GetParentPosY() - Panel_Widget_FloatingTooltip_Renew:GetSizeY() - 10)
  Panel_Widget_FloatingTooltip_Renew:SetPosX(slot:GetParentPosX())
end
...
function PaGlobalFunc_Quest_SetTooltip(questType, show, rewardStr, index, mentalCardKey)
  ...
  if true == show then
    ...
    if "base" == rewardStr then
      ...
      if "Knowledge" == questType then
        self._ui._static_BaseToolTip:SetPosX(self._ui._baseRewardControl[index]:GetPosX())
      else
        self._ui._static_BaseToolTip:SetPosX(self._ui._baseRewardControl[index]:GetPosX() + self._ui._baseRewardControl[index]:GetSizeX() / 2 - self._ui._static_BaseToolTip:GetSizeX() / 2)
      end
      self._ui._static_BaseToolTip:SetShow(true)
    elseif "select" == rewardStr then
      self._ui._static_SelectToolTip:SetText(str)
      if "Knowledge" == questType then
        self._ui._static_SelectToolTip:SetPosX(self._ui._selectRewardControl[index]:GetPosX())
      else
        self._ui._static_SelectToolTip:SetPosX(self._ui._selectRewardControl[index]:GetPosX() + self._ui._selectRewardControl[index]:GetSizeX() / 2 - self._ui._static_SelectToolTip:GetSizeX() / 2)
      end
      self._ui._static_SelectToolTip:SetShow(true)
    end
    local paddingSize = 30
    self._ui._static_BaseToolTip:SetSize(self._ui._static_BaseToolTip:GetTextSizeX() + paddingSize, self._ui._static_BaseToolTip:GetTextSizeY() + paddingSize)
    self._ui._static_SelectToolTip:SetSize(self._ui._static_SelectToolTip:GetTextSizeX() + paddingSize, self._ui._static_SelectToolTip:GetTextSizeY() + paddingSize)
...
function Window_QuestInfo:DetailClear()
  ...
  PaGlobalFunc_Quest_SetTooltip(nil, false)
...
function PaGlobal_Quest_MoveSnapToDetail()
  local self = Window_QuestInfo
  local firstSlot = self._ui._baseRewardControl[0]
  if nil ~= firstSlot and firstSlot:GetShow() then
    ToClient_padSnapChangeToTarget(firstSlot)
  end
end
