...
function LocalWarInfo_Initionalize()
  ...
  self._txtRule:SetTextMode(__eTextMode_AutoWrap)
  self._txtReward:SetTextMode(__eTextMode_AutoWrap)
  self._txtInfo:SetTextMode(__eTextMode_AutoWrap)
...
function LocalWarInfo_ESCMenuFunc()
