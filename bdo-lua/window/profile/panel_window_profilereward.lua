...
function ProfileReward:Init()
  ...
  control._period:SetTextMode(__eTextMode_AutoWrap)
  control._desc:SetTextMode(__eTextMode_AutoWrap)
...
function ProfileReward:registEvent()
  ...
  self._control._list2Profile:registEvent(__ePAUIList2EventType_LuaChangeContent, "ProfileReward_DataSet")
  self._control._list2Profile:createChildContent(__ePAUIList2ElementManagerType_List)
end
