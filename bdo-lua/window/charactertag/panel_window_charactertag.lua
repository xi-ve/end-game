...
function CharacterTag:Initialize()
  ...
  selfUI._CheckButton_PopUp:SetShow(_ContentsGroup_PopUp)
  ...
  selfUI._StaticText_Desc:SetTextMode(__eTextMode_AutoWrap)
  ...
  for index = 0, 5 do
    selfUI._Static_CharacterList[index] = UI.createControl(__ePAUIControl_Static, Panel_CharacterTag, "Static_CharacterList_" .. index)
    CopyBaseProperty(templateCharacterList, selfUI._Static_CharacterList[index])
    local Static_Image = UI.createControl(__ePAUIControl_Static, selfUI._Static_CharacterList[index], "Static_Image")
    CopyBaseProperty(templateImage, Static_Image)
    local StaticText_State = UI.createControl(__ePAUIControl_StaticText, selfUI._Static_CharacterList[index], "StaticText_State")
    CopyBaseProperty(templateState, StaticText_State)
    local StaticText_Level = UI.createControl(__ePAUIControl_StaticText, selfUI._Static_CharacterList[index], "StaticText_Level")
    CopyBaseProperty(templateLevel, StaticText_Level)
    local Static_EXP = UI.createControl(__ePAUIControl_Static, selfUI._Static_CharacterList[index], "Static_EXP")
    CopyBaseProperty(templateExpImg, Static_EXP)
    local Static_BG = UI.createControl(__ePAUIControl_Static, selfUI._Static_CharacterList[index], "Static_BG")
  ...
  selfUI._StaticText_EventDesc:SetShow(false)
...
function CharacterTag:SetLeftFace(idx, isRegionKey)
  ...
  local isCaptureExist = self._UI._Static_MainImage_1:ChangeTextureInfoNameNotDDS(char_TextureName, char_Type, isExitPhoto)
...
function CharacterTag:SetRightFace(idx)
  ...
  local isCaptureExist = self._UI._Static_MainImage_2:ChangeTextureInfoNameNotDDS(char_TextureName, char_Type, isExitPhoto)
  if true == isCaptureExist then
