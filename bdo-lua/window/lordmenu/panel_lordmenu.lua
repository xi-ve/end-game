...
local function Panel_LordMenu_Initialize()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(ui_Main._buttonQuestion, "\"PanelLordMenu\"")
...
function Panel_LordMenu_TerInfoUpdate()
  ...
  ui_Ter._txt_TerrHelp:SetTextMode(__eTextMode_AutoWrap)
  ui_Ter._happy_Help:SetTextMode(__eTextMode_AutoWrap)
...
function Panel_LordMenu_PayInfoUpdate()
  ...
  for ii = 0, territorysInNationalCount - 1 do
    ...
    if 3 == territoryKeyInNational or 4 == territoryKeyInNational then
      ...
      ui_Pay._txt_Balance_Help:SetTextMode(__eTextMode_AutoWrap)
      ui_Pay._txt_Balance_Help:SetText("")
      ui_Main._txt_Desc:SetTextMode(__eTextMode_AutoWrap)
  ...
  ui_Pay._txt_TaxNow_Help:SetTextMode(__eTextMode_AutoWrap)
  ui_Pay._txt_TaxBef_Help:SetTextMode(__eTextMode_AutoWrap)
  ui_Pay._tax_Help:SetTextMode(__eTextMode_AutoWrap)
...
function Panel_LordMenu_TaxInfoUpdate()
  ...
  ui_Tax._txt_TransferTax_Help:SetTextMode(__eTextMode_AutoWrap)
  ui_Tax._txt_DutyTax_Help:SetTextMode(__eTextMode_AutoWrap)
