    ...
    if ii < reviveListCount then
      ...
      if nil ~= buildingInfo then
        ...
        if nil ~= regionInfo then
          ...
          if 100000 < fortressToPlayerDistance then
...
function PaGlobalFunc_DeadMessage_Update(deltaTime)
  ...
  if 0 < ResurrectionTime then
    ...
    _button_GuildObserverMode:SetShow(isObserverButtonShow)
    ...
    _button_ObserverMode:SetShow(isObserverButtonShow)
    _regenTime:SetShow(false)
  end
end
