...
function CashRevivalBuy:Update()
  ...
  for itemIdx = 0, CashRevivalDataCount - 1 do
    if nil == self.ItemUiPOOL[itemIdx] then
      local tempSlot = {}
      local CreateItemBG = UI.createControl(__ePAUIControl_Static, Panel_Cash_Revival_BuyItem, "CashRevivalBuy_ItemBG_" .. itemIdx)
      ...
      local CreateItemNameBG = UI.createControl(__ePAUIControl_Static, CreateItemBG, "CashRevivalBuy_ItemNameBG_" .. itemIdx)
      ...
      local CreateItemSelectBTN = UI.createControl(__ePAUIControl_RadioButton, CreateItemBG, "CashRevivalBuy_ItemSelectBTN_" .. itemIdx)
      ...
      local CreateItemName = UI.createControl(__ePAUIControl_StaticText, CreateItemBG, "CashRevivalBuy_ItemName_" .. itemIdx)
      ...
      local CreateItemPeriod = UI.createControl(__ePAUIControl_StaticText, CreateItemBG, "CashRevivalBuy_ItemPeriod_" .. itemIdx)
      ...
      local CreatePearlIcon = UI.createControl(__ePAUIControl_Static, CreateItemBG, "CashRevivalBuy_PearlIcon_" .. itemIdx)
      ...
      local CreateItemPrice = UI.createControl(__ePAUIControl_StaticText, CreateItemBG, "CashRevivalBuy_ItemPrice_" .. itemIdx)
  ...
  self.bg:SetSize(self.bg:GetSizeX(), self.bg_notify:GetSizeY() + 15 + (self.ItemListRow + 1) * (TemplateBuyPanelUI.ItemBG:GetSizeY() + 6))
end
function CashRevivalBuy_SetPosition()
  local self = CashRevivalBuy
  local scrSizeX = getScreenSizeX()
  local scrSizeY = getScreenSizeY()
  Panel_Cash_Revival_BuyItem:SetSize(Panel_Cash_Revival_BuyItem:GetSizeX(), self.bg:GetSizeY() + 102)
