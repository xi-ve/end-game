...
function Panel_NumberPad_SetMaxCount()
  if _ContentsGroup_NewUI_WareHouse_All then
    Panel_NumberPad_Show_MaxCount(true, numberPad.s64_moneyMaxNumber, slotNo, PaGlobal_Warehouse_All_PushFromInventoryItemXXX, nil, whereType)
  else
...
function numberPad:checkConfirmEnable()
  return Defines.s64_const.s64_0 < tonumber64(tostring(self.s64_inputNumber))
end
