...
function PaGlobal_Achievement_BookShelf:initialize()
  ...
  PaGlobal_Achievement_BookShelf._ui._stctxt_bookShelfDesc:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_Achievement_BookShelf:setBookShelf()
  ...
  for index = 1, nowJournalMaxKey * PaGlobal_Achievement_BookShelf._BOOK_AREA_CNT do
    ...
    if index <= PaGlobal_Achievement_BookShelf._journalGroupCnt then
      while true do
        if nil ~= ToClient_GetJournalName(callindex) or callindex > PaGlobal_Achievement_BookShelf._MAX_CALLING_COUNT then
          break
        end
        callindex = callindex + 1
      end
    end
    stctxt_bookArea_bookCondition:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_Achievement_BookShelf:registEventHandler()
  ...
  PaGlobal_Achievement_BookShelf._ui._list2_bookChapterList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_Achievement_BookShelf_BookChapterListCreate")
  PaGlobal_Achievement_BookShelf._ui._list2_bookChapterList:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PaGlobal_Achievement_BookShelf:chapterSelect(chapterIndex)
  ...
  if nil ~= PaGlobalFunc_Achievement_Open_From_BookShelf then
    PaGlobal_Achievement_BookShelf._selectedJournalChapter = chapterIndex
...
function PaGlobal_Achievement_BookShelf_GetBookInfoForBookmark()
  return PaGlobal_Achievement_BookShelf._selectedJournalGroup, PaGlobal_Achievement_BookShelf._selectedJournalChapter
end
