...
function MarketPlaceSelectList:createControl()
  ...
  self._ui._list2_SelectThing:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_MarketPlaceSelectList_List2CreateControl")
...
function PaGlobalFunc_MarketPlaceSelectList_Open(selectListType, standardPrice_s64, startIndex, endIndex)
  if false == (0 <= selectListType and selectListType < 3) then
    return
  end
  local self = MarketPlaceSelectList
