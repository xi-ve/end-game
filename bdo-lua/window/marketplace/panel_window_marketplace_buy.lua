...
function FromClient_responseBuyItemToWorldMarket(mySilver)
  ...
  ToClient_requestGetBiddingList(ItemEnchantKey(self._itemKey, self._itemMinLevel), true, PaGlobalFunc_ItemMarket_isHotCategory())
end
...
function HandleLClick_MarketPlace_CountButton(type, isPlus)
  ...
  if 1 == type then
    ...
    if 0 < resultValue and resultValue <= Int64toInt32(self._maxItemCount_s64) then
