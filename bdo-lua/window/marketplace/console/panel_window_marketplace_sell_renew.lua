...
function MarketPlaceSell:createControl()
  ...
  self._config._defaultRingBuffSpanY = self._ui._selectRingBuffBg:GetSpanSize().y
...
function MarketPlaceSell:setPanelSize()
  ...
  if true == self._ui._selectRingBuffBg:GetShow() then
    startSizeY = startSizeY + 55
    if false == self._ui._selectItemCountBg:GetShow() then
      self._ui._selectRingBuffBg:SetSpanSize(self._ui._selectRingBuffBg:GetSpanSize().x, self._ui._selectItemCountBg:GetSpanSize().y)
    else
      self._ui._selectRingBuffBg:SetSpanSize(self._ui._selectRingBuffBg:GetSpanSize().x, self._config._defaultRingBuffSpanY)
    end
  end
