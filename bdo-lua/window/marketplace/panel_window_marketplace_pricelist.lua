...
function MarketPlacePriceList:updateList()
  ...
  for ii = 0, size - 1 do
    ...
    if 0 < sellCount and (price_s64 < self._lowestSellBiddingPrice or toInt64(0, 0) == self._lowestSellBiddingPrice) then
      self._lowestSellBiddingPrice = price_s64
      self._lowestSellBiddingIndex = ii
    end
    if 0 < buyCount and (price_s64 > self._highestBuyBiddingPirce or toInt64(0, 0) == self._highestBuyBiddingPirce) then
