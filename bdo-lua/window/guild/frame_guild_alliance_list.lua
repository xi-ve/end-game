...
function PaGlobal_GuildAllianceList:initialize()
  if nil == Panel_Guild_Alliance_List then
    return
  end
  self._ui_main = {
  ...
  self._ui_main._guildAllianceMember_Title:SetTextMode(__eTextMode_LimitText)
  ...
  listMember:registEvent(__ePAUIList2EventType_LuaChangeContent, "FGlobal_GuildAllianceMember_ListUpdate")
  listMember:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  self._ui_info._occupyingArea:SetTextMode(__eTextMode_LimitText)
  local listGuild = self._ui_info._guild_list2
  listGuild:changeAnimationSpeed(10)
  listGuild:registEvent(__ePAUIList2EventType_LuaChangeContent, "FGlobal_GuildAllianceGuild_ListUpdate")
  listGuild:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui_info._buttonShowAll:addInputEvent("Mouse_LUp", "HandleClicked_GuildAllianceList_ShowAll()")
  self._ui_info._Web = UI.createControl(__ePAUIControl_WebControl, self._ui_main._todayBoard, "WebControl_Alliance_WebLink")
...
function PaGlobal_GuildAllianceList_Initialize()
  PaGlobal_GuildAllianceList:initialize()
end
