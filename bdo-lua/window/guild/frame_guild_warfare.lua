...
function GuildWarfareInfoPage:initialize()
  ...
  function createWarfareInfo(pIndex)
    ...
    rtGuildWarfareInfo._txtCharName = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_CharName_" .. pIndex)
    rtGuildWarfareInfo._txtTower = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_Tower_" .. pIndex)
    rtGuildWarfareInfo._txtCommandCenter = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_CommandCenter_" .. pIndex)
    rtGuildWarfareInfo._txtCastleGate = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_CastleGate_" .. pIndex)
    rtGuildWarfareInfo._txtHelp = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_Help_" .. pIndex)
    rtGuildWarfareInfo._txtSummons = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_Summons_" .. pIndex)
    rtGuildWarfareInfo._txtInstallation = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_Installation_" .. pIndex)
    rtGuildWarfareInfo._txtMaster = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_Master_" .. pIndex)
    rtGuildWarfareInfo._txtCommander = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_Commander_" .. pIndex)
    rtGuildWarfareInfo._txtMember = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_Member_" .. pIndex)
    rtGuildWarfareInfo._txtDeath = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_Death_" .. pIndex)
    rtGuildWarfareInfo._txtKillBySiege = UI.createControl(__ePAUIControl_StaticText, self._ui._content_Warfare, "StaticText_C_KillBySiege_" .. pIndex)
