...
function GuildQuestInfoPage:initialize()
  ...
  self._txtProgressDesc = UI.getChildControl(Panel_Guild_Quest, "StaticText_Pro_Desc")
  ...
  self._txtProgresshelpAccept = UI.getChildControl(Panel_Guild_Quest, "StaticText_helpAccept")
  self._questCompleteAlert = UI.getChildControl(Panel_Guild_Quest, "StaticText_GuildQuestCompleteAlert")
  ...
  self._btnPreocc = UI.getChildControl(Panel_Guild_Quest, "Button_List_Preocc")
  self._btnWide = UI.getChildControl(Panel_Guild_Quest, "Button_List_Wide")
  self._btnPreoccInfo = UI.getChildControl(Panel_Guild_Quest, "Button_List_PreoccInfo")
  ...
  for index = 0, self._constCurrentGuildQuestMaxCount - 1 do
    self._txtProgressQuestCondition[index] = UI.createControl(__ePAUIControl_StaticText, Panel_Guild_Quest, "StaticText_Pro_Count_" .. index)
    ...
    self._txtProgressQuestCondition[index]:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._btnPreocc:SetTextMode(__eTextMode_LimitText)
  self._btnWide:SetTextMode(__eTextMode_LimitText)
  self._btnPreoccInfo:SetTextMode(__eTextMode_LimitText)
  ...
  self._questCompleteAlert:SetTextMode(__eTextMode_AutoWrap)
  ...
  function createQuestListInfo(pIndex)
    ...
    rtGuildQuestListInfo._list_BG = UI.createControl(__ePAUIControl_Static, questList_BG, "Static_List_BG_" .. pIndex)
    rtGuildQuestListInfo._list_Title = UI.createControl(__ePAUIControl_StaticText, rtGuildQuestListInfo._list_BG, "StaticText_C_List_Title_" .. pIndex)
    rtGuildQuestListInfo._list_Desc = UI.createControl(__ePAUIControl_StaticText, rtGuildQuestListInfo._list_BG, "StaticText_C_List_Desc_" .. pIndex)
    rtGuildQuestListInfo._list_Time = UI.createControl(__ePAUIControl_StaticText, rtGuildQuestListInfo._list_BG, "StaticText_C_List_Time_" .. pIndex)
    rtGuildQuestListInfo._list_Gold = UI.createControl(__ePAUIControl_StaticText, rtGuildQuestListInfo._list_BG, "StaticText_C_List_Gold_" .. pIndex)
    rtGuildQuestListInfo._list_AcceptBtn = UI.createControl(__ePAUIControl_Button, rtGuildQuestListInfo._list_BG, "Button_List_C_Accept_" .. pIndex)
    rtGuildQuestListInfo._list_RewardBtn = UI.createControl(__ePAUIControl_Button, rtGuildQuestListInfo._list_BG, "Button_Reward_" .. pIndex)
    rtGuildQuestListInfo._list_QuestIcon = UI.createControl(__ePAUIControl_Static, rtGuildQuestListInfo._list_BG, "Static_QuestIcon_" .. pIndex)
    rtGuildQuestListInfo._list_QuestIconBG = UI.createControl(__ePAUIControl_Static, rtGuildQuestListInfo._list_BG, "Static_IconBackground_" .. pIndex)
    ...
    rtGuildQuestListInfo._list_Title:SetTextMode(__eTextMode_LimitText)
    ...
    rtGuildQuestListInfo._list_Desc:SetTextMode(__eTextMode_Limit_AutoWrap)
  ...
  self._txtProgressQuestName:SetTextMode(__eTextMode_LimitText)
  self._txtProgressDesc:SetLineCount(3)
  self._txtProgressDesc:SetTextMode(__eTextMode_Limit_AutoWrap)
...
function GuildQuestInfoPage:UpdateData()
  ...
  if true == boolProgressing then
    ...
    if ToClient_isGuildQuestOtherServer() then
      ...
      self._txtProgresshelpAccept:SetTextMode(__eTextMode_AutoWrap)
