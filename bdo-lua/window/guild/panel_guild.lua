...
function GuildInfoPage:initialize()
  ...
  self._txtGuildTerritoryValue:SetTextMode(__eTextMode_LimitText)
  self._btnEvacuation = UI.getChildControl(Panel_Window_Guild, "Button_Evacuation")
  self._stcWarHPSet = UI.getChildControl(self._area_Info, "Static_WarHPSet")
  ...
  self._txtGuildServantValue:SetTextMode(__eTextMode_LimitText)
  ...
  self._btnGuildJoinRequestRegist = UI.getChildControl(self._area_Info, "Button_GuildJoinRequestRegist")
  ...
  self._Web = UI.createControl(__ePAUIControl_WebControl, self._area_TodayComment, "WebControl_TodayComment")
  ...
  if true == _ContentsGroup_MajorSiege_AddMaxHp then
    self._stcWarHPSet:SetShow(true)
  end
  ...
  if true == _ContentsGroup_Guild_JoinRequest then
    self._btnGuildJoinRequestRegist:addInputEvent("Mouse_LUp", "PaGlobal_GuildJoinRequestSet:open()")
    self._btnGuildJoinRequestRegist:addInputEvent("Mouse_On", "GuildSimplTooltips( true, 18 )")
    self._btnGuildJoinRequestRegist:addInputEvent("Mouse_Out", "GuildSimplTooltips( false, 18 )")
  end
  if true == _ContentsGroup_MajorSiege_AddMaxHp then
    self._stcWarHPSet:addInputEvent("Mouse_On", "GuildSimplTooltips( true, 19 )")
    self._stcWarHPSet:addInputEvent("Mouse_Out", "GuildSimplTooltips( false, 19 )")
  end
...
function FromClient_updateMajorSiegeHpStack(guildNo, hpStack)
  if nil == Panel_Window_Guild then
    return
  end
end
...
function GuildInfoPage:UpdateData()
  ...
  if myGuildInfo ~= nil then
    ...
    self._stcWarHPSet:SetPosX(self._txtGuildTerritoryValue:GetSpanSize().x + self._txtGuildTerritoryValue:GetTextSizeX() + 10)
...
function GuildLetsWarPage:initialize()
  ...
  self:SetShow(false)
  self._txtLetsWarHelp:SetTextMode(__eTextMode_AutoWrap)
...
function GuildWarInfoPage:initialize()
  ...
  self._list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_GuildWarInfo_List2Event")
  self._list2:createChildContent(__ePAUIList2ElementManagerType_List)
  self._list2_2:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_GuildWarInfo2_List2Event")
  self._list2_2:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PaGlobal_GuildWarInfo_List2Event(contents, key)
  ...
  self._txtNoWar:SetTextMode(__eTextMode_AutoWrap)
...
function GuildManager:initialize()
  ...
  self.mainBtn_BossSpawn = UI.getChildControl(Panel_Window_Guild, "Button_Tab_BossSummon")
  ...
  self._buttonRefresh = UI.getChildControl(Panel_Window_Guild, "Button_Refresh")
  ...
  self.mainBtn_BossSpawn:addInputEvent("Mouse_LUp", "GuildManager:TabToggle( 12 )")
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"PanelGuild\"")
  PaGlobal_Util_RegistWebResetControl(self._buttonRefresh)
  self._buttonRefresh:SetShow(_ContentsGroup_ResetCoherent)
  ...
  self.mainBtn_BossSpawn:addInputEvent("Mouse_On", "Panel_Guild_Tab_ToolTip_Func( 17, true )")
  ...
  self.mainBtn_BossSpawn:addInputEvent("Mouse_Out", "Panel_Guild_Tab_ToolTip_Func( 17, false )")
  ...
  if true == _ContentsGroup_BossSpawn then
    self.mainBtn_BossSpawn:SetShow(true)
  else
    self.mainBtn_BossSpawn:SetShow(false)
  end
  ...
  guildManagerButtonPositionList[12] = self.mainBtn_BossSpawn:GetPosX()
...
function Panel_Guild_Tab_ToolTip_Func(tabNo, isOn, inPut_index, isLeft)
  ...
  if true == isOn then
    ...
    elseif 16 == tabNo then
      ...
      desc = nil
    elseif 17 == tabNo then
      uiControl = GuildManager.mainBtn_BossSpawn
      name = PAGetString(Defines.StringSheet_GAME, "LUA_NEW_GUILDRAID_SUMMON")
      desc = nil
...
function GuildSimplTooltips(isShow, tipType)
  ...
  elseif 18 == tipType then
    ...
    control = GuildInfoPage._btnGuildJoinRequestRegist
  elseif 19 == tipType then
    ...
    control = GuildInfoPage._stcWarHPSet
  end
...
function GuildManager:TabToggle(index)
  ...
  if 10 == index then
    ...
    if true ~= _isGuildAllianceMember then
      ...
      self.mainBtn_BossSpawn:SetCheck(12 == tabNumber)
      return
    end
  end
  tabNumber = 99
  ...
  self.mainBtn_BossSpawn:SetCheck(12 == index)
  ...
  PaGlobal_GuildBossSpawn:close()
  if true == _ContentsGroup_Guild_JoinRequest then
    PaGlobal_GuildJoinRequestList:close()
  end
  if 0 == index then
  ...
  elseif 5 == index then
    ...
    GuildMainInfo_Hide()
    if true == _ContentsGroup_Guild_JoinRequest then
      PaGlobal_GuildJoinRequestList:open()
    else
...
function GuildManager:Hide()
  ...
  if true == _ContentsGroup_NewUI_Guild_All then
    PaGlobalFunc_GuildUseFund_All_ShowToggle(nil, false)
  else
...
function GuildManager:Show()
  ...
  if false == GuildInfoPage:getShowPanel() then
    ...
    if _isGuildAllianceMember then
      ...
      self.mainBtn_BossSpawn:SetPosX(guildManagerButtonPositionList[12])
    else
      ...
      self.mainBtn_BossSpawn:ComputePos()
    ...
    if isDeadInWatchingMode() and false == isDeadMessageOpen then
      ...
      self.mainBtn_GuildAllianceList:SetCheck(false)
      self.mainBtn_BossSpawn:SetCheck(false)
      ...
      self.mainBtn_BossSpawn:SetIgnore(true)
      ...
      self.mainBtn_BossSpawn:SetMonoTone(true)
...
function GuildMainInfo_Show()
  ...
  self._btnGuildJoinRequestRegist:SetShow(false)
  if true == _ContentsGroup_Guild_JoinRequest and (isGuildMaster or isGuildSubMaster) then
    self._btnGuildJoinRequestRegist:SetShow(true)
  end
  if nil ~= guildCommentsWebUrl then
    self._Web:SetShow(true)
  end
...
function GuildMainInfo_Hide()
  ...
  if true == _ContentsGroup_Guild_JoinRequest then
    GuildInfoPage._btnGuildJoinRequestRegist:SetShow(false)
  end
...
function FromClient_ResponseGuildUpdate()
  ...
  elseif true == _ContentsGroup_NewUI_Guild_All then
    if true == Panel_Window_ClanList_All:GetShow() then
