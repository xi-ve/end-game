...
function GuildSkillList:registEvent()
  self._ui.list_Skill:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_GuildSkill_CreateControl")
  self._ui.list_Skill:createChildContent(__ePAUIList2ElementManagerType_List)
end
...
function GuildSkillList:makeSlotData(skillSlot, skillNo, isActiveSkill, pointingLink)
  ...
  skillSlot.effect:SetTextMode(__eTextMode_Limit_AutoWrap)
...
function PaGlobalFunc_GuildSkill_CreateControl(content, key)
  ...
  elseif 0 < skillIdx and skillIdx < self._keyIdentifier then
