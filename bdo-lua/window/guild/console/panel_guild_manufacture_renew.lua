PaGlobal_Guild_Manufacture = {
  _ui = {
    _guildBG = UI.getChildControl(Panel_Window_Guild, "Static_Frame_GuildManufactureBG"),
    _baseNoneStateBG = UI.getChildControl(Panel_Guild_Manufacture, "Static_NoneState"),
    _baseProceedingStateBG = UI.getChildControl(Panel_Guild_Manufacture, "Static_ProceedingState"),
    _baseReadyStateBG = UI.getChildControl(Panel_Guild_Manufacture, "Static_ReadyState"),
    _baseCompleteStateBG = UI.getChildControl(Panel_Guild_Manufacture, "Static_CompleteState"),
    _baseProductSlot = UI.getChildControl(Panel_Guild_Manufacture, "Static_Result_IconBG")
  },
  _slotConfig = {
    createIcon = true,
    createBorder = true,
...
function PaGlobal_Guild_Manufacture:registEventHandler()
...
function PaGlobal_Guild_Manufacture:createControl()
  ...
  for ii = 0, __eGuildManufactureProductItemCount - 1 do
    ...
    tempProductSlot_0.bg = UI.createControl(__ePAUIControl_Static, noneSlot._backGround, "ProductItemBG_0_" .. ii)
    ...
    tempProductSlot_1.bg = UI.createControl(__ePAUIControl_Static, proceedingSlot._backGround, "ProductItemBG_1_" .. ii)
    ...
    tempProductSlot_2.bg = UI.createControl(__ePAUIControl_Static, readySlot._backGround, "ProductItemBG_2_" .. ii)
    ...
    tempProductSlot_3.bg = UI.createControl(__ePAUIControl_Static, completeSlot._backGround, "ProductItemBG_3_" .. ii)
  ...
  Panel_Guild_Manufacture:SetShow(false)
...
function PaGlobal_Guild_Manufacture:set(index)
  ...
  if true == Panel_Guild_ManufactureSelect:GetShow() then
    PaGlobal_Guild_ManufactureSelect:close()
  end
end
