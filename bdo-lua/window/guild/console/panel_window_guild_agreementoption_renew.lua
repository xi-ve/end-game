...
function PaGlobalFunc_AgreementGuild_SignOption_DailyPayEditClick()
  ...
  Panel_NumberPad_Show(true, toInt64(0, maxBenefit), nil, PaGlobalFunc_AgreementGuild_SignOption_DailyPayComfirm, nil, nil, nil, nil, nil)
...
function PaGlobalFunc_AgreementGuild_SignOption_PenaltyEditClick()
  ...
  Panel_NumberPad_Show(true, toInt64(0, maxpenalty), param, PaGlobalFunc_AgreementGuild_SignOption_PenaltyComfirm, nil, nil, nil, nil, nil)
  Panel_NumberPad_SetType("Guild_AgreementOption")
end
