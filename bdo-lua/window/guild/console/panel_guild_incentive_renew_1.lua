function PaGlobal_GuildIncentive:initialize()
  ...
  txt_fundationDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  txt_optionDesc:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_GuildIncentive:registEventHandler()
  ...
  PaGlobal_GuildIncentive._ui._list2_guildMember:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_GuildIncentive_addGuildMemberContent")
  PaGlobal_GuildIncentive._ui._list2_guildMember:createChildContent(__ePAUIList2ElementManagerType_List)
...
function PaGlobal_GuildIncentiveTier_Show()
  ...
  if PaGlobal_GuildIncentive._isIndividualSetting then
    ...
    stc_Caution:SetTextMode(__eTextMode_AutoWrap)
