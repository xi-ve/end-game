...
function GuildQuestList:registEvent()
  self._ui.list_questList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_GuildQuestList_CreateQuest")
  self._ui.list_questList:createChildContent(__ePAUIList2ElementManagerType_List)
