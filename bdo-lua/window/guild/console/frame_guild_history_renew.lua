...
for index = 0, 11 do
  ...
  monthIndex[index] = {}
  monthIndex[index] = UI.createControl(__ePAUIControl_RadioButton, Panel_Guild_Journal, "RadioButton_Month_" .. index + 1)
...
function guild_helpWidget_Create()
  ...
  helpWidget = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "HelpWindow_For_GuildHistory")
  ...
  for dayIndex = currentValue._day, 1, -1 do
    ...
    for i = _listCount - 1, 0, -1 do
      ...
      if nil ~= _journalInfo[i] and dayIndex == _journalInfo[i]:getJournalDay() then
        ...
        if 1 == dayLogCount % 2 then
          local _dayHistoryLeftValue = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "StaticText_GuildHistory_" .. i)
          ...
          local _dayHistoryRightValue = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "StaticText_GuildHistory_" .. i)
