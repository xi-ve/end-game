...
function PaGlobal_Guild_InvitationGuildAlliance:initialize()
  ...
  self._ui.frame_Summary:SetTextMode(__eTextMode_AutoWrap)
  ...
  for ii = 0, 9 do
    if nil == self._ui.guildName[ii] then
      self._ui.guildName[ii] = UI.createControl(__ePAUIControl_StaticText, self._ui.frame2_List, "StaticText_InvitiationGuildName" .. ii)
    ...
    if nil == self._ui.guildLimitMemberCount[ii] then
      self._ui.guildLimitMemberCount[ii] = UI.createControl(__ePAUIControl_StaticText, self._ui.frame2_List, "StaticText_InvitiationGuildLimitMemberCount" .. ii)
    ...
    if nil == self._ui.guildtaxRate[ii] then
      self._ui.guildtaxRate[ii] = UI.createControl(__ePAUIControl_StaticText, self._ui.frame2_List, "StaticText_InvitiationGuildTaxRate" .. ii)
