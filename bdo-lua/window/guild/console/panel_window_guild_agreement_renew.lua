local Window_GuildAgreementInfo = {
  _ui = {
    _frame_ContentBG = UI.getChildControl(Panel_Console_Window_GuildAgreement, "Frame_Detail"),
    _scroll_FrameVertical = nil,
    _static_AgreementContentBg = nil,
    _staticText_Content = nil,
...
function Window_GuildAgreementInfo:InitControl()
  self._ui._scroll_FrameVertical = UI.getChildControl(self._ui._frame_ContentBG, "Frame_1_VerticalScroll")
  self._ui._static_AgreementContentBg = UI.getChildControl(self._ui._frame_ContentBG, "Frame_1_Content")
  self._ui._staticText_Content = UI.getChildControl(self._ui._static_AgreementContentBg, "StaticText_Content")
  self._ui._staticText_Content:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui._frame_ContentBG:UpdateContentPos()
  self._ui._frame_ContentBG:UpdateContentScroll()
  self._ui._frame_ContentBG:ComputePos()
end
...
function PaGlobalFunc_AgreementGuild_Master_ContractOpen(memberIndex, requesterMemberGrade, usableActivity)
  ...
  self._ui._staticText_ToValue:SetTextMode(__eTextMode_LimitText)
  self._ui._staticText_ToValue:SetText(name)
  self._ui._staticText_FromValue:SetTextMode(__eTextMode_LimitText)
