...
function PaGlobal_Guild_AllianceInfo:InviteListCreate()
  ...
  for ii = 1, 9 do
    ...
    self._inviteUi.inputUi.guildBGUi[ii] = UI.createControl(__ePAUIControl_Static, self._inviteUi.frame1_List, "StaticText_GuildBG" .. ii)
    ...
    self._inviteUi.inputUi.guildNameUi[ii] = UI.createControl(__ePAUIControl_Edit, self._inviteUi.frame1_List, "StaticText_GuildName" .. ii)
    ...
    self._inviteUi.inputUi.guildMemeberCountUi[ii] = UI.createControl(__ePAUIControl_StaticText, self._inviteUi.frame1_List, "StaticText_GuildMemberCount" .. ii)
    ...
    self._inviteUi.inputUi.taxConstRateUi[ii] = UI.createControl(__ePAUIControl_StaticText, self._inviteUi.frame1_List, "StaticText_TaxConstRate" .. ii)
...
function PaGlobal_Guild_AllianceInfo:gulidalliance_CautionInitialize()
  ...
  self.gulidalliance_Caution:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_Guild_AllianceInfo:InfoInitialize()
  ...
  self._infoUi.editAllianceNoticeUi:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_Guild_AllianceInfo:InfoInitialize_Load()
  ...
  for ii = 0, 9 do
    self._infoUi.guildAllianceMaster[ii] = UI.createControl(__ePAUIControl_Static, self._mainUi.allianceInfoBg, "StaticText_InfoGuildMasterIcon_" .. ii)
    ...
    self._infoUi.guildName[ii] = UI.createControl(__ePAUIControl_StaticText, self._mainUi.allianceInfoBg, "StaticText_InfoGuildName" .. ii)
    ...
    self._infoUi.guildMemberCount[ii] = UI.createControl(__ePAUIControl_StaticText, self._mainUi.allianceInfoBg, "StaticText_InfoGuildMemberCount" .. ii)
    ...
    self._infoUi.guildtaxConst[ii] = UI.createControl(__ePAUIControl_StaticText, self._mainUi.allianceInfoBg, "StaticText_InfoGuildTaxConst" .. ii)
...
function FromClient_luaLoadComplete_Panel_Guild_AllianceInfo()
  local self = PaGlobal_Guild_AllianceInfo
  self:InviteInitialize_Load()
  self:InfoInitialize_Load()
  self:OpenGuildAlliance()
