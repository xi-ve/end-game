PaGlobal_Guild_ManufactureSelect = {
  _ui = {
    _closeButton = UI.getChildControl(Panel_Guild_ManufactureSelect, "Button_Close"),
    _staticBG = UI.getChildControl(Panel_Guild_ManufactureSelect, "Static_BG"),
    _baseSlot = UI.getChildControl(Panel_Guild_ManufactureSelect, "Static_Slot"),
    _notice = UI.getChildControl(Panel_Guild_ManufactureSelect, "StaticText_Notice")
  },
  _config = {
    _col = 6,
    _startPosX = 10,
...
function PaGlobal_Guild_ManufactureSelect:initialize()
  self._ui._notice:SetTextMode(__eTextMode_AutoWrap)
  ...
  for ii = 0, #productEnchantKeyList do
    ...
    if nil ~= manufactureStatic then
      local slot = {}
      slot.bg = UI.createControl(__ePAUIControl_Static, self._ui._staticBG, "ProductItemBG_" .. ii)
...
function PaGlobal_Guild_ManufactureSelect:open(index)
  if true == Panel_Guild_ManufactureSelect:IsShow() then
    return
  end
  self._index = index
  local productEnchantKeyList = ToClient_Guild_Manufacture_ProductItemEnchantKeyList()
