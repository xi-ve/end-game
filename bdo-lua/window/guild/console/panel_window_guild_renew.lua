...
function GuildMain:openTab(tabIdx_)
  ...
  self._ui.txt_LTConsoleUI:SetShow(false)
  ...
  elseif tabIdx_ == self._tabIdxData.guildMember then
    ...
    self._ui.txt_YConsoleUI:SetShow(true)
    self._ui.txt_LTConsoleUI:SetShow(true)
    _panel:registerPadEvent(__eConsoleUIPadEvent_Up_Y, "PaGlobalFunc_GuildMemberList_SwapFamilyOrCharacterName()")
    _panel:registerPadEvent(__eConsoleUIPadEvent_LT, "PaGlobal_GuildWarfareDesc_Open()")
...
function GuildMain:init()
  ...
  self._btnCtrl[self._tabIdxData.guildMember]:SetTextMode(__eTextMode_AutoWrap)
  ...
  if self._ui.txt_ProtectValue:GetPosX() < self._ui.txt_Protect:GetSpanSize().x + self._ui.txt_Protect:GetTextSizeX() + 10 then
  ...
  self._ui.txt_WarinfoValue:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.txt_GuildNotice:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.txt_GuildIntroduce:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.txt_LTConsoleUI = UI.getChildControl(self._ui.stc_BottomBg, "Button_LT_ConsoleUI")
  self._keyGuideList[self._keyGuideType.buttonLT] = self._ui.txt_LTConsoleUI
  self:registEvent()
end
...
function GuildMain:registEvent()
  ...
  self._ui.list_DeclareGuild:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_GuildMain_CreateDeclareGuild")
  self._ui.list_DeclareGuild:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui.list_DeclaredByGuild:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_GuildMain_CreateDeclaredByGuild")
  self._ui.list_DeclaredByGuild:createChildContent(__ePAUIList2ElementManagerType_List)
...
function FromClient_GuildMain_ResponseGuildUpdate(notifyType)
  ...
  if nil == notifyType or 10 ~= notifyType then
    PaGlobal_GuildMemberList_NotClearAndUpdate()
