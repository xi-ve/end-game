...
function _guildListInfoPage_MandateTooltipShow(isShow, titleType, controlIdx)
  ...
  if myGuildMemberInfo:isSelf() and 0 < memberIsGrade then
...
function GuildListInfoPage:registMessageHandler()
  if false == _ContentsGroup_RenewUI_Guild and false == _ContentsGroup_NewUI_Guild_All then
...
function HandleClick_GuildMemberList_Listening(index)
  ...
  if 0 < setVol_selectedMemberVol then
    checkVoiceChatListenOtherTexture(true)
  else
    checkVoiceChatListenOtherTexture(false)
  end
