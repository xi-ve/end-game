...
function Guild_Incentive:initialize()
  ...
  Guild_Incentive._desc:SetTextMode(__eTextMode_AutoWrap)
...
function Guild_Incentive:ResetControl()
  ...
  for i = 1, _memberCtrlCount do
    local index = i - 1
    _guildList[index] = {}
    _guildList[index]._memberGrade = UI.createControl(__ePAUIControl_StaticText, _contentGuildList, "StaticText_Grade_" .. i)
    _guildList[index]._memberName = UI.createControl(__ePAUIControl_StaticText, _contentGuildList, "StaticText_MemberName_" .. i)
    _guildList[index]._memberContribution = UI.createControl(__ePAUIControl_StaticText, _contentGuildList, "StaticText_MemberContribution_" .. i)
    _guildList[index]._memberIncentiveValue = UI.createControl(__ePAUIControl_StaticText, _contentGuildList, "StaticText_memberIncentiveValue_" .. i)
    _guildList[index]._comboboxRank = UI.createControl(__ePAUIControl_ComboBox, _contentGuildList, "Combobox_Rank_" .. i)
    _guildList[index]._radio_All = UI.createControl(__ePAUIControl_RadioButton, _contentGuildList, "Radiobutton_All_" .. i)
    _guildList[index]._radio_Personal = UI.createControl(__ePAUIControl_RadioButton, _contentGuildList, "Radiobutton_Personal_" .. i)
    _guildList[index]._btn_IncentiveLevel = UI.createControl(__ePAUIControl_StaticText, _contentGuildList, "Button_IncentiveLevel_" .. i)
...
function Guild_Incentive:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(Guild_Incentive._btnQuestion, "\"PanelGuild\"")
end
function guildIncentiveMoneyValue:initialize()
  ...
  guildIncentiveMoneyValue._txt_Desc:SetTextMode(__eTextMode_AutoWrap)
