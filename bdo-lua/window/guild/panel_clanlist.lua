...
PaGlobal_Util_RegistHelpTooltipEvent(clanList.btn_Question, "\"PanelClan\"")
local Template = {
...
function clanList:Initialize()
  self.btn_setSubMaster = UI.createControl(__ePAUIControl_Button, self.memberMenuBG, "ClanList_SetSubMaster_BTN")
  ...
  self.btn_kickClan = UI.createControl(__ePAUIControl_Button, self.memberMenuBG, "ClanList_KickClan_BTN")
  ...
  self.btn_unsetSubMaster = UI.createControl(__ePAUIControl_Button, self.memberMenuBG, "ClanList_UnsetSubMasterClan_BTN")
  ...
  for memberIdx = 0, self.maxMemberCount - 1 do
    local temSlot = {}
    local Created_MemberGrade = UI.createControl(__ePAUIControl_StaticText, self.frameContent, "ClanList_MemberGrade_" .. memberIdx)
    ...
    local Created_MemberLevel = UI.createControl(__ePAUIControl_StaticText, Created_MemberGrade, "ClanList_MemberLevel_" .. memberIdx)
    ...
    local Created_MemberClass = UI.createControl(__ePAUIControl_StaticText, Created_MemberGrade, "ClanList_MemberClass_" .. memberIdx)
    ...
    local Created_MemberName = UI.createControl(__ePAUIControl_StaticText, Created_MemberGrade, "ClanList_MemberName_" .. memberIdx)
