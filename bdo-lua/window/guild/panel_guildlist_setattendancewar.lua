...
function SetAttendanceWar:init()
  self._ui._pariticipantList2:registEvent(__ePAUIList2EventType_LuaChangeContent, "FGlobal_SiegeParticipant_List2EventControlCreate")
  self._ui._pariticipantList2:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui._nonPariticipantList2:registEvent(__ePAUIList2EventType_LuaChangeContent, "FGlobal_SiegeNonParticipant_List2EventControlCreate")
  self._ui._nonPariticipantList2:createChildContent(__ePAUIList2ElementManagerType_List)
...
function HandleClicked_SetAttendanceWar_SetParticipantToggle(index)
  ...
  if true == isparticipant and 5 <= count then
