...
function PaGlobal_GuildPanelLoad:setPanel(ePanelType, panel)
  ...
  elseif PaGlobal_GuildPanelLoad._eType._guildRecruitment == ePanelType then
    if false == _ContentsGroup_Guild_JoinRequest then
      ...
      Panel_Window_GuildJoinRequestList = panel
    end
  ...
  elseif PaGlobal_GuildPanelLoad._eType._guildBossSpawn == ePanelType then
    Panel_Window_GuildBossSpawn = panel
  end
end
function PaGlobal_GuildPanelLoad:getPanel(ePanelType)
  ...
  elseif PaGlobal_GuildPanelLoad._eType._guildRecruitment == ePanelType then
    if false == _ContentsGroup_Guild_JoinRequest then
      ...
      return Panel_Window_GuildJoinRequestList
    end
  elseif PaGlobal_GuildPanelLoad._eType._guildQuest == ePanelType then
  ...
  elseif PaGlobal_GuildPanelLoad._eType._guildBossSpawn == ePanelType then
    return Panel_Window_GuildBossSpawn
  end
  return nil
end
function PaGlobal_GuildPanelLoad:checkLoadUI(ePanelType)
  ...
  elseif PaGlobal_GuildPanelLoad._eType._guildRecruitment == ePanelType then
    if false == _ContentsGroup_Guild_JoinRequest then
      ...
      rv = reqLoadUI("UI_Data/Window/Guild/Panel_Guild_RequestList.XML", "Panel_Window_GuildJoinRequestList", Defines.UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({
        Defines.RenderMode.eRenderMode_Default
      }))
    end
  elseif PaGlobal_GuildPanelLoad._eType._guildQuest == ePanelType then
  ...
  elseif PaGlobal_GuildPanelLoad._eType._guildBossSpawn == ePanelType then
    rv = reqLoadUI("UI_Data/Window/Guild/Panel_Guild_BossSummon.XML", "Panel_Window_GuildBossSpawn", Defines.UIGroup.PAGameUIGroup_Windows, PAUIRenderModeBitSet({
      Defines.RenderMode.eRenderMode_Default
    }))
  end
  if nil ~= rv then
...
function PaGlobal_GuildPanelLoad:initialize(ePanelType)
  ...
  elseif PaGlobal_GuildPanelLoad._eType._guildRecruitment == ePanelType then
    if false == _ContentsGroup_Guild_JoinRequest then
      ...
      PaGlobal_GuildJoinRequestList:init()
    end
  elseif PaGlobal_GuildPanelLoad._eType._guildQuest == ePanelType then
