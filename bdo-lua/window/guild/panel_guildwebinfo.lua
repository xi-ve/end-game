...
local _btn_Refresh = UI.getChildControl(Panel_GuildWebInfo, "Button_Refresh")
local _Web
local isShowGuildWebInfo = false
local webSizeY = 630
function Panel_GuildWebInfo_Initialize()
  _Web = UI.createControl(__ePAUIControl_WebControl, Panel_GuildWebInfo, "WebControl_GuildWebInfo_WebLink")
  _Web:SetShow(true)
  _Web:SetPosX(33)
  _Web:SetPosY(68)
  ...
  registerEvent("FromClient_resetCoherentUI", "FromClient_resetCoherentUIForGuildWebInfo")
end
...
function FromClient_resetCoherentUIForGuildWebInfo()
  if Panel_GuildWebInfo:GetShow() then
    TooltipSimple_Hide()
    HandleClicked_GuildWebInfo_Close()
  end
end
