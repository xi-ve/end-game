...
function recommandName:init()
  uiStaticContentHelper:SetTextMode(__eTextMode_AutoWrap)
  uiStaticWarnning:SetTextMode(__eTextMode_AutoWrap)
  ...
  uiEditName:setXboxVirtualKeyBoardEndEvent("PaGlobal_RecommandName_VirtualKeyboardEnd")
...
function PaGlobal_RecommandName_VirtualKeyboardEnd(str)
  ClearFocusEdit()
  uiEditName:SetEditText(str)
end
...
FromClient_luaLoadComplete_RecommandNameInit()
SendMailForHelpInit()
