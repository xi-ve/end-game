...
elements.SelfPlayerNameTagVisible._radioButtonMapping = {
  [0] = {
    _string = "PANEL_NEWGAMEOPTION_SelfPlayerNameTagVisible_0"
  },
  [1] = {
    _string = "PANEL_NEWGAMEOPTION_SelfPlayerNameTagVisible_2"
  },
  [2] = {
    _string = "PANEL_NEWGAMEOPTION_SelfPlayerNameTagVisible_1"
  },
  _count = 3
}
