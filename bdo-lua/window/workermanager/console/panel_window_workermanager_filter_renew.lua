...
function workerSortFilter:initControl()
  ...
  workerFilterUi._list2_1_SelectFilter:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_WorkerManager_Filter_Create")
  workerFilterUi._list2_1_SelectFilter:createChildContent(__ePAUIList2ElementManagerType_List)
