...
function UpdateFunc_BloodAltarGauge_ExitAnimation(deltaTime)
  ...
  local isRetryPanelShow = nil ~= Panel_Window_BloodAltar_Retry_All and Panel_Window_BloodAltar_Retry_All:GetShow()
  if 0 <= PaGlobal_BloodAltarGauge_All._exitPosX and PaGlobal_BloodAltarGauge_All._exitPosX <= 90 then
    if true == PaGlobal_BloodAltarGauge_All._isExitOn or true == isRetryPanelShow then
