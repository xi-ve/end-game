...
function PaGlobal_DanceAction:Initialize()
  ...
  uiList2:registEvent(__ePAUIList2EventType_LuaChangeContent, "PanelDanceAction_Ev_ControlCreate")
  uiList2:createChildContent(__ePAUIList2ElementManagerType_List)
