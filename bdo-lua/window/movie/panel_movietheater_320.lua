...
function Panel_MovieTheater320_TriggerEvent()
  ...
  if isWarrior then
    ...
    elseif 7 <= playerLevel and playerLevel <= 15 then
      ...
      playedNo = 100
    elseif 16 <= playerLevel and playerLevel <= 20 then
      if isGameTypeTaiwan() then
      ...
      playedNo = 101
    elseif 21 <= playerLevel and playerLevel <= 25 then
      if isGameTypeTaiwan() then
      ...
      playedNo = 102
    elseif 26 <= playerLevel and playerLevel <= 30 then
      ...
      playedNo = 103
    elseif 31 <= playerLevel and playerLevel <= 35 then
      _txt_Title:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_MOVEITHEATER_320_COMMON_LINK_HIGHTOP", "getText", warriorText))
...
function UpdateMovieTheater320(deltaTime)
  ...
  if 1 < updateTime and _movieTheater_320:isReadyView() then
