...
function monthIndex_Create()
  ...
  for index = 0, 11 do
    ...
    monthIndex[index] = {}
    monthIndex[index] = UI.createControl(__ePAUIControl_RadioButton, Panel_Window_CharInfo_HistoryInfo, "RadioButton_Month_" .. index + 1)
...
function helpWidget_Create()
  ...
  helpWidget = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "HelpWindow_For_CharHistory")
...
function FromClient_MyHistoryInfo_Update()
  ...
  local frameContent = {
    _monthValue = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "StaticText_Month_Value"),
    _monthLine = UI.createControl(__ePAUIControl_Static, _contentHistoryList, "Static_MonthLine"),
    _verticalLine = UI.createControl(__ePAUIControl_Static, _contentHistoryList, "Static_VerticalLine")
  }
  ...
  for dayIndex = currentValue._day, 1, -1 do
    ...
    if 1 == dayLogCount % 2 then
      local _dayLeftValue = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "StaticText_DayLeft_Value_" .. dayIndex)
      local _dayLeftLine = UI.createControl(__ePAUIControl_Static, _contentHistoryList, "Static_DayLeftLine_" .. dayIndex)
      ...
      local _dayRightValue = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "StaticText_DayRight_Value_" .. dayIndex)
      local _dayRightLine = UI.createControl(__ePAUIControl_Static, _contentHistoryList, "Static_DayRightLine" .. dayIndex)
    ...
    for i = _listCount - 1, 0, -1 do
      ...
      if nil ~= _journalInfo[i] and dayIndex == _journalInfo[i]:getJournalDay() then
        ...
        if 1 == dayLogCount % 2 then
          local _dayHistoryLeftValue = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "StaticText_MyHistory_" .. i)
          ...
          local _dayHistoryRightValue = UI.createControl(__ePAUIControl_StaticText, _contentHistoryList, "StaticText_MyHistory_" .. i)
