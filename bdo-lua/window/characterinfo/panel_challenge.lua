...
local function createExpTooltip()
  ...
  expTooltip = UI.createControl(__ePAUIControl_StaticText, Panel_Window_Challenge, "expTooltip")
...
function Challenge_TapMenu_Create()
  ...
  for index = 0, tapCount - 1 do
    _tapMenu[index] = {}
    _tapMenu[index] = UI.createControl(__ePAUIControl_RadioButton, Panel_Window_Challenge, "Challenge_Tapmenu_" .. index)
...
function Challenge_Initialize()
  ...
  for index = 0, controlCount - 1 do
    _content[index] = {}
    _content[index].BG = UI.createControl(__ePAUIControl_Static, contentBody, "Challenge_content_BG_" .. index)
    _content[index].Title = UI.createControl(__ePAUIControl_StaticText, _content[index].BG, "Challenge_content_Title_" .. index)
    _content[index].Desc = UI.createControl(__ePAUIControl_StaticText, _content[index].BG, "Challenge_content_Desc_" .. index)
    _content[index].Icon = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_content_Icon_" .. index)
    _content[index].btnGetReward = UI.createControl(__ePAUIControl_Button, _content[index].BG, "Challenge_content_btnGetReward_" .. index)
    _content[index].normalText = UI.createControl(__ePAUIControl_StaticText, _content[index].BG, "StaticText_NormalReward_" .. index)
    _content[index].selectText = UI.createControl(__ePAUIControl_StaticText, _content[index].BG, "StaticText_SelectReward_" .. index)
    _content[index].rewardBG = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_RewardBG_" .. index)
    _content[index].itemSlotBG0 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_ResultSlot0_" .. index)
    _content[index].itemSlotBG1 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_ResultSlot1_" .. index)
    _content[index].itemSlotBG2 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_ResultSlot2_" .. index)
    _content[index].itemSlotBG3 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_ResultSlot3_" .. index)
    _content[index].itemIcon0 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_ItemIcon0_" .. index)
    _content[index].itemIcon1 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_ItemIcon1_" .. index)
    _content[index].itemIcon2 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_ItemIcon2_" .. index)
    _content[index].itemIcon3 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_ItemIcon3_" .. index)
    _content[index].selectSlotBG0 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectSlot0_" .. index)
    _content[index].selectSlotBG1 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectSlot1_" .. index)
    _content[index].selectSlotBG2 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectSlot2_" .. index)
    _content[index].selectSlotBG3 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectSlot3_" .. index)
    _content[index].selectSlotBG4 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectSlot4_" .. index)
    _content[index].selectSlotBG5 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectSlot5_" .. index)
    _content[index].selectItemIcon0 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectItemIcon0_" .. index)
    _content[index].selectItemIcon1 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectItemIcon1_" .. index)
    _content[index].selectItemIcon2 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectItemIcon2_" .. index)
    _content[index].selectItemIcon3 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectItemIcon3_" .. index)
    _content[index].selectItemIcon4 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectItemIcon4_" .. index)
    _content[index].selectItemIcon5 = UI.createControl(__ePAUIControl_Static, _content[index].BG, "Challenge_Static_SelectItemIcon5_" .. index)
    _content[index].contentComplete = UI.createControl(__ePAUIControl_StaticText, _content[index].BG, "Challenge_content_Complete_" .. index)
    ...
    _content[index].Desc:SetTextMode(__eTextMode_Limit_AutoWrap)
    if 0 == index then
...
function Challenge_SlotSetting(index)
  ...
  for jj = 0, _maxSelectSlotCount - 1 do
    ...
    slot.selectedSatic = UI.createControl(__ePAUIControl_Static, _selectReward[index][jj], "Challenge_Static_SelectedSlot_" .. index .. "_" .. jj)
...
function Challenge_Update()
  ...
  if true == _ContentsGroup_PCRoomCumulativeTime then
    AccumulateTimePcroomValue:SetShow(true)
    AccumulateTimeRefresh:SetShow(false)
  else
    AccumulateTimePcroomValue:SetShow(false)
    AccumulateTimeRefresh:SetShow(false)
  end
  AccumulateTimePcroomValue:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_CHALLANGE_ACCUMULATEPCROOMPLAYTIME", "time", convertStringFromDatetimeAll(ToClient_GetUserPcRoomPlayTime())))
  local viewCount = 4
    ...
    if 0 < controlValueCount then
      ...
      for i = 0, _count - 1 do
        ...
        if nil ~= progressInfo then
          _content[uiIdx].Title:SetTextMode(__eTextMode_None)
  ...
  elseif 5 == _tapValue then
    ...
    if 0 < controlValueCount then
      ...
      if 4 < maxCount and 1 == maxCount - controlValueCount then
      ...
      for challenge_Idx = 0, controlValueCount - 1 do
        ...
        if nil ~= rewardWrapper then
          _content[challenge_Idx].Title:SetTextMode(__eTextMode_LimitText)
          ...
          if 0 < existRewardCount then
            ...
            if true == _ContentsGroup_ChallengeReward then
              _content[challenge_Idx].btnGetReward:addInputEvent("Mouse_LUp", "FGlobal_requestChallengeReward( " .. firstIndex .. "," .. existRewardCount .. ")")
            else
...
function FGlobal_requestChallengeRewardXXX(inputNumber, challengeKey)
...
function FGlobal_requestChallengeReward(challengeIndex, maxRewardCount)
  if false == _ContentsGroup_ChallengeReward then
    return
  end
  if nil == Panel_Window_Challenge then
  ...
  local challengeWrapper = ToClient_GetChallengeRewardInfoWrapper(challengeIndex)
  if nil == challengeWrapper then
  ...
  if _selectedReward_ChallengeIndex ~= challengeIndex and 0 ~= selectRewardCount then
    Proc_ShowMessage_Ack_WithOut_ChattingMessage(PAGetString(Defines.StringSheet_GAME, "LUA_CHALLENGE_WRONGSELECTVALUE"))
    return
  end
  ...
  for ii = 0, challengeWrapper:getBaseRewardCount() - 1 do
    if false == challengeWrapper:getBaseRewardAt(ii):_itemStatic():isStackable() then
      maxRewardCount_edit = 1
      break
    end
  end
  if 0 == selectRewardCount and 1 < maxRewardCount_edit then
    Panel_NumberPad_Show(true, toInt64(0, maxRewardCount_edit), challengeKey, FGlobal_requestChallengeRewardXXX)
  else
    ToClient_requestChallengeReward(challengeKey, selectedRewardSlotIndex, 1)
    for ui_idx = 0, controlCount - 1 do
      for idx = 0, _maxSelectSlotCount - 1 do
        _listSelectRewardSlots[ui_idx][idx].selectedSatic:SetShow(false)
      end
...
local function initializeChallengeInfo()
  ...
  AccumulateTimePcroomValue = UI.getChildControl(Panel_Window_Challenge, "StaticText_AccumulationPcroomTime")
  AccumulateTimeRefresh = UI.getChildControl(Panel_Window_Challenge, "Button_RefreshPcroom")
  ...
  AccumulateTimePcroomValue:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_CHALLANGE_ACCUMULATEPCROOMPLAYTIME", "time", convertStringFromDatetimeAll(ToClient_GetUserPcRoomPlayTime())))
  AccumulateTimePcroomValue:addInputEvent("Mouse_On", "PaGlobal_CharacterInfo_Challenge_PcroomAccumulateTimeByTime(true)")
  AccumulateTimePcroomValue:addInputEvent("Mouse_Out", "PaGlobal_CharacterInfo_Challenge_PcroomAccumulateTimeByTime(false)")
  AccumulateTimePcroomValue:SetIgnore(false)
  AccumulateTimePcroomValue:SetEnableArea(-(AccumulateTimePcroomValue:GetTextSizeX() - AccumulateTimePcroomValue:GetSizeX()), 0, AccumulateTimePcroomValue:GetSizeX(), 20)
  AccumulateTimeRefresh:ClearDisableTime()
  AccumulateTimeRefresh:SetAutoDisableTime(60)
  createExpTooltip()
end
function PaGlobal_CharacterInfo_Challenge_PcroomAccumulateTimeByTime(isShow)
  ...
  control = AccumulateTimePcroomValue
...
local function registEventHandler()
  ...
  AccumulateTimeRefresh:addInputEvent("Mouse_LUp", "Challenge_UpdatePcroomTime()")
  AccumulateTimeRefresh:addInputEvent("Mouse_On", "Challenge_TooltipPcroomTimeRefresh(true)")
  AccumulateTimeRefresh:addInputEvent("Mouse_Out", "Challenge_TooltipPcroomTimeRefresh(false)")
end
function Challenge_UpdatePcroomTime()
  AccumulateTimePcroomValue:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_CHALLANGE_ACCUMULATEPCROOMPLAYTIME", "time", convertStringFromDatetimeAll(ToClient_GetUserPcRoomPlayTime())))
end
function Challenge_TooltipPcroomTimeRefresh(isShow)
  if false == isShow then
    TooltipSimple_Hide()
    return
  end
  local name, desc, control
  name = PAGetString(Defines.StringSheet_GAME, "LUA_PCROOMTIME_REFRESH_TOOLTIP_TITLE")
  desc = PAGetString(Defines.StringSheet_GAME, "LUA_PCROOMTIME_REFRESH_TOOLTIP_DESC")
  control = AccumulateTimeRefresh
  TooltipSimple_Show(control, name, desc)
end
