...
function CharacterTitleInfo:init()
  ...
  self._ui.txt_Title_Name_Info:SetTextMode(__eTextMode_AutoWrap)
...
function CharacterTitleInfo:registMessageHandler()
  self._ui.list_TitleList:registEvent(__ePAUIList2EventType_LuaChangeContent, "CharacterInfo_TitleList_ControlCreate")
  self._ui.list_TitleList:createChildContent(__ePAUIList2ElementManagerType_List)
...
function CharacterTitleInfo:titleInfoUpdate()
  ...
  self._ui.txt_Reward:SetTextMode(__eTextMode_AutoWrap)
