...
function CharacterInfo:potentialGauge_Init()
  ...
  for ii = 1, self.POTENTIAL_TYPE.TOTALCOUNT do
    ...
    for jj = 1, self._potentialUIData.limitPotentialLevel do
      self._ui.stc_PotentialBarBg[ii][jj] = UI.createControl(__ePAUIControl_Static, self._ui.stc_StatBattleInfoBg, "Static_Potential_BarBg" .. ii .. jj)
      CopyBaseProperty(self._ui.stc_Potential_BarBgTemplete, self._ui.stc_PotentialBarBg[ii][jj])
      self._ui.stc_PotentialBar[ii][jj] = UI.createControl(__ePAUIControl_Static, self._ui.stc_PotentialBarBg[ii][jj], "Static_Potential_Bar" .. ii .. jj)
...
function CharacterInfo:abilitystatic_Init()
  for idx = 0, 4 do
    self.attackspeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "attackSpeed_SlotBG_" .. idx)
    ...
    self.attackspeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "attackSpeed_Slot_" .. idx)
    ...
    self.attackspeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "attackSpeed_MinusSlot_" .. idx)
    ...
    self.castspeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "castspeed_SlotBG_" .. idx)
    ...
    self.castspeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "castspeed_Slot_" .. idx)
    ...
    self.castspeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "castspeed_MinusSlot_" .. idx)
    ...
    self.movespeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "movespeed_SlotBG_" .. idx)
    ...
    self.movespeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "movespeed_Slot_" .. idx)
    ...
    self.movespeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "movespeed_MinusSlot_" .. idx)
    ...
    self.critical_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "critical_SlotBG_" .. idx)
    ...
    self.critical_Slot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "critical_Slot_" .. idx)
    ...
    self.critical_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "critical_MinusSlot_" .. idx)
    ...
    self.fishTime_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "fishTime_SlotBG_" .. idx)
    ...
    self.fishTime_Slot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "fishTime_Slot_" .. idx)
    ...
    self.fishTime_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "fishTime_MinusSlot_" .. idx)
    ...
    self.product_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "product_SlotBG_" .. idx)
    ...
    self.product_Slot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "product_Slot_" .. idx)
    ...
    self.product_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "product_MinusSlot_" .. idx)
    ...
    self.dropChance_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "dropChance_SlotBG_" .. idx)
    ...
    self.dropChance_Slot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "dropChance_Slot_" .. idx)
    ...
    self.dropChance_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self._ui.stc_AbilityBg, "dropChance_MinusSlot_" .. idx)
...
function CharacterInfo:mpTitle_Init()
  ...
  if __eClassType_ElfRanger == self._player:getClassType() or __eClassType_ShyWaman == self._player:getClassType() or __eClassType_RangerMan == self._player:getClassType() then
  ...
  elseif __eClassType_Warrior == self._player:getClassType() or __eClassType_Giant == self._player:getClassType() or __eClassType_BladeMaster == self._player:getClassType() or __eClassType_BladeMasterWoman == self._player:getClassType() or __eClassType_Kunoichi == self._player:getClassType() or __eClassType_NinjaMan == self._player:getClassType() or __eClassType_Combattant == self._player:getClassType() or __eClassType_Mystic == self._player:getClassType() or __eClassType_Lhan == self._player:getClassType() or __eClassType_Guardian == self._player:getClassType() then
    ...
    self._ui.progress_Mental:getBaseTexture():setUV(x1, y1, x2, y2)
    self._ui.progress_Mental:setRenderTexture(self._ui.progress_Mental:getBaseTexture())
  elseif __eClassType_Sorcerer == self._player:getClassType() or __eClassType_Tamer == self._player:getClassType() or __eClassType_WizardMan == self._player:getClassType() or __eClassType_WizardWoman == self._player:getClassType() then
    ...
    self._ui.progress_Mental:getBaseTexture():setUV(x1, y1, x2, y2)
    self._ui.progress_Mental:setRenderTexture(self._ui.progress_Mental:getBaseTexture())
  elseif __eClassType_Valkyrie == self._player:getClassType() then
    ...
    self._ui.progress_Mental:getBaseTexture():setUV(x1, y1, x2, y2)
    self._ui.progress_Mental:setRenderTexture(self._ui.progress_Mental:getBaseTexture())
  elseif __eClassType_DarkElf == self._player:getClassType() then
...
function CharacterInfo:update()
  ...
  self._ui.edit_Introduce:SetTextMode(__eTextMode_AutoWrap)
...
function FromClient_CharacterInfo_Basic_SkillPointChanged()
  LUA_SCOPED_PROFILE("FromClient_CharacterInfo_Basic_SkillPointChanged")
  local self = CharacterInfo
  if _panel:IsShow() == false then
    return
  end
