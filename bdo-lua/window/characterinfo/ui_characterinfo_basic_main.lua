...
PaGlobal_CharacterInfoBasic = {
  ...
  _ui = {
    ...
    _staticTextStatExtra_Param1_Title = nil,
    _staticTextStatExtra_Param1_Value = nil,
    _staticTextStatExtra_Param2_Title = nil,
    _staticTextStatExtra_Param2_Value = nil,
    _staticTextStatExtra_Param3_Title = nil,
    _staticTextStatExtra_Param3_Value = nil,
...
function PaGlobal_CharacterInfoBasic:initialize()
  ...
  self._ui._multilineEditIntroduce:SetTextMode(__eTextMode_LimitText)
  ...
  if __eClassType_DarkElf == classType then
...
function PaGlobal_CharacterInfoBasic:initializeControl()
  ...
  self._ui._staticTextStatExtra_Param1_Title = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_ShyStat1_Title")
  self._ui._staticTextStatExtra_Param2_Title = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_ShyStat2_Title")
  self._ui._staticTextStatExtra_Param3_Title = UI.getChildControl(Panel_Window_CharInfo_BasicStatus, "StaticText_ShyStat3_Title")
  ...
  self._ui._staticTextStatExtra_Param1_Value = UI.getChildControl(self._ui._staticTextStatExtra_Param1_Title, "StaticText_ShyStat1_Value")
  self._ui._staticTextStatExtra_Param2_Value = UI.getChildControl(self._ui._staticTextStatExtra_Param2_Title, "StaticText_ShyStat2_Value")
  self._ui._staticTextStatExtra_Param3_Value = UI.getChildControl(self._ui._staticTextStatExtra_Param3_Title, "StaticText_ShyStat3_Value")
  for key, index in pairs(self._regist) do
    ...
    self._ui._staticTextResist_Title[index]:SetTextMode(__eTextMode_LimitText)
  end
  ...
  for key, index in pairs(self._potential) do
    ...
    self._ui._staticTextPotential_Title[index]:SetTextMode(__eTextMode_LimitText)
    for slotIndex = 0, 4 do
      self._ui._staticPotencialGradeBg[index][slotIndex] = UI.createControl(__ePAUIControl_Static, self._ui._staticTextPotential_Title[index], "attackSpeed_SlotBG_" .. index .. "_" .. slotIndex)
      ...
      self._ui._staticPotencialPlusGrade[index][slotIndex] = UI.createControl(__ePAUIControl_Static, self._ui._staticTextPotential_Title[index], "attackSpeed_PlusSlot_" .. index .. "_" .. slotIndex)
      ...
      self._ui._staticPotencialMinusGrade[index][slotIndex] = UI.createControl(__ePAUIControl_Static, self._ui._staticTextPotential_Title[index], "attackSpeed_MinusSlot_" .. index .. "_" .. slotIndex)
  ...
  local lifeIdx = PaGlobal_CharacterInfo_GetLifeIdx()
  showDetailBtn_LifeInfo:addInputEvent("Mouse_LUp", "PaGlobal_CharacterInfo:showWindow(" .. lifeIdx .. ")")
...
function PaGlobal_CharacterInfoBasic:BaseInfoShow(isBattleInfo)
  ...
  self._ui._staticTextStatExtra_Param1_Title:SetShow(isBattleInfo)
  self._ui._staticTextStatExtra_Param2_Title:SetShow(isBattleInfo)
  self._ui._staticTextStatExtra_Param3_Title:SetShow(isBattleInfo)
...
function PaGlobal_CharacterInfoBasic:registMessageHandler()
  ...
  registerEvent("FromClient_ResponseEnchantFailCountOfMyCharacters", "FromClient_UI_CharacterInfo_Basic_NormalStackChanged")
end
