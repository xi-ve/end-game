...
function CharacterInfo:Init()
  ...
  CharacterInfo.potenTooltip = UI.createControl(__ePAUIControl_StaticText, Panel_Window_CharInfo_Status, "PotenTooltip")
  ...
  CharacterInfo.fitnessTooltip = UI.createControl(__ePAUIControl_StaticText, Panel_Window_CharInfo_Status, "FitnessTooltip")
  ...
  CharacterInfo.fitnessTooltip:SetTextMode(__eTextMode_None)
  ...
  for idx = 0, 6 do
    self.attackspeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self.attackspeed, "attackSpeed_SlotBG_" .. idx)
    ...
    self.attackspeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, self.attackspeed, "attackSpeed_Slot_" .. idx)
    ...
    self.attackspeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self.attackspeed, "attackSpeed_MinusSlot_" .. idx)
    ...
    self.castspeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self.castspeed, "castspeed_SlotBG_" .. idx)
    ...
    self.castspeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, self.castspeed, "castspeed_Slot_" .. idx)
    ...
    self.castspeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self.castspeed, "castspeed_MinusSlot_" .. idx)
    ...
    self.movespeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self.movespeed, "movespeed_SlotBG_" .. idx)
    ...
    self.movespeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, self.movespeed, "movespeed_Slot_" .. idx)
    ...
    self.movespeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self.movespeed, "movespeed_MinusSlot_" .. idx)
    ...
    self.critical_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self.critical, "critical_SlotBG_" .. idx)
    ...
    self.critical_Slot[idx] = UI.createControl(__ePAUIControl_Static, self.critical, "critical_Slot_" .. idx)
    ...
    self.critical_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self.critical, "critical_MinusSlot_" .. idx)
    ...
    self.fishTime_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self.fishTime, "fishTime_SlotBG_" .. idx)
    ...
    self.fishTime_Slot[idx] = UI.createControl(__ePAUIControl_Static, self.fishTime, "fishTime_Slot_" .. idx)
    ...
    self.fishTime_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self.fishTime, "fishTime_MinusSlot_" .. idx)
    ...
    self.product_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self.product, "product_SlotBG_" .. idx)
    ...
    self.product_Slot[idx] = UI.createControl(__ePAUIControl_Static, self.product, "product_Slot_" .. idx)
    ...
    self.product_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self.product, "product_MinusSlot_" .. idx)
    ...
    self.dropChance_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, self.dropChance, "dropChance_SlotBG_" .. idx)
    ...
    self.dropChance_Slot[idx] = UI.createControl(__ePAUIControl_Static, self.dropChance, "dropChance_Slot_" .. idx)
    ...
    self.dropChance_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, self.dropChance, "dropChance_MinusSlot_" .. idx)
...
function SelfCharacterInfo_UpdateMainStatus()
  ...
  if __eClassType_ElfRanger == player:getClassType() or __eClassType_RangerMan == player:getClassType() then
  ...
  elseif __eClassType_Warrior == player:getClassType() or __eClassType_Giant == player:getClassType() or __eClassType_BladeMaster == player:getClassType() or __eClassType_BladeMasterWoman == player:getClassType() or __eClassType_Kunoichi == player:getClassType() or __eClassType_NinjaMan == player:getClassType() or __eClassType_Combattant == player:getClassType() or __eClassType_Mystic == player:getClassType() or __eClassType_Lhan == player:getClassType() or __eClassType_Guardian == player:getClassType() then
    ...
    CharacterInfo._progress2_mp:getBaseTexture():setUV(x1, y1, x2, y2)
    CharacterInfo._progress2_mp:setRenderTexture(CharacterInfo._progress2_mp:getBaseTexture())
  elseif __eClassType_Sorcerer == player:getClassType() or __eClassType_Tamer == player:getClassType() or __eClassType_WizardMan == player:getClassType() or __eClassType_WizardWoman == player:getClassType() then
    ...
    CharacterInfo._progress2_mp:getBaseTexture():setUV(x1, y1, x2, y2)
    CharacterInfo._progress2_mp:setRenderTexture(CharacterInfo._progress2_mp:getBaseTexture())
  elseif __eClassType_Valkyrie == player:getClassType() then
    ...
    CharacterInfo._progress2_mp:getBaseTexture():setUV(x1, y1, x2, y2)
    CharacterInfo._progress2_mp:setRenderTexture(CharacterInfo._progress2_mp:getBaseTexture())
  elseif __eClassType_DarkElf == player:getClassType() then
...
function SelfCharacterInfo_UpdateMainStatusRegen()
  ...
  if __eClassType_ElfRanger == player:getClassType() or __eClassType_DarkElf == player:getClassType() or __eClassType_RangerMan == player:getClassType() then
...
function SelfCharacterInfo_UpdateCraftLevel()
  ...
  CharacterInfo._gather:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(gatherLevel))
  ...
  CharacterInfo._manufacture:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(manufatureLevel))
  ...
  CharacterInfo._cooking:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(cookingLevel))
  ...
  CharacterInfo._alchemy:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(alchemyLevel))
  ...
  CharacterInfo._fishing:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(fishingLevel))
  ...
  CharacterInfo._hunting:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(huntingLevel))
  ...
  CharacterInfo._training:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(trainingLevel))
  ...
  CharacterInfo._trade:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(tradeLevel))
  ...
  CharacterInfo._growth:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(growthLevel))
  ...
  CharacterInfo._sail:SetText(PaGlobalFunc_Util_CraftLevelColorReplace(sailLevel))
...
function CharacterInfo:registEventHandler()
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"SelfCharacterInfo\"")
end
...
function CharacterInfo_changedBattlePoint(battlePoint, tier)
  ...
  if true == _ContentsGroup_StatTierIcon and 1 <= highTier and highTier <= ToClient_GetHighTierCount() then
