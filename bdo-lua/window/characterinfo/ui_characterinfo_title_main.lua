...
function PaGlobal_CharacterInfoTitle:initialize()
  ...
  self._ui._list2Title:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui._staticText_PartName:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui._staticText_TotalReward_Value:SetTextMode(__eTextMode_AutoWrap)
  self._ui._staticText_PartDesc:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_CharacterInfoTitle:registEventHandler()
  ...
  self._ui._list2Title:registEvent(__ePAUIList2EventType_LuaChangeContent, "FromClient_UI_CharacterInfo_Title_CreateList")
end
