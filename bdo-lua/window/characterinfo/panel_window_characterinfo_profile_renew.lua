...
function CharacterProfileInfo:init()
  ...
  self._ui.txt_MonsterDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.txt_FishDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.txt_GatherDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.txt_WeightDesc:SetTextMode(__eTextMode_AutoWrap)
