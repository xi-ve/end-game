...
function TitleInfo:TitleUpdate()
  ...
  self.txt_PartDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  for index = 0, titleTotalCount - 1 do
    ...
    if nil ~= titleBuffWrapper then
      ...
      self.txt_TotalReward_Value:SetTextMode(__eTextMode_AutoWrap)
...
function TitleInfo:registEventHandler()
  ...
  self.list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "CharacterInfo_Title_ListControlCreate")
...
function HandleClick_ShowDescription(categoryIdx, titleIdx)
  ...
  TitleInfo.txt_PartDesc:SetTextMode(__eTextMode_AutoWrap)
