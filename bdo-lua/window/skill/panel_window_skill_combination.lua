...
function PaGlobal_SkillCombination:initalize()
  ...
  self._ui._staticTextDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui._list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "SkillCombinationListControlCreate")
