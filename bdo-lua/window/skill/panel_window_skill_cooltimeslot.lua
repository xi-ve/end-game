...
function PaGlobal_Window_Skill_CoolTimeSlot:skillCoolTimeSlot_MakeControl(index)
  local ui = {}
  index = index - 1
  ui._IconBG = UI.createControl(__ePAUIControl_Static, Panel_SkillCoolTimeSlot, "Static_SkillBG_" .. index)
  ...
  ui._skillIcon = UI.createControl(__ePAUIControl_Static, Panel_SkillCoolTimeSlot, "Static_SkillIcon_" .. index)
  ...
  ui._skillName = UI.createControl(__ePAUIControl_StaticText, Panel_SkillCoolTimeSlot, "StaticText_SkillName_" .. index)
  ...
  ui._ComboBox = UI.createControl(__ePAUIControl_ComboBox, Panel_SkillCoolTimeSlot, "Combobox_SkillCoolTimeQuickSlot_" .. index)
