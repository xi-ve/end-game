...
function inGameShopDetailInfo:init()
  ...
  self._static_Name:SetTextMode(__eTextMode_AutoWrap)
...
function inGameShopDetailInfo:update()
  ...
  self._static_GroupName:SetTextMode(__eTextMode_LimitText)
...
function IngameShopDetailInfo_ConvertFromCategoryToClassDesc(cashProduct)
  ...
  if cashProduct:doHaveDisplayClass() then
    if cashProduct:isClassTypeUsable(__eClassType_Warrior) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_ElfRanger) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_Sorcerer) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_Giant) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_Tamer) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_Valkyrie) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_BladeMaster) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_BladeMasterWoman) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_WizardMan) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_WizardWoman) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_Kunoichi) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_NinjaMan) then
    ...
    if cashProduct:isClassTypeUsable(__eClassType_Combattant) then
