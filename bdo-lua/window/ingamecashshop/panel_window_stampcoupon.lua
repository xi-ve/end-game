...
function PearlStamp:Init()
  ...
  staticBottom:SetTextMode(__eTextMode_AutoWrap)
  ...
  for index = 0, self.pearlStampCount - 1 do
    local temp = {}
    temp._dayControl = UI.createControl(__ePAUIControl_Static, Panel_Window_StampCoupon, "Static_PearStamp_slot_" .. index)
