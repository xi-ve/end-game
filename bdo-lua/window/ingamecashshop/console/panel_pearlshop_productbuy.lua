...
function pearlShopProductBuy:buy()
  ...
  self:close()
  getIngameCashMall():requestBuyItem(productInfo:getNoRaw(), count, productInfo:getPrice(), false, couponNo, couponKey, 0, wareType)
