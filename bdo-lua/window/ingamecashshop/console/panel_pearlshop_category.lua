...
function pearlShopCategory:checkValidMainCategory(index)
  return 0 <= index and index < getCashMainCategorySize()
end
...
function pearlShopCategory:checkValidSubCategory(subCategoryIndex)
  ...
  return 0 <= subCategoryIndex and subCategoryIndex < getCashMiddleCategorySize(mainCategoryInfo:getNoRaw())
end
