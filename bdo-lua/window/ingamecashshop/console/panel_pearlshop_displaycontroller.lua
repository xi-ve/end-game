...
function pearlShopDisplayController:setCharacterEquip()
  ...
  for itemIdx = 0, itemCount - 1 do
    ...
    if itemSSW:isUsableServant() then
      ...
      elseif itemSSW:get():isServantTypeUsable(CppEnums.ServantKind.Type_Horse, 0) then
      ...
      elseif itemSSW:get():isServantTypeUsable(CppEnums.ServantKind.Type_Donkey, 0) then
