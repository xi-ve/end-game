...
function PaGlobal_PearlShopCoupon_Init()
  ...
  self._ui._txt_noCoupon:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui._list2_Coupon:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_PearlShopCoupon_CreateListContents")
...
function PaGlobal_PearlShopCoupon_CreateListContents(contents, key)
  ...
  txt_Date:SetTextMode(__eTextMode_Limit_AutoWrap)
