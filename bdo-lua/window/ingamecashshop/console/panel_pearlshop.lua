...
function pearlShop:initialize()
  ...
  local menuYSize = (buttonTemp:GetSizeY() + 10) * self._classCount
...
function pearlShop:showDescXXX(index)
  ...
  local showSubProductFlag = 0 < topPosY and 0 < bottomPosY
...
function pearlShop:getProductControlByControlIndex(index)
  if 0 <= index and index < self._ui._productControlListSize then
...
function pearlShop:updateControlInfo(index)
  ...
  for i = 0, self._ui._subProductNameControlListSize - 1 do
    ...
    local subName = ""
    local subInfo
    if i < subInfoListSize and 1 < subInfoListSize then
