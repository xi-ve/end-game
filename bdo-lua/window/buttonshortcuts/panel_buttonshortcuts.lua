...
function PaGlobal_ButtonShortcuts:Open(index)
  ...
  if true == isCurrentMode then
    ...
    self._ui._curButtonString:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobalFunc_ButtonShortcuts_UiRefresh(index)
  if nil == index then
    return
  end
  PaGlobal_ButtonShortcuts:UiRefresh(index)
end
...
function PaGlobalFunc_ButtonShortcuts_Remove()
...
function PaGlobalFunc_ButtonShortcuts_Register(VirtualKeyCode)
  PaGlobal_ButtonShortcuts:Register(VirtualKeyCode)
end
...
function PaGlobal_ButtonShortcuts:InitUI()
  ...
  buttonshortcutsDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui._checkButtonAllVeiw:SetCheck(false)
  self._ui._list2:registEvent(__ePAUIList2EventType_LuaChangeContent, "FGlobal_ButtonShortcurs_List2EventControlCreate")
