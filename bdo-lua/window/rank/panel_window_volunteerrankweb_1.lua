function PaGlobal_VolunteerRankWeb:initialize()
  ...
  PaGlobal_VolunteerRankWeb._ui.btn_Refresh = UI.getChildControl(PaGlobal_VolunteerRankWeb._ui.stc_titleBG, "Button_Refresh")
  PaGlobal_VolunteerRankWeb._webControl = UI.createControl(__ePAUIControl_WebControl, Panel_Window_VolunteerRankWeb, "WebControl_VolunteerRank_WebLink")
  ...
  PaGlobal_VolunteerRankWeb._webControl:SetVerticalTop()
  PaGlobal_VolunteerRankWeb._webControl:SetSpanSize(0, 60)
  ...
  PaGlobal_VolunteerRankWeb._ui.btn_Refresh:SetShow(_ContentsGroup_ResetCoherent)
...
function PaGlobal_VolunteerRankWeb:registEventHandler()
  ...
  PaGlobal_Util_RegistWebResetControl(PaGlobal_VolunteerRankWeb._ui.btn_Refresh)
  registerEvent("FromClient_resetCoherentUI", "FromClient_resetCoherentUIForVolunteerRankWeb")
