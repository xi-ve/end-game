...
function initSculptingBoneTestUI()
  ...
  for index = 1, 11 do
    self.StaticText[index] = UI.createControl(__ePAUIControl_StaticText, Panel_CustomizationTest, "StaticText" .. index)
  ...
  for index = 1, self.CONTROL_PARAM_COUNT do
    self.EditText[index] = UI.createControl(__ePAUIControl_Edit, Panel_CustomizationTest, "EditText" .. index)
