...
local function createWeatherGroup(mainInfo)
  ...
  for ii = 1, count do
    mainInfo.subControl[ii] = UI.createControl(__ePAUIControl_Button, Panel_CustomizationMainSlide, "MAIN_BUTTON_SLIDE_WEATHER" .. ii)
    CopyBaseProperty(Button_Group, mainInfo.subControl[ii])
    mainInfo.subControlImage[ii] = UI.createControl(__ePAUIControl_Static, Panel_CustomizationMainSlide, "MAIN_STATIC_SLIDE_WEATER_IMG_" .. ii)
...
local function createCustomizationGroup(mainInfo)
  for ii = 1, 3 do
    mainInfo.subControl[ii] = UI.createControl(__ePAUIControl_Button, Panel_CustomizationMainSlide, "MAIN_BUTTON_SLIDE_CUSTOM" .. ii)
    CopyBaseProperty(Button_Group, mainInfo.subControl[ii])
    mainInfo.subControlImage[ii] = UI.createControl(__ePAUIControl_Static, Panel_CustomizationMainSlide, "MAIN_STATIC_SLIDE_CUSTOM" .. ii)
...
local function createPoseGroup(mainInfo)
  for ii = 1, 2 do
    mainInfo.subControl[ii] = UI.createControl(__ePAUIControl_Button, Panel_CustomizationMainSlide, "MAIN_BUTTON_SLIDE_POSE" .. ii)
    CopyBaseProperty(Button_Group, mainInfo.subControl[ii])
    mainInfo.subControlImage[ii] = UI.createControl(__ePAUIControl_Static, Panel_CustomizationMainSlide, "MAIN_STATIC_SLIDE_POSE" .. ii)
...
local function createBackgroundGroup(mainInfo)
  ...
  mainInfo.subControlCount = count
  for ii = 1, count do
    mainInfo.subControl[ii] = UI.createControl(__ePAUIControl_Button, Panel_CustomizationMainSlide, "MAIN_BUTTON_SLIDE_BG" .. ii)
    CopyBaseProperty(Button_Group, mainInfo.subControl[ii])
...
function SlideMenuCreateUI()
  for idx = 1, 4 do
    local mainInfo = {
      control = UI.createControl(__ePAUIControl_Button, Panel_CustomizationMainSlide, "MAIN_BUTTON_SLIDE_" .. idx),
      slideImage = UI.createControl(__ePAUIControl_Static, Panel_CustomizationMainSlide, "STATIC_SLIDE_IMAGE_" .. idx),
      isOpen = false,
      subControlCount = 0,
      subControl = {},
      subControlImage = {}
