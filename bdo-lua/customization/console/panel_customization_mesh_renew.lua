...
function HandleClicked_Customization_Mesh_Open(classType, uiId)
  ...
  if listCount == 1 then
    ...
    for itemIndex = 0, meshCount - 1 do
      ...
      if nil == control then
        control = UI.createControl(__ePAUIControl_RadioButton, self._ui._static_TypeBg, "HairType_Image_" .. itemIndex)
  ...
  if detailListCount == 1 then
    ...
    for elementIndex = 0, meshCount - 1 do
      ...
      if nil == control then
        control = UI.createControl(__ePAUIControl_RadioButton, self._ui._static_TypeBg, "HairType_Image_" .. elementIndex)
        CopyBaseProperty(self._ui._hairTypeTemplate, control)
      end
