...
function Panel_MovieGuide_Initialize()
  ...
  ui_PanelWindow._list:registEvent(__ePAUIList2EventType_LuaChangeContent, "MovieGuide_ListUpdate")
  ui_PanelWindow._list:registEvent(__ePAUIList2EventType_ScrollBeginToBegin, "MovieGuide_ListUpdate_BEGIN")
  ui_PanelWindow._list:registEvent(__ePAUIList2EventType_ScrollEndToEnd, "MovieGuide_ListUpdate_END")
  ui_PanelWindow._list:createChildContent(__ePAUIList2ElementManagerType_List)
...
function MovieGuide_ListUpdate(contents, key)
  ...
  movieName:SetTextMode(__eTextMode_LimitText)
  ...
  if playerLevel <= 22 then
    if 1 <= playerLevel and playerLevel <= 4 then
      if idx <= 4 then
        isEnableBtn()
      end
    elseif 5 <= playerLevel and playerLevel <= 7 then
      if idx <= 12 then
        isEnableBtn()
      end
    elseif 8 <= playerLevel and playerLevel <= 12 then
      if idx <= 15 then
        isEnableBtn()
      end
    elseif 13 <= playerLevel and playerLevel <= 16 then
      if idx <= 18 then
        isEnableBtn()
      end
    elseif 17 <= playerLevel and playerLevel <= 18 then
      if idx <= 19 then
        isEnableBtn()
      end
    elseif 19 <= playerLevel and playerLevel <= 22 and idx <= 30 then
      isEnableBtn()
    end
  elseif 23 <= playerLevel and idx <= 33 then
    isEnableBtn()
  end
end
