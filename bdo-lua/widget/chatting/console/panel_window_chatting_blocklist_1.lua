...
function PaGlobal_Chatting_BlockList:registEventHandler()
  ...
  PaGlobal_Chatting_BlockList._ui.list2_blockedUser:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_Chatting_BlockList_addBlockListContent")
  PaGlobal_Chatting_BlockList._ui.list2_blockedUser:createChildContent(__ePAUIList2ElementManagerType_List)
end
