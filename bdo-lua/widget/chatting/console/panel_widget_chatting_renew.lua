...
function ChattingInfo:open()
  ...
  elseif nil ~= Panel_Window_VoiceChat and Panel_Window_VoiceChat:GetShow() then
  ...
  elseif nil ~= Panel_Window_Menu_Renew and Panel_Window_Menu_Renew:GetShow() then
  ...
  elseif Panel_Window_Manufacture_All:GetShow() then
    PaGlobalFunc_Manufacture_All_Close()
  end
  if _ContentsGroup_NewUI_Achievement_All and nil ~= Panel_Window_Achievement_BookShelf_All and Panel_Window_Achievement_BookShelf_All:GetShow() then
...
function PaGlobalFunc_ChattingInfo_SetShowFunctionKeyGuide(isSender)
  ...
  ChattingInfo._ui.txt_keyGuideLTX:SetShow(isSender and ToClient_isPS4() and selfPlayerPlatform == senderPlatformType)
