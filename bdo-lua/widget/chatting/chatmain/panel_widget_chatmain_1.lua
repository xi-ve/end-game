...
function PaGlobal_ChatMain:update(chatPanel, panelIndex, isShow)
  ...
  if false == isChatOpen then
    ...
    if 0 == myChannelChatRoomInfo._chatRoomNo then
      isExistCacheData = ToClient_getGameUIManagerWrapper():hasLuaCacheDataList(__eChannelChat)
...
function PaGlobal_ChatMain:UpdateSmoothChattingContent(chattingUpTime)
  ...
  if 0.2 < chattingUpTime and false == PaGlobal_ChatMain._issmoothupMessage then
