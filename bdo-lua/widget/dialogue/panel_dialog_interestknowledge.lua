...
needKnowledgeText:SetTextMode(__eTextMode_AutoWrap)
...
function InterestKnowledge_Init()
  for index = 0, _knowledgeMaxCount - 1 do
    uiText[index] = UI.createControl(__ePAUIControl_StaticText, Panel_Interest_Knowledge, "StaticText_InterestKnowledgeList_" .. index)
...
PaGlobal_Util_RegistHelpTooltipEvent(_buttonQuestion, "\"PanelImportantKnowledge\"")
