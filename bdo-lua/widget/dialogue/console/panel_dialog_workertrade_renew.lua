...
function workerTrade:setSkillSizeToSlot(skillIdx)
  ...
  skill._staticText_SkillName:SetTextMode(__eTextMode_AutoWrap)
  skill._staticText_SkillName:SetText(skill._staticText_SkillName:GetText())
  skill._staticText_SkillDesc:SetTextMode(__eTextMode_AutoWrap)
  ...
  if 1 <= skillIdx and nil ~= self._ui._skillInfo[skillIdx - 1] then
...
function workerTrade:setSkillInfoToSlot(skillIdx, skillStaticStatusWrapper)
  ...
  skill._staticText_SkillDesc:SetTextMode(__eTextMode_None)
