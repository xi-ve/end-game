...
function Window_MentalGameInfo:InitControl()
  ...
  self._ui._staitcText_NpcName:SetTextMode(__eTextMode_AutoWrap)
  self._ui._staticText_Bonus:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui._static_Zodiac._control = UI.createControl(__ePAUIControl_Static, self._ui._static_Zodiac._panel, "ZodiacCenterPanelImage")
...
function Window_MentalGameInfo:SetBottomCardList()
  ...
  for index = 0, count - 1 do
    ...
    if nil == self._bottomCardList[index] then
      ...
      local ui = {}
      ui._static_SelectBg = UI.createControl(__ePAUIControl_Static, self._ui._static_BottomBg, "selectIcon_" .. index)
      ...
      ui._static_CardIcon = UI.createControl(__ePAUIControl_Static, self._ui._static_BottomBg, "cardIcon_" .. index)
      ...
      ui._staticText_CardText = UI.createControl(__ePAUIControl_StaticText, self._ui._static_BottomBg, "cardText_" .. index)
      ...
      ui._staticText_CardText:SetTextMode(__eTextMode_AutoWrap)
...
function Window_MentalGameInfo:SetMentalGameInfo()
  ...
  for index = 0, intimacyRewardCount - 1 do
    ...
    local imageFileName = ""
    if 0 <= percent and percent <= 1 and true == ToClient_checkIntimacyInformationFixedState(intimacyInformationData) then
      ...
      if nil == rewardIcon then
        rewardIcon = UI.createControl(__ePAUIControl_Static, self._ui._static_LeftBg, "static_rewardIcon_" .. tostring(index))
      ...
      if nil == rewardText then
        rewardText = UI.createControl(__ePAUIControl_StaticText, self._ui._static_LeftBg, "static_rewardText_" .. tostring(index))
...
function PaGlobalFunc_MentalGame_Close(isDead)
  ...
  self:Clear()
  self:StageClear()
  PaGlobalFunc_MentalGame_RemoveControl()
  if true == _ContentsGroup_NewUI_Dialog_All then
    PaGlobalFunc_DialogMain_All_ShowToggle(true)
  else
...
function PaGlobalFunc_MentalGame_RemoveControl()
  local self = Window_MentalGameInfo
  for key, value in pairs(self._bottomCardList) do
    if nil ~= value then
      self._ui._static_BottomBg:RemoveControl(value._static_SelectBg)
      self._ui._static_BottomBg:RemoveControl(value._static_CardIcon)
      self._ui._static_BottomBg:RemoveControl(value._staticText_CardText)
    end
  end
  self._bottomCardList = {}
end
