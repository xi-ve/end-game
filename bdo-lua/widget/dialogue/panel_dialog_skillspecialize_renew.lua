...
function SkillSpecialize:childControl()
  ...
  self._ui.txt_tip:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.list2_1_SelectSkill:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_Dialog_SkillSpecialize_Page2SkillListCreate")
  self._ui.list2_1_SelectSkill:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui.list2_2_SelectEffect1 = UI.getChildControl(self._ui.static_Content, "List2_2_SelectEffect1")
  self._ui.list2_2_SelectEffect1:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_Dialog_SkillSpecialize_Page2EffectListCreate")
  self._ui.list2_2_SelectEffect1:createChildContent(__ePAUIList2ElementManagerType_List)
  self._ui.list2_2_SelectEffect2 = UI.getChildControl(self._ui.static_Content, "List2_2_SelectEffect2")
  self._ui.list2_2_SelectEffect2:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobalFunc_Dialog_SkillSpecialize_Page2EffectListCreate")
  self._ui.list2_2_SelectEffect2:createChildContent(__ePAUIList2ElementManagerType_List)
  ...
  self._ui.staticText_EffectBg1:SetTextMode(__eTextMode_AutoWrap)
  self._ui.staticText_EffectBg2:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.staticText_Skill_Desc_Popup:SetTextMode(__eTextMode_AutoWrap)
  ...
  self._ui.staticText_SkillEffectDesc_Popup:SetTextMode(__eTextMode_AutoWrap)
  if getSelfPlayer():getClassType() == __eClassType_ShyWaman then
    self._ui.staticText_Skill_Awaken_Special_Title:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_SKILLREINFORCE_AWAKEN_BYSHY"))
  end
  local keyGuides = {
...
function SkillSpecialize:setContentPage1()
  ...
  for index = self._config.reinforceSkillCount, self._config.reinforceSkillViewCount - 1 do
    ...
    if awakenSkill_ReinforceCount > index - 3 then
      ...
      if totalReinforceCount == reinforcableSkillCount or getSelfPlayer():getClassType() == __eClassType_ShyWaman then
        control.state = self._enum.eButtonStateLock
        control.staticText_EnableSpecialize:SetShow(false)
        self:changeTexturePage1Button(control.radiobutton, self._enum.eButtonStateLock)
        control.radiobutton:SetEnable(false)
        ...
        control.staticText_EnableSpecialize:SetShow(true)
        if getSelfPlayer():getClassType() == __eClassType_ShyWaman then
          control.staticText_EnableSpecialize:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_SKILLREINFORCE_AWAKEN_3"))
        else
...
function SkillSpecialize:isSkillChangePossible()
  ...
  if nil ~= control.reinforceIndex then
    ...
    if nil ~= skillNo then
      ...
      local selfGet = selfPlayer:get()
      local applyAwakenSkillReset = selfGet:isApplyChargeSkill(CppEnums.UserChargeType.eUserChargeType_UnlimitedSkillAwakening)
      local bookOfCombat = selfGet:isApplyChargeSkill(CppEnums.UserChargeType.eUserChargeType_BookOfCombat)
      local inventory = selfGet:getInventory()
      local hasMemoryFlag = inventory:getItemCount_s64(ItemEnchantKey(44195, 0))
      if toInt64(0, 0) == hasMemoryFlag and not applyAwakenSkillReset and not bookOfCombat then
        return false
      end
    end
...
function SkillSpecialize:setSkillButtonData(buttonIndex, control)
  ...
  control.staticText_Skill_Desc:SetTextMode(__eTextMode_Limit_AutoWrap)
  ...
  txt:SetTextMode(__eTextMode_Limit_AutoWrap)
...
function SkillSpecialize:setPage2SelectedSkill(skillNo)
  if nil == skillNo then
    ...
    self._ui.staticText_SkillDesc:SetTextMode(__eTextMode_Limit_AutoWrap)
...
function PaGlobalFunc_Dialog_SkillSpecialize_Page2SkillListCreate(list_content, key)
  ...
  staticText_SkillDesc:SetTextMode(__eTextMode_LimitText)
  local _type = self:getSkillAwakeningType(self._value.currentSpecializeIndex)
  local reinforcableCount = ToClient_GetAwakeningListCount()
  local count = 0
  for index = 0, reinforcableCount - 1 do
...
function PaGlobalFunc_Dialog_SkillSpecialize_Page2EffectListCreate(list_content, key)
  ...
  local skillSSW = getSkillStaticStatus(self._value.currentReinforceSkillNo, 1)
  local activeSkillSS = skillSSW:getActiveSkillStatus()
  radioButton_Effect:SetTextMode(__eTextMode_Limit_AutoWrap)
