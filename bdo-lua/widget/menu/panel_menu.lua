...
local MenuButtonId = {
  ...
  btn_AltarRank = 69,
  btn_SailerManager = 70,
  btn_Bater = 71,
  btn_ChannelChat = 72,
  btn_ArshaApplyWeb = 73,
  btn_Music = 74,
  btn_FarmingList = 75,
  btn_Homepage = 76,
  btn_GameOption = 77,
...
function TargetWindow_ShowToggle(index)
  ...
  elseif MenuButtonId.btn_Channel == index then
    if true == _ContentsGroup_NewUI_ChannelSelect_All and nil ~= Panel_ChannelSelect_All then
...
function GameMenu_CheckEnAble(buttonType)
  ...
  if buttonType == MenuButtonId.btn_FarmingList then
    returnValue = PaGlobal_Menu_IsOpenConetents(isFarmingListOpen, true)
  end
