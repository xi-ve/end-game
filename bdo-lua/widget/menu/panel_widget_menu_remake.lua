PaGlobal_Menu_Remake = {
  ...
  _contentsGroup = {
    ...
    _isMarketPlaceOpen = true == _ContentsGroup_RenewUI and ToClient_IsContentsGroupOpen("464") or _ContentsGroup_RenewUI_ItemMarketPlace,
    ...
    _isCopyright = false == isGameTypeKR2()
  },
  _conditionGroup = {},
  numberKeySetting = {
