...
PaGlobal_Menu._bannerData = {
  _hot = {
    ...
    [PaGlobal_Menu._bannerHot._itemMarket] = {
      ...
      _x2 = 376,
      _y2 = 116,
      _isContentOpen = false == _ContentsGroup_RenewUI_ItemMarketPlace_Only and false == isGameTypeKR2()
    },
    ...
    [PaGlobal_Menu._bannerHot._marketPlace] = {
      ...
      _x2 = 376,
      _y2 = 116,
      _isContentOpen = true == PaGlobal_Menu._contentsGroup._isMarketPlaceOpen and false == isGameTypeKR2()
    },
  ...
  _new = {
    ...
    [PaGlobal_Menu._bannerNew._blackDesertTv] = {
      ...
      _x2 = 188,
      _y2 = 58,
      _isContentOpen = false == PaGlobal_Menu._contentsGroup._isTestServer and false == isGameTypeKR2()
    },
...
PaGlobal_Menu._categoryData = {
  ...
  [3] = {
    ...
    [PaGlobal_Menu._infomation._warInfo] = {
      ...
      _x2 = 372,
      _y2 = 434,
      _isContentOpen = false == isGameTypeKR2(),
      _isNew = false,
      _isHot = false,
      _index = 36
    },
  ...
  [5] = {
    [PaGlobal_Menu._banner._blackDesertTv] = {
      ...
      _x2 = 124,
      _y2 = 62,
      _isContentOpen = not PaGlobal_Menu._contentsGroup._isTestServer and false == isGameTypeKR2(),
      _isNew = false,
      _isHot = false,
      _index = 51
    },
  ...
  elseif 3 == categoryIndex then
    ...
    elseif PaGlobal_Menu._infomation._warInfo == index then
      if true == _ContentsGroup_SeigeSeason5 then
        if _ContentsGroup_NewUI_GuildWarInfo_All then
