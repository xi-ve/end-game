...
function PaGlobal_FunctionButtonArea:OpenCheck()
  ...
  self._data[buttonId._worker]._isOpen = 0 < workerCount
  ...
  self._data[buttonId._pet]._isOpen = 0 < havePetCount
  local maidCount = getTotalMaidList()
  self._data[buttonId._maid]._isOpen = 0 <= maidCount
  local isRegisted = ToClient_isCampingReigsted()
  self._data[buttonId._camp]._isOpen = isRegisted
  self._data[buttonId._blackSpiritTraining]._isOpen = 50 <= playerLevel
