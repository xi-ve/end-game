...
function maidList:Init()
  ...
  for maidIndex = 0, self.maxShowCount - 1 do
    local temp = {}
    temp.name = UI.createControl(__ePAUIControl_StaticText, Panel_Window_MaidList, "StaticText_MaidName_" .. maidIndex)
    ...
    temp.town = UI.createControl(__ePAUIControl_StaticText, Panel_Window_MaidList, "StaticText_MaidTown_" .. maidIndex)
    ...
    temp.func = UI.createControl(__ePAUIControl_StaticText, Panel_Window_MaidList, "StaticText_MaidFunc_" .. maidIndex)
    ...
    temp.coolTime = UI.createControl(__ePAUIControl_StaticText, Panel_Window_MaidList, "StaticText_MaidCoolTime_" .. maidIndex)
