...
Panel_WorldmapKeyGuideInfo._controlList = {
  ...
  [7] = Panel_WorldmapKeyGuideInfo._staticText_LSC,
  [8] = Panel_WorldmapKeyGuideInfo._staticText_RSC,
  [9] = Panel_WorldmapKeyGuideInfo._staticText_DpadDown,
  [10] = Panel_WorldmapKeyGuideInfo._staticText_DpadUp
}
