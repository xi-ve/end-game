...
function initMenuButtons()
  ...
  local MenuButtonEventFunction = {
    [MenuButtonId.Btn_GameExit] = "PaGlobalFunc_UiMain_GameExitOpen(false)",
    [MenuButtonId.Btn_Setting] = "showGameOption()",
    [MenuButtonId.Btn_Menu] = "Panel_Menu_ShowToggle()",
    [MenuButtonId.Btn_BlackStone] = "GlobalKeyBinder_MouseKeyMap(" .. __eUiInputType_BlackSpirit .. ")",
    [MenuButtonId.Btn_Beauty] = "IngameCustomize_Show()",
    [MenuButtonId.Btn_CashShop] = "GlobalKeyBinder_MouseKeyMap(" .. __eUiInputType_CashShop .. ")",
    [MenuButtonId.Btn_Mail] = "GlobalKeyBinder_MouseKeyMap(" .. __eUiInputType_Mail .. ")",
    [MenuButtonId.Btn_FriendList] = "GlobalKeyBinder_MouseKeyMap(" .. __eUiInputType_FriendList .. ")",
    [MenuButtonId.Btn_Guild] = "GlobalKeyBinder_MouseKeyMap(" .. __eUiInputType_Guild .. ")"
  }
  ...
  for idx, controlId in ipairs(MenuButtonControlId) do
    ...
    buttonAni[idx] = UI.createControl(__ePAUIControl_Static, button, "Static_ButtonAni" .. idx)
...
local bubbleNoticeData = {
  ...
  },
  {
    _x = 115,
    _y = 50,
    _text = PAGetStringParam1(Defines.StringSheet_GAME, "LUA_UIMAIN_NOTICE_BLACKSTONE", "getKey", keyCustom_GetString_UiKey(__eUiInputType_BlackSpirit))
  },
  {
    _x = 70,
    _y = 50,
...
function UIMain_QuestUpdate()
  ...
  if questList_doHaveNewQuest() and checkNewQuestForEffect == false then
    ...
    blackSpritCall:SetText(PAGetStringParam1(Defines.StringSheet_GAME, "LUA_UIMAIN_BLACKSPIRIT_TOOLTIP", "getKey", keyCustom_GetString_UiKey(__eUiInputType_BlackSpirit)))
...
function FromClient_RegisterCoupon()
  ...
  if 0 < count then
    Panel_Coupon_Alert:SetShow(isCouponOpen and not _ContentsGroup_UsePadSnapping)
...
function FGlobal_ItemMarket_SetCount()
  ...
  itemMarketAlarmCount:SetShow(0 < alarmCount)
  itemMarketIcon:EraseAllEffect()
  if 0 < alarmCount then
    itemMarketIcon:AddEffect("fUI_ItemMarket_Alert_01A", true, 0, 0)
  end
end
...
function PaGlobalFunc_UiMain_GetMailButton()
  if nil ~= MenuButtonId.Btn_Mail then
    return MenuButtonId.Btn_Mail
  end
end
function PaGlobalFunc_UiMain_GameExitOpen(isAttack)
  if true == _ContentsGroup_NewUI_GameExit then
    PaGlobal_GameExit_All_ShowToggle(isAttack)
  else
    GameExitShowToggle(isAttack)
  end
end
UIMain_QuestUpdate()
...
registerEvent("FromClient_ApplyUISettingPanelInfo", "ResetPos_WidgetButton")
