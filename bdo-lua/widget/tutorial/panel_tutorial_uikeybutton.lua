...
function PaGlobal_TutorialUiKeyButton:changeActionKeyByKeySetting()
...
function PaGlobal_TutorialUiKeyButton:setShowAll(isShow)
...
function PaGlobal_TutorialUiKeyButton:computePosAll()
...
function PaGlobal_TutorialUiKeyButton:resetVertexAniAll()
...
function PaGlobal_TutorialUiKeyButton:disappearAll()
  self:resetVertexAniAll()
...
function PaGlobal_TutorialUiKeyButton:setAlphaAll(value)
...
function PaGlobal_TutorialUiKeyButton:setShow(key, isShow)
  self._ui[key]:SetShow(isShow)
end
function PaGlobal_TutorialUiKeyButton:setAlpha(key, value)
  self._ui[key]:SetAlpha(value)
end
function PaGlobal_TutorialUiKeyButton:setPrevUsingKey(key, isPrevUsing)
  self._prevUsingKey[key] = isPrevUsing
end
function PaGlobal_TutorialUiKeyButton:setPrevUsingKeyMany(isPrevUsing, ...)
...
function PaGlobal_TutorialUiKeyButton:setPrevUsingKeyAll(isPrevUsing)
  for key, value in pairs(self._ui) do
    self:setPrevUsingKey(key, isPrevUsing)
  end
end
function PaGlobal_TutorialUiKeyButton:ButtonToggleAll(isOn)
  for key, value in pairs(self._uvSet) do
    self:ButtonToggle(key, isOn)
  end
end
function PaGlobal_TutorialUiKeyButton:addEffect(key, effectName, isLoop, posX, posY)
  self._ui[key]:AddEffect(effectName, isLoop, posX, posY)
end
function PaGlobal_TutorialUiKeyButton:eraseEffectAll()
  for key, value in pairs(self._ui) do
    value:EraseAllEffect()
  end
end
local index = 0
function PaGlobal_TutorialUiKeyButton:ButtonToggle(key, isOn)
