...
local function updateDeltaTime_TamingBubble(deltaTime, index)
  ...
  if 1 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_1"))
    else
  ...
  elseif 2 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_2"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  elseif 3 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_3"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  elseif 4 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_4"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  elseif 5 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_5"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  elseif 6 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_6"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  elseif 7 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_7"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  elseif 8 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_8"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  elseif 9 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_9"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  elseif 10 == index then
    if _updateTime < 20 then
      ui._obsidian_Text:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_HORSE_TAMING_TUTORIAL_10"))
    else
      Panel_TamingBubble_Close()
      _updateTime = 0
    end
  ...
  ui._obsidian:SetPosY(basePosY - ui._obsidian:GetSizeY() + 75)
