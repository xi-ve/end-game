...
local function updateDeltaTime_SummonGamos(deltaTime)
  ...
  if 600 == _stepNo then
    ...
    elseif 10 <= _updateTime and _updateTime < 15 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(600, 0)
      end
    elseif 16 < _updateTime and _updateTime < 20 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(600, 1)
      end
    elseif 40 < _updateTime and _updateTime < 43 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(601, 0)
      end
    elseif 44 < _updateTime and _updateTime < 47 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(601, 1)
      end
    elseif 48 < _updateTime and _updateTime < 51 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(601, 2)
      end
    elseif 52 < _updateTime and _updateTime < 55 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(601, 3)
      end
    elseif 56 < _updateTime and _updateTime < 59 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(601, 4)
      end
    elseif 79 < _updateTime and _updateTime < 84 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(602, 0)
      end
    elseif 85 < _updateTime and _updateTime < 88 then
      if not ui._textBg:GetShow() then
        ui_Show(true)
        tutorial_UISet(602, 1)
      end
    elseif 89 < _updateTime then
