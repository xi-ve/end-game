...
PaGlobal_SummonBossTutorial_UiKeyButton = {
  _ui = {
    _button_Q = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_Q"),
    _button_W = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_W"),
    _button_A = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_A"),
    _button_S = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_S"),
    _button_D = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_D"),
    _button_E = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_E"),
    _button_F = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_F"),
    _button_T = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_T"),
    _button_Tab = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_Tab"),
    _button_Shift = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_Shift"),
    _button_Space = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_Space"),
    _button_Ctrl = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Btn_Ctrl"),
    _m0 = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_M0"),
    _m1 = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_M1"),
    _mBody = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Mouse_Body"),
    _buttonLock = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_Button_Lock"),
    _m0_Lock = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_M0_Lock"),
    _m1_Lock = UI.getChildControl(Panel_SummonBossTutorial, "StaticText_M1_Lock")
  },
  _uvSet = {
    _button_Q = {
      on = {
...
function PaGlobal_SummonBossTutorial_UiKeyButton:changeActionKeyByKeySetting()
  ...
  self._ui._button_Ctrl:SetText(keyCustom_GetString_UiKey(__eUiInputType_CursorOnOff))
end
function PaGlobal_SummonBossTutorial_UiKeyButton:setShowAll(isShow)
...
function PaGlobal_SummonBossTutorial_UiKeyButton:computePosAll()
...
function PaGlobal_SummonBossTutorial_UiKeyButton:resetVertexAniAll()
...
function PaGlobal_SummonBossTutorial_UiKeyButton:disappearAll()
  self:resetVertexAniAll()
...
function PaGlobal_SummonBossTutorial_UiKeyButton:setAlphaAll(value)
...
function PaGlobal_SummonBossTutorial_UiKeyButton:setShow(key, isShow)
  self._ui[key]:SetShow(isShow)
end
function PaGlobal_SummonBossTutorial_UiKeyButton:setAlpha(key, value)
  self._ui[key]:SetAlpha(value)
end
function PaGlobal_SummonBossTutorial_UiKeyButton:setPrevUsingKey(key, isPrevUsing)
  self._prevUsingKey[key] = isPrevUsing
end
function PaGlobal_SummonBossTutorial_UiKeyButton:setPrevUsingKeyMany(isPrevUsing, ...)
...
function PaGlobal_SummonBossTutorial_UiKeyButton:setPrevUsingKeyAll(isPrevUsing)
  for key, value in pairs(self._ui) do
    self:setPrevUsingKey(key, isPrevUsing)
  end
end
function PaGlobal_SummonBossTutorial_UiKeyButton:ButtonToggleAll(isOn)
  for key, value in pairs(self._uvSet) do
    self:ButtonToggle(key, isOn)
  end
end
function PaGlobal_SummonBossTutorial_UiKeyButton:addEffect(key, effectName, isLoop, posX, posY)
  self._ui[key]:AddEffect(effectName, isLoop, posX, posY)
end
function PaGlobal_SummonBossTutorial_UiKeyButton:eraseEffectAll()
  for key, value in pairs(self._ui) do
    value:EraseAllEffect()
  end
end
local index = 0
function PaGlobal_SummonBossTutorial_UiKeyButton:ButtonToggle(key, isOn)
  ...
  if key == "_button_Ctrl" then
    if true == isOn and keyCustom_IsPressed_Ui(__eUiInputType_CursorOnOff) then
      keyName = "click"
