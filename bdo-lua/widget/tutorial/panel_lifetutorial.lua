...
local function actionKey_Change()
  ...
  ui._button_Ctrl:SetText(keyCustom_GetString_UiKey(__eUiInputType_CursorOnOff))
end
local function bubbleKey_Change()
  ...
  ui._bubbleKey_I:SetText(keyCustom_GetString_UiKey(__eUiInputType_Inventory))
  ...
  ui._bubbleKey_Ctrl:SetText(keyCustom_GetString_UiKey(__eUiInputType_CursorOnOff))
end
