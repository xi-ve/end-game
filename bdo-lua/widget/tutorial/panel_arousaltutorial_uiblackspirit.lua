...
function PaGlobal_ArousalTutorial_UiBlackSpirit:showObsidian(isShow)
  self._ui._obsidian:SetShow(isShow)
  self._ui._obsidian_B:SetShow(isShow)
  self._ui._obsidian_Text:SetShow(isShow)
  self._ui._obsidian_B_Left:SetShow(isShow)
  self._ui._obsidian_Text_2:SetShow(isShow)
end
