PaGlobal_TutorialUiBlackSpirit = {
  _ui = {
    ...
    _bubbleKey_W = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_W"),
    _bubbleKey_A = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_A"),
    _bubbleKey_S = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_S"),
    _bubbleKey_D = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_D"),
    _bubbleKey_I = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_I"),
    _bubbleKey_R = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_R"),
    _bubbleKey_T = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_T"),
    _bubbleKey_Shift = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_Shift"),
    _bubbleKey_Ctrl = UI.getChildControl(Panel_Tutorial, "StaticText_BubbleKey_Ctrl"),
    _mouseBody_L = UI.getChildControl(Panel_Tutorial, "Static_MouseBody_L"),
    _mouseLButton_L = UI.getChildControl(Panel_Tutorial, "Static_L_Btn_L"),
    _mouseLButton_R = UI.getChildControl(Panel_Tutorial, "Static_L_Btn_R"),
    _mouseBody_R = UI.getChildControl(Panel_Tutorial, "Static_MouseBody_R"),
    _mouseRButton_L = UI.getChildControl(Panel_Tutorial, "Static_R_Btn_L"),
    _mouseRButton_R = UI.getChildControl(Panel_Tutorial, "Static_R_Btn_R")
  },
...
function PaGlobal_TutorialUiBlackSpirit:setShowMouseL(bShow)
  self._ui._mouseBody_L:SetShow(bShow)
  self._ui._mouseLButton_L:SetShow(bShow)
  self._ui._mouseLButton_R:SetShow(bShow)
end
function PaGlobal_TutorialUiBlackSpirit:setPosMouseL(posX, posY)
...
function PaGlobal_TutorialUiBlackSpirit:initialize()
  ...
  self._ui._obsidian_B:addInputEvent("Mouse_LUp", "PaGlobal_TutorialUiBlackSpirit:handleMouseLUpBubble()")
  self._ui._obsidian_B:addInputEvent("Mouse_LDown", "PaGlobal_TutorialUiBlackSpirit:handleMouseLDownBubble()")
  self._ui._obsidian_B:addInputEvent("Mouse_On", "PaGlobal_TutorialUiBlackSpirit:handleMouseOnBubble()")
  self._ui._obsidian_B:addInputEvent("Mouse_Out", "PaGlobal_TutorialUiBlackSpirit:handleMouseOutBubble()")
  self._ui._obsidian_B_Left:addInputEvent("Mouse_LUp", "PaGlobal_TutorialUiBlackSpirit:handleMouseLUpBubble()")
  self._ui._obsidian_B_Left:addInputEvent("Mouse_LDown", "PaGlobal_TutorialUiBlackSpirit:handleMouseLDownBubble()")
  self._ui._obsidian_B_Left:addInputEvent("Mouse_On", "PaGlobal_TutorialUiBlackSpirit:handleMouseOnBubble()")
  self._ui._obsidian_B_Left:addInputEvent("Mouse_Out", "PaGlobal_TutorialUiBlackSpirit:handleMouseOutBubble()")
end
function PaGlobal_TutorialUiBlackSpirit:getBubbleKeyMargin()
...
function PaGlobal_TutorialUiBlackSpirit:setShowBubbleKey(key, isShow)
  self._ui[key]:SetShow(isShow)
end
...
function PaGlobal_TutorialUiBlackSpirit:hideBubbleKey()
...
function PaGlobal_TutorialUiBlackSpirit:changeBubbleKeyByKeySetting()
  ...
  self._ui._bubbleKey_I:SetText(keyCustom_GetString_UiKey(__eUiInputType_Inventory))
  ...
  self._ui._bubbleKey_Ctrl:SetText(keyCustom_GetString_UiKey(__eUiInputType_CursorOnOff))
end
...
function PaGlobal_TutorialUiBlackSpirit:setSpiritUiForTutorial(text1, text2, isLeftSideBubble, spiritPosX, spiritPosY, isIgnore)
...
function PaGlobal_TutorialUiBlackSpirit:addBubbleKey(...)
...
function PaGlobal_TutorialUiBlackSpirit:addOverBubbleKey(destKey, targetKey)
...
function PaGlobal_TutorialUiBlackSpirit:getCurrentObsidianBubble()
...
function PaGlobal_TutorialUiBlackSpirit:setIgnoreBubble(bIgnore)
  local currentBubble = self:getCurrentObsidianBubble()
  currentBubble:SetIgnore(bIgnore)
end
function PaGlobal_TutorialUiBlackSpirit:handleMouseOnBubble()
  local currentBubble = self:getCurrentObsidianBubble()
...
function PaGlobal_TutorialUiBlackSpirit:handleMouseOutBubble()
  local currentBubble = self:getCurrentObsidianBubble()
  if nil ~= currentBubble then
    self:changeBubbleTextureForAni(true)
...
function PaGlobal_TutorialUiBlackSpirit:handleMouseLDownBubble()
  local currentBubble = self:getCurrentObsidianBubble()
  if nil ~= currentBubble then
    self:changeBubbleTextureForAni(true)
...
function PaGlobal_TutorialUiBlackSpirit:handleMouseLUpBubble()
  local currentBubble = self:getCurrentObsidianBubble()
  if nil ~= currentBubble then
    self:changeBubbleTextureForAni(true)
...
function PaGlobal_TutorialUiBlackSpirit:changeBubbleTextureForAni(bWhite)
