...
function PaGlobal_TutorialMenu:checkShowConditionWeight()
  local selfPlayer = getSelfPlayer()
  local playerLevel = selfPlayer:get():getLevel()
  if nil ~= self._refWeightOverUi and true == self._refWeightOverUi:GetShow() and true == PaGlobal_TutorialPhase_ItemSell._isPhaseOpen and 10 <= playerLevel and playerLevel <= 40 then
    return true
  end
  return false
end
function PaGlobal_TutorialMenu:checkShowConditionNewEquip()
  local selfPlayer = getSelfPlayer()
  local playerLevel = selfPlayer:get():getLevel()
  if true == Panel_NewEquip:GetShow() and true == PaGlobal_TutorialPhase_NewItemEquip._isPhaseOpen and 6 <= playerLevel and playerLevel <= 49 then
    return true
  end
  return false
end
