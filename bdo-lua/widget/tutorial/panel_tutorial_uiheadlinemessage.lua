...
function PaGlobal_TutorialUiHeadlineMessage:setPurposeText(string)
  if nil == string then
...
function PaGlobal_TutorialUiHeadlineMessage:setTextPurposeText(text)
...
function PaGlobal_TutorialUiHeadlineMessage:resetClearStepEffect()
  self:computePosAll()
  self._ui._nextStep_1:SetFontColor(Defines.Color.C_FFFFFFFF)
  self._ui._nextStep_2:SetFontColor(Defines.Color.C_FFFFFFFF)
  self._ui._nextStep_3:SetFontColor(Defines.Color.C_FFFFFFFF)
