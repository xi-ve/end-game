...
function SinGaugeBar_UpdateGauge()
  ...
  if sinGaugeBarStart == true then
    if 0 <= gaugeBarSizeX and gaugeIsGrowing == true and gaugeBarSizeX < 273 then
    ...
    elseif gaugeIsGrowing == false and 10 < gaugeBarSizeX and checkGaugeCount < 5 then
      ...
      _sinGaugeBar:SetSize(gaugeBarSizeX, 20)
    elseif gaugeIsGrowing == true and 273 <= gaugeBarSizeX then
      gaugeIsGrowing = false
      gaugeBarSizeX = 273
