PaGlobal_MiniGame_Gradient_All = {
  _ui = {
    ...
    stc_mouseBody_L = nil,
    stc_mouseBody_R = nil,
    stc_mouseButton_L = nil,
    stc_mouseButton_R = nil,
    stc_keyguideBG = nil,
    stc_keyguide_LT = nil,
    stc_keyguide_RT = nil,
    stc_gaugeBG = nil,
...
runLua("UI_Data/Script/Widget/MiniGame/Panel_MiniGame_Gradient_All_1.lua")
runLua("UI_Data/Script/Widget/MiniGame/Panel_MiniGame_Gradient_All_2.lua")
