...
function default_PosY_Size:Init()
  ...
  if true == isConsole then
    default_PosY_Size._Resource_gapY = 40
  end
end
...
local function Insert_Tooltip_Work_Data(esSSW, isToolTip, controlIndex, nodeInfo, nodeType, isGuildManufactureSelect)
  ...
  if nodeType == CppEnums.NpcWorkingType.eNpcWorkingType_PlantBuliding then
    ...
    PAGlobalFunc_SetItemTextColorForNewUI(self._Work_Name, itemSSW)
    ...
    PAGlobalFunc_SetItemTextColorForNewUI(self._Result_Name, itemSSW)
    ...
    for idx = 0, eSSCount - 1 do
      ...
      PAGlobalFunc_SetItemTextColorForNewUI(self._Resource_Name[idx], esSSW:getResourceItemStaticStatusWrapper(idx))
