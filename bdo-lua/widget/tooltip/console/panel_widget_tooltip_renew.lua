...
function TooltipInfo_updateDESCRIPTION(itemWrapper, itemSSW, tooltipTargetType)
  local desc = ""
  local clothBagSlotNo = Inventory_GetToolTipItemSlotNo()
  if Defines.TooltipTargetType.Item == tooltipTargetType and CppEnums.ContentsEventType.ContentsType_InventoryBag == itemSSW:get():getContentsEventType() and nil ~= clothBagSlotNo then
