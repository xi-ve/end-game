...
local normalTooltip = {
  ...
  _randomOptionTitle = UI.getChildControl(Panel_Tooltip_Item, "StaticText_RandomOptionTitle"),
  _randomOptionValue = {
    [0] = UI.getChildControl(Panel_Tooltip_Item, "StaticText_RandomOption1"),
    [1] = UI.getChildControl(Panel_Tooltip_Item, "StaticText_RandomOption2"),
    [2] = UI.getChildControl(Panel_Tooltip_Item, "StaticText_RandomOption3"),
    [3] = UI.getChildControl(Panel_Tooltip_Item, "StaticText_RandomOption4"),
    [4] = UI.getChildControl(Panel_Tooltip_Item, "StaticText_RandomOption5")
  },
...
local equippedTooltip = {
  ...
  _randomOptionTitle = UI.getChildControl(Panel_Tooltip_Item_equipped, "StaticText_RandomOptionTitle"),
  _randomOptionValue = {
    [0] = UI.getChildControl(Panel_Tooltip_Item_equipped, "StaticText_RandomOption1"),
    [1] = UI.getChildControl(Panel_Tooltip_Item_equipped, "StaticText_RandomOption2"),
    [2] = UI.getChildControl(Panel_Tooltip_Item_equipped, "StaticText_RandomOption3"),
    [3] = UI.getChildControl(Panel_Tooltip_Item_equipped, "StaticText_RandomOption4"),
    [4] = UI.getChildControl(Panel_Tooltip_Item_equipped, "StaticText_RandomOption5")
  },
...
local chattingLinkedItemTooltip = {
  ...
  _randomOptionTitle = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItem, "StaticText_RandomOptionTitle"),
  _randomOptionValue = {
    [0] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItem, "StaticText_RandomOption1"),
    [1] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItem, "StaticText_RandomOption2"),
    [2] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItem, "StaticText_RandomOption3"),
    [3] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItem, "StaticText_RandomOption4"),
    [4] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItem, "StaticText_RandomOption5")
  },
...
local chattingLinkedItemClickTooltip = {
  ...
  _randomOptionTitle = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItemClick, "StaticText_RandomOptionTitle"),
  _randomOptionValue = {
    [0] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItemClick, "StaticText_RandomOption1"),
    [1] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItemClick, "StaticText_RandomOption2"),
    [2] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItemClick, "StaticText_RandomOption3"),
    [3] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItemClick, "StaticText_RandomOption4"),
    [4] = UI.getChildControl(Panel_Tooltip_Item_chattingLinkedItemClick, "StaticText_RandomOption5")
  },
...
function Panel_Tooltip_Item_ShowInfo(target, inputValue, isSSW, isItemWrapper, chattingLinkedItem, index, isNextEnchantInfo, invenSlotNo, itemNamingStr)
  ...
  if true == _ContentsGroup_ItemRandomOption and nil ~= itemWrapper and false == itemWrapper:isEmptyRandomOption() or true == isKR2 then
  ...
  if 0 == nameColorGrade then
    target.itemName:SetFontColor(UI_color.C_FFC4C4C4)
  elseif 1 == nameColorGrade then
    target.itemName:SetFontColor(UI_color.C_FF83A543)
  elseif 2 == nameColorGrade then
    target.itemName:SetFontColor(UI_color.C_FF438DCC)
  elseif 3 == nameColorGrade then
    target.itemName:SetFontColor(UI_color.C_FFF5BA3A)
  elseif 4 == nameColorGrade then
    target.itemName:SetFontColor(UI_color.C_FFD05D48)
  else
    target.itemName:SetFontColor(UI_color.C_FFC4C4C4)
  end
  ...
  target._randomOptionTitle:SetShow(false)
  for index = 0, __eMaxItemOptionCount - 1 do
    target._randomOptionValue[index]:SetShow(false)
  end
  target._randomOptionTitle:SetSize(300, target._randomOptionTitle:GetSizeY())
  target._randomOptionTitle:SetTextMode(__eTextMode_AutoWrap)
  if true == _ContentsGroup_ItemRandomOption and nil ~= itemWrapper and true == itemWrapper:isRandomOptionTarget() then
    target._randomOptionTitle:SetShow(true)
    if true == itemWrapper:isEmptyRandomOption() then
      for index = 0, __eMaxItemOptionCount - 1 do
        if 0 == index then
          ...
          target._randomOptionValue[index]:SetText(randomOptionStr)
          target._randomOptionValue[index]:SetShow(true)
        else
          target._randomOptionValue[index]:SetShow(false)
        end
      end
      ...
      for index = 0, __eMaxItemOptionCount - 1 do
        if index <= #randomStatList then
          target._randomOptionValue[index]:SetText(randomStatList[index + 1]._statValueStr)
          target._randomOptionValue[index]:SetShow(true)
        else
          target._randomOptionValue[index]:SetShow(false)
        end
...
- ]] .. itemSSW:getEnchantDescription()
  ...
  if isTradeItem then
    ...
    if s64_originalPrice > _const.s64_0 and 0 == enchantLevel then
      if __ePriceType_Shell == itemSSW:getTradePriceType() then
        target.itemPrice_storeSell_value:SetText(PAGetString(Defines.StringSheet_GAME, "LUA_AUCTION_SEASHELL") .. " " .. tostring(makeDotMoney(s64_originalPrice)))
      else
  ...
  if target._randomOptionTitle:GetShow() then
    target._randomOptionTitle:SetPosY(TooltipYPos + 5)
    TooltipYPos = GetBottomPos(target._randomOptionTitle, true)
    for index = 0, 4 do
      if target._randomOptionValue[index]:GetShow() then
        target._randomOptionValue[index]:SetPosX(target._randomOptionTitle:GetPosX() + 10)
        target._randomOptionValue[index]:SetPosY(TooltipYPos + 1)
        TooltipYPos = GetBottomPos(target._randomOptionValue[index], true)
      end
    end
