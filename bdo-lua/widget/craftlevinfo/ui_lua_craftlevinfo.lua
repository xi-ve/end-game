...
local helpWidget = UI.createControl(__ePAUIControl_StaticText, Panel_Widget_CraftLevInfo, "HelpWindow_For_CraftLevInfo")
...
helpWidget:SetTextMode(__eTextMode_AutoWrap)
...
function CraftLevInfo:Update()
  ...
  if true == _ContentsGroup_RenewUI then
    ...
    self.gathering_LevText:SetText(PaGlobalFunc_Util_CraftLevelReplace(gatherLevel))
  end
  ...
  if true == _ContentsGroup_RenewUI then
    ...
    self.manufacture_LevText:SetText(PaGlobalFunc_Util_CraftLevelReplace(manufatureLevel))
  end
  ...
  if true == _ContentsGroup_RenewUI then
    ...
    self.cook_LevText:SetText(PaGlobalFunc_Util_CraftLevelReplace(cookingLevel))
  end
  ...
  if true == _ContentsGroup_RenewUI then
    ...
    self.alchemy_LevText:SetText(PaGlobalFunc_Util_CraftLevelReplace(alchemyLevel))
  end
  ...
  if true == _ContentsGroup_RenewUI then
    ...
    self.fishing_LevText:SetText(PaGlobalFunc_Util_CraftLevelReplace(fishingLevel))
  end
  ...
  if true == _ContentsGroup_RenewUI then
    ...
    self.hunting_LevText:SetText(PaGlobalFunc_Util_CraftLevelReplace(huntingLevel))
  end
  ...
  if true == _ContentsGroup_RenewUI then
    ...
    self.training_LevText:SetText(PaGlobalFunc_Util_CraftLevelReplace(trainingLevel))
  end
  ...
  if true == _ContentsGroup_RenewUI then
    ...
    self.trade_LevText:SetText(PaGlobalFunc_Util_CraftLevelReplace(tradeLevel))
  end
