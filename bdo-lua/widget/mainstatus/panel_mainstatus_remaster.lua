...
function MainStatus:setMPBarTexture()
  ...
  elseif classType == __eClassType_Sorcerer or classType == __eClassType_WizardWoman or classType == __eClassType_WizardMan or classType == __eClassType_Tamer or classType == __eClassType_Hashashin then
...
function MainStatus:checkHpAlert(hp, maxHp, isLevelUp)
  ...
  if 40 <= totalHp and false == self._strongMonsterAlert then
...
function MainStatus:updateResource()
  ...
  elseif __eClassType_BladeMasterWoman == classType then
    ...
    if true == self._ui.stc_ClassType3:GetShow() and 2 <= resourceCount then
