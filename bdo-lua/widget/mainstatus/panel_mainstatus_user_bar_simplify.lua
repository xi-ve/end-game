...
function PaGlobal_MainStatus_User_Bar_simplify:Initialize()
  ...
  self._combatResourceTypeList = {
    [__eClassType_ElfRanger] = self._combatResource_EP_RG,
    [__eClassType_DarkElf] = self._combatResource_EP_DE,
    [__eClassType_RangerMan] = self._combatResource_EP_RG,
    [__eClassType_Warrior] = self._combatResource_FP,
    [__eClassType_Giant] = self._combatResource_FP,
    [__eClassType_BladeMaster] = self._combatResource_FP,
    [__eClassType_BladeMasterWoman] = self._combatResource_FP,
    [__eClassType_Kunoichi] = self._combatResource_FP,
    [__eClassType_Combattant] = self._combatResource_FP,
    [__eClassType_Mystic] = self._combatResource_FP,
    [__eClassType_Lhan] = self._combatResource_FP,
    [__eClassType_Guardian] = self._combatResource_FP,
    [__eClassType_Valkyrie] = self._combatResource_BP
  }
  self._uvDataList = {
