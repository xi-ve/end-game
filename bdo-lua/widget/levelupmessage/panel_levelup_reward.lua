...
function LevelUp_ShowStatus_Init()
  ...
  for index = 1, copyBaseCount do
    local _lvup_Status = UI.createControl(__ePAUIControl_StaticText, Panel_Levelup_Reward, "StaticText_Status_" .. index)
...
function LevelUp_Update_ShowFunction(deltaTime)
  ...
  if 5 < currTime and Panel_Levelup_Reward:IsShow() == true then
    currTime = 0
