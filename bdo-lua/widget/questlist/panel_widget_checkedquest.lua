...
function PaGlobalFunc_CheckedQuest_CloseQuestInfo()
  ...
  elseif true == Panel_CheckedQuestInfo:GetShow() then
...
function checkedQuestWidget:doReleaseCheckForTutorial()
  ...
  if true == self._welcomeToTheWorld then
      ...
      if nil ~= temp_questGroupInfo then
        if true == temp_questGroupInfo:isGroupQuest() then
          ...
          for questGroupIdx = 0, tempGroupCount - 1 do
            ...
            if tempQuestInfo._isProgressing and not tempQuestInfo._isCleared and self._welcomeToTheWorld and not TutorialQuestCompleteCheck() and (3 == tempQuestInfo:getQuestType() or 4 == tempQuestInfo:getQuestType() or 5 == tempQuestInfo:getQuestType() or 6 == tempQuestInfo:getQuestType() or recommandLevel > selfLevel) then
    ...
    if self._welcomeToTheWorld and not TutorialQuestCompleteCheck() and 0 < temp_progressCount then
...
function checkedQuestWidget:handleClicked_QuestWidgetPanelResize()
  ...
  local mousePosY = getMousePosY()
  if 300 < orgPanelSizeY + deltaY and orgPanelSizeY + deltaY < 700 then
...
function HandleClicked_QuestReward_Show(groupId, questId, window)
  ...
  if false == _ContentsGroup_RenewUI and false == _ContentsGroup_NewUI_Quest_All and Panel_Window_Quest_New:IsUISubApp() == true then
