...
function mainQuestWidget:SetTutorial(index)
  ...
  self._ui._clearNpcEffect:SetPosY(clearNpcPos)
  self._ui._clearNpcEffect2:SetPosY(clearNpcPos)
  self._ui._mouseR:SetPosY(clearNpcPos + 1)
...
function mainQuestWidget:mouseOverToMaindQuestWidget(isMouseOver, isAcceptedQuest)
  ...
  if true == isMouseOver then
    ...
    local isSelectedNaviBtn = self._ui._checkButton_AutoNavi:IsCheck() or self._ui._checkbox_Quest_Navi:IsCheck()
