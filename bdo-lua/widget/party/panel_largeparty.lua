...
function PaGlobal_LargeParty:Initialize()
  ...
  self._ui._staticTextUserName:SetTextMode(__eTextMode_LimitText)
  self._ui._staticTextRightUserName:SetTextMode(__eTextMode_LimitText)
  for index = 0, self._maxPartyMemberCount - 1 do
    local partyMember = {}
    partyMember._base = UI.createControl(__ePAUIControl_Static, Panel_LargeParty, "PartyMember_Back" .. index)
    ...
    partyMember._actionBtn = UI.createControl(__ePAUIControl_Button, partyMember._base, "PartyMember_ActionBtn" .. index)
    partyMember._deadConditionBG = UI.createControl(__ePAUIControl_Static, partyMember._base, "PartyMember_DeadConditionBG" .. index)
    partyMember._deadCondition = UI.createControl(__ePAUIControl_StaticText, partyMember._base, "PartyMember_DeadCondition" .. index)
    if index < 10 then
