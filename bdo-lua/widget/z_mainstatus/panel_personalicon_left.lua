...
function FromClient_PackageIconUpdate()
  ...
  if true == isPremiumPcRoom and not isGameTypeRussia() and not isGameTypeEnglish() and not isGameTypeSA() and not isGameTypeKR2() and not isGameServiceTypeConsole() then
