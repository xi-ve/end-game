...
function Potential_UI:Init()
  ...
  for idx = 0, potenMaxNo - 1 do
    Potential_UI.attackspeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._attackSpeedText, "attackSpeed_SlotBG_" .. idx)
    ...
    Potential_UI.attackspeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._attackSpeedText, "attackSpeed_Slot_" .. idx)
    ...
    Potential_UI.attackspeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._attackSpeedText, "attackSpeed_MinusSlot_" .. idx)
    ...
    Potential_UI.castspeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._castingSpeedText, "castspeed_SlotBG_" .. idx)
    ...
    Potential_UI.castspeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._castingSpeedText, "castspeed_Slot_" .. idx)
    ...
    Potential_UI.castspeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._castingSpeedText, "castspeed_MinusSlot_" .. idx)
    ...
    Potential_UI.movespeed_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._moveSpeedText, "movespeed_SlotBG_" .. idx)
    ...
    Potential_UI.movespeed_Slot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._moveSpeedText, "movespeed_Slot_" .. idx)
    ...
    Potential_UI.movespeed_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._moveSpeedText, "movespeed_MinusSlot_" .. idx)
    ...
    Potential_UI.critical_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._criticalRateText, "critical_SlotBG_" .. idx)
    ...
    Potential_UI.critical_Slot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._criticalRateText, "critical_Slot_" .. idx)
    ...
    Potential_UI.critical_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._criticalRateText, "critical_MinusSlot_" .. idx)
    ...
    Potential_UI.fishTime_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._fishingRateText, "fishTime_SlotBG_" .. idx)
    ...
    Potential_UI.fishTime_Slot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._fishingRateText, "fishTime_Slot_" .. idx)
    ...
    Potential_UI.fishTime_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._fishingRateText, "fishTime_MinusSlot_" .. idx)
    ...
    Potential_UI.product_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._gatheringRateText, "product_SlotBG_" .. idx)
    ...
    Potential_UI.product_Slot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._gatheringRateText, "product_Slot_" .. idx)
    ...
    Potential_UI.product_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._gatheringRateText, "product_MinusSlot_" .. idx)
    ...
    Potential_UI.dropChance_SlotBG[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._dropItemRateText, "dropChance_SlotBG_" .. idx)
    ...
    Potential_UI.dropChance_Slot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._dropItemRateText, "dropChance_Slot_" .. idx)
    ...
    Potential_UI.dropChance_MinusSlot[idx] = UI.createControl(__ePAUIControl_Static, Poten_UI._dropItemRateText, "dropChance_MinusSlot_" .. idx)
...
function Potencial_Up_Update_ShowFunction(deltaTime)
  ...
  if 3.5 < currTime and Panel_Potencial_Up:IsShow() == true then
    currTime = 0
