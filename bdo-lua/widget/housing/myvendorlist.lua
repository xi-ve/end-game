...
function MyVendorList:initialize()
  ...
  function createVendorList(pIndex)
    local rtVendor = {}
    rtVendor._staticBack = UI.createControl(__ePAUIControl_Static, Panel_MyVendor_List, "Static_BackGround_" .. pIndex)
    rtVendor._staticType = UI.createControl(__ePAUIControl_StaticText, rtVendor._staticBack, "Static_Type" .. pIndex)
    rtVendor._staticName = UI.createControl(__ePAUIControl_StaticText, rtVendor._staticBack, "Static_Name" .. pIndex)
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"MyVendorList\"")
