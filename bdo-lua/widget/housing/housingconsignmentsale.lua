...
function ConsignmentSaleManager:initialize()
  ...
  function createConsignmentSaleList(pIndex, pName)
    local rtConsignment = {}
    rtConsignment._staticBack = UI.createControl(__ePAUIControl_Static, Panel_Housing_ConsignmentSale, "Static_BackGround_" .. pIndex .. pName)
    rtConsignment._buttonBuy = UI.createControl(__ePAUIControl_Button, rtConsignment._staticBack, "Button_Buy_" .. pIndex .. pName)
    rtConsignment._textBuyPrice = UI.createControl(__ePAUIControl_StaticText, rtConsignment._staticBack, "Text_BuyPrice_" .. pIndex .. pName)
    rtConsignment._textRegisterPrice = UI.createControl(__ePAUIControl_StaticText, rtConsignment._staticBack, "Text_RegisterPrice" .. pIndex .. pName)
    rtConsignment._staticRemainedTime = UI.createControl(__ePAUIControl_StaticText, rtConsignment._staticBack, "Text_ItemCount_" .. pIndex .. pName)
    rtConsignment._staticItemicon = UI.createControl(__ePAUIControl_Static, rtConsignment._staticBack, "Static_Itemicon_" .. pIndex .. pName)
    rtConsignment._staticItemName = UI.createControl(__ePAUIControl_StaticText, rtConsignment._staticBack, "StaticText_ItemName_" .. pIndex .. pName)
    rtConsignment._staticRegisterPrice = UI.createControl(__ePAUIControl_StaticText, rtConsignment._staticBack, "StaticText_RegisterPrice_" .. pIndex .. pName)
    rtConsignment._staticBuyPrice = UI.createControl(__ePAUIControl_StaticText, rtConsignment._staticBack, "StaticText_BuyPrice_" .. pIndex .. pName)
    rtConsignment._iconRegister = UI.createControl(__ePAUIControl_StaticText, rtConsignment._staticBack, "StaticText_RegisterIcon_" .. pIndex .. pName)
    rtConsignment._IconSale = UI.createControl(__ePAUIControl_StaticText, rtConsignment._staticBack, "StaticText_SaleIcon_" .. pIndex .. pName)
    rtConsignment._editRegisterPrice = UI.createControl(__ePAUIControl_Edit, rtConsignment._staticBack, "Edit_RegistPrice_" .. pIndex .. pName)
    ...
    if 0 == pIndex and "Sale" == pName then
      rtConsignment._editSalePrice = UI.createControl(__ePAUIControl_Edit, rtConsignment._staticBack, "Edit_SalePrice_" .. pIndex .. pName)
      rtConsignment._buttonRegister = UI.createControl(__ePAUIControl_Button, rtConsignment._staticBack, "Button_Register_" .. pIndex .. pName)
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"HousingConsignmentSale\"")
...
function ConsignmentSaleManager:Show()
  ...
  if false == Panel_Housing_ConsignmentSale:IsShow() then
    ...
    ConsignmentSaleManager._itemCount = 0
    if true == _ContentsGroup_NewUI_Inventory_All then
      PaGlobalFunc_Inventory_All_SetInventoryDragNoUse(Panel_Housing_ConsignmentSale)
    else
