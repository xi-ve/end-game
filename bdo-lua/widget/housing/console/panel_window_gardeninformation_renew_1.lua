...
function PaGlobal_GardenInformation:registEventHandler()
  ...
  PaGlobal_GardenInformation._ui._list2_cropInfo:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_GardenInformation_addGardenCropContent")
  PaGlobal_GardenInformation._ui._list2_cropInfo:createChildContent(__ePAUIList2ElementManagerType_List)
end
