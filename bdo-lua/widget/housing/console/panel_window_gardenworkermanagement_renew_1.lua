function PaGlobal_GardenWorkerManagement:initialize()
  ...
  txt_workerDesc:SetTextMode(__eTextMode_AutoWrap)
...
function PaGlobal_GardenWorkerManagement:registEventHandler()
  ...
  PaGlobal_GardenWorkerManagement._ui._list2_workerList:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_GardenWorkerManagement_List2EventControlCreate")
  PaGlobal_GardenWorkerManagement._ui._list2_workerList:createChildContent(__ePAUIList2ElementManagerType_List)
