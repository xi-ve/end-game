...
function PaGlobal_GardenList:registEventHandler()
  ...
  PaGlobal_GardenList._ui._list2_garden:registEvent(__ePAUIList2EventType_LuaChangeContent, "PaGlobal_GardenList_addGardenListContent")
  PaGlobal_GardenList._ui._list2_garden:createChildContent(__ePAUIList2ElementManagerType_List)
end
