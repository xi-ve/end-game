...
function VendingMachineManager:initialize()
  ...
  function createVendingMechineList(pIndex)
    local rtMachine = {}
    rtMachine._staticBack = UI.createControl(__ePAUIControl_Static, Panel_Housing_VendingMachineList, "Static_BackGround_" .. pIndex)
    rtMachine._buttonBuy = UI.createControl(__ePAUIControl_Button, rtMachine._staticBack, "Button_Buy_" .. pIndex)
    rtMachine._buttonSell = UI.createControl(__ePAUIControl_Button, rtMachine._staticBack, "Button_Sell_" .. pIndex)
    rtMachine._buttonOut = UI.createControl(__ePAUIControl_Button, rtMachine._staticBack, "Button_Out_" .. pIndex)
    rtMachine._buttonIn = UI.createControl(__ePAUIControl_Button, rtMachine._staticBack, "Button_In_" .. pIndex)
    rtMachine._textBuyPrice = UI.createControl(__ePAUIControl_StaticText, rtMachine._staticBack, "Text_BuyPrice_" .. pIndex)
    rtMachine._textSellPrice = UI.createControl(__ePAUIControl_StaticText, rtMachine._staticBack, "Text_SellPrice_" .. pIndex)
    rtMachine._textItemCount = UI.createControl(__ePAUIControl_StaticText, rtMachine._staticBack, "Text_ItemCount_" .. pIndex)
    rtMachine._textMaxCount = UI.createControl(__ePAUIControl_StaticText, rtMachine._staticBack, "Text_MaxCount_" .. pIndex)
    rtMachine._staticItemIcon = UI.createControl(__ePAUIControl_Static, rtMachine._staticBack, "Static_ItemIcon_" .. pIndex)
    rtMachine._staticItemName = UI.createControl(__ePAUIControl_StaticText, rtMachine._staticBack, "StaticText_ItemName_" .. pIndex)
    rtMachine._staticBuyPrice = UI.createControl(__ePAUIControl_StaticText, rtMachine._staticBack, "StaticText_BuyPrice_" .. pIndex)
    rtMachine._staticSellPrice = UI.createControl(__ePAUIControl_StaticText, rtMachine._staticBack, "StaticText_SellPrice_" .. pIndex)
    rtMachine._staticMaxCount = UI.createControl(__ePAUIControl_StaticText, rtMachine._staticBack, "StaticText_MaxCount_" .. pIndex)
    rtMachine._editBuyPrice = UI.createControl(__ePAUIControl_Edit, rtMachine._staticBack, "Edit_BuyPrice_" .. pIndex)
    rtMachine._editSellPrice = UI.createControl(__ePAUIControl_Edit, rtMachine._staticBack, "Edit_SellPrice_" .. pIndex)
    rtMachine._editMaxCount = UI.createControl(__ePAUIControl_Edit, rtMachine._staticBack, "Edit_MaxCount_" .. pIndex)
    rtMachine._buttonDeleteItem = UI.createControl(__ePAUIControl_Button, rtMachine._staticBack, "Button_DeleteItem_" .. pIndex)
  ...
  PaGlobal_Util_RegistHelpTooltipEvent(self._buttonQuestion, "\"HosingVendingMachine\"")
...
function VendingMachineManager:Show()
  if false == Panel_Housing_VendingMachineList:IsShow() then
    if true == _ContentsGroup_NewUI_Inventory_All then
      PaGlobalFunc_Inventory_All_SetInventoryDragNoUse(Panel_Housing_VendingMachineList)
    else
