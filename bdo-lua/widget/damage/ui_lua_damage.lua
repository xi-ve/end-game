...
function DamageOutputFunction_OnDamage(attakeeKeyRaw, effectNumber, effectType, additionalDamageType, posFloat3, isTribeAttack, attackerActorKeyRaw, isNotRandom)
  ...
  if (96 == effectType or 97 == effectType or 93 == effectType or 92 == effectType or 91 == effectType) and 0 == effectNumber then
    return
  end
  ...
  if 96 == effectType or 97 == effectType or 93 == effectType or 92 == effectType or 91 == effectType then
