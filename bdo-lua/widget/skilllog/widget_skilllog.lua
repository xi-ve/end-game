...
notifySkillMsg[0] = UI.createControl(__ePAUIControl_StaticText, Panel_Widget_SkillLog, "StaticText_SkillMsg_1")
CopyBaseProperty(skillLog, notifySkillMsg[0])
notifySkillMsg[1] = UI.createControl(__ePAUIControl_StaticText, Panel_Widget_SkillLog, "StaticText_SkillMsg_2")
CopyBaseProperty(skillLog, notifySkillMsg[1])
notifySkillMsg[2] = UI.createControl(__ePAUIControl_StaticText, Panel_Widget_SkillLog, "StaticText_SkillMsg_3")
