...
local _movieLength, _movieURL, _movieOrder
...
if isGameTypeKR2() then
  ...
  bgImageTexture = {}
  bgImageTexture = {
    [0] = "New_UI_Common_ForLua/Window/Lobby/bgBase_1.dds",
    [1] = "New_UI_Common_ForLua/Window/Lobby/bgBase_2.dds",
    [2] = "New_UI_Common_ForLua/Window/Lobby/bgBase_3.dds",
    [3] = "New_UI_Common_ForLua/Window/Lobby/bgCalpeon_1.dds",
    [4] = "New_UI_Common_ForLua/Window/Lobby/bgCalpeon_2.dds",
    [5] = "New_UI_Common_ForLua/Window/Lobby/bgCalpeon_3.dds",
    [6] = "New_UI_Common_ForLua/Window/Lobby/bgCalpeon_4.dds",
    count = 7
  }
end
...
function LoadingPanel_Init()
  ...
  if true == isGameServiceTypeConsole() or isGameTypeKR2() then
    stc_movieBG:SetShow(false)
    stc_fade:SetShow(false)
  end
end
...
function LoadingPanel_LoadMovie()
  if false == _ContentsGroup_RemasterUI_Lobby or true == isGameServiceTypeConsole() or isGameTypeKR2() then
    return
  end
  stc_movieBG:SetShow(true)
  if nil == _ui_web_loadingMovie then
    _ui_web_loadingMovie = UI.createControl(__ePAUIControl_WebControl, backGroundEvnetImage, "Static_LoadingMovie")
    _ui_web_loadingMovie:addInputEvent("Mouse_LUp", "LoadingPanel_SetRandomGuide()")
  end
...
function LoadingPanel_SetRandomGuide()
  ...
  control:SetText(tostring(randomGuideText))
  control:ComputePos()
end
RegisterEvent()
